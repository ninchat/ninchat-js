...
$packages["sort"]=(function(){var $pkg={},$init,A;A=function(a,b){var $ptr,a,b,c,d,e,f,g,h,i,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=0;d=a;e=c;f=d;case 1:if(!(e<f)){$s=2;continue;}h=e+(g=((f-e>>0))/2,(g===g&&g!==1/0&&g!==-1/0)?g>>0:$throwRuntimeError("integer divide by zero"))>>0;i=b(h);$s=6;case 6:if($c){$c=false;i=i.$blk();}if(i&&i.$blk!==undefined){break s;}if(!i){$s=3;continue;}$s=4;continue;case 3:e=h+1>>0;$s=5;continue;case 4:f=h;case 5:$s=1;continue;case 2:return e;}return;}if($f===undefined){$f={$blk:A};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.$s=$s;$f.$r=$r;return $f;};$pkg.Search=A;$init=function(){$pkg.$init=function(){};var $f,$c=false,$s=0,$r;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:}return;}if($f===undefined){$f={$blk:$init};}$f.$s=$s;$f.$r=$r;return $f;};$pkg.$init=$init;return $pkg;})();
$packages["github.com/ninchat/ninchat-go"]=(function(){var $pkg={},$init,A,B,C,F,G,H,K,Y,Z,AC,AU,AV,AW,AX,BB,BH,BI,BJ,BK,BL,BM,BN,BO,BP,BQ,BR,BS,BT,BU,BV,BW,BX,BY,BZ,CA,CB,CC,CD,CE,CF,CG,V,W,AT,BA,D,E,L,M,N,O,Q,R,S,T,U,X,AA,AB,AD,AE,AF,AG,AH,AI,AJ,AK,AL,AM,AN,AO,AP,AQ,AR,AS,AY,AZ,BC,BD,BE,BF,BG;A=$packages["errors"];B=$packages["github.com/gopherjs/gopherjs/js"];C=$packages["sort"];F=$pkg.Action=$newType(0,$kindStruct,"ninchat.Action","Action","github.com/ninchat/ninchat-go",function(Params_,Payload_,OnReply_,id_){this.$val=this;if(arguments.length===0){this.Params=false;this.Payload=BP.nil;this.OnReply=$throwNilPointerError;this.id=new $Int64(0,0);return;}this.Params=Params_;this.Payload=Payload_;this.OnReply=OnReply_;this.id=id_;});G=$pkg.Event=$newType(0,$kindStruct,"ninchat.Event","Event","github.com/ninchat/ninchat-go",function(Params_,Payload_,LastReply_){this.$val=this;if(arguments.length===0){this.Params=false;this.Payload=BP.nil;this.LastReply=false;return;}this.Params=Params_;this.Payload=Payload_;this.LastReply=LastReply_;});H=$pkg.backoff=$newType(0,$kindStruct,"ninchat.backoff","backoff","github.com/ninchat/ninchat-go",function(lastSlot_){this.$val=this;if(arguments.length===0){this.lastSlot=0;return;}this.lastSlot=lastSlot_;});K=$pkg.Caller=$newType(0,$kindStruct,"ninchat.Caller","Caller","github.com/ninchat/ninchat-go",function(Address_){this.$val=this;if(arguments.length===0){this.Address="";return;}this.Address=Address_;});Y=$pkg.httpHeader=$newType(4,$kindMap,"ninchat.httpHeader","httpHeader","github.com/ninchat/ninchat-go",null);Z=$pkg.httpRequest=$newType(0,$kindStruct,"ninchat.httpRequest","httpRequest","github.com/ninchat/ninchat-go",function(Method_,URL_,Header_,data_){this.$val=this;if(arguments.length===0){this.Method="";this.URL="";this.Header=false;this.data=null;return;}this.Method=Method_;this.URL=URL_;this.Header=Header_;this.data=data_;});AC=$pkg.httpResponse=$newType(0,$kindStruct,"ninchat.httpResponse","httpResponse","github.com/ninchat/ninchat-go",function(data_,err_){this.$val=this;if(arguments.length===0){this.data=null;this.err=$ifaceNil;return;}this.data=data_;this.err=err_;});AU=$pkg.Session=$newType(0,$kindStruct,"ninchat.Session","Session","github.com/ninchat/ninchat-go",function(OnSessionEvent_,OnEvent_,OnConnState_,OnConnActive_,OnLog_,Address_,forceLongPoll_,sessionParams_,sessionId_,latestConnState_,lastActionId_,sendNotify_,sendBuffer_,numSent_,sendEventAck_,receivedEventId_,ackedEventId_,closeNotify_,closed_,running_){this.$val=this;if(arguments.length===0){this.OnSessionEvent=$throwNilPointerError;this.OnEvent=$throwNilPointerError;this.OnConnState=$throwNilPointerError;this.OnConnActive=$throwNilPointerError;this.OnLog=$throwNilPointerError;this.Address="";this.forceLongPoll=false;this.sessionParams=false;this.sessionId=$ifaceNil;this.latestConnState="";this.lastActionId=new $Int64(0,0);this.sendNotify=$chanNil;this.sendBuffer=BW.nil;this.numSent=0;this.sendEventAck=false;this.receivedEventId=new $Int64(0,0);this.ackedEventId=new $Int64(0,0);this.closeNotify=$chanNil;this.closed=false;this.running=false;return;}this.OnSessionEvent=OnSessionEvent_;this.OnEvent=OnEvent_;this.OnConnState=OnConnState_;this.OnConnActive=OnConnActive_;this.OnLog=OnLog_;this.Address=Address_;this.forceLongPoll=forceLongPoll_;this.sessionParams=sessionParams_;this.sessionId=sessionId_;this.latestConnState=latestConnState_;this.lastActionId=lastActionId_;this.sendNotify=sendNotify_;this.sendBuffer=sendBuffer_;this.numSent=numSent_;this.sendEventAck=sendEventAck_;this.receivedEventId=receivedEventId_;this.ackedEventId=ackedEventId_;this.closeNotify=closeNotify_;this.closed=closed_;this.running=running_;});AV=$pkg.transport=$newType(4,$kindFunc,"ninchat.transport","transport","github.com/ninchat/ninchat-go",null);AW=$pkg.duration=$newType(8,$kindInt64,"ninchat.duration","duration","github.com/ninchat/ninchat-go",null);AX=$pkg.timer=$newType(0,$kindStruct,"ninchat.timer","timer","github.com/ninchat/ninchat-go",function(C_,id_){this.$val=this;if(arguments.length===0){this.C=$chanNil;this.id=null;return;}this.C=C_;this.id=id_;});BB=$pkg.webSocket=$newType(0,$kindStruct,"ninchat.webSocket","webSocket","github.com/ninchat/ninchat-go",function(notify_,goingAway_,err_,impl_,open_,buf_){this.$val=this;if(arguments.length===0){this.notify=$chanNil;this.goingAway=false;this.err=$ifaceNil;this.impl=null;this.open=false;this.buf=BP.nil;return;}this.notify=notify_;this.goingAway=goingAway_;this.err=err_;this.impl=impl_;this.open=open_;this.buf=buf_;});BH=$sliceType($String);BI=$sliceType($emptyInterface);BJ=$mapType($String,$emptyInterface);BK=$ptrType(G);BL=$sliceType(BK);BM=$ptrType(BI);BN=$ptrType(BJ);BO=$ptrType(B.Object);BP=$sliceType(BO);BQ=$sliceType($Uint8);BR=$ptrType(Z);BS=$funcType([],[],false);BT=$ptrType($Bool);BU=$structType([]);BV=$ptrType(F);BW=$sliceType(BV);BX=$ptrType(AX);BY=$ptrType(BB);BZ=$funcType([BO],[],false);CA=$funcType([BK],[],false);CB=$ptrType(H);CC=$ptrType(K);CD=$ptrType(AU);CE=$funcType([$String],[],false);CF=$funcType([BI],[],true);CG=$chanType(BU,false,false);D=function(a){var $ptr,a;if(a===""){return"api.ninchat.com";}else{return a;}};E=function(a){var $ptr,a,b,c,d,e,f,g,h,i,j,k,l,m,n;b=BH.nil;c=$ifaceNil;e=(d=a[$String.keyFor("hosts")],d!==undefined?d.v:$ifaceNil);if($interfaceIsEqual(e,$ifaceNil)){c=A.New("invalid endpoint document");return[b,c];}f=$assertType(e,BI,true);g=f[0];h=f[1];if(!h){c=A.New("invalid endpoint hosts type");return[b,c];}if(g.$length===0){c=A.New("no endpoint hosts");return[b,c];}i=g;j=0;while(true){if(!(j<i.$length)){break;}k=((j<0||j>=i.$length)?$throwRuntimeError("index out of range"):i.$array[i.$offset+j]);l=$assertType(k,$String,true);m=l[0];n=l[1];if(n){b=$append(b,m);}else{c=A.New("invalid endpoint host value type");}j++;}if(b.$length>0){c=$ifaceNil;}return[b,c];};F.ptr.prototype.String=function(){var $ptr,a,b,c,d,e,f,g;a="";b=this;c=(d=b.Params[$String.keyFor("action")],d!==undefined?[d.v,true]:[$ifaceNil,false]);e=c[0];f=c[1];if(f){g=$assertType(e,$String,true);a=g[0];}return a;};F.prototype.String=function(){return this.$val.String();};G.ptr.prototype.Bool=function(a){var $ptr,a,b,c,d,e,f;b=false;c=this;e=(d=c.Params[$String.keyFor(a)],d!==undefined?d.v:$ifaceNil);if(!($interfaceIsEqual(e,$ifaceNil))){f=$assertType(e,$Bool,true);b=f[0];}return b;};G.prototype.Bool=function(a){return this.$val.Bool(a);};G.ptr.prototype.Int=function(a){var $ptr,a,b,c,d,e,f,g,h;b=0;c=false;d=this;f=(e=d.Params[$String.keyFor(a)],e!==undefined?e.v:$ifaceNil);if(!($interfaceIsEqual(f,$ifaceNil))){g=0;h=$assertType(f,$Float64,true);g=h[0];c=h[1];if(c){b=(g>>0);}}return[b,c];};G.prototype.Int=function(a){return this.$val.Int(a);};G.ptr.prototype.Int64=function(a){var $ptr,a,b,c,d,e,f,g,h;b=new $Int64(0,0);c=false;d=this;f=(e=d.Params[$String.keyFor(a)],e!==undefined?e.v:$ifaceNil);if(!($interfaceIsEqual(f,$ifaceNil))){g=0;h=$assertType(f,$Float64,true);g=h[0];c=h[1];if(c){b=new $Int64(0,g);}}return[b,c];};G.prototype.Int64=function(a){return this.$val.Int64(a);};G.ptr.prototype.Float64=function(a){var $ptr,a,b,c,d,e,f,g;b=0;c=false;d=this;f=(e=d.Params[$String.keyFor(a)],e!==undefined?e.v:$ifaceNil);if(!($interfaceIsEqual(f,$ifaceNil))){g=$assertType(f,$Float64,true);b=g[0];c=g[1];}return[b,c];};G.prototype.Float64=function(a){return this.$val.Float64(a);};G.ptr.prototype.Str=function(a){var $ptr,a,b,c,d,e,f,g;b="";c=false;d=this;f=(e=d.Params[$String.keyFor(a)],e!==undefined?e.v:$ifaceNil);if(!($interfaceIsEqual(f,$ifaceNil))){g=$assertType(f,$String,true);b=g[0];c=g[1];}return[b,c];};G.prototype.Str=function(a){return this.$val.Str(a);};G.ptr.prototype.Array=function(a){var $ptr,a,b,c,d,e,f,g;b=BI.nil;c=false;d=this;f=(e=d.Params[$String.keyFor(a)],e!==undefined?e.v:$ifaceNil);if(!($interfaceIsEqual(f,$ifaceNil))){g=$assertType(f,BI,true);b=g[0];c=g[1];}return[b,c];};G.prototype.Array=function(a){return this.$val.Array(a);};G.ptr.prototype.Map=function(a){var $ptr,a,b,c,d,e,f,g;b=false;c=false;d=this;f=(e=d.Params[$String.keyFor(a)],e!==undefined?e.v:$ifaceNil);if(!($interfaceIsEqual(f,$ifaceNil))){g=$assertType(f,BJ,true);b=g[0];c=g[1];}return[b,c];};G.prototype.Map=function(a){return this.$val.Map(a);};G.ptr.prototype.String=function(){var $ptr,a,b,c;a="";b=this;c=b.Str("event");a=c[0];return a;};G.prototype.String=function(){return this.$val.String();};G.ptr.prototype.initLastReply=function(a){var $ptr,a,b,c,d,e,f;b=this;c=b.Int("history_length");d=c[0];if(d>0){return;}if(a.String()==="search"){if(!($interfaceIsEqual((e=b.Params[$String.keyFor("users")],e!==undefined?e.v:$ifaceNil),$ifaceNil))||!($interfaceIsEqual((f=b.Params[$String.keyFor("channels")],f!==undefined?f.v:$ifaceNil),$ifaceNil))){return;}}b.LastReply=true;};G.prototype.initLastReply=function(a){return this.$val.initLastReply(a);};G.ptr.prototype.getError=function(){var $ptr,a,b,c,d,e,f,g,h,i,j,k,l,m;a="";b="";c=false;d=$ifaceNil;e=this;f=(g=e.Params[$String.keyFor("event")],g!==undefined?[g.v,true]:[$ifaceNil,false]);h=f[0];i=f[1];if(!i||!($assertType(h,$String)==="error")){return[a,b,c,d];}a=$assertType((j=e.Params[$String.keyFor("error_type")],j!==undefined?j.v:$ifaceNil),$String);l=(k=e.Params[$String.keyFor("error_reason")],k!==undefined?k.v:$ifaceNil);if(!($interfaceIsEqual(l,$ifaceNil))){b=$assertType(l,$String);}m=a;if(m==="session_not_found"){c=true;if(!(b==="")){d=A.New("error: "+a+" ("+b+")");}else{d=A.New("error: "+a);}}else if(m==="connection_superseded"||m==="message_has_too_many_parts"||m==="message_part_too_long"||m==="message_too_long"||m==="request_malformed"){if(!(b==="")){d=A.New("error: "+a+" ("+b+")");}else{d=A.New("error: "+a);}}return[a,b,c,d];};G.prototype.getError=function(){return this.$val.getError();};H.ptr.prototype.success=function(){var $ptr,a;a=this;a.lastSlot=0;};H.prototype.success=function(){return this.$val.success();};H.ptr.prototype.failure=function(a){var $ptr,a,b,c;b=new AW(0,0);c=this;if(c.lastSlot>0){b=new AW(0,AF($flatten64(a)*c.lastSlot/1024,-0.5));}if(c.lastSlot<1023){c.lastSlot=((((c.lastSlot+1>>0))<<1>>0))-1>>0;}return b;};H.prototype.failure=function(a){return this.$val.failure(a);};K.ptr.prototype.Call=function(a){var $ptr,a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=[b];c=[c];d=BL.nil;e=$ifaceNil;f=this;g="https://"+D(f.Address)+"/v2/call";h=S(g,a.Params);i=h[0];e=h[1];if(!($interfaceIsEqual(e,$ifaceNil))){return[d,e];}new Y(i.Header).Set("Accept","application/json");new Y(i.Header).Set("Content-Type","application/json");j=AG(new AW(0,11000),0.1);l=AD(i,j);$s=1;case 1:if($c){$c=false;l=l.$blk();}if(l&&l.$blk!==undefined){break s;}k=l;m=k[0];e=k[1];if(!($interfaceIsEqual(e,$ifaceNil))){return[d,e];}c[0]=BI.nil;if(!($interfaceIsEqual(AJ(m,(c.$ptr||(c.$ptr=new BM(function(){return this.$target[0];},function($v){this.$target[0]=$v;},c)))),$ifaceNil))){b[0]=false;e=AK(m,(b.$ptr||(b.$ptr=new BN(function(){return this.$target[0];},function($v){this.$target[0]=$v;},b))));if(!($interfaceIsEqual(e,$ifaceNil))){return[d,e];}c[0]=new BI([new BJ(b[0])]);}d=$makeSlice(BL,0,c[0].$length);n=c[0];o=0;case 2:if(!(o<n.$length)){$s=3;continue;}p=o;q=((o<0||o>=n.$length)?$throwRuntimeError("index out of range"):n.$array[n.$offset+o]);r=$assertType(q,BJ,true);s=r[0];t=r[1];if(!t){e=A.New("response event header is not an object");return[d,e];}u=new G.ptr(s,BP.nil,p===(c[0].$length-1>>0));if(!(a.OnReply===$throwNilPointerError)){$s=4;continue;}$s=5;continue;case 4:$r=a.OnReply(u);$s=6;case 6:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 5:d=$append(d,u);o++;$s=2;continue;case 3:return[d,e];}return;}if($f===undefined){$f={$blk:K.ptr.prototype.Call};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.$s=$s;$f.$r=$r;return $f;};K.prototype.Call=function(a){return this.$val.Call(a);};L=function(){var $ptr;return new($global.String)();};M=function(a){var $ptr,a;return new BP([a]);};N=function(a){var $ptr,a;return $parseInt(a.length);};O=function(a){var $ptr,a;return Q(a);};Q=function(a){var $ptr,a,b,c,d,e,f;b=$assertType($internalize(a,$emptyInterface),$String,true);c=b[1];if(c){return a;}d=new($global.Uint8Array)(a);e=$assertType($internalize(d,$emptyInterface),BQ);f=$bytesToString(e);return new($global.String)($externalize(f,$String));};$pkg.StringifyFrame=Q;R=function(a){var $ptr,a,b,c,d,e,f;b=$ifaceNil;if(!($interfaceIsEqual(a,$ifaceNil))){c=a;if($assertType(c,$error,true)[1]){d=c;b=d;}else if($assertType(c,$String,true)[1]){e=c.$val;b=A.New(e);}else{f=c;b=A.New("?");}}return b;};S=function(a,b){var $ptr,a,b,c,d,e,f,g;c=BR.nil;d=$ifaceNil;e=AI(b);f=e[0];d=e[1];if(!($interfaceIsEqual(d,$ifaceNil))){return[c,d];}g=AB("POST",a,f);c=g[0];d=g[1];return[c,d];};T=function(a,b,c){var $ptr,a,b,c,d,e,f,g,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:d=new $Chan(AC,1);e=S(a,b);f=e[0];g=e[1];if($interfaceIsEqual(g,$ifaceNil)){$s=1;continue;}$s=2;continue;case 1:$r=AE(f,c,d);$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=3;continue;case 2:$r=$send(d,new AC.ptr(null,g));$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 3:return d;}return;}if($f===undefined){$f={$blk:T};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.$s=$s;$f.$r=$r;return $f;};U=function(a,b){var $ptr,a,b,c,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=new $Chan(AC,1);$r=AE(a,b,c);$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return c;}return;}if($f===undefined){$f={$blk:U};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.$s=$s;$f.$r=$r;return $f;};X=function(){var $ptr;V=$global.XDomainRequest;if(V===undefined){V=$global.XMLHttpRequest;W=true;}};Y.prototype.Set=function(a,b){var $ptr,a,b,c,d;c=this.$val;d=a;(c||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(d)]={k:d,v:b};};$ptrType(Y).prototype.Set=function(a,b){return new Y(this.$get()).Set(a,b);};AA=function(a){var $ptr,a,b,c;b=BR.nil;c=$ifaceNil;b=new Z.ptr("GET",a,{},null);return[b,c];};AB=function(a,b,c){var $ptr,a,b,c,d,e;d=BR.nil;e=$ifaceNil;d=new Z.ptr(a,b,{},c);return[d,e];};AD=function(a,b){var $ptr,a,b,c,d,e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=U(a,b);$s=1;case 1:if($c){$c=false;c=c.$blk();}if(c&&c.$blk!==undefined){break s;}d=$recv(c);$s=2;case 2:if($c){$c=false;d=d.$blk();}if(d&&d.$blk!==undefined){break s;}e=$clone(d[0],AC);return[e.data,e.err];}return;}if($f===undefined){$f={$blk:AD};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};AE=function(a,b,c){var $ptr,a,b,c,d,e,f,g,h,i,j,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);c=[c];d=[d];$deferred.push([(function(c,d){return function $b(){var $ptr,e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:e=R($recover());if(!($interfaceIsEqual(e,$ifaceNil))){$s=1;continue;}$s=2;continue;case 1:$r=$send(c[0],new AC.ptr(null,e));$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 2:$s=-1;case-1:}return;}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};})(c,d),[]]);d[0]=new(V)();d[0].onload=$externalize((function(c,d){return function(){var $ptr,e;e=d[0].responseText;$go((function(c,d){return function $b(){var $ptr,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=$send(c[0],new AC.ptr(e,$ifaceNil));$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;case-1:}return;}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.$s=$s;$f.$r=$r;return $f;};})(c,d),[]);};})(c,d),BS);d[0].onprogress=$externalize((function(c,d){return function(){var $ptr;};})(c,d),BS);d[0].ontimeout=$externalize((function(c,d){return function(){var $ptr;$go((function(c,d){return function $b(){var $ptr,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=$send(c[0],new AC.ptr(null,A.New("timeout")));$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;case-1:}return;}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.$s=$s;$f.$r=$r;return $f;};})(c,d),[]);};})(c,d),BS);d[0].onerror=$externalize((function(c,d){return function(){var $ptr;$go((function(c,d){return function $b(){var $ptr,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=$send(c[0],new AC.ptr(null,A.New("error")));$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;case-1:}return;}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.$s=$s;$f.$r=$r;return $f;};})(c,d),[]);};})(c,d),BS);d[0].open($externalize(a.Method,$String),$externalize(a.URL,$String));d[0].timeout=$externalize(b,AW);if(W){e=a.Header;f=0;g=$keys(e);while(true){if(!(f<g.length)){break;}h=e[g[f]];if(h===undefined){f++;continue;}i=h.k;j=h.v;d[0].setRequestHeader($externalize(i,$String),$externalize(j,$String));f++;}}d[0].send(a.data);$s=-1;case-1:}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AE};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AF=function(a,b){var $ptr,a,b;return a+a*b*AS();};AG=function(a,b){var $ptr,a,b;return new AW(0,AF($flatten64(a),b));};AH=function(a,b){var $ptr,a,b;return new $Int64(0,AF($flatten64(a),b));};AI=function(a){var $ptr,a,b,c,$deferred;var $err=null;try{$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=null;c=$ifaceNil;$deferred.push([(function(){var $ptr;c=R($recover());}),[]]);b=$global.JSON.stringify($externalize(a,BJ));return[b,c];}catch(err){$err=err;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return[b,c];}}};AJ=function(a,b){var $ptr,a,b,c,d,e,f,g,h;c=$ifaceNil;d=AL(a);e=d[0];c=d[1];if(!($interfaceIsEqual(c,$ifaceNil))){return c;}f=$assertType(e,BI,true);g=f[0];h=f[1];if(!h){c=A.New("json: cannot unmarshal value into Go value of type *[]interface{}");return c;}b.$set(g);return c;};AK=function(a,b){var $ptr,a,b,c,d,e,f,g,h;c=$ifaceNil;d=AL(a);e=d[0];c=d[1];if(!($interfaceIsEqual(c,$ifaceNil))){return c;}f=$assertType(e,BJ,true);g=f[0];h=f[1];if(!h){c=A.New("json: cannot unmarshal value into Go value of type *map[string]interface{}");return c;}b.$set(g);return c;};AL=function(a){var $ptr,a,b,c,$deferred;var $err=null;try{$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=$ifaceNil;c=$ifaceNil;$deferred.push([(function(){var $ptr;c=R($recover());}),[]]);b=$internalize($global.JSON.parse(a),$emptyInterface);return[b,c];}catch(err){$err=err;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return[b,c];}}};AM=function(a){var $ptr,a,b,c,d,e,f;b=BI.nil;c=a.Payload;d=0;while(true){if(!(d<c.$length)){break;}e=((d<0||d>=c.$length)?$throwRuntimeError("index out of range"):c.$array[c.$offset+d]);f=e.split($externalize(",",$String))[1];b=$append(b,new $jsObjectPtr(f));d++;}return b;};AN=function(a,b){var $ptr,a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=[c];d=[d];e=[e];d[0]=false;e[0]=false;f="https://"+b+"/v2/poll";if($interfaceIsEqual(a.sessionId,$ifaceNil)){$s=1;continue;}$s=2;continue;case 1:$r=a.log(new BI([new $String("session creation")]));$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}g=a.makeCreateSessionAction();h=AG(new AW(0,13000),0.2);i=T(f,g,h);$s=5;case 5:if($c){$c=false;i=i.$blk();}if(i&&i.$blk!==undefined){break s;}k=$select([[i],[a.closeNotify]]);$s=6;case 6:if($c){$c=false;k=k.$blk();}if(k&&k.$blk!==undefined){break s;}j=k;if(j[0]===0){$s=7;continue;}if(j[0]===1){$s=8;continue;}$s=9;continue;case 7:l=$clone(j[1][0],AC);if(!($interfaceIsEqual(l.err,$ifaceNil))){$s=10;continue;}$s=11;continue;case 10:$r=a.log(new BI([new $String("session creation:"),l.err]));$s=12;case 12:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return[d[0],e[0]];case 11:c[0]=BI.nil;m=AJ(l.data,(c.$ptr||(c.$ptr=new BM(function(){return this.$target[0];},function($v){this.$target[0]=$v;},c))));if(!($interfaceIsEqual(m,$ifaceNil))){$s=13;continue;}$s=14;continue;case 13:$r=a.log(new BI([new $String("session creation response:"),m]));$s=15;case 15:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return[d[0],e[0]];case 14:if(c[0].$length===0){$s=16;continue;}$s=17;continue;case 16:$r=a.log(new BI([new $String("session creation response JSON array is empty")]));$s=18;case 18:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return[d[0],e[0]];case 17:n=$assertType((0>=c[0].$length?$throwRuntimeError("index out of range"):c[0].$array[c[0].$offset+0]),BJ,true);o=n[0];p=n[1];if(!p){$s=19;continue;}$s=20;continue;case 19:$r=a.log(new BI([new $String("session creation response header is not a JSON object")]));$s=21;case 21:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return[d[0],e[0]];case 20:q=a.handleSessionEvent(o);$s=24;case 24:if($c){$c=false;q=q.$blk();}if(q&&q.$blk!==undefined){break s;}if(!q){$s=22;continue;}$s=23;continue;case 22:return[d[0],e[0]];case 23:$s=9;continue;case 8:$r=AQ(a,f);$s=25;case 25:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return[d[0],e[0]];case 9:d[0]=true;e[0]=true;$r=a.connState("connected");$s=26;case 26:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=a.connActive();$s=27;case 27:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=3;continue;case 2:$r=a.log(new BI([new $String("session resumption")]));$s=28;case 28:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=AP(a,f);$s=29;case 29:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 3:$r=AO(a,f,(d.$ptr||(d.$ptr=new BT(function(){return this.$target[0];},function($v){this.$target[0]=$v;},d))),(e.$ptr||(e.$ptr=new BT(function(){return this.$target[0];},function($v){this.$target[0]=$v;},e))));$s=30;case 30:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return[d[0],e[0]];}return;}if($f===undefined){$f={$blk:AN};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.$s=$s;$f.$r=$r;return $f;};AO=function(a,b,c,d){var $ptr,a,aa,ab,ac,ad,ae,af,ag,ah,ai,aj,ak,al,am,an,ao,ap,aq,ar,as,at,au,av,aw,ax,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;aa=$f.aa;ab=$f.ab;ac=$f.ac;ad=$f.ad;ae=$f.ae;af=$f.af;ag=$f.ag;ah=$f.ah;ai=$f.ai;aj=$f.aj;ak=$f.ak;al=$f.al;am=$f.am;an=$f.an;ao=$f.ao;ap=$f.ap;aq=$f.aq;ar=$f.ar;as=$f.as;at=$f.at;au=$f.au;av=$f.av;aw=$f.aw;ax=$f.ax;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;v=$f.v;w=$f.w;x=$f.x;y=$f.y;z=$f.z;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:e=$chanNil;f=$chanNil;g=new $Int64(0,0);h=0;a.numSent=0;case 1:if(!(h<2)){$s=2;continue;}i=[i];j=[j];if(e===$chanNil){$s=3;continue;}$s=4;continue;case 3:k=a.makeResumeSessionAction(true);l=AG(new AW(0,64000),0.2);m=T(b,k,l);$s=5;case 5:if($c){$c=false;m=m.$blk();}if(m&&m.$blk!==undefined){break s;}e=m;case 4:if(f===$chanNil&&a.numSent<a.sendBuffer.$length){$s=6;continue;}$s=7;continue;case 6:p=(n=a.sendBuffer,o=a.numSent,((o<0||o>=n.$length)?$throwRuntimeError("index out of range"):n.$array[n.$offset+o]));if(!(p.Payload===BP.nil)){$s=8;continue;}$s=9;continue;case 8:if(p.String()==="update_user"){$s=10;continue;}$s=11;continue;case 10:q="payload";(p.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(q)]={k:q,v:AM(p)};$s=12;continue;case 11:i[0]=false;s=AK((r=p.Payload,(0>=r.$length?$throwRuntimeError("index out of range"):r.$array[r.$offset+0])),(i.$ptr||(i.$ptr=new BN(function(){return this.$target[0];},function($v){this.$target[0]=$v;},i))));if(!($interfaceIsEqual(s,$ifaceNil))){$s=13;continue;}$s=14;continue;case 13:$r=a.log(new BI([new $String("send:"),s]));$s=15;case 15:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return;case 14:t="payload";(p.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(t)]={k:t,v:new BJ(i[0])};case 12:case 9:u="session_id";(p.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(u)]={k:u,v:a.sessionId};v=AG(new AW(0,7000),0.2);w=T(b,p.Params,v);$s=16;case 16:if($c){$c=false;w=w.$blk();}if(w&&w.$blk!==undefined){break s;}x=w;delete p.Params[$String.keyFor("session_id")];delete p.Params[$String.keyFor("payload")];if((y=p.id,(y.$high===0&&y.$low===0))){$go(AR,[a,x,"send error:"]);a.sendBuffer=$appendSlice($subslice(a.sendBuffer,0,a.numSent),$subslice(a.sendBuffer,(a.numSent+1>>0)));}else{f=x;g=p.id;}case 7:z=new AC.ptr(null,$ifaceNil);ab=$select([[e],[f],[a.sendNotify],[a.closeNotify]]);$s=17;case 17:if($c){$c=false;ab=ab.$blk();}if(ab&&ab.$blk!==undefined){break s;}aa=ab;if(aa[0]===0){$s=18;continue;}if(aa[0]===1){$s=19;continue;}if(aa[0]===2){$s=20;continue;}if(aa[0]===3){$s=21;continue;}$s=22;continue;case 18:$copy(z,aa[1][0],AC);if(!($interfaceIsEqual(z.err,$ifaceNil))){$s=23;continue;}$s=24;continue;case 23:$r=a.log(new BI([new $String("poll error:"),z.err]));$s=25;case 25:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 24:e=$chanNil;$r=a.connActive();$s=26;case 26:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=22;continue;case 19:$copy(z,aa[1][0],AC);if(!($interfaceIsEqual(z.err,$ifaceNil))){$s=27;continue;}if((g.$high>0||(g.$high===0&&g.$low>0))){$s=28;continue;}$s=29;continue;case 27:$r=a.log(new BI([new $String("send error:"),z.err]));$s=30;case 30:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=29;continue;case 28:a.numSent=a.numSent+(1)>>0;case 29:f=$chanNil;g=new $Int64(0,0);$s=22;continue;case 20:ac=aa[1];ad=ac[1];if(!ad){$s=31;continue;}$s=32;continue;case 31:$r=AQ(a,b);$s=33;case 33:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return;case 32:$s=1;continue;$s=22;continue;case 21:$r=AQ(a,b);$s=34;case 34:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return;case 22:j[0]=BI.nil;ae=z.err;if($interfaceIsEqual(ae,$ifaceNil)){$s=35;continue;}$s=36;continue;case 35:ae=AJ(z.data,(j.$ptr||(j.$ptr=new BM(function(){return this.$target[0];},function($v){this.$target[0]=$v;},j))));if(!($interfaceIsEqual(ae,$ifaceNil))){$s=37;continue;}$s=38;continue;case 37:$r=a.log(new BI([new $String("response:"),ae]));$s=39;case 39:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 38:case 36:if(!($interfaceIsEqual(ae,$ifaceNil))){$s=40;continue;}$s=41;continue;case 40:h=h+(1)>>0;a.numSent=0;$s=1;continue;case 41:h=0;c.$set(true);af=j[0];ag=0;case 42:if(!(ag<af.$length)){$s=43;continue;}ah=((ag<0||ag>=af.$length)?$throwRuntimeError("index out of range"):af.$array[af.$offset+ag]);ai=$assertType(ah,BJ,true);aj=ai[0];ak=ai[1];if(!ak){$s=44;continue;}$s=45;continue;case 44:$r=a.log(new BI([new $String("poll event is not an object")]));$s=46;case 46:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return;case 45:al=new G.ptr(aj,BP.nil,false);an=(am=aj[$String.keyFor("payload")],am!==undefined?am.v:$ifaceNil);if(!($interfaceIsEqual(an,$ifaceNil))){$s=47;continue;}$s=48;continue;case 47:ao=$assertType(an,BJ,true);ap=ao[0];aq=ao[1];if(!aq){$s=49;continue;}$s=50;continue;case 49:$r=a.log(new BI([new $String("poll payload is not an object")]));$s=51;case 51:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return;case 50:ar=AI(ap);as=ar[0];at=ar[1];if(!($interfaceIsEqual(at,$ifaceNil))){$s=52;continue;}$s=53;continue;case 52:$r=a.log(new BI([new $String("poll payload:"),at]));$s=54;case 54:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return;case 53:al.Payload=M(as);case 48:av=a.handleEvent(al);$s=55;case 55:if($c){$c=false;av=av.$blk();}if(av&&av.$blk!==undefined){break s;}au=av;aw=au[0];ax=au[1];ak=au[3];if((g.$high>0||(g.$high===0&&g.$low>0))&&(g.$high<aw.$high||(g.$high===aw.$high&&g.$low<=aw.$low))){g=new $Int64(0,0);a.numSent=a.numSent+(1)>>0;}if(!ak){if(ax){d.$set(true);}return;}if(!d.$get()){$s=56;continue;}$s=57;continue;case 56:d.$set(true);$r=a.connState("connected");$s=58;case 58:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 57:ag++;$s=42;continue;case 43:$s=1;continue;case 2:return;}return;}if($f===undefined){$f={$blk:AO};}$f.$ptr=$ptr;$f.a=a;$f.aa=aa;$f.ab=ab;$f.ac=ac;$f.ad=ad;$f.ae=ae;$f.af=af;$f.ag=ag;$f.ah=ah;$f.ai=ai;$f.aj=aj;$f.ak=ak;$f.al=al;$f.am=am;$f.an=an;$f.ao=ao;$f.ap=ap;$f.aq=aq;$f.ar=ar;$f.as=as;$f.at=at;$f.au=au;$f.av=av;$f.aw=aw;$f.ax=ax;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.v=v;$f.w=w;$f.x=x;$f.y=y;$f.z=z;$f.$s=$s;$f.$r=$r;return $f;};AP=function(a,b){var $ptr,a,b,c,d,e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=$makeMap($String.keyFor,[{k:"action",v:new $String("ping")},{k:"session_id",v:a.sessionId}]);d=T(b,c,AG(new AW(0,7000),0.9));$s=1;case 1:if($c){$c=false;d=d.$blk();}if(d&&d.$blk!==undefined){break s;}e=d;$go(AR,[a,e,"ping error:"]);$s=-1;case-1:}return;}if($f===undefined){$f={$blk:AP};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};AQ=function(a,b){var $ptr,a,b,c,d,e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=$makeMap($String.keyFor,[{k:"action",v:new $String("close_session")},{k:"session_id",v:a.sessionId}]);d=T(b,c,AG(new AW(0,7000),0.9));$s=1;case 1:if($c){$c=false;d=d.$blk();}if(d&&d.$blk!==undefined){break s;}e=d;$go(AR,[a,e,"send error:"]);$s=-1;case-1:}return;}if($f===undefined){$f={$blk:AQ};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};AR=function(a,b,c){var $ptr,a,b,c,d,e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:d=$recv(b);$s=1;case 1:if($c){$c=false;d=d.$blk();}if(d&&d.$blk!==undefined){break s;}e=$clone(d[0],AC);if(!($interfaceIsEqual(e.err,$ifaceNil))){$s=2;continue;}$s=3;continue;case 2:$r=a.log(new BI([new $String(c),e.err]));$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 3:$s=-1;case-1:}return;}if($f===undefined){$f={$blk:AR};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};AS=function(){var $ptr;return $parseFloat($global.Math.random());};AU.ptr.prototype.SetParams=function(a){var $ptr,a,b,c,d,e,f,g;b=this;if($interfaceIsEqual((c=a[$String.keyFor("message_types")],c!==undefined?c.v:$ifaceNil),$ifaceNil)){$panic(new $String("message_types parameter not defined"));}d=(e=a[$String.keyFor("session_id")],e!==undefined?[e.v,true]:[$ifaceNil,false]);f=d[0];g=d[1];if(!($interfaceIsEqual(f,$ifaceNil))){b.sessionId=f;}else if(g){delete a[$String.keyFor("session_id")];}b.sessionParams=a;if(!(b.sendNotify===$chanNil)&&!b.running){$go($methodVal(b,"discover"),[]);}};AU.prototype.SetParams=function(a){return this.$val.SetParams(a);};AU.ptr.prototype.SetTransport=function(a){var $ptr,a,b,c;b=this;if(a===""){b.forceLongPoll=false;return;}c=a;if(c==="websocket"){$panic(new $String("websocket transport cannot be forced"));}else if(c==="longpoll"){b.forceLongPoll=true;}else{$panic(new $String("unknown transport: "+a));}};AU.prototype.SetTransport=function(a){return this.$val.SetTransport(a);};AU.ptr.prototype.Open=function(){var $ptr,a;a=this;if(a.closed){$panic(new $String("session already closed"));}if(!(a.sendNotify===$chanNil)){$panic(new $String("session already initialized"));}if(a.OnSessionEvent===$throwNilPointerError){$panic(new $String("onSessionEvent callback not defined"));}if(a.OnEvent===$throwNilPointerError){$panic(new $String("onEvent callback not defined"));}if(a.sessionParams===false){$panic(new $String("session parameters not defined"));}a.sendNotify=new $Chan(BU,1);a.closeNotify=new $Chan(BU,1);a.running=true;$go($methodVal(a,"discover"),[]);};AU.prototype.Open=function(){return this.$val.Open();};AU.ptr.prototype.Close=function(){var $ptr,a,b,c,d,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;d=$f.d;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:a=[a];a[0]=this;if(a[0].closed){return;}b=a[0].sendBuffer;c=0;case 1:if(!(c<b.$length)){$s=2;continue;}d=((c<0||c>=b.$length)?$throwRuntimeError("index out of range"):b.$array[b.$offset+c]);if(!(d.OnReply===$throwNilPointerError)){$s=3;continue;}$s=4;continue;case 3:$r=d.OnReply(BK.nil);$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 4:c++;$s=1;continue;case 2:a[0].sendBuffer=BW.nil;a[0].numSent=0;a[0].closed=true;a[0].running=false;$go((function(a){return function $b(){var $ptr,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=$send(a[0].closeNotify,new BU.ptr());$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$close(a[0].sendNotify);$s=-1;case-1:}return;}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.$s=$s;$f.$r=$r;return $f;};})(a),[]);$s=-1;case-1:}return;}if($f===undefined){$f={$blk:AU.ptr.prototype.Close};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.$s=$s;$f.$r=$r;return $f;};AU.prototype.Close=function(){return this.$val.Close();};AU.ptr.prototype.Send=function(a){var $ptr,a,b,c,d,e,f,g,h,i;b=this;if(b.sendNotify===$chanNil){$panic(new $String("session not initialized"));}if(b.closed){$panic(new $String("session already closed"));}if(a.Payload.$length===0){a.Payload=BP.nil;}c=(d=a.Params[$String.keyFor("action_id")],d!==undefined?[d.v,true]:[$ifaceNil,false]);e=c[0];f=c[1];if(f&&$interfaceIsEqual(e,$ifaceNil)){delete a.Params[$String.keyFor("action_id")];}else{b.lastActionId=(g=b.lastActionId,h=new $Int64(0,1),new $Int64(g.$high+h.$high,g.$low+h.$low));a.id=b.lastActionId;i="action_id";(a.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(i)]={k:i,v:a.id};}b.send(a);return;};AU.prototype.Send=function(a){return this.$val.Send(a);};AU.ptr.prototype.send=function(a){var $ptr,a,b;b=this;b.sendBuffer=$append(b.sendBuffer,a);$go((function $b(){var $ptr,c,$r;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;c=$f.c;$r=$f.$r;}c=$select([[b.sendNotify,new BU.ptr()],[]]);if(c[0]===0){}else if(c[0]===1){}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.c=c;$f.$r=$r;return $f;}),[]);return;};AU.prototype.send=function(a){return this.$val.send(a);};AU.ptr.prototype.sendAck=function(){var $ptr,a;a=this;a.sendEventAck=true;$go((function $b(){var $ptr,b,$r;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;b=$f.b;$r=$f.$r;}b=$select([[a.sendNotify,new BU.ptr()],[]]);if(b[0]===0){}else if(b[0]===1){}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.b=b;$f.$r=$r;return $f;}),[]);};AU.prototype.sendAck=function(){return this.$val.sendAck();};AU.ptr.prototype.discover=function(){var $ptr,a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);a=[a];b=this;$r=b.log(new BI([new $String("opening")]));$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(b,"log"),[new BI([new $String("closed")])]]);$deferred.push([$methodVal(b,"connState"),["disconnected"]]);a[0]=new H.ptr(0);case 2:if(!(b.running)){$s=3;continue;}c=[c];$r=b.log(new BI([new $String("endpoint discovery")]));$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=b.connState("connecting");$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}d="https://"+D(b.Address)+"/v2/endpoint";e=AA(d);f=e[0];g=e[1];if(!($interfaceIsEqual(g,$ifaceNil))){$panic(g);}h=U(f,AG(new AW(0,7000),0.1));$s=6;case 6:if($c){$c=false;h=h.$blk();}if(h&&h.$blk!==undefined){break s;}j=$select([[h],[b.closeNotify]]);$s=7;case 7:if($c){$c=false;j=j.$blk();}if(j&&j.$blk!==undefined){break s;}i=j;if(i[0]===0){$s=8;continue;}if(i[0]===1){$s=9;continue;}$s=10;continue;case 8:k=$clone(i[1][0],AC);l=BH.nil;m=k.err;if($interfaceIsEqual(m,$ifaceNil)){c[0]=false;m=AK(k.data,(c.$ptr||(c.$ptr=new BN(function(){return this.$target[0];},function($v){this.$target[0]=$v;},c))));if($interfaceIsEqual(m,$ifaceNil)){n=E(c[0]);l=n[0];m=n[1];}}if($interfaceIsEqual(m,$ifaceNil)){$s=11;continue;}$s=12;continue;case 11:$r=b.log(new BI([new $String("endpoint discovered")]));$s=14;case 14:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(BA&&!b.forceLongPoll){$s=15;continue;}$s=16;continue;case 15:o=b.connect(BD,l,a[0]);$s=19;case 19:if($c){$c=false;o=o.$blk();}if(o&&o.$blk!==undefined){break s;}if(o){$s=17;continue;}$s=18;continue;case 17:$s=2;continue;case 18:case 16:p=b.connect(AN,l,a[0]);$s=20;case 20:if($c){$c=false;p=p.$blk();}if(p&&p.$blk!==undefined){break s;}p;$s=13;continue;case 12:$r=b.log(new BI([new $String("endpoint discovery:"),m]));$s=21;case 21:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 13:$s=10;continue;case 9:return;case 10:q=a[0].failure(new AW(0,60000));if((q.$high>0||(q.$high===0&&q.$low>0))){$s=22;continue;}$s=23;continue;case 22:$r=b.log(new BI([new $String("sleeping")]));$s=24;case 24:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=b.connState("disconnected");$s=25;case 25:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=AZ(q);$s=26;case 26:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 23:$s=2;continue;case 3:$s=-1;case-1:}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AU.ptr.prototype.discover};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AU.prototype.discover=function(){return this.$val.discover();};AU.ptr.prototype.connect=function(a,b,c){var $ptr,a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:d=false;e=this;f=0;case 1:if(!(f<2)){$s=2;continue;}g=b;h=0;case 3:if(!(h<g.$length)){$s=4;continue;}i=((h<0||h>=g.$length)?$throwRuntimeError("index out of range"):g.$array[g.$offset+h]);$r=e.connState("connecting");$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}j=e.Address;k=0;while(true){if(!(k<j.length)){break;}l=$decodeRune(j,k);m=k;n=l[0];if(n===47){i=i+(e.Address.substring(m));break;}k+=l[1];}p=a(e,i);$s=6;case 6:if($c){$c=false;p=p.$blk();}if(p&&p.$blk!==undefined){break s;}o=p;q=o[0];r=o[1];if(q){d=true;}if(r){c.success();return d;}if(!e.running){return d;}s=c.failure(new AW(0,60000));if((s.$high>0||(s.$high===0&&s.$low>0))){$s=7;continue;}$s=8;continue;case 7:$r=e.log(new BI([new $String("sleeping")]));$s=9;case 9:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=e.connState("disconnected");$s=10;case 10:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=AZ(s);$s=11;case 11:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 8:h++;$s=3;continue;case 4:f=f+(1)>>0;$s=1;continue;case 2:return d;}return;}if($f===undefined){$f={$blk:AU.ptr.prototype.connect};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.$s=$s;$f.$r=$r;return $f;};AU.prototype.connect=function(a,b,c){return this.$val.connect(a,b,c);};AU.ptr.prototype.canLogin=function(){var $ptr,a,b,c,d,e,f,g,h;a=this;if(!($interfaceIsEqual((b=a.sessionParams[$String.keyFor("access_key")],b!==undefined?b.v:$ifaceNil),$ifaceNil))){return true;}if(!($interfaceIsEqual((c=a.sessionParams[$String.keyFor("user_id")],c!==undefined?c.v:$ifaceNil),$ifaceNil))){return!($interfaceIsEqual((d=a.sessionParams[$String.keyFor("user_auth")],d!==undefined?d.v:$ifaceNil),$ifaceNil))||!($interfaceIsEqual((e=a.sessionParams[$String.keyFor("master_sign")],e!==undefined?e.v:$ifaceNil),$ifaceNil));}return!($interfaceIsEqual((f=a.sessionParams[$String.keyFor("identity_type")],f!==undefined?f.v:$ifaceNil),$ifaceNil))&&!($interfaceIsEqual((g=a.sessionParams[$String.keyFor("identity_name")],g!==undefined?g.v:$ifaceNil),$ifaceNil))&&!($interfaceIsEqual((h=a.sessionParams[$String.keyFor("identity_auth")],h!==undefined?h.v:$ifaceNil),$ifaceNil));};AU.prototype.canLogin=function(){return this.$val.canLogin();};AU.ptr.prototype.makeCreateSessionAction=function(){var $ptr,a,aa,ab,ac,ad,ae,af,ag,ah,ai,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z;a=false;b=this;a=$makeMap($String.keyFor,[{k:"action",v:new $String("create_session")}]);d=(c=b.sessionParams[$String.keyFor("user_id")],c!==undefined?c.v:$ifaceNil);if($interfaceIsEqual(d,$ifaceNil)){e=b.sessionParams;f=0;g=$keys(e);while(true){if(!(f<g.length)){break;}h=e[g[f]];if(h===undefined){f++;continue;}i=h.k;j=h.v;k=i;(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(k)]={k:k,v:j};f++;}}else{m=(l=b.sessionParams[$String.keyFor("user_auth")],l!==undefined?l.v:$ifaceNil);if(!($interfaceIsEqual(m,$ifaceNil))){n="user_id";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(n)]={k:n,v:d};o="user_auth";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(o)]={k:o,v:m};}else{q=(p=b.sessionParams[$String.keyFor("master_sign")],p!==undefined?p.v:$ifaceNil);if(!($interfaceIsEqual(q,$ifaceNil))){r="user_id";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(r)]={k:r,v:d};s="master_sign";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(s)]={k:s,v:q};}else{u=(t=b.sessionParams[$String.keyFor("identity_type")],t!==undefined?t.v:$ifaceNil);if(!($interfaceIsEqual(u,$ifaceNil))){v="identity_type";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(v)]={k:v,v:u};w="identity_name";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(w)]={k:w,v:(x=b.sessionParams[$String.keyFor("identity_name")],x!==undefined?x.v:$ifaceNil)};y="identity_auth";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(y)]={k:y,v:(z=b.sessionParams[$String.keyFor("identity_auth")],z!==undefined?z.v:$ifaceNil)};}else{aa="user_id";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(aa)]={k:aa,v:d};}}}ab=b.sessionParams;ac=0;ad=$keys(ab);while(true){if(!(ac<ad.length)){break;}ae=ab[ad[ac]];if(ae===undefined){ac++;continue;}af=ae.k;ag=ae.v;ah=af;if(ah==="user_id"||ah==="user_auth"||ah==="identity_type"||ah==="identity_name"||ah==="identity_auth"||ah==="access_key"||ah==="master_sign"){}else{ai=af;(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(ai)]={k:ai,v:ag};}ac++;}}return a;};AU.prototype.makeCreateSessionAction=function(){return this.$val.makeCreateSessionAction();};AU.ptr.prototype.makeResumeSessionAction=function(a){var $ptr,a,b,c,d;b=false;c=this;b=$makeMap($String.keyFor,[{k:"action",v:new $String("resume_session")},{k:"event_id",v:c.receivedEventId}]);if(a){d="session_id";(b||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(d)]={k:d,v:c.sessionId};}c.sendEventAck=false;c.ackedEventId=c.receivedEventId;return b;};AU.prototype.makeResumeSessionAction=function(a){return this.$val.makeResumeSessionAction(a);};AU.ptr.prototype.handleSessionEvent=function(a){var $ptr,a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=false;c=this;d=new G.ptr(a,BP.nil,false);e=false;if(d.String()==="error"){c.sessionId=$ifaceNil;c.running=false;e=true;}$r=c.OnSessionEvent(d);$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(e){return b;}delete c.sessionParams[$String.keyFor("user_attrs")];delete c.sessionParams[$String.keyFor("user_settings")];delete c.sessionParams[$String.keyFor("identity_attrs")];delete c.sessionParams[$String.keyFor("access_key")];delete c.sessionParams[$String.keyFor("master_sign")];f="user_id";(c.sessionParams||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(f)]={k:f,v:(g=d.Params[$String.keyFor("user_id")],g!==undefined?g.v:$ifaceNil)};i=(h=d.Params[$String.keyFor("user_auth")],h!==undefined?h.v:$ifaceNil);if(!($interfaceIsEqual(i,$ifaceNil))){j="user_auth";(c.sessionParams||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(j)]={k:j,v:i};}k=new BH(["identity_type","identity_name","identity_auth"]);l=0;while(true){if(!(l<k.$length)){break;}m=((l<0||l>=k.$length)?$throwRuntimeError("index out of range"):k.$array[k.$offset+l]);o=(n=c.sessionParams[$String.keyFor(m+"_new")],n!==undefined?n.v:$ifaceNil);if(!($interfaceIsEqual(o,$ifaceNil))){delete c.sessionParams[$String.keyFor(m+"_new")];p=m;(c.sessionParams||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(p)]={k:p,v:o};}l++;}c.sessionId=(q=d.Params[$String.keyFor("session_id")],q!==undefined?q.v:$ifaceNil);if(c.sendBuffer.$length===0){c.lastActionId=new $Int64(0,0);}c.sendEventAck=false;r=d.Int64("event_id");c.receivedEventId=r[0];c.ackedEventId=new $Int64(0,0);$r=c.log(new BI([new $String("session created")]));$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}b=true;return b;}return;}if($f===undefined){$f={$blk:AU.ptr.prototype.handleSessionEvent};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.$s=$s;$f.$r=$r;return $f;};AU.prototype.handleSessionEvent=function(a){return this.$val.handleSessionEvent(a);};AU.ptr.prototype.handleEvent=function(a){var $ptr,a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=[b];c=[c];b[0]=new $Int64(0,0);d=false;e=false;f=false;c[0]=this;g=a.Int64("event_id");h=g[0];if((h.$high>0||(h.$high===0&&h.$low>0))){c[0].receivedEventId=h;if(!c[0].sendEventAck){if((i=(j=c[0].receivedEventId,k=c[0].ackedEventId,new $Int64(j.$high-k.$high,j.$low-k.$low)),(i.$high>AT.$high||(i.$high===AT.$high&&i.$low>=AT.$low)))){c[0].sendAck();}else{e=true;}}}l=a.Int64("action_id");b[0]=l[0];if((b[0].$high>0||(b[0].$high===0&&b[0].$low>0))){$s=1;continue;}$s=2;continue;case 1:m=C.Search(c[0].numSent,(function(b,c){return function(m){var $ptr,m,n,o,p;o=(n=c[0].sendBuffer,((m<0||m>=n.$length)?$throwRuntimeError("index out of range"):n.$array[n.$offset+m]));return(p=o.id,(p.$high>b[0].$high||(p.$high===b[0].$high&&p.$low>=b[0].$low)));};})(b,c));$s=3;case 3:if($c){$c=false;m=m.$blk();}if(m&&m.$blk!==undefined){break s;}n=m;if(n<c[0].numSent){$s=4;continue;}$s=5;continue;case 4:p=(o=c[0].sendBuffer,((n<0||n>=o.$length)?$throwRuntimeError("index out of range"):o.$array[o.$offset+n]));if((q=p.id,(q.$high===b[0].$high&&q.$low===b[0].$low))){$s=6;continue;}$s=7;continue;case 6:a.initLastReply(p);if(!(p.OnReply===$throwNilPointerError)){$s=8;continue;}$s=9;continue;case 8:$r=p.OnReply(a);$s=10;case 10:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 9:if(a.LastReply){c[0].sendBuffer=$appendSlice($subslice(c[0].sendBuffer,0,n),$subslice(c[0].sendBuffer,(n+1>>0)));c[0].numSent=c[0].numSent-(1)>>0;}case 7:case 5:case 2:r=a.getError();s=r[0];t=r[1];d=r[2];u=r[3];if(!($interfaceIsEqual(u,$ifaceNil))){$s=11;continue;}$s=12;continue;case 11:$r=c[0].log(new BI([new $String("event:"),u]));$s=13;case 13:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(d){$s=14;continue;}$s=15;continue;case 14:c[0].sessionId=$ifaceNil;if(!c[0].canLogin()){$s=16;continue;}$s=17;continue;case 16:c[0].running=false;$r=c[0].OnSessionEvent(a);$s=18;case 18:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 17:case 15:return[b[0],d,e,f];case 12:if(s==="deprecated"){$s=19;continue;}$s=20;continue;case 19:$r=c[0].log(new BI([new $String("deprecated:"),new $String(t)]));$s=21;case 21:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 20:$r=c[0].OnEvent(a);$s=22;case 22:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}f=true;return[b[0],d,e,f];}return;}if($f===undefined){$f={$blk:AU.ptr.prototype.handleEvent};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.$s=$s;$f.$r=$r;return $f;};AU.prototype.handleEvent=function(a){return this.$val.handleEvent(a);};AU.ptr.prototype.connState=function(a){var $ptr,a,b,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=this;if(!(b.latestConnState===a)){$s=1;continue;}$s=2;continue;case 1:b.latestConnState=a;if(!(b.OnConnState===$throwNilPointerError)){$s=3;continue;}$s=4;continue;case 3:$r=b.OnConnState(b.latestConnState);$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 4:case 2:$s=-1;case-1:}return;}if($f===undefined){$f={$blk:AU.ptr.prototype.connState};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.$s=$s;$f.$r=$r;return $f;};AU.prototype.connState=function(a){return this.$val.connState(a);};AU.ptr.prototype.connActive=function(){var $ptr,a,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:a=this;if(!(a.OnConnActive===$throwNilPointerError)){$s=1;continue;}$s=2;continue;case 1:$r=a.OnConnActive();$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 2:$s=-1;case-1:}return;}if($f===undefined){$f={$blk:AU.ptr.prototype.connActive};}$f.$ptr=$ptr;$f.a=a;$f.$s=$s;$f.$r=$r;return $f;};AU.prototype.connActive=function(){return this.$val.connActive();};AU.ptr.prototype.log=function(a){var $ptr,a,b,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=this;if(!(b.OnLog===$throwNilPointerError)){$s=1;continue;}$s=2;continue;case 1:$r=b.OnLog(a);$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 2:$s=-1;case-1:}return;}if($f===undefined){$f={$blk:AU.ptr.prototype.log};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.$s=$s;$f.$r=$r;return $f;};AU.prototype.log=function(a){return this.$val.log(a);};AY=function(a){var $ptr,a,b;b=BX.nil;b=new AX.ptr(new $Chan(BU,0),null);if((a.$high>0||(a.$high===0&&a.$low>=0))){b.Reset(a);}return b;};AX.ptr.prototype.Active=function(){var $ptr,a;a=this;return!(a.id===null);};AX.prototype.Active=function(){return this.$val.Active();};AX.ptr.prototype.Reset=function(a){var $ptr,a,b;b=this;b.Stop();b.id=$global.setTimeout($externalize((function(){var $ptr;b.id=null;$go((function $b(){var $ptr,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=$send(b.C,new BU.ptr());$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;case-1:}return;}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.$s=$s;$f.$r=$r;return $f;}),[]);}),BS),$externalize(a,AW));};AX.prototype.Reset=function(a){return this.$val.Reset(a);};AX.ptr.prototype.Stop=function(){var $ptr,a;a=this;if(!(a.id===null)){$global.clearTimeout(a.id);a.id=null;}};AX.prototype.Stop=function(){return this.$val.Stop();};AZ=function(a){var $ptr,a,b,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=$recv(AY(a).C);$s=1;case 1:if($c){$c=false;b=b.$blk();}if(b&&b.$blk!==undefined){break s;}b[0];$s=-1;case-1:}return;}if($f===undefined){$f={$blk:AZ};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.$s=$s;$f.$r=$r;return $f;};BC=function(a,b){var $ptr,a,b,c,d,e,f,g;c=BY.nil;c=new BB.ptr(new $Chan(BU,1),false,$ifaceNil,new($global.WebSocket)($externalize(a,$String)),false,BP.nil);c.impl.binaryType=$externalize("arraybuffer",$String);d=false;e=(function(){var $ptr;if(!d){d=true;$go((function(){var $ptr;$close(c.notify);}),[]);}});f=$global.setTimeout($externalize((function $b(){var $ptr,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c.err=A.New("timeout");$r=e();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;case-1:}return;}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.$s=$s;$f.$r=$r;return $f;}),BS),$externalize(b,AW));g=(function(){var $ptr;if(!(f===null)){$global.clearTimeout(f);f=null;}});c.impl.onopen=$externalize((function $b(h){var $ptr,h,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;h=$f.h;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=g();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!($interfaceIsEqual(c.err,$ifaceNil))){c.impl.close();return;}c.open=true;$go((function $b(){var $ptr,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:if(!d){$s=1;continue;}$s=2;continue;case 1:$r=$send(c.notify,new BU.ptr());$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 2:$s=-1;case-1:}return;}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.$s=$s;$f.$r=$r;return $f;}),[]);$s=-1;case-1:}return;}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.h=h;$f.$s=$s;$f.$r=$r;return $f;}),BZ);c.impl.onmessage=$externalize((function(h){var $ptr,h;c.buf=$append(c.buf,h.data);$go((function $b(){var $ptr,i,$r;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;i=$f.i;$r=$f.$r;}if(!d){i=$select([[c.notify,new BU.ptr()],[]]);if(i[0]===0){}else if(i[0]===1){}}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.i=i;$f.$r=$r;return $f;}),[]);}),BZ);c.impl.onclose=$externalize((function $b(h){var $ptr,h,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;h=$f.h;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c.goingAway=(($parseInt(h.code)>>0)===1001);c.open=false;$r=e();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;case-1:}return;}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.h=h;$f.$s=$s;$f.$r=$r;return $f;}),BZ);c.impl.onerror=$externalize((function $b(h){var $ptr,h,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;h=$f.h;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=g();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if($interfaceIsEqual(c.err,$ifaceNil)){c.err=A.New($internalize(h.message,$String));}$r=e();$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;case-1:}return;}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.h=h;$f.$s=$s;$f.$r=$r;return $f;}),BZ);return c;};BB.ptr.prototype.send=function(a){var $ptr,a,b,c,$deferred;var $err=null;try{$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=$ifaceNil;c=this;$deferred.push([(function(){var $ptr;b=R($recover());}),[]]);c.impl.send(a);return b;}catch(err){$err=err;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return b;}}};BB.prototype.send=function(a){return this.$val.send(a);};BB.ptr.prototype.sendJSON=function(a){var $ptr,a,b,c,d,e;b=$ifaceNil;c=this;d=AI(a);e=d[0];b=d[1];if(!($interfaceIsEqual(b,$ifaceNil))){return b;}b=c.send(e);return b;};BB.prototype.sendJSON=function(a){return this.$val.sendJSON(a);};BB.ptr.prototype.sendPayload=function(a){var $ptr,a,b,c,d,e,f,g,h,i,j,k,l,$deferred;var $err=null;try{$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=$ifaceNil;c=this;$deferred.push([(function(){var $ptr;b=R($recover());}),[]]);d=a.String()==="update_user";e=a.Payload;f=0;while(true){if(!(f<e.$length)){break;}g=((f<0||f>=e.$length)?$throwRuntimeError("index out of range"):e.$array[e.$offset+f]);if(d){h=g.split($externalize(",",$String))[1];i=$global.atob(h);j=$parseInt(i.length);g=new($global.ArrayBuffer)(j);k=new($global.Uint8Array)(g);l=0;while(true){if(!(l<j)){break;}k[l]=i.charCodeAt(l);l=l+(1)>>0;}}c.impl.send(g);f++;}return b;}catch(err){$err=err;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return b;}}};BB.prototype.sendPayload=function(a){return this.$val.sendPayload(a);};BB.ptr.prototype.receive=function(){var $ptr,a,b,c;a=null;b=this;if(b.buf.$length>0){a=(c=b.buf,(0>=c.$length?$throwRuntimeError("index out of range"):c.$array[c.$offset+0]));b.buf=$subslice(b.buf,1);}return a;};BB.prototype.receive=function(){return this.$val.receive();};BB.ptr.prototype.receiveJSON=function(){var $ptr,a,b,c,d,e;a=false;b=$ifaceNil;c=this;d=c.receive();if(d===null){return[a,b];}b=AK(O(d),(e||(e=new BN(function(){return a;},function($v){a=$v;}))));return[a,b];};BB.prototype.receiveJSON=function(){return this.$val.receiveJSON();};BB.ptr.prototype.close=function(){var $ptr,a,$deferred;var $err=null;try{$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);a=this;$deferred.push([(function(){var $ptr;$recover();}),[]]);a.impl.close();}catch(err){$err=err;}finally{$callDeferred($deferred,$err);}};BB.prototype.close=function(){return this.$val.close();};BD=function(a,b){var $ptr,a,b,c,d,e,f,g,h,i,j,k,l,m,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);c=[c];d=false;e=false;c[0]=BY.nil;$deferred.push([(function(c){return function(){var $ptr;if(!(c[0]===BY.nil)){c[0].close();}};})(c),[]]);case 1:e=false;f=false;$r=a.log(new BI([new $String("connecting to"),new $String(b)]));$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}c[0]=BC("wss://"+b+"/v2/socket",AG(new AW(0,9000),0.1));h=$select([[c[0].notify],[a.closeNotify]]);$s=4;case 4:if($c){$c=false;h=h.$blk();}if(h&&h.$blk!==undefined){break s;}g=h;if(g[0]===0){$s=5;continue;}if(g[0]===1){$s=6;continue;}$s=7;continue;case 5:i=g[1];j=i[1];if(j){$s=8;continue;}$s=9;continue;case 8:$r=a.log(new BI([new $String("connected")]));$s=11;case 11:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=a.connState("connected");$s=12;case 12:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}d=true;l=BE(a,c[0]);$s=13;case 13:if($c){$c=false;l=l.$blk();}if(l&&l.$blk!==undefined){break s;}k=l;e=k[0];f=k[1];$s=10;continue;case 9:$r=a.log(new BI([new $String("connection failed:"),c[0].err]));$s=14;case 14:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 10:$s=7;continue;case 6:case 7:m=c[0].goingAway;c[0].close();c[0]=BY.nil;if(m){$s=15;continue;}$s=16;continue;case 15:$r=a.log(new BI([new $String("disconnected (server is going away)")]));$s=18;case 18:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=17;continue;case 16:$r=a.log(new BI([new $String("disconnected")]));$s=19;case 19:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 17:if(!e||!f||!a.running||m){return[d,e];}$s=1;continue;case 2:$s=-1;case-1:}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return[d,e];}if($curGoroutine.asleep){if($f===undefined){$f={$blk:BD};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};BE=function(a,b){var $ptr,a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=false;d=false;e=false;if($interfaceIsEqual(a.sessionId,$ifaceNil)){$s=1;continue;}$s=2;continue;case 1:$r=a.log(new BI([new $String("session creation")]));$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}e=a.makeCreateSessionAction();$s=3;continue;case 2:$r=a.log(new BI([new $String("session resumption")]));$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}e=a.makeResumeSessionAction(true);case 3:f=b.sendJSON(e);if(!($interfaceIsEqual(f,$ifaceNil))){$s=6;continue;}$s=7;continue;case 6:$r=a.log(new BI([new $String("send:"),f]));$s=8;case 8:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 7:if($interfaceIsEqual(a.sessionId,$ifaceNil)){$s=9;continue;}$s=10;continue;case 9:g=false;h=true;i=AY(AG(new AW(0,13000),0.2));case 11:j=$ifaceNil;k=b.receiveJSON();g=k[0];j=k[1];if(!($interfaceIsEqual(j,$ifaceNil))){$s=13;continue;}$s=14;continue;case 13:$r=a.log(new BI([new $String("session creation:"),j]));$s=15;case 15:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return[c,d];case 14:if(!(g===false)){i.Stop();$s=12;continue;}if(!h){$s=16;continue;}$s=17;continue;case 16:$r=a.log(new BI([new $String("disconnected during session creation:"),b.err]));$s=18;case 18:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}i.Stop();return[c,d];case 17:m=$select([[b.notify],[i.C]]);$s=19;case 19:if($c){$c=false;m=m.$blk();}if(m&&m.$blk!==undefined){break s;}l=m;if(l[0]===0){$s=20;continue;}if(l[0]===1){$s=21;continue;}$s=22;continue;case 20:n=l[1];h=n[1];$s=22;continue;case 21:$r=a.log(new BI([new $String("session creation timeout")]));$s=23;case 23:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return[c,d];case 22:$s=11;continue;case 12:o=a.handleSessionEvent(g);$s=26;case 26:if($c){$c=false;o=o.$blk();}if(o&&o.$blk!==undefined){break s;}if(!o){$s=24;continue;}$s=25;continue;case 24:return[c,d];case 25:c=true;d=true;$r=a.connActive();$s=27;case 27:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 10:p=new $Chan(BU,1);q=new $Chan(BU,0);$go(BF,[a,b,p,q]);s=BG(a,b,p);$s=28;case 28:if($c){$c=false;s=s.$blk();}if(s&&s.$blk!==undefined){break s;}r=s;t=r[0];d=r[1];if(t){c=true;}u=$recv(q);$s=29;case 29:if($c){$c=false;u=u.$blk();}if(u&&u.$blk!==undefined){break s;}u[0];return[c,d];}return;}if($f===undefined){$f={$blk:BE};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.$s=$s;$f.$r=$r;return $f;};BF=function(a,b,c,d){var $ptr,a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;v=$f.v;w=$f.w;x=$f.x;y=$f.y;z=$f.z;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);d=[d];$deferred.push([(function(d){return function $b(){var $ptr,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=$send(d[0],new BU.ptr());$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;case-1:}return;}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.$s=$s;$f.$r=$r;return $f;};})(d),[]]);e=AY(AG(new AW(0,56000),-0.3));$deferred.push([$methodVal(e,"Stop"),[]]);a.numSent=0;case 1:case 3:if(!(a.numSent<a.sendBuffer.$length)){$s=4;continue;}h=(f=a.sendBuffer,g=a.numSent,((g<0||g>=f.$length)?$throwRuntimeError("index out of range"):f.$array[f.$offset+g]));if(!(h.Payload===BP.nil)){i="frames";(h.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(i)]={k:i,v:new $Int(h.Payload.$length)};}if(!((j=a.receivedEventId,k=a.ackedEventId,(j.$high===k.$high&&j.$low===k.$low)))){l="event_id";(h.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(l)]={k:l,v:a.receivedEventId};a.sendEventAck=false;a.ackedEventId=a.receivedEventId;}m=b.sendJSON(h.Params);delete h.Params[$String.keyFor("frames")];delete h.Params[$String.keyFor("event_id")];if(!($interfaceIsEqual(m,$ifaceNil))){$s=5;continue;}$s=6;continue;case 5:$r=a.log(new BI([new $String("send:"),m]));$s=7;case 7:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(c,new BU.ptr());$s=8;case 8:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return;case 6:if(!(h.Payload===BP.nil)){$s=9;continue;}$s=10;continue;case 9:n=b.sendPayload(h);if(!($interfaceIsEqual(n,$ifaceNil))){$s=11;continue;}$s=12;continue;case 11:$r=a.log(new BI([new $String("send:"),n]));$s=13;case 13:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(c,new BU.ptr());$s=14;case 14:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return;case 12:case 10:if((o=h.id,(o.$high===0&&o.$low===0))){a.sendBuffer=$appendSlice($subslice(a.sendBuffer,0,a.numSent),$subslice(a.sendBuffer,(a.numSent+1>>0)));}else{a.numSent=a.numSent+(1)>>0;}e.Reset(AG(new AW(0,56000),-0.3));$s=3;continue;case 4:if(a.sendEventAck&&!((p=a.receivedEventId,q=a.ackedEventId,(p.$high===q.$high&&p.$low===q.$low)))){$s=15;continue;}$s=16;continue;case 15:r=a.makeResumeSessionAction(false);s=b.sendJSON(r);if(!($interfaceIsEqual(s,$ifaceNil))){$s=17;continue;}$s=18;continue;case 17:$r=a.log(new BI([new $String("send:"),s]));$s=19;case 19:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(c,new BU.ptr());$s=20;case 20:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return;case 18:case 16:u=$select([[a.sendNotify],[e.C],[c]]);$s=21;case 21:if($c){$c=false;u=u.$blk();}if(u&&u.$blk!==undefined){break s;}t=u;if(t[0]===0){$s=22;continue;}if(t[0]===1){$s=23;continue;}if(t[0]===2){$s=24;continue;}$s=25;continue;case 22:v=t[1];w=v[1];if(!w){$s=26;continue;}$s=27;continue;case 26:x=$makeMap($String.keyFor,[{k:"action",v:new $String("close_session")}]);y=b.sendJSON(x);if(!($interfaceIsEqual(y,$ifaceNil))){$s=28;continue;}$s=29;continue;case 28:$r=a.log(new BI([new $String("send:"),y]));$s=30;case 30:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 29:return;case 27:$s=25;continue;case 23:z=b.send(L());if(!($interfaceIsEqual(z,$ifaceNil))){$s=31;continue;}$s=32;continue;case 31:$r=a.log(new BI([new $String("send:"),z]));$s=33;case 33:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(c,new BU.ptr());$s=34;case 34:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return;case 32:e.Reset(AG(new AW(0,56000),-0.3));$s=25;continue;case 24:return;case 25:$s=1;continue;case 2:$s=-1;case-1:}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:BF};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.v=v;$f.w=w;$f.x=x;$f.y=y;$f.z=z;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};BG=function(a,b,c){var $ptr,a,aa,ab,ac,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;aa=$f.aa;ab=$f.ab;ac=$f.ac;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;v=$f.v;w=$f.w;x=$f.x;y=$f.y;z=$f.z;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);d=false;e=false;f=BK.nil;g=0;h=AY(AG(new AW(0,64000),0.3));$deferred.push([$methodVal(h,"Stop"),[]]);i=AY(new AW(-1,4294967295));$deferred.push([$methodVal(i,"Stop"),[]]);case 1:j=false;case 3:k=[k];if(f===BK.nil){$s=5;continue;}$s=6;continue;case 5:l=b.receive();if(l===null){$s=4;continue;}h.Reset(AG(new AW(0,64000),0.7));$r=a.connActive();$s=8;case 8:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}m=O(l);if(N(m)===0){$s=9;continue;}$s=10;continue;case 9:$s=3;continue;case 10:k[0]=false;n=AK(m,(k.$ptr||(k.$ptr=new BN(function(){return this.$target[0];},function($v){this.$target[0]=$v;},k))));if(!($interfaceIsEqual(n,$ifaceNil))){$s=11;continue;}$s=12;continue;case 11:$r=a.log(new BI([new $String("receive:"),n]));$s=13;case 13:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}e=false;$r=$send(c,new BU.ptr());$s=14;case 14:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return[d,e];case 12:f=new G.ptr(k[0],BP.nil,false);o=f.Int("frames");p=o[0];if(p>0){g=p;}$s=7;continue;case 6:q=b.receive();if(q===null){$s=4;continue;}f.Payload=$append(f.Payload,q);g=g-(1)>>0;case 7:if(g===0){$s=15;continue;}$s=16;continue;case 15:s=a.handleEvent(f);$s=17;case 17:if($c){$c=false;s=s.$blk();}if(s&&s.$blk!==undefined){break s;}r=s;t=r[1];u=r[2];v=r[3];if(!v){$s=18;continue;}$s=19;continue;case 18:if(t){d=true;}else{e=false;}$r=$send(c,new BU.ptr());$s=20;case 20:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return[d,e];case 19:if(u){j=true;}f=BK.nil;g=0;d=true;e=true;case 16:w=$select([[a.closeNotify],[c],[]]);if(w[0]===0){return[d,e];}else if(w[0]===1){return[d,e];}else if(w[0]===2){}$s=3;continue;case 4:if(j&&!i.Active()){i.Reset(AG(new AW(0,7000),-0.3));}y=$select([[b.notify],[h.C],[i.C],[a.closeNotify],[c]]);$s=21;case 21:if($c){$c=false;y=y.$blk();}if(y&&y.$blk!==undefined){break s;}x=y;if(x[0]===0){$s=22;continue;}if(x[0]===1){$s=23;continue;}if(x[0]===2){$s=24;continue;}if(x[0]===3){$s=25;continue;}if(x[0]===4){$s=26;continue;}$s=27;continue;case 22:z=x[1];aa=z[1];if(!aa){$s=28;continue;}$s=29;continue;case 28:$r=a.log(new BI([new $String("receive:"),b.err]));$s=30;case 30:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(c,new BU.ptr());$s=31;case 31:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return[d,e];case 29:$s=27;continue;case 23:$r=a.log(new BI([new $String("receive timeout")]));$s=32;case 32:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(c,new BU.ptr());$s=33;case 33:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return[d,e];case 24:if(!a.sendEventAck&&!((ab=a.ackedEventId,ac=a.receivedEventId,(ab.$high===ac.$high&&ab.$low===ac.$low)))){a.sendAck();}$s=27;continue;case 25:return[d,e];case 26:return[d,e];case 27:$s=1;continue;case 2:$s=-1;case-1:}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return[d,e];}if($curGoroutine.asleep){if($f===undefined){$f={$blk:BG};}$f.$ptr=$ptr;$f.a=a;$f.aa=aa;$f.ab=ab;$f.ac=ac;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.v=v;$f.w=w;$f.x=x;$f.y=y;$f.z=z;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};BV.methods=[{prop:"String",name:"String",pkg:"",typ:$funcType([],[$String],false)}];BK.methods=[{prop:"Bool",name:"Bool",pkg:"",typ:$funcType([$String],[$Bool],false)},{prop:"Int",name:"Int",pkg:"",typ:$funcType([$String],[$Int,$Bool],false)},{prop:"Int64",name:"Int64",pkg:"",typ:$funcType([$String],[$Int64,$Bool],false)},{prop:"Float64",name:"Float64",pkg:"",typ:$funcType([$String],[$Float64,$Bool],false)},{prop:"Str",name:"Str",pkg:"",typ:$funcType([$String],[$String,$Bool],false)},{prop:"Array",name:"Array",pkg:"",typ:$funcType([$String],[BI,$Bool],false)},{prop:"Map",name:"Map",pkg:"",typ:$funcType([$String],[BJ,$Bool],false)},{prop:"String",name:"String",pkg:"",typ:$funcType([],[$String],false)},{prop:"initLastReply",name:"initLastReply",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BV],[],false)},{prop:"getError",name:"getError",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[$String,$String,$Bool,$error],false)}];CB.methods=[{prop:"success",name:"success",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[],false)},{prop:"failure",name:"failure",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([AW],[AW],false)}];CC.methods=[{prop:"Call",name:"Call",pkg:"",typ:$funcType([BV],[BL,$error],false)}];Y.methods=[{prop:"Set",name:"Set",pkg:"",typ:$funcType([$String,$String],[],false)}];CD.methods=[{prop:"SetParams",name:"SetParams",pkg:"",typ:$funcType([BJ],[],false)},{prop:"SetTransport",name:"SetTransport",pkg:"",typ:$funcType([$String],[],false)},{prop:"Open",name:"Open",pkg:"",typ:$funcType([],[],false)},{prop:"Close",name:"Close",pkg:"",typ:$funcType([],[],false)},{prop:"Send",name:"Send",pkg:"",typ:$funcType([BV],[],false)},{prop:"send",name:"send",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BV],[],false)},{prop:"sendAck",name:"sendAck",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[],false)},{prop:"discover",name:"discover",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[],false)},{prop:"connect",name:"connect",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([AV,BH,CB],[$Bool],false)},{prop:"canLogin",name:"canLogin",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[$Bool],false)},{prop:"makeCreateSessionAction",name:"makeCreateSessionAction",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[BJ],false)},{prop:"makeResumeSessionAction",name:"makeResumeSessionAction",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([$Bool],[BJ],false)},{prop:"handleSessionEvent",name:"handleSessionEvent",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BJ],[$Bool],false)},{prop:"handleEvent",name:"handleEvent",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BK],[$Int64,$Bool,$Bool,$Bool],false)},{prop:"connState",name:"connState",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([$String],[],false)},{prop:"connActive",name:"connActive",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[],false)},{prop:"log",name:"log",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BI],[],true)}];BX.methods=[{prop:"Active",name:"Active",pkg:"",typ:$funcType([],[$Bool],false)},{prop:"Reset",name:"Reset",pkg:"",typ:$funcType([AW],[],false)},{prop:"Stop",name:"Stop",pkg:"",typ:$funcType([],[],false)}];BY.methods=[{prop:"send",name:"send",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BO],[$error],false)},{prop:"sendJSON",name:"sendJSON",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BJ],[$error],false)},{prop:"sendPayload",name:"sendPayload",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BV],[$error],false)},{prop:"receive",name:"receive",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[BO],false)},{prop:"receiveJSON",name:"receiveJSON",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[BJ,$error],false)},{prop:"close",name:"close",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[],false)}];F.init([{prop:"Params",name:"Params",pkg:"",typ:BJ,tag:""},{prop:"Payload",name:"Payload",pkg:"",typ:BP,tag:""},{prop:"OnReply",name:"OnReply",pkg:"",typ:CA,tag:""},{prop:"id",name:"id",pkg:"github.com/ninchat/ninchat-go",typ:$Int64,tag:""}]);G.init([{prop:"Params",name:"Params",pkg:"",typ:BJ,tag:""},{prop:"Payload",name:"Payload",pkg:"",typ:BP,tag:""},{prop:"LastReply",name:"LastReply",pkg:"",typ:$Bool,tag:""}]);H.init([{prop:"lastSlot",name:"lastSlot",pkg:"github.com/ninchat/ninchat-go",typ:$Int,tag:""}]);K.init([{prop:"Address",name:"Address",pkg:"",typ:$String,tag:""}]);Y.init($String,$String);Z.init([{prop:"Method",name:"Method",pkg:"",typ:$String,tag:""},{prop:"URL",name:"URL",pkg:"",typ:$String,tag:""},{prop:"Header",name:"Header",pkg:"",typ:Y,tag:""},{prop:"data",name:"data",pkg:"github.com/ninchat/ninchat-go",typ:BO,tag:""}]);AC.init([{prop:"data",name:"data",pkg:"github.com/ninchat/ninchat-go",typ:BO,tag:""},{prop:"err",name:"err",pkg:"github.com/ninchat/ninchat-go",typ:$error,tag:""}]);AU.init([{prop:"OnSessionEvent",name:"OnSessionEvent",pkg:"",typ:CA,tag:""},{prop:"OnEvent",name:"OnEvent",pkg:"",typ:CA,tag:""},{prop:"OnConnState",name:"OnConnState",pkg:"",typ:CE,tag:""},{prop:"OnConnActive",name:"OnConnActive",pkg:"",typ:BS,tag:""},{prop:"OnLog",name:"OnLog",pkg:"",typ:CF,tag:""},{prop:"Address",name:"Address",pkg:"",typ:$String,tag:""},{prop:"forceLongPoll",name:"forceLongPoll",pkg:"github.com/ninchat/ninchat-go",typ:$Bool,tag:""},{prop:"sessionParams",name:"sessionParams",pkg:"github.com/ninchat/ninchat-go",typ:BJ,tag:""},{prop:"sessionId",name:"sessionId",pkg:"github.com/ninchat/ninchat-go",typ:$emptyInterface,tag:""},{prop:"latestConnState",name:"latestConnState",pkg:"github.com/ninchat/ninchat-go",typ:$String,tag:""},{prop:"lastActionId",name:"lastActionId",pkg:"github.com/ninchat/ninchat-go",typ:$Int64,tag:""},{prop:"sendNotify",name:"sendNotify",pkg:"github.com/ninchat/ninchat-go",typ:CG,tag:""},{prop:"sendBuffer",name:"sendBuffer",pkg:"github.com/ninchat/ninchat-go",typ:BW,tag:""},{prop:"numSent",name:"numSent",pkg:"github.com/ninchat/ninchat-go",typ:$Int,tag:""},{prop:"sendEventAck",name:"sendEventAck",pkg:"github.com/ninchat/ninchat-go",typ:$Bool,tag:""},{prop:"receivedEventId",name:"receivedEventId",pkg:"github.com/ninchat/ninchat-go",typ:$Int64,tag:""},{prop:"ackedEventId",name:"ackedEventId",pkg:"github.com/ninchat/ninchat-go",typ:$Int64,tag:""},{prop:"closeNotify",name:"closeNotify",pkg:"github.com/ninchat/ninchat-go",typ:CG,tag:""},{prop:"closed",name:"closed",pkg:"github.com/ninchat/ninchat-go",typ:$Bool,tag:""},{prop:"running",name:"running",pkg:"github.com/ninchat/ninchat-go",typ:$Bool,tag:""}]);AV.init([CD,$String],[$Bool,$Bool],false);AX.init([{prop:"C",name:"C",pkg:"",typ:CG,tag:""},{prop:"id",name:"id",pkg:"github.com/ninchat/ninchat-go",typ:BO,tag:""}]);BB.init([{prop:"notify",name:"notify",pkg:"github.com/ninchat/ninchat-go",typ:CG,tag:""},{prop:"goingAway",name:"goingAway",pkg:"github.com/ninchat/ninchat-go",typ:$Bool,tag:""},{prop:"err",name:"err",pkg:"github.com/ninchat/ninchat-go",typ:$error,tag:""},{prop:"impl",name:"impl",pkg:"github.com/ninchat/ninchat-go",typ:BO,tag:""},{prop:"open",name:"open",pkg:"github.com/ninchat/ninchat-go",typ:$Bool,tag:""},{prop:"buf",name:"buf",pkg:"github.com/ninchat/ninchat-go",typ:BP,tag:""}]);$init=function(){$pkg.$init=function(){};var $f,$c=false,$s=0,$r;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=A.$init();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=B.$init();$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=C.$init();$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}V=null;W=false;AT=AH(new $Int64(0,4096),-0.25);BA=!($global.WebSocket===undefined);X();}return;}if($f===undefined){$f={$blk:$init};}$f.$s=$s;$f.$r=$r;return $f;};$pkg.$init=$init;return $pkg;})();
$packages["ninchatclient"]=(function(){var $pkg={},$init,A,B,E,F,G,I,J,K,L,M,N,O,P,Q,R,S,T,U,V,W,X,Y,Z,AA,AB,AC,C,D,H;A=$packages["github.com/gopherjs/gopherjs/js"];B=$packages["github.com/ninchat/ninchat-go"];E=$pkg.callback1=$newType(4,$kindFunc,"main.callback1","callback1","ninchatclient",null);F=$pkg.callback2=$newType(4,$kindFunc,"main.callback2","callback2","ninchatclient",null);G=$pkg.promise=$newType(0,$kindStruct,"main.promise","promise","ninchatclient",function(resolvers_,rejecters_,notifiers_,onPanic_){this.$val=this;if(arguments.length===0){this.resolvers=I.nil;this.rejecters=J.nil;this.notifiers=I.nil;this.onPanic=$throwNilPointerError;return;}this.resolvers=resolvers_;this.rejecters=rejecters_;this.notifiers=notifiers_;this.onPanic=onPanic_;});I=$sliceType(F);J=$sliceType(E);K=$ptrType(A.Object);L=$sliceType(K);M=$mapType($String,$emptyInterface);N=$sliceType(M);O=$funcType([M,K,$String],[K],false);P=$funcType([],[M],false);Q=$funcType([K],[K],false);R=$funcType([F,E,F],[],false);S=$ptrType(B.Event);T=$ptrType(B.Action);U=$sliceType(T);V=$sliceType($emptyInterface);W=$funcType([K],[],false);X=$funcType([M],[],false);Y=$funcType([$String],[],false);Z=$funcType([],[],false);AA=$funcType([M,K],[K],false);AB=$ptrType(G);AC=$funcType([$String,$emptyInterface],[],false);C=function(a,b,c){var $ptr,a,b,c,d;d=new G.ptr(I.nil,J.nil,I.nil,(function $b(d,e){var $ptr,d,e,f,g,h,i,j,k,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:if(!($interfaceIsEqual(e,$ifaceNil))&&!(b===null)){$s=1;continue;}$s=2;continue;case 1:f="";g=e;if($assertType(g,$String,true)[1]){$s=3;continue;}if($assertType(g,$error,true)[1]){$s=4;continue;}$s=5;continue;case 3:h=g.$val;f=h;$s=6;continue;case 4:i=g;j=i.Error();$s=7;case 7:if($c){$c=false;j=j.$blk();}if(j&&j.$blk!==undefined){break s;}f=j;$s=6;continue;case 5:k=g;f="?";case 6:b($externalize(d+" "+f,$String));case 2:$s=-1;case-1:}return;}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.$s=$s;$f.$r=$r;return $f;}));$go((function $b(){var $ptr,e,f,g,h,i,j,k,l,m,n,o,p,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:e=new B.Caller.ptr(c);f=new B.Action.ptr(a,L.nil,$throwNilPointerError,new $Int64(0,0));h=e.Call(f);$s=1;case 1:if($c){$c=false;h=h.$blk();}if(h&&h.$blk!==undefined){break s;}g=h;i=g[0];j=g[1];if(!($interfaceIsEqual(j,$ifaceNil))){$s=2;continue;}$s=3;continue;case 2:k=j.Error();$s=4;case 4:if($c){$c=false;k=k.$blk();}if(k&&k.$blk!==undefined){break s;}l=k;b($externalize(l,$String));$r=d.onReply(new B.Event.ptr($makeMap($String.keyFor,[{k:"event",v:new $String("error")},{k:"error_type",v:new $String("internal")},{k:"error_reason",v:new $String(l)}]),L.nil,false));$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}return;case 3:m=N.nil;n=i;o=0;while(true){if(!(o<n.$length)){break;}p=((o<0||o>=n.$length)?$throwRuntimeError("index out of range"):n.$array[n.$offset+o]);m=$append(m,p.Params);o++;}$r=d.resolveCall(m);$s=6;case 6:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;case-1:}return;}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.$s=$s;$f.$r=$r;return $f;}),[]);return d.object();};D=function(){var $ptr,a;a=new($global.Object)();a.call=$externalize(C,O);a.newSession=$externalize(H,P);a.stringifyFrame=$externalize(B.StringifyFrame,Q);$global.NinchatClient=a;};G.ptr.prototype.object=function(){var $ptr,a,b;a=null;b=this;a=new($global.Object)();a.then=$externalize((function(c,d,e){var $ptr,c,d,e;if(!(c===$throwNilPointerError)){b.resolvers=$append(b.resolvers,c);}if(!(d===$throwNilPointerError)){b.rejecters=$append(b.rejecters,d);}if(!(e===$throwNilPointerError)){b.notifiers=$append(b.notifiers,e);}}),R);return a;};G.prototype.object=function(){return this.$val.object();};G.ptr.prototype.onReply=function(a){var $ptr,a,b,c,d,e,f,g,h,i,j,k,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=this;if(!(a===S.nil)){$s=1;continue;}$s=2;continue;case 1:if(a.String()==="error"){$s=3;continue;}if(a.LastReply){$s=4;continue;}$s=5;continue;case 3:c=b.rejecters;d=0;case 7:if(!(d<c.$length)){$s=8;continue;}e=((d<0||d>=c.$length)?$throwRuntimeError("index out of range"):c.$array[c.$offset+d]);$r=b.invoke1(e,a,"Promise reject callback:");$s=9;case 9:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}d++;$s=7;continue;case 8:$s=6;continue;case 4:f=b.resolvers;g=0;case 10:if(!(g<f.$length)){$s=11;continue;}h=((g<0||g>=f.$length)?$throwRuntimeError("index out of range"):f.$array[f.$offset+g]);$r=b.invoke2(h,a,"Promise resolve callback:");$s=12;case 12:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}g++;$s=10;continue;case 11:$s=6;continue;case 5:i=b.notifiers;j=0;case 13:if(!(j<i.$length)){$s=14;continue;}k=((j<0||j>=i.$length)?$throwRuntimeError("index out of range"):i.$array[i.$offset+j]);$r=b.invoke2(k,a,"Promise notify callback:");$s=15;case 15:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}j++;$s=13;continue;case 14:case 6:case 2:$s=-1;case-1:}return;}if($f===undefined){$f={$blk:G.ptr.prototype.onReply};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.$s=$s;$f.$r=$r;return $f;};G.prototype.onReply=function(a){return this.$val.onReply(a);};G.ptr.prototype.resolveCall=function(a){var $ptr,a,b,c,d,e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=this;c=b.resolvers;d=0;case 1:if(!(d<c.$length)){$s=2;continue;}e=((d<0||d>=c.$length)?$throwRuntimeError("index out of range"):c.$array[c.$offset+d]);$r=b.invokeCall(e,a,"Promise resolve callback:");$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}d++;$s=1;continue;case 2:$s=-1;case-1:}return;}if($f===undefined){$f={$blk:G.ptr.prototype.resolveCall};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};G.prototype.resolveCall=function(a){return this.$val.resolveCall(a);};G.ptr.prototype.invoke1=function(a,b,c){var $ptr,a,b,c,d,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;d=$f.d;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);c=[c];d=[d];d[0]=this;$deferred.push([(function(c,d){return function $b(){var $ptr,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=d[0].onPanic(c[0],$recover());$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;case-1:}return;}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.$s=$s;$f.$r=$r;return $f;};})(c,d),[]]);$r=a(b.Params);$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;case-1:}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:G.ptr.prototype.invoke1};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};G.prototype.invoke1=function(a,b,c){return this.$val.invoke1(a,b,c);};G.ptr.prototype.invoke2=function(a,b,c){var $ptr,a,b,c,d,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;d=$f.d;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);c=[c];d=[d];d[0]=this;$deferred.push([(function(c,d){return function $b(){var $ptr,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=d[0].onPanic(c[0],$recover());$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;case-1:}return;}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.$s=$s;$f.$r=$r;return $f;};})(c,d),[]]);$r=a(new M(b.Params),b.Payload);$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;case-1:}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:G.ptr.prototype.invoke2};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};G.prototype.invoke2=function(a,b,c){return this.$val.invoke2(a,b,c);};G.ptr.prototype.invokeCall=function(a,b,c){var $ptr,a,b,c,d,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;a=$f.a;b=$f.b;c=$f.c;d=$f.d;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);c=[c];d=[d];d[0]=this;$deferred.push([(function(c,d){return function $b(){var $ptr,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=d[0].onPanic(c[0],$recover());$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;case-1:}return;}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.$s=$s;$f.$r=$r;return $f;};})(c,d),[]]);$r=a(b,L.nil);$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;case-1:}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:G.ptr.prototype.invokeCall};}$f.$ptr=$ptr;$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};G.prototype.invokeCall=function(a,b,c){return this.$val.invokeCall(a,b,c);};H=function(){var $ptr,a,b;a=new B.Session.ptr($throwNilPointerError,$throwNilPointerError,$throwNilPointerError,$throwNilPointerError,$throwNilPointerError,"",false,false,$ifaceNil,"",new $Int64(0,0),$chanNil,U.nil,0,false,new $Int64(0,0),new $Int64(0,0),$chanNil,false,false);b=(function $b(b,c){var $ptr,b,c,d,e,f,g,h,i,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:if(!($interfaceIsEqual(c,$ifaceNil))&&!(a.OnLog===$throwNilPointerError)){$s=1;continue;}$s=2;continue;case 1:d="";e=c;if($assertType(e,$String,true)[1]){$s=3;continue;}if($assertType(e,$error,true)[1]){$s=4;continue;}$s=5;continue;case 3:f=e.$val;d=f;$s=6;continue;case 4:g=e;h=g.Error();$s=7;case 7:if($c){$c=false;h=h.$blk();}if(h&&h.$blk!==undefined){break s;}d=h;$s=6;continue;case 5:i=e;d=$internalize($global.JSON.stringify($externalize(i,$emptyInterface)),$String);case 6:$r=a.OnLog(new V([new $String(b),new $String(d)]));$s=8;case 8:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 2:$s=-1;case-1:}return;}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.$s=$s;$f.$r=$r;return $f;});return $makeMap($String.keyFor,[{k:"onSessionEvent",v:new W((function(c){var $ptr,c;a.OnSessionEvent=(function $b(d){var $ptr,d,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;d=$f.d;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);$deferred.push([(function $b(){var $ptr,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=b("Session onSessionEvent callback:",$recover());$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;case-1:}return;}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.$s=$s;$f.$r=$r;return $f;}),[]]);c($externalize(d.Params,M));$s=-1;case-1:}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.d=d;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}});}))},{k:"onEvent",v:new W((function(c){var $ptr,c;a.OnEvent=(function $b(d){var $ptr,d,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;d=$f.d;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);$deferred.push([(function $b(){var $ptr,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=b("Session onEvent callback:",$recover());$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;case-1:}return;}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.$s=$s;$f.$r=$r;return $f;}),[]]);c($externalize(d.Params,M),$externalize(d.Payload,L));$s=-1;case-1:}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.d=d;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}});}))},{k:"onConnState",v:new W((function(c){var $ptr,c;if(c===null){a.OnConnState=$throwNilPointerError;return;}a.OnConnState=(function $b(d){var $ptr,d,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;d=$f.d;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);$deferred.push([(function $b(){var $ptr,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=b("Session onConnState callback:",$recover());$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;case-1:}return;}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.$s=$s;$f.$r=$r;return $f;}),[]]);c($externalize(d,$String));$s=-1;case-1:}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.d=d;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}});}))},{k:"onConnActive",v:new W((function(c){var $ptr,c;if(c===null){a.OnConnActive=$throwNilPointerError;return;}a.OnConnActive=(function $b(){var $ptr,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);$deferred.push([(function $b(){var $ptr,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=b("Session onConnActive callback:",$recover());$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;case-1:}return;}if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.$s=$s;$f.$r=$r;return $f;}),[]]);c(new($global.Date)().getTime());$s=-1;case-1:}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}});}))},{k:"onLog",v:new W((function(c){var $ptr,c;if(c===null){a.OnLog=$throwNilPointerError;return;}a.OnLog=(function $b(d){var $ptr,d,e,f,g,h,i,j,k,l,m,n,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$ptr=$f.$ptr;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);$deferred.push([(function(){var $ptr;$recover();}),[]]);e="";f=d;g=0;case 1:if(!(g<f.$length)){$s=2;continue;}h=((g<0||g>=f.$length)?$throwRuntimeError("index out of range"):f.$array[f.$offset+g]);i="";j=h;if($assertType(j,$String,true)[1]){$s=3;continue;}if($assertType(j,$error,true)[1]){$s=4;continue;}$s=5;continue;case 3:k=j.$val;i=k;$s=6;continue;case 4:l=j;m=l.Error();$s=7;case 7:if($c){$c=false;m=m.$blk();}if(m&&m.$blk!==undefined){break s;}i=m;$s=6;continue;case 5:n=j;i=$internalize($global.JSON.stringify($externalize(n,$emptyInterface)),$String);case 6:if(e.length>0){e=e+(" ");}e=e+(i);g++;$s=1;continue;case 2:while(true){if(!(e.length>0&&(e.charCodeAt((e.length-1>>0))===32))){break;}e=e.substring(0,(e.length-1>>0));}c($externalize(e,$String));$s=-1;case-1:}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:$b};}$f.$ptr=$ptr;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}});}))},{k:"setParams",v:new X($methodVal(a,"SetParams"))},{k:"setTransport",v:new Y($methodVal(a,"SetTransport"))},{k:"setAddress",v:new Y((function(c){var $ptr,c;a.Address=c;}))},{k:"open",v:new Z($methodVal(a,"Open"))},{k:"close",v:new Z($methodVal(a,"Close"))},{k:"send",v:new AA((function(c,d){var $ptr,c,d,e,f,g,h,i,j,k;e=null;f=new B.Action.ptr(c,L.nil,$throwNilPointerError,new $Int64(0,0));g=(h=c[$String.keyFor("action_id")],h!==undefined?[h.v,true]:[$ifaceNil,false]);i=g[1];if(!i){j=new G.ptr(I.nil,J.nil,I.nil,b);f.OnReply=$methodVal(j,"onReply");e=j.object();}if(!(d===null)&&!(d===undefined)){k=0;while(true){if(!(k<$parseInt(d.length))){break;}f.Payload=$append(f.Payload,d[k]);k=k+(1)>>0;}}a.Send(f);return e;}))}]);};AB.methods=[{prop:"object",name:"object",pkg:"ninchatclient",typ:$funcType([],[K],false)},{prop:"onReply",name:"onReply",pkg:"ninchatclient",typ:$funcType([S],[],false)},{prop:"resolveCall",name:"resolveCall",pkg:"ninchatclient",typ:$funcType([N],[],false)},{prop:"invoke1",name:"invoke1",pkg:"ninchatclient",typ:$funcType([E,S,$String],[],false)},{prop:"invoke2",name:"invoke2",pkg:"ninchatclient",typ:$funcType([F,S,$String],[],false)},{prop:"invokeCall",name:"invokeCall",pkg:"ninchatclient",typ:$funcType([F,N,$String],[],false)}];E.init([M],[],false);F.init([$emptyInterface,L],[],false);G.init([{prop:"resolvers",name:"resolvers",pkg:"ninchatclient",typ:I,tag:""},{prop:"rejecters",name:"rejecters",pkg:"ninchatclient",typ:J,tag:""},{prop:"notifiers",name:"notifiers",pkg:"ninchatclient",typ:I,tag:""},{prop:"onPanic",name:"onPanic",pkg:"ninchatclient",typ:AC,tag:""}]);$init=function(){$pkg.$init=function(){};var $f,$c=false,$s=0,$r;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=A.$init();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=B.$init();$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if($pkg===$mainPkg){D();}}return;}if($f===undefined){$f={$blk:$init};}$f.$s=$s;$f.$r=$r;return $f;};$pkg.$init=$init;return $pkg;})();
$synthesizeMethods();
