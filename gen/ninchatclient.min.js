...
$packages["sync"]=(function(){var $pkg={},$init,A,C,D,B,F,Z,AC,AD,AO,AY,AZ,BA,BB,BC,BI,BL,BM,BQ,CA,CD,H,I,W,AJ,G,K,L,M,N,O,P,AH,AK,AL,AT,AU;A=$packages["github.com/gopherjs/gopherjs/js"];C=$packages["internal/race"];D=$packages["runtime"];B=$packages["sync/atomic"];F=$pkg.Pool=$newType(0,$kindStruct,"sync.Pool",true,"sync",true,function(local_,localSize_,store_,New_){this.$val=this;if(arguments.length===0){this.local=0;this.localSize=0;this.store=BM.nil;this.New=$throwNilPointerError;return;}this.local=local_;this.localSize=localSize_;this.store=store_;this.New=New_;});Z=$pkg.Mutex=$newType(0,$kindStruct,"sync.Mutex",true,"sync",true,function(state_,sema_){this.$val=this;if(arguments.length===0){this.state=0;this.sema=0;return;}this.state=state_;this.sema=sema_;});AC=$pkg.poolLocalInternal=$newType(0,$kindStruct,"sync.poolLocalInternal",true,"sync",false,function(private$0_,shared_,Mutex_){this.$val=this;if(arguments.length===0){this.private$0=$ifaceNil;this.shared=BM.nil;this.Mutex=new Z.ptr(0,0);return;}this.private$0=private$0_;this.shared=shared_;this.Mutex=Mutex_;});AD=$pkg.poolLocal=$newType(0,$kindStruct,"sync.poolLocal",true,"sync",false,function(poolLocalInternal_,pad_){this.$val=this;if(arguments.length===0){this.poolLocalInternal=new AC.ptr($ifaceNil,BM.nil,new Z.ptr(0,0));this.pad=CD.zero();return;}this.poolLocalInternal=poolLocalInternal_;this.pad=pad_;});AO=$pkg.notifyList=$newType(0,$kindStruct,"sync.notifyList",true,"sync",false,function(wait_,notify_,lock_,head_,tail_){this.$val=this;if(arguments.length===0){this.wait=0;this.notify=0;this.lock=0;this.head=0;this.tail=0;return;}this.wait=wait_;this.notify=notify_;this.lock=lock_;this.head=head_;this.tail=tail_;});AY=$ptrType(F);AZ=$sliceType(AY);BA=$ptrType($Uint32);BB=$chanType($Bool,false,false);BC=$sliceType(BB);BI=$ptrType($Int32);BL=$ptrType(AD);BM=$sliceType($emptyInterface);BQ=$funcType([],[$emptyInterface],false);CA=$ptrType(Z);CD=$arrayType($Uint8,100);F.ptr.prototype.Get=function(){var l,m,n,o,p,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:l=this;if(l.store.$length===0){$s=1;continue;}$s=2;continue;case 1:if(!(l.New===$throwNilPointerError)){$s=3;continue;}$s=4;continue;case 3:m=l.New();$s=5;case 5:if($c){$c=false;m=m.$blk();}if(m&&m.$blk!==undefined){break s;}$s=-1;return m;case 4:$s=-1;return $ifaceNil;case 2:p=(n=l.store,o=l.store.$length-1>>0,((o<0||o>=n.$length)?($throwRuntimeError("index out of range"),undefined):n.$array[n.$offset+o]));l.store=$subslice(l.store,0,(l.store.$length-1>>0));$s=-1;return p;}return;}if($f===undefined){$f={$blk:F.ptr.prototype.Get};}$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.$s=$s;$f.$r=$r;return $f;};F.prototype.Get=function(){return this.$val.Get();};F.ptr.prototype.Put=function(l){var l,m;m=this;if($interfaceIsEqual(l,$ifaceNil)){return;}m.store=$append(m.store,l);};F.prototype.Put=function(l){return this.$val.Put(l);};G=function(l){var l;};K=function(l,m){var l,m,n,o,p,q,r,s,t,u,v,w,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;v=$f.v;w=$f.w;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:if(((l.$get()-(n=I[BA.keyFor(l)],n!==undefined?n.v:0)>>>0))===0){$s=1;continue;}$s=2;continue;case 1:o=new $Chan($Bool,0);if(m){p=l;(H||$throwRuntimeError("assignment to entry in nil map"))[BA.keyFor(p)]={k:p,v:$appendSlice(new BC([o]),(q=H[BA.keyFor(l)],q!==undefined?q.v:BC.nil))};}else{r=l;(H||$throwRuntimeError("assignment to entry in nil map"))[BA.keyFor(r)]={k:r,v:$append((s=H[BA.keyFor(l)],s!==undefined?s.v:BC.nil),o)};}t=$recv(o);$s=3;case 3:if($c){$c=false;t=t.$blk();}if(t&&t.$blk!==undefined){break s;}t[0];u=l;(I||$throwRuntimeError("assignment to entry in nil map"))[BA.keyFor(u)]={k:u,v:(v=I[BA.keyFor(l)],v!==undefined?v.v:0)-(1)>>>0};if((w=I[BA.keyFor(l)],w!==undefined?w.v:0)===0){delete I[BA.keyFor(l)];}case 2:l.$set(l.$get()-(1)>>>0);$s=-1;return;}return;}if($f===undefined){$f={$blk:K};}$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.v=v;$f.w=w;$f.$s=$s;$f.$r=$r;return $f;};L=function(l,m){var l,m,n,o,p,q,r,s,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:l.$set(l.$get()+(1)>>>0);o=(n=H[BA.keyFor(l)],n!==undefined?n.v:BC.nil);if(o.$length===0){$s=-1;return;}p=(0>=o.$length?($throwRuntimeError("index out of range"),undefined):o.$array[o.$offset+0]);o=$subslice(o,1);q=l;(H||$throwRuntimeError("assignment to entry in nil map"))[BA.keyFor(q)]={k:q,v:o};if(o.$length===0){delete H[BA.keyFor(l)];}r=l;(I||$throwRuntimeError("assignment to entry in nil map"))[BA.keyFor(r)]={k:r,v:(s=I[BA.keyFor(l)],s!==undefined?s.v:0)+(1)>>>0};$r=$send(p,true);$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:L};}$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.$s=$s;$f.$r=$r;return $f;};M=function(l){var l;};N=function(l){var l;return false;};O=function(){return $mul64($internalize(new($global.Date)().getTime(),$Int64),new $Int64(0,1000000));};P=function(l){var l;$throwRuntimeError($externalize(l,$String));};Z.ptr.prototype.Lock=function(){var l,m,n,o,p,q,r,s,t,u,v,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;v=$f.v;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:l=this;if(B.CompareAndSwapInt32((l.$ptr_state||(l.$ptr_state=new BI(function(){return this.$target.state;},function($v){this.$target.state=$v;},l))),0,1)){if(false){C.Acquire((l));}$s=-1;return;}m=new $Int64(0,0);n=false;o=false;p=0;q=l.state;case 1:if(((q&5)===1)&&N(p)){$s=3;continue;}$s=4;continue;case 3:if(!o&&((q&2)===0)&&!(((q>>3>>0)===0))&&B.CompareAndSwapInt32((l.$ptr_state||(l.$ptr_state=new BI(function(){return this.$target.state;},function($v){this.$target.state=$v;},l))),q,q|2)){o=true;}AU();p=p+(1)>>0;q=l.state;$s=1;continue;case 4:r=q;if((q&4)===0){r=r|(1);}if(!(((q&5)===0))){r=r+(8)>>0;}if(n&&!(((q&1)===0))){r=r|(4);}if(o){if((r&2)===0){P("sync: inconsistent mutex state");}r=(r&~(2))>>0;}if(B.CompareAndSwapInt32((l.$ptr_state||(l.$ptr_state=new BI(function(){return this.$target.state;},function($v){this.$target.state=$v;},l))),q,r)){$s=5;continue;}$s=6;continue;case 5:if((q&5)===0){$s=2;continue;}s=!((m.$high===0&&m.$low===0));if((m.$high===0&&m.$low===0)){m=O();}$r=K((l.$ptr_sema||(l.$ptr_sema=new BA(function(){return this.$target.sema;},function($v){this.$target.sema=$v;},l))),s);$s=8;case 8:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}n=n||(t=(u=O(),new $Int64(u.$high-m.$high,u.$low-m.$low)),(t.$high>0||(t.$high===0&&t.$low>1000000)));q=l.state;if(!(((q&4)===0))){if(!(((q&3)===0))||((q>>3>>0)===0)){P("sync: inconsistent mutex state");}v=-7;if(!n||((q>>3>>0)===1)){v=v-(4)>>0;}B.AddInt32((l.$ptr_state||(l.$ptr_state=new BI(function(){return this.$target.state;},function($v){this.$target.state=$v;},l))),v);$s=2;continue;}o=true;p=0;$s=7;continue;case 6:q=l.state;case 7:$s=1;continue;case 2:if(false){C.Acquire((l));}$s=-1;return;}return;}if($f===undefined){$f={$blk:Z.ptr.prototype.Lock};}$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.v=v;$f.$s=$s;$f.$r=$r;return $f;};Z.prototype.Lock=function(){return this.$val.Lock();};Z.ptr.prototype.Unlock=function(){var l,m,n,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;l=$f.l;m=$f.m;n=$f.n;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:l=this;if(false){$unused(l.state);C.Release((l));}m=B.AddInt32((l.$ptr_state||(l.$ptr_state=new BI(function(){return this.$target.state;},function($v){this.$target.state=$v;},l))),-1);if((((m+1>>0))&1)===0){P("sync: unlock of unlocked mutex");}if((m&4)===0){$s=1;continue;}$s=2;continue;case 1:n=m;case 4:if(((n>>3>>0)===0)||!(((n&7)===0))){$s=-1;return;}m=((n-8>>0))|2;if(B.CompareAndSwapInt32((l.$ptr_state||(l.$ptr_state=new BI(function(){return this.$target.state;},function($v){this.$target.state=$v;},l))),n,m)){$s=6;continue;}$s=7;continue;case 6:$r=L((l.$ptr_sema||(l.$ptr_sema=new BA(function(){return this.$target.sema;},function($v){this.$target.sema=$v;},l))),false);$s=8;case 8:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 7:n=l.state;$s=4;continue;case 5:$s=3;continue;case 2:$r=L((l.$ptr_sema||(l.$ptr_sema=new BA(function(){return this.$target.sema;},function($v){this.$target.sema=$v;},l))),true);$s=9;case 9:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 3:$s=-1;return;}return;}if($f===undefined){$f={$blk:Z.ptr.prototype.Unlock};}$f.l=l;$f.m=m;$f.n=n;$f.$s=$s;$f.$r=$r;return $f;};Z.prototype.Unlock=function(){return this.$val.Unlock();};AH=function(){var l,m,n,o,p,q,r,s,t,u;l=AJ;m=0;while(true){if(!(m<l.$length)){break;}n=m;o=((m<0||m>=l.$length)?($throwRuntimeError("index out of range"),undefined):l.$array[l.$offset+m]);((n<0||n>=AJ.$length)?($throwRuntimeError("index out of range"),undefined):AJ.$array[AJ.$offset+n]=AY.nil);p=0;while(true){if(!(p<((o.localSize>>0)))){break;}q=AL(o.local,p);q.poolLocalInternal.private$0=$ifaceNil;r=q.poolLocalInternal.shared;s=0;while(true){if(!(s<r.$length)){break;}t=s;(u=q.poolLocalInternal.shared,((t<0||t>=u.$length)?($throwRuntimeError("index out of range"),undefined):u.$array[u.$offset+t]=$ifaceNil));s++;}q.poolLocalInternal.shared=BM.nil;p=p+(1)>>0;}o.local=0;o.localSize=0;m++;}AJ=new AZ([]);};AK=function(){G(AH);};AL=function(l,m){var l,m,n;n=(((l)+($imul(((m>>>0)),128)>>>0)>>>0));return($pointerOfStructConversion(n,BL));};AT=function(){var l;l=new AO.ptr(0,0,0,0,0);M(20);};AU=function(){$throwRuntimeError("native function not implemented: sync.runtime_doSpin");};AY.methods=[{prop:"Get",name:"Get",pkg:"",typ:$funcType([],[$emptyInterface],false)},{prop:"Put",name:"Put",pkg:"",typ:$funcType([$emptyInterface],[],false)},{prop:"getSlow",name:"getSlow",pkg:"sync",typ:$funcType([],[$emptyInterface],false)},{prop:"pin",name:"pin",pkg:"sync",typ:$funcType([],[BL],false)},{prop:"pinSlow",name:"pinSlow",pkg:"sync",typ:$funcType([],[BL],false)}];CA.methods=[{prop:"Lock",name:"Lock",pkg:"",typ:$funcType([],[],false)},{prop:"Unlock",name:"Unlock",pkg:"",typ:$funcType([],[],false)}];F.init("sync",[{prop:"local",name:"local",anonymous:false,exported:false,typ:$UnsafePointer,tag:""},{prop:"localSize",name:"localSize",anonymous:false,exported:false,typ:$Uintptr,tag:""},{prop:"store",name:"store",anonymous:false,exported:false,typ:BM,tag:""},{prop:"New",name:"New",anonymous:false,exported:true,typ:BQ,tag:""}]);Z.init("sync",[{prop:"state",name:"state",anonymous:false,exported:false,typ:$Int32,tag:""},{prop:"sema",name:"sema",anonymous:false,exported:false,typ:$Uint32,tag:""}]);AC.init("sync",[{prop:"private$0",name:"private",anonymous:false,exported:false,typ:$emptyInterface,tag:""},{prop:"shared",name:"shared",anonymous:false,exported:false,typ:BM,tag:""},{prop:"Mutex",name:"Mutex",anonymous:true,exported:true,typ:Z,tag:""}]);AD.init("sync",[{prop:"poolLocalInternal",name:"poolLocalInternal",anonymous:true,exported:false,typ:AC,tag:""},{prop:"pad",name:"pad",anonymous:false,exported:false,typ:CD,tag:""}]);AO.init("sync",[{prop:"wait",name:"wait",anonymous:false,exported:false,typ:$Uint32,tag:""},{prop:"notify",name:"notify",anonymous:false,exported:false,typ:$Uint32,tag:""},{prop:"lock",name:"lock",anonymous:false,exported:false,typ:$Uintptr,tag:""},{prop:"head",name:"head",anonymous:false,exported:false,typ:$UnsafePointer,tag:""},{prop:"tail",name:"tail",anonymous:false,exported:false,typ:$UnsafePointer,tag:""}]);$init=function(){$pkg.$init=function(){};var $f,$c=false,$s=0,$r;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=A.$init();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=C.$init();$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=D.$init();$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=B.$init();$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}AJ=AZ.nil;H={};I={};W=(new Uint8Array(8));AK();AT();}return;}if($f===undefined){$f={$blk:$init};}$f.$s=$s;$f.$r=$r;return $f;};$pkg.$init=$init;return $pkg;})();
$packages["github.com/ninchat/ninchat-go"]=(function(){var $pkg={},$init,A,B,C,D,G,H,I,K,N,AA,AB,AE,AW,AX,AY,AZ,BD,BI,BO,BP,BQ,BR,BS,BT,BU,BV,BW,BX,BY,BZ,CA,CB,CC,CD,CE,CF,CG,CH,CI,CJ,CK,CL,CM,CN,CO,X,Y,AV,BF,BG,E,F,J,O,P,Q,S,T,U,V,W,Z,AC,AD,AF,AG,AH,AI,AJ,AK,AL,AM,AN,AO,AP,AQ,AR,AS,AT,AU,BA,BB,BC,BE,BH,BJ,BK,BL,BM,BN;A=$packages["errors"];B=$packages["github.com/gopherjs/gopherjs/js"];C=$packages["github.com/ninchat/ninchat-go/vendor/sort"];D=$packages["sync"];G=$pkg.Action=$newType(0,$kindStruct,"ninchat.Action",true,"github.com/ninchat/ninchat-go",true,function(Params_,Payload_,OnReply_,id_){this.$val=this;if(arguments.length===0){this.Params=false;this.Payload=BR.nil;this.OnReply=$throwNilPointerError;this.id=new $Int64(0,0);return;}this.Params=Params_;this.Payload=Payload_;this.OnReply=OnReply_;this.id=id_;});H=$pkg.Event=$newType(0,$kindStruct,"ninchat.Event",true,"github.com/ninchat/ninchat-go",true,function(Params_,Payload_,LastReply_){this.$val=this;if(arguments.length===0){this.Params=false;this.Payload=BR.nil;this.LastReply=false;return;}this.Params=Params_;this.Payload=Payload_;this.LastReply=LastReply_;});I=$pkg.Frame=$newType(4,$kindPtr,"ninchat.Frame",true,"github.com/ninchat/ninchat-go",true,null);K=$pkg.backoff=$newType(0,$kindStruct,"ninchat.backoff",true,"github.com/ninchat/ninchat-go",false,function(lastSlot_){this.$val=this;if(arguments.length===0){this.lastSlot=0;return;}this.lastSlot=lastSlot_;});N=$pkg.Caller=$newType(0,$kindStruct,"ninchat.Caller",true,"github.com/ninchat/ninchat-go",true,function(Address_){this.$val=this;if(arguments.length===0){this.Address="";return;}this.Address=Address_;});AA=$pkg.httpHeader=$newType(4,$kindMap,"ninchat.httpHeader",true,"github.com/ninchat/ninchat-go",false,null);AB=$pkg.httpRequest=$newType(0,$kindStruct,"ninchat.httpRequest",true,"github.com/ninchat/ninchat-go",false,function(Method_,URL_,Header_,data_){this.$val=this;if(arguments.length===0){this.Method="";this.URL="";this.Header=false;this.data=null;return;}this.Method=Method_;this.URL=URL_;this.Header=Header_;this.data=data_;});AE=$pkg.httpResponse=$newType(0,$kindStruct,"ninchat.httpResponse",true,"github.com/ninchat/ninchat-go",false,function(data_,err_){this.$val=this;if(arguments.length===0){this.data=null;this.err=$ifaceNil;return;}this.data=data_;this.err=err_;});AW=$pkg.Session=$newType(0,$kindStruct,"ninchat.Session",true,"github.com/ninchat/ninchat-go",true,function(OnSessionEvent_,OnEvent_,OnClose_,OnConnState_,OnConnActive_,OnLog_,Address_,forceLongPoll_,mutex_,sessionParams_,sessionId_,latestConnState_,lastActionId_,sendNotify_,sendBuffer_,numSent_,sendEventAck_,receivedEventId_,ackedEventId_,closeNotify_,closed_,running_){this.$val=this;if(arguments.length===0){this.OnSessionEvent=$throwNilPointerError;this.OnEvent=$throwNilPointerError;this.OnClose=$throwNilPointerError;this.OnConnState=$throwNilPointerError;this.OnConnActive=$throwNilPointerError;this.OnLog=$throwNilPointerError;this.Address="";this.forceLongPoll=false;this.mutex=new D.Mutex.ptr(0,0);this.sessionParams=false;this.sessionId=$ifaceNil;this.latestConnState="";this.lastActionId=new $Int64(0,0);this.sendNotify=$chanNil;this.sendBuffer=CD.nil;this.numSent=0;this.sendEventAck=false;this.receivedEventId=new $Int64(0,0);this.ackedEventId=new $Int64(0,0);this.closeNotify=$chanNil;this.closed=false;this.running=false;return;}this.OnSessionEvent=OnSessionEvent_;this.OnEvent=OnEvent_;this.OnClose=OnClose_;this.OnConnState=OnConnState_;this.OnConnActive=OnConnActive_;this.OnLog=OnLog_;this.Address=Address_;this.forceLongPoll=forceLongPoll_;this.mutex=mutex_;this.sessionParams=sessionParams_;this.sessionId=sessionId_;this.latestConnState=latestConnState_;this.lastActionId=lastActionId_;this.sendNotify=sendNotify_;this.sendBuffer=sendBuffer_;this.numSent=numSent_;this.sendEventAck=sendEventAck_;this.receivedEventId=receivedEventId_;this.ackedEventId=ackedEventId_;this.closeNotify=closeNotify_;this.closed=closed_;this.running=running_;});AX=$pkg.transport=$newType(4,$kindFunc,"ninchat.transport",true,"github.com/ninchat/ninchat-go",false,null);AY=$pkg.duration=$newType(8,$kindInt64,"ninchat.duration",true,"github.com/ninchat/ninchat-go",false,null);AZ=$pkg.timeTime=$newType(8,$kindInt64,"ninchat.timeTime",true,"github.com/ninchat/ninchat-go",false,null);BD=$pkg.timer=$newType(0,$kindStruct,"ninchat.timer",true,"github.com/ninchat/ninchat-go",false,function(C_,id_){this.$val=this;if(arguments.length===0){this.C=$chanNil;this.id=null;return;}this.C=C_;this.id=id_;});BI=$pkg.webSocket=$newType(0,$kindStruct,"ninchat.webSocket",true,"github.com/ninchat/ninchat-go",false,function(notify_,goingAway_,err_,impl_,open_,buf_){this.$val=this;if(arguments.length===0){this.notify=$chanNil;this.goingAway=false;this.err=$ifaceNil;this.impl=null;this.open=false;this.buf=CG.nil;return;}this.notify=notify_;this.goingAway=goingAway_;this.err=err_;this.impl=impl_;this.open=open_;this.buf=buf_;});BO=$sliceType($String);BP=$sliceType($emptyInterface);BQ=$mapType($String,$emptyInterface);BR=$sliceType(I);BS=$ptrType(H);BT=$sliceType(BS);BU=$ptrType(BP);BV=$ptrType(BQ);BW=$sliceType($Uint8);BX=$ptrType(AB);BY=$funcType([],[],false);BZ=$ptrType(B.Object);CA=$ptrType($Bool);CB=$structType("",[]);CC=$ptrType(G);CD=$sliceType(CC);CE=$ptrType(BD);CF=$ptrType(BI);CG=$sliceType(BZ);CH=$funcType([BZ],[],false);CI=$funcType([BS],[],false);CJ=$ptrType(K);CK=$ptrType(N);CL=$ptrType(AW);CM=$funcType([$String],[],false);CN=$funcType([BP],[],true);CO=$chanType(CB,false,false);E=function(a){var a;if(a===""){return"api.ninchat.com";}else{return a;}};F=function(a){var a,b,c,d,e,f,g,h,i,j,k,l,m,n;b=BO.nil;c=$ifaceNil;e=(d=a[$String.keyFor("hosts")],d!==undefined?d.v:$ifaceNil);if($interfaceIsEqual(e,$ifaceNil)){c=A.New("invalid endpoint document");return[b,c];}f=$assertType(e,BP,true);g=f[0];h=f[1];if(!h){c=A.New("invalid endpoint hosts type");return[b,c];}if(g.$length===0){c=A.New("no endpoint hosts");return[b,c];}i=g;j=0;while(true){if(!(j<i.$length)){break;}k=((j<0||j>=i.$length)?($throwRuntimeError("index out of range"),undefined):i.$array[i.$offset+j]);l=$assertType(k,$String,true);m=l[0];n=l[1];if(n){b=$append(b,m);}else{c=A.New("invalid endpoint host value type");}j++;}if(b.$length>0){c=$ifaceNil;}return[b,c];};G.ptr.prototype.String=function(){var a,b,c,d,e,f,g;a="";b=this;c=(d=b.Params[$String.keyFor("action")],d!==undefined?[d.v,true]:[$ifaceNil,false]);e=c[0];f=c[1];if(f){g=$assertType(e,$String,true);a=g[0];}return a;};G.prototype.String=function(){return this.$val.String();};H.ptr.prototype.Bool=function(a){var a,b,c,d,e,f;b=false;c=this;e=(d=c.Params[$String.keyFor(a)],d!==undefined?d.v:$ifaceNil);if(!($interfaceIsEqual(e,$ifaceNil))){f=$assertType(e,$Bool,true);b=f[0];}return b;};H.prototype.Bool=function(a){return this.$val.Bool(a);};H.ptr.prototype.Int=function(a){var a,b,c,d,e,f,g,h;b=0;c=false;d=this;f=(e=d.Params[$String.keyFor(a)],e!==undefined?e.v:$ifaceNil);if(!($interfaceIsEqual(f,$ifaceNil))){g=0;h=$assertType(f,$Float64,true);g=h[0];c=h[1];if(c){b=((g>>0));}}return[b,c];};H.prototype.Int=function(a){return this.$val.Int(a);};H.ptr.prototype.Int64=function(a){var a,b,c,d,e,f,g,h;b=new $Int64(0,0);c=false;d=this;f=(e=d.Params[$String.keyFor(a)],e!==undefined?e.v:$ifaceNil);if(!($interfaceIsEqual(f,$ifaceNil))){g=0;h=$assertType(f,$Float64,true);g=h[0];c=h[1];if(c){b=(new $Int64(0,g));}}return[b,c];};H.prototype.Int64=function(a){return this.$val.Int64(a);};H.ptr.prototype.Float64=function(a){var a,b,c,d,e,f,g;b=0;c=false;d=this;f=(e=d.Params[$String.keyFor(a)],e!==undefined?e.v:$ifaceNil);if(!($interfaceIsEqual(f,$ifaceNil))){g=$assertType(f,$Float64,true);b=g[0];c=g[1];}return[b,c];};H.prototype.Float64=function(a){return this.$val.Float64(a);};H.ptr.prototype.Str=function(a){var a,b,c,d,e,f,g;b="";c=false;d=this;f=(e=d.Params[$String.keyFor(a)],e!==undefined?e.v:$ifaceNil);if(!($interfaceIsEqual(f,$ifaceNil))){g=$assertType(f,$String,true);b=g[0];c=g[1];}return[b,c];};H.prototype.Str=function(a){return this.$val.Str(a);};H.ptr.prototype.Array=function(a){var a,b,c,d,e,f,g;b=BP.nil;c=false;d=this;f=(e=d.Params[$String.keyFor(a)],e!==undefined?e.v:$ifaceNil);if(!($interfaceIsEqual(f,$ifaceNil))){g=$assertType(f,BP,true);b=g[0];c=g[1];}return[b,c];};H.prototype.Array=function(a){return this.$val.Array(a);};H.ptr.prototype.Map=function(a){var a,b,c,d,e,f,g;b=false;c=false;d=this;f=(e=d.Params[$String.keyFor(a)],e!==undefined?e.v:$ifaceNil);if(!($interfaceIsEqual(f,$ifaceNil))){g=$assertType(f,BQ,true);b=g[0];c=g[1];}return[b,c];};H.prototype.Map=function(a){return this.$val.Map(a);};H.ptr.prototype.String=function(){var a,b,c;a="";b=this;c=b.Str("event");a=c[0];return a;};H.prototype.String=function(){return this.$val.String();};H.ptr.prototype.initLastReply=function(a){var a,b,c,d,e,f;b=this;c=b.Int("history_length");d=c[0];if(d>0){return;}if(b.String()==="search_results"){if(!($interfaceIsEqual((e=b.Params[$String.keyFor("users")],e!==undefined?e.v:$ifaceNil),$ifaceNil))||!($interfaceIsEqual((f=b.Params[$String.keyFor("channels")],f!==undefined?f.v:$ifaceNil),$ifaceNil))){return;}}b.LastReply=true;};H.prototype.initLastReply=function(a){return this.$val.initLastReply(a);};H.ptr.prototype.getError=function(){var a,b,c,d,e,f,g,h,i,j,k,l,m;a="";b="";c=false;d=$ifaceNil;e=this;f=(g=e.Params[$String.keyFor("event")],g!==undefined?[g.v,true]:[$ifaceNil,false]);h=f[0];i=f[1];if(!i||!($assertType(h,$String)==="error")){return[a,b,c,d];}a=$assertType((j=e.Params[$String.keyFor("error_type")],j!==undefined?j.v:$ifaceNil),$String);l=(k=e.Params[$String.keyFor("error_reason")],k!==undefined?k.v:$ifaceNil);if(!($interfaceIsEqual(l,$ifaceNil))){b=$assertType(l,$String);}m=a;if(m===("session_not_found")){c=true;if(!(b==="")){d=A.New("error: "+a+" ("+b+")");}else{d=A.New("error: "+a);}}else if(m===("connection_superseded")||m===("message_has_too_many_parts")||m===("message_part_too_long")||m===("message_too_long")||m===("request_malformed")){if(!(b==="")){d=A.New("error: "+a+" ("+b+")");}else{d=A.New("error: "+a);}}return[a,b,c,d];};H.prototype.getError=function(){return this.$val.getError();};J=function(a){var a;return new BR([a]);};K.ptr.prototype.success=function(){var a;a=this;a.lastSlot=0;};K.prototype.success=function(){return this.$val.success();};K.ptr.prototype.failure=function(a){var a,b,c;b=new AY(0,0);c=this;if(c.lastSlot>0){b=(new AY(0,AH(($flatten64(a))*(c.lastSlot)/1024,-0.5)));}if(c.lastSlot<1023){c.lastSlot=((((c.lastSlot+1>>0))<<1>>0))-1>>0;}return b;};K.prototype.failure=function(a){return this.$val.failure(a);};N.ptr.prototype.Call=function(a){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=[b];c=[c];d=BT.nil;e=$ifaceNil;f=this;g="https://"+E(f.Address)+"/v2/call";h=U(g,a.Params);i=h[0];e=h[1];if(!($interfaceIsEqual(e,$ifaceNil))){$s=-1;return[d,e];}new AA(i.Header).Set("Accept","application/json");new AA(i.Header).Set("Content-Type","application/json");j=AI(new AY(0,11000),0.1);l=AF(i,j);$s=1;case 1:if($c){$c=false;l=l.$blk();}if(l&&l.$blk!==undefined){break s;}k=l;m=k[0];e=k[1];if(!($interfaceIsEqual(e,$ifaceNil))){$s=-1;return[d,e];}b[0]=BP.nil;if(!($interfaceIsEqual(AL(m,(b.$ptr||(b.$ptr=new BU(function(){return this.$target[0];},function($v){this.$target[0]=$v;},b)))),$ifaceNil))){c[0]=false;e=AM(m,(c.$ptr||(c.$ptr=new BV(function(){return this.$target[0];},function($v){this.$target[0]=$v;},c))));if(!($interfaceIsEqual(e,$ifaceNil))){$s=-1;return[d,e];}b[0]=new BP([new BQ(c[0])]);}d=$makeSlice(BT,0,b[0].$length);n=b[0];o=0;case 2:if(!(o<n.$length)){$s=3;continue;}p=o;q=((o<0||o>=n.$length)?($throwRuntimeError("index out of range"),undefined):n.$array[n.$offset+o]);r=$assertType(q,BQ,true);s=r[0];t=r[1];if(!t){e=A.New("response event header is not an object");$s=-1;return[d,e];}u=new H.ptr(s,BR.nil,p===(b[0].$length-1>>0));if(!(a.OnReply===$throwNilPointerError)){$s=4;continue;}$s=5;continue;case 4:$r=a.OnReply(u);$s=6;case 6:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 5:d=$append(d,u);o++;$s=2;continue;case 3:$s=-1;return[d,e];}return;}if($f===undefined){$f={$blk:N.ptr.prototype.Call};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.$s=$s;$f.$r=$r;return $f;};N.prototype.Call=function(a){return this.$val.Call(a);};O=function(){return new($global.ArrayBuffer)();};P=function(a){var a;return $parseInt(a.length);};Q=function(a){var a;return S(a);};S=function(a){var a,b,c,d,e,f;b=$assertType($internalize(a,$emptyInterface),$String,true);c=b[1];if(c){return a;}d=new($global.Uint8Array)(a);e=$assertType($internalize(d,$emptyInterface),BW);f=($bytesToString(e));return new($global.String)($externalize(f,$String));};$pkg.StringifyFrame=S;T=function(a){var a,b,c,d,e,f;b=$ifaceNil;if(!($interfaceIsEqual(a,$ifaceNil))){c=a;if($assertType(c,$error,true)[1]){d=c;b=d;}else if($assertType(c,$String,true)[1]){e=c.$val;b=A.New(e);}else{f=c;b=A.New("?");}}return b;};U=function(a,b){var a,b,c,d,e,f,g;c=BX.nil;d=$ifaceNil;e=AK(b);f=e[0];d=e[1];if(!($interfaceIsEqual(d,$ifaceNil))){return[c,d];}g=AD("POST",a,f);c=g[0];d=g[1];return[c,d];};V=function(a,b,c){var a,b,c,d,e,f,g,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:d=new $Chan(AE,1);e=U(a,b);f=e[0];g=e[1];if($interfaceIsEqual(g,$ifaceNil)){$s=1;continue;}$s=2;continue;case 1:$r=AG(f,c,d);$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=3;continue;case 2:$r=$send(d,$clone(new AE.ptr(null,g),AE));$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 3:$s=-1;return d;}return;}if($f===undefined){$f={$blk:V};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.$s=$s;$f.$r=$r;return $f;};W=function(a,b){var a,b,c,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=new $Chan(AE,1);$r=AG(a,b,c);$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return c;}return;}if($f===undefined){$f={$blk:W};}$f.a=a;$f.b=b;$f.c=c;$f.$s=$s;$f.$r=$r;return $f;};Z=function(){X=$global.XDomainRequest;if(X===undefined){X=$global.XMLHttpRequest;if(X===undefined){X=$module.require($externalize("xhr2",$String));}Y=true;}};AA.prototype.Set=function(a,b){var a,b,c,d;c=this.$val;d=a;(c||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(d)]={k:d,v:b};};$ptrType(AA).prototype.Set=function(a,b){return new AA(this.$get()).Set(a,b);};AC=function(a){var a,b,c;b=BX.nil;c=$ifaceNil;b=new AB.ptr("GET",a,{},null);return[b,c];};AD=function(a,b,c){var a,b,c,d,e;d=BX.nil;e=$ifaceNil;d=new AB.ptr(a,b,{},c);return[d,e];};AF=function(a,b){var a,b,c,d,e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=W(a,b);$s=1;case 1:if($c){$c=false;c=c.$blk();}if(c&&c.$blk!==undefined){break s;}d=$recv(c);$s=2;case 2:if($c){$c=false;d=d.$blk();}if(d&&d.$blk!==undefined){break s;}e=$clone(d[0],AE);$s=-1;return[e.data,e.err];}return;}if($f===undefined){$f={$blk:AF};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};AG=function(a,b,c){var a,b,c,d,e,f,g,h,i,j,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);a=[a];c=[c];d=[d];$deferred.push([(function(a,c,d){return function $b(){var e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:e=T($recover());if(!($interfaceIsEqual(e,$ifaceNil))){$s=1;continue;}$s=2;continue;case 1:$r=$send(c[0],$clone(new AE.ptr(null,e),AE));$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 2:$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};})(a,c,d),[]]);d[0]=new(X)();d[0].onload=$externalize((function(a,c,d){return function(){var e;e=d[0].responseText;$go((function(a,c,d){return function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=$send(c[0],$clone(new AE.ptr(e,$ifaceNil),AE));$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;};})(a,c,d),[]);};})(a,c,d),BY);d[0].onprogress=$externalize((function(a,c,d){return function(){$global.setTimeout($externalize((function(a,c,d){return function(){};})(a,c,d),BY),0);};})(a,c,d),BY);d[0].ontimeout=$externalize((function(a,c,d){return function(){$go((function(a,c,d){return function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=$send(c[0],$clone(new AE.ptr(null,A.New("timeout")),AE));$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;};})(a,c,d),[]);};})(a,c,d),BY);d[0].onerror=$externalize((function(a,c,d){return function(){$go((function(a,c,d){return function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=$send(c[0],$clone(new AE.ptr(null,A.New("error")),AE));$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;};})(a,c,d),[]);};})(a,c,d),BY);d[0].open($externalize(a[0].Method,$String),$externalize(a[0].URL,$String));d[0].timeout=$externalize(b,AY);if(Y){e=a[0].Header;f=0;g=$keys(e);while(true){if(!(f<g.length)){break;}h=e[g[f]];if(h===undefined){f++;continue;}i=h.k;j=h.v;d[0].setRequestHeader($externalize(i,$String),$externalize(j,$String));f++;}}$global.setTimeout($externalize((function(a,c,d){return function(){d[0].send(a[0].data);};})(a,c,d),BY),0);$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AG};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AH=function(a,b){var a,b;return a+a*b*AU();};AI=function(a,b){var a,b;return(new AY(0,AH(($flatten64(a)),b)));};AJ=function(a,b){var a,b;return(new $Int64(0,AH(($flatten64(a)),b)));};AK=function(a){var a,b,c,$deferred;var $err=null;try{$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=null;c=$ifaceNil;$deferred.push([(function(){c=T($recover());}),[]]);b=$global.JSON.stringify($externalize(a,BQ));return[b,c];}catch(err){$err=err;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return[b,c];}}};AL=function(a,b){var a,b,c,d,e,f,g,h;c=$ifaceNil;d=AN(a);e=d[0];c=d[1];if(!($interfaceIsEqual(c,$ifaceNil))){return c;}f=$assertType(e,BP,true);g=f[0];h=f[1];if(!h){c=A.New("json: cannot unmarshal value into Go value of type *[]interface{}");return c;}b.$set(g);return c;};AM=function(a,b){var a,b,c,d,e,f,g,h;c=$ifaceNil;d=AN(a);e=d[0];c=d[1];if(!($interfaceIsEqual(c,$ifaceNil))){return c;}f=$assertType(e,BQ,true);g=f[0];h=f[1];if(!h){c=A.New("json: cannot unmarshal value into Go value of type *map[string]interface{}");return c;}b.$set(g);return c;};AN=function(a){var a,b,c,$deferred;var $err=null;try{$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=$ifaceNil;c=$ifaceNil;$deferred.push([(function(){c=T($recover());}),[]]);b=$internalize($global.JSON.parse(a),$emptyInterface);return[b,c];}catch(err){$err=err;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return[b,c];}}};AO=function(a){var a,b,c,d,e,f;b=BP.nil;c=a.Payload;d=0;while(true){if(!(d<c.$length)){break;}e=((d<0||d>=c.$length)?($throwRuntimeError("index out of range"),undefined):c.$array[c.$offset+d]);f=($pointerOfStructConversion(e,BZ)).split($externalize(",",$String))[1];b=$append(b,new $jsObjectPtr(f));d++;}return b;};AP=function(a,b){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=[c];d=[d];e=[e];d[0]=false;e[0]=false;f="https://"+b+"/v2/poll";if($interfaceIsEqual(a.sessionId,$ifaceNil)){$s=1;continue;}$s=2;continue;case 1:$r=a.log(new BP([new $String("session creation")]));$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}g=a.makeCreateSessionAction();h=AI(new AY(0,13000),0.2);$r=a.mutex.Unlock();$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}j=V(f,g,h);$s=6;case 6:if($c){$c=false;j=j.$blk();}if(j&&j.$blk!==undefined){break s;}k=$select([[j],[a.closeNotify]]);$s=7;case 7:if($c){$c=false;k=k.$blk();}if(k&&k.$blk!==undefined){break s;}i=k;if(i[0]===0){$s=8;continue;}if(i[0]===1){$s=9;continue;}$s=10;continue;case 8:l=$clone(i[1][0],AE);$r=a.mutex.Lock();$s=11;case 11:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!($interfaceIsEqual(l.err,$ifaceNil))){$s=12;continue;}$s=13;continue;case 12:$r=a.log(new BP([new $String("session creation:"),l.err]));$s=14;case 14:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d[0],e[0]];case 13:c[0]=BP.nil;m=AL(l.data,(c.$ptr||(c.$ptr=new BU(function(){return this.$target[0];},function($v){this.$target[0]=$v;},c))));if(!($interfaceIsEqual(m,$ifaceNil))){$s=15;continue;}$s=16;continue;case 15:$r=a.log(new BP([new $String("session creation response:"),m]));$s=17;case 17:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d[0],e[0]];case 16:if(c[0].$length===0){$s=18;continue;}$s=19;continue;case 18:$r=a.log(new BP([new $String("session creation response JSON array is empty")]));$s=20;case 20:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d[0],e[0]];case 19:n=$assertType((0>=c[0].$length?($throwRuntimeError("index out of range"),undefined):c[0].$array[c[0].$offset+0]),BQ,true);o=n[0];p=n[1];if(!p){$s=21;continue;}$s=22;continue;case 21:$r=a.log(new BP([new $String("session creation response header is not a JSON object")]));$s=23;case 23:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d[0],e[0]];case 22:q=a.handleSessionEvent(o);$s=26;case 26:if($c){$c=false;q=q.$blk();}if(q&&q.$blk!==undefined){break s;}if(!q){$s=24;continue;}$s=25;continue;case 24:$s=-1;return[d[0],e[0]];case 25:$s=10;continue;case 9:$r=a.mutex.Lock();$s=27;case 27:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=AS(a,f);$s=28;case 28:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d[0],e[0]];case 10:d[0]=true;e[0]=true;$r=a.connState("connected");$s=29;case 29:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=a.connActive();$s=30;case 30:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=3;continue;case 2:$r=a.log(new BP([new $String("session resumption")]));$s=31;case 31:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=AR(a,f);$s=32;case 32:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 3:$r=AQ(a,f,(d.$ptr||(d.$ptr=new CA(function(){return this.$target[0];},function($v){this.$target[0]=$v;},d))),(e.$ptr||(e.$ptr=new CA(function(){return this.$target[0];},function($v){this.$target[0]=$v;},e))));$s=33;case 33:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d[0],e[0]];}return;}if($f===undefined){$f={$blk:AP};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.$s=$s;$f.$r=$r;return $f;};AQ=function(a,b,c,d){var a,aa,ab,ac,ad,ae,af,ag,ah,ai,aj,ak,al,am,an,ao,ap,aq,ar,as,at,au,av,aw,ax,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;aa=$f.aa;ab=$f.ab;ac=$f.ac;ad=$f.ad;ae=$f.ae;af=$f.af;ag=$f.ag;ah=$f.ah;ai=$f.ai;aj=$f.aj;ak=$f.ak;al=$f.al;am=$f.am;an=$f.an;ao=$f.ao;ap=$f.ap;aq=$f.aq;ar=$f.ar;as=$f.as;at=$f.at;au=$f.au;av=$f.av;aw=$f.aw;ax=$f.ax;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;v=$f.v;w=$f.w;x=$f.x;y=$f.y;z=$f.z;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:e=$chanNil;f=$chanNil;g=new $Int64(0,0);h=0;a.numSent=0;case 1:if(!(h<2)){$s=2;continue;}i=[i];j=[j];if(e===$chanNil){$s=3;continue;}$s=4;continue;case 3:k=a.makeResumeSessionAction(true);l=AI(new AY(0,64000),0.2);m=V(b,k,l);$s=5;case 5:if($c){$c=false;m=m.$blk();}if(m&&m.$blk!==undefined){break s;}e=m;case 4:if(f===$chanNil&&a.numSent<a.sendBuffer.$length){$s=6;continue;}$s=7;continue;case 6:p=(n=a.sendBuffer,o=a.numSent,((o<0||o>=n.$length)?($throwRuntimeError("index out of range"),undefined):n.$array[n.$offset+o]));if(!(p.Payload===BR.nil)){$s=8;continue;}$s=9;continue;case 8:if(p.String()==="update_user"){$s=10;continue;}$s=11;continue;case 10:q="payload";(p.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(q)]={k:q,v:AO(p)};$s=12;continue;case 11:j[0]=false;s=AM((r=p.Payload,(0>=r.$length?($throwRuntimeError("index out of range"),undefined):r.$array[r.$offset+0])),(j.$ptr||(j.$ptr=new BV(function(){return this.$target[0];},function($v){this.$target[0]=$v;},j))));if(!($interfaceIsEqual(s,$ifaceNil))){$s=13;continue;}$s=14;continue;case 13:$r=a.log(new BP([new $String("send:"),s]));$s=15;case 15:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 14:t="payload";(p.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(t)]={k:t,v:new BQ(j[0])};case 12:case 9:u="session_id";(p.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(u)]={k:u,v:a.sessionId};v=AI(new AY(0,7000),0.2);w=V(b,p.Params,v);$s=16;case 16:if($c){$c=false;w=w.$blk();}if(w&&w.$blk!==undefined){break s;}x=w;delete p.Params[$String.keyFor("session_id")];delete p.Params[$String.keyFor("payload")];if((y=p.id,(y.$high===0&&y.$low===0))){$go(AT,[a,x,"send error:"]);a.sendBuffer=$appendSlice($subslice(a.sendBuffer,0,a.numSent),$subslice(a.sendBuffer,(a.numSent+1>>0)));}else{f=x;g=p.id;}case 7:z=new AE.ptr(null,$ifaceNil);$r=a.mutex.Unlock();$s=17;case 17:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}ab=$select([[e],[f],[a.sendNotify],[a.closeNotify]]);$s=18;case 18:if($c){$c=false;ab=ab.$blk();}if(ab&&ab.$blk!==undefined){break s;}aa=ab;if(aa[0]===0){$s=19;continue;}if(aa[0]===1){$s=20;continue;}if(aa[0]===2){$s=21;continue;}if(aa[0]===3){$s=22;continue;}$s=23;continue;case 19:AE.copy(z,aa[1][0]);$r=a.mutex.Lock();$s=24;case 24:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!($interfaceIsEqual(z.err,$ifaceNil))){$s=25;continue;}$s=26;continue;case 25:$r=a.log(new BP([new $String("poll error:"),z.err]));$s=27;case 27:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 26:e=$chanNil;$r=a.connActive();$s=28;case 28:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=23;continue;case 20:AE.copy(z,aa[1][0]);$r=a.mutex.Lock();$s=29;case 29:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!($interfaceIsEqual(z.err,$ifaceNil))){$s=30;continue;}if((g.$high>0||(g.$high===0&&g.$low>0))){$s=31;continue;}$s=32;continue;case 30:$r=a.log(new BP([new $String("send error:"),z.err]));$s=33;case 33:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=32;continue;case 31:a.numSent=a.numSent+(1)>>0;case 32:f=$chanNil;g=new $Int64(0,0);$s=23;continue;case 21:ac=aa[1];ad=ac[1];$r=a.mutex.Lock();$s=34;case 34:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!ad){$s=35;continue;}$s=36;continue;case 35:$r=AS(a,b);$s=37;case 37:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 36:$s=1;continue;$s=23;continue;case 22:$r=a.mutex.Lock();$s=38;case 38:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=AS(a,b);$s=39;case 39:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 23:i[0]=BP.nil;ae=z.err;if($interfaceIsEqual(ae,$ifaceNil)){$s=40;continue;}$s=41;continue;case 40:ae=AL(z.data,(i.$ptr||(i.$ptr=new BU(function(){return this.$target[0];},function($v){this.$target[0]=$v;},i))));if(!($interfaceIsEqual(ae,$ifaceNil))){$s=42;continue;}$s=43;continue;case 42:$r=a.log(new BP([new $String("response:"),ae]));$s=44;case 44:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 43:case 41:if(!($interfaceIsEqual(ae,$ifaceNil))){$s=45;continue;}$s=46;continue;case 45:h=h+(1)>>0;a.numSent=0;$s=1;continue;case 46:h=0;c.$set(true);af=i[0];ag=0;case 47:if(!(ag<af.$length)){$s=48;continue;}ah=((ag<0||ag>=af.$length)?($throwRuntimeError("index out of range"),undefined):af.$array[af.$offset+ag]);ai=$assertType(ah,BQ,true);aj=ai[0];ak=ai[1];if(!ak){$s=49;continue;}$s=50;continue;case 49:$r=a.log(new BP([new $String("poll event is not an object")]));$s=51;case 51:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 50:al=new H.ptr(aj,BR.nil,false);an=(am=aj[$String.keyFor("payload")],am!==undefined?am.v:$ifaceNil);if(!($interfaceIsEqual(an,$ifaceNil))){$s=52;continue;}$s=53;continue;case 52:ao=$assertType(an,BQ,true);ap=ao[0];aq=ao[1];if(!aq){$s=54;continue;}$s=55;continue;case 54:$r=a.log(new BP([new $String("poll payload is not an object")]));$s=56;case 56:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 55:ar=AK(ap);as=ar[0];at=ar[1];if(!($interfaceIsEqual(at,$ifaceNil))){$s=57;continue;}$s=58;continue;case 57:$r=a.log(new BP([new $String("poll payload:"),at]));$s=59;case 59:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 58:al.Payload=J(as);case 53:av=a.handleEvent(al);$s=60;case 60:if($c){$c=false;av=av.$blk();}if(av&&av.$blk!==undefined){break s;}au=av;aw=au[0];ax=au[1];ak=au[3];if((g.$high>0||(g.$high===0&&g.$low>0))&&(g.$high<aw.$high||(g.$high===aw.$high&&g.$low<=aw.$low))){g=new $Int64(0,0);a.numSent=a.numSent+(1)>>0;}if(!ak){if(ax){d.$set(true);}$s=-1;return;}if(!d.$get()){$s=61;continue;}$s=62;continue;case 61:d.$set(true);$r=a.connState("connected");$s=63;case 63:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 62:ag++;$s=47;continue;case 48:$s=1;continue;case 2:$s=-1;return;}return;}if($f===undefined){$f={$blk:AQ};}$f.a=a;$f.aa=aa;$f.ab=ab;$f.ac=ac;$f.ad=ad;$f.ae=ae;$f.af=af;$f.ag=ag;$f.ah=ah;$f.ai=ai;$f.aj=aj;$f.ak=ak;$f.al=al;$f.am=am;$f.an=an;$f.ao=ao;$f.ap=ap;$f.aq=aq;$f.ar=ar;$f.as=as;$f.at=at;$f.au=au;$f.av=av;$f.aw=aw;$f.ax=ax;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.v=v;$f.w=w;$f.x=x;$f.y=y;$f.z=z;$f.$s=$s;$f.$r=$r;return $f;};AR=function(a,b){var a,b,c,d,e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=$makeMap($String.keyFor,[{k:"action",v:new $String("ping")},{k:"session_id",v:a.sessionId}]);d=V(b,c,AI(new AY(0,7000),0.9));$s=1;case 1:if($c){$c=false;d=d.$blk();}if(d&&d.$blk!==undefined){break s;}e=d;$go(AT,[a,e,"ping error:"]);$s=-1;return;}return;}if($f===undefined){$f={$blk:AR};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};AS=function(a,b){var a,b,c,d,e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=$makeMap($String.keyFor,[{k:"action",v:new $String("close_session")},{k:"session_id",v:a.sessionId}]);d=V(b,c,AI(new AY(0,7000),0.9));$s=1;case 1:if($c){$c=false;d=d.$blk();}if(d&&d.$blk!==undefined){break s;}e=d;$go(AT,[a,e,"send error:"]);$s=-1;return;}return;}if($f===undefined){$f={$blk:AS};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};AT=function(a,b,c){var a,b,c,d,e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:d=$recv(b);$s=1;case 1:if($c){$c=false;d=d.$blk();}if(d&&d.$blk!==undefined){break s;}e=$clone(d[0],AE);if(!($interfaceIsEqual(e.err,$ifaceNil))&&!(a.OnLog===$throwNilPointerError)){$s=2;continue;}$s=3;continue;case 2:$r=a.OnLog(new BP([new $String(c),e.err]));$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 3:$s=-1;return;}return;}if($f===undefined){$f={$blk:AT};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};AU=function(){return $parseFloat($global.Math.random());};AW.ptr.prototype.SetParams=function(a){var a,b,c,d,e,f,g,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=this;$r=b.mutex.Lock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(b.mutex,"Unlock"),[]]);if($interfaceIsEqual((c=a[$String.keyFor("message_types")],c!==undefined?c.v:$ifaceNil),$ifaceNil)){$panic(new $String("message_types parameter not defined"));}d=(e=a[$String.keyFor("session_id")],e!==undefined?[e.v,true]:[$ifaceNil,false]);f=d[0];g=d[1];if(!($interfaceIsEqual(f,$ifaceNil))){b.sessionId=f;}else if(g){delete a[$String.keyFor("session_id")];}b.sessionParams=a;if(!(b.sendNotify===$chanNil)&&!b.running){b.running=true;$go($methodVal(b,"discover"),[]);}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AW.ptr.prototype.SetParams};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AW.prototype.SetParams=function(a){return this.$val.SetParams(a);};AW.ptr.prototype.Open=function(){var a,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);a=this;$r=a.mutex.Lock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(a.mutex,"Unlock"),[]]);if(a.closed){$panic(new $String("session already closed"));}if(!(a.sendNotify===$chanNil)){$panic(new $String("session already initialized"));}if(a.OnSessionEvent===$throwNilPointerError){$panic(new $String("onSessionEvent callback not defined"));}if(a.OnEvent===$throwNilPointerError){$panic(new $String("onEvent callback not defined"));}if(a.sessionParams===false){$panic(new $String("session parameters not defined"));}a.sendNotify=new $Chan(CB,1);a.closeNotify=new $Chan(CB,1);a.running=true;$go($methodVal(a,"discover"),[]);$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AW.ptr.prototype.Open};}$f.a=a;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AW.prototype.Open=function(){return this.$val.Open();};AW.ptr.prototype.Close=function(){var a,b,c,d,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);a=[a];a[0]=this;$r=a[0].mutex.Lock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(a[0].mutex,"Unlock"),[]]);if(a[0].closed){$s=-1;return;}b=a[0].sendBuffer;c=0;case 2:if(!(c<b.$length)){$s=3;continue;}d=((c<0||c>=b.$length)?($throwRuntimeError("index out of range"),undefined):b.$array[b.$offset+c]);if(!(d.OnReply===$throwNilPointerError)){$s=4;continue;}$s=5;continue;case 4:$r=d.OnReply(BS.nil);$s=6;case 6:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 5:c++;$s=2;continue;case 3:a[0].sendBuffer=CD.nil;a[0].numSent=0;a[0].closed=true;a[0].running=false;$go((function(a){return function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=$send(a[0].closeNotify,$clone(new CB.ptr(),CB));$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$close(a[0].sendNotify);$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;};})(a),[]);$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AW.ptr.prototype.Close};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AW.prototype.Close=function(){return this.$val.Close();};AW.ptr.prototype.Send=function(a){var a,b,c,d,e,f,g,h,i,j,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=$ifaceNil;c=this;$r=c.mutex.Lock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(c.mutex,"Unlock"),[]]);if(c.sendNotify===$chanNil){$panic(new $String("session not initialized"));}if(c.closed){$panic(new $String("session already closed"));}if(a.Payload.$length===0){a.Payload=BR.nil;}d=(e=a.Params[$String.keyFor("action_id")],e!==undefined?[e.v,true]:[$ifaceNil,false]);f=d[0];g=d[1];if(g&&$interfaceIsEqual(f,$ifaceNil)){delete a.Params[$String.keyFor("action_id")];}else{c.lastActionId=(h=c.lastActionId,i=new $Int64(0,1),new $Int64(h.$high+i.$high,h.$low+i.$low));a.id=c.lastActionId;j="action_id";(a.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(j)]={k:j,v:a.id};}c.send(a);$s=-1;return b;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return b;}if($curGoroutine.asleep){if($f===undefined){$f={$blk:AW.ptr.prototype.Send};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AW.prototype.Send=function(a){return this.$val.Send(a);};AW.ptr.prototype.send=function(a){var a,b;b=this;b.sendBuffer=$append(b.sendBuffer,a);$go((function $b(){var c,$r;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;c=$f.c;$r=$f.$r;}c=$select([[b.sendNotify,new CB.ptr()],[]]);if(c[0]===0){}else if(c[0]===1){}if($f===undefined){$f={$blk:$b};}$f.c=c;$f.$r=$r;return $f;}),[]);return;};AW.prototype.send=function(a){return this.$val.send(a);};AW.ptr.prototype.sendAck=function(){var a;a=this;a.sendEventAck=true;$go((function $b(){var b,$r;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;$r=$f.$r;}b=$select([[a.sendNotify,new CB.ptr()],[]]);if(b[0]===0){}else if(b[0]===1){}if($f===undefined){$f={$blk:$b};}$f.b=b;$f.$r=$r;return $f;}),[]);};AW.prototype.sendAck=function(){return this.$val.sendAck();};AW.ptr.prototype.discover=function(){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);a=[a];b=[b];b[0]=this;$r=b[0].mutex.Lock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([(function(a,b){return function $b(){var c,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;c=$f.c;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=b[0].closed;$r=b[0].mutex.Unlock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(c&&!(b[0].OnClose===$throwNilPointerError)){$s=2;continue;}$s=3;continue;case 2:$r=b[0].OnClose();$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 3:$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.c=c;$f.$s=$s;$f.$r=$r;return $f;};})(a,b),[]]);$r=b[0].log(new BP([new $String("starting")]));$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(b[0],"log"),[new BP([new $String("stopped")])]]);$deferred.push([$methodVal(b[0],"connState"),["disconnected"]]);a[0]=new K.ptr(0);case 3:if(!(b[0].running)){$s=4;continue;}c=[c];$r=b[0].connState("connecting");$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}d="https://"+E(b[0].Address)+"/v2/endpoint";e=AC(d);f=e[0];g=e[1];if(!($interfaceIsEqual(g,$ifaceNil))){$panic(g);}$r=b[0].mutex.Unlock();$s=6;case 6:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}i=W(f,AI(new AY(0,7000),0.1));$s=7;case 7:if($c){$c=false;i=i.$blk();}if(i&&i.$blk!==undefined){break s;}j=$select([[i],[b[0].closeNotify]]);$s=8;case 8:if($c){$c=false;j=j.$blk();}if(j&&j.$blk!==undefined){break s;}h=j;if(h[0]===0){$s=9;continue;}if(h[0]===1){$s=10;continue;}$s=11;continue;case 9:k=$clone(h[1][0],AE);$r=b[0].mutex.Lock();$s=12;case 12:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}l=BO.nil;m=k.err;if($interfaceIsEqual(m,$ifaceNil)){c[0]=false;m=AM(k.data,(c.$ptr||(c.$ptr=new BV(function(){return this.$target[0];},function($v){this.$target[0]=$v;},c))));if($interfaceIsEqual(m,$ifaceNil)){n=F(c[0]);l=n[0];m=n[1];}}if($interfaceIsEqual(m,$ifaceNil)){$s=13;continue;}$s=14;continue;case 13:$r=b[0].log(new BP([new $String("endpoint discovered")]));$s=16;case 16:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(BG&&!b[0].forceLongPoll){$s=17;continue;}$s=18;continue;case 17:o=b[0].connect(BK,l,a[0]);$s=21;case 21:if($c){$c=false;o=o.$blk();}if(o&&o.$blk!==undefined){break s;}if(o){$s=19;continue;}$s=20;continue;case 19:$s=3;continue;case 20:case 18:p=b[0].connect(AP,l,a[0]);$s=22;case 22:if($c){$c=false;p=p.$blk();}if(p&&p.$blk!==undefined){break s;}p;$s=15;continue;case 14:$r=b[0].log(new BP([new $String("endpoint discovery:"),m]));$s=23;case 23:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 15:$s=11;continue;case 10:$r=b[0].mutex.Lock();$s=24;case 24:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 11:q=b[0].backOff(a[0]);$s=27;case 27:if($c){$c=false;q=q.$blk();}if(q&&q.$blk!==undefined){break s;}if(!q){$s=25;continue;}$s=26;continue;case 25:$s=-1;return;case 26:$s=3;continue;case 4:$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AW.ptr.prototype.discover};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AW.prototype.discover=function(){return this.$val.discover();};AW.ptr.prototype.connect=function(a,b,c){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:d=false;e=this;f=0;case 1:if(!(f<2)){$s=2;continue;}g=b;h=0;case 3:if(!(h<g.$length)){$s=4;continue;}i=((h<0||h>=g.$length)?($throwRuntimeError("index out of range"),undefined):g.$array[g.$offset+h]);$r=e.connState("connecting");$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}j=e.Address;k=0;while(true){if(!(k<j.length)){break;}l=$decodeRune(j,k);m=k;n=l[0];if(n===47){i=i+($substring(e.Address,m));break;}k+=l[1];}p=a(e,i);$s=6;case 6:if($c){$c=false;p=p.$blk();}if(p&&p.$blk!==undefined){break s;}o=p;q=o[0];r=o[1];if(q){d=true;}if(r){c.success();$s=-1;return d;}if(!e.running){$s=-1;return d;}s=e.backOff(c);$s=9;case 9:if($c){$c=false;s=s.$blk();}if(s&&s.$blk!==undefined){break s;}if(!s){$s=7;continue;}$s=8;continue;case 7:$s=-1;return d;case 8:h++;$s=3;continue;case 4:f=f+(1)>>0;$s=1;continue;case 2:$s=-1;return d;}return;}if($f===undefined){$f={$blk:AW.ptr.prototype.connect};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.$s=$s;$f.$r=$r;return $f;};AW.prototype.connect=function(a,b,c){return this.$val.connect(a,b,c);};AW.ptr.prototype.backOff=function(a){var a,b,c,d,e,f,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=false;c=this;d=a.failure(new AY(0,60000));if((d.$high===0&&d.$low===0)){b=true;$s=-1;return b;}$r=c.connState("disconnected");$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=c.log(new BP([new $String("sleeping")]));$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=c.mutex.Unlock();$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(c.mutex,"Lock"),[]]);f=$select([[BE(d).C],[c.closeNotify]]);$s=4;case 4:if($c){$c=false;f=f.$blk();}if(f&&f.$blk!==undefined){break s;}e=f;if(e[0]===0){b=true;}else if(e[0]===1){}$s=-1;return b;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return b;}if($curGoroutine.asleep){if($f===undefined){$f={$blk:AW.ptr.prototype.backOff};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AW.prototype.backOff=function(a){return this.$val.backOff(a);};AW.ptr.prototype.canLogin=function(){var a,b,c,d,e,f,g,h;a=this;if(!($interfaceIsEqual((b=a.sessionParams[$String.keyFor("access_key")],b!==undefined?b.v:$ifaceNil),$ifaceNil))){return true;}if(!($interfaceIsEqual((c=a.sessionParams[$String.keyFor("user_id")],c!==undefined?c.v:$ifaceNil),$ifaceNil))){return!($interfaceIsEqual((d=a.sessionParams[$String.keyFor("user_auth")],d!==undefined?d.v:$ifaceNil),$ifaceNil))||!($interfaceIsEqual((e=a.sessionParams[$String.keyFor("master_sign")],e!==undefined?e.v:$ifaceNil),$ifaceNil));}return!($interfaceIsEqual((f=a.sessionParams[$String.keyFor("identity_type")],f!==undefined?f.v:$ifaceNil),$ifaceNil))&&!($interfaceIsEqual((g=a.sessionParams[$String.keyFor("identity_name")],g!==undefined?g.v:$ifaceNil),$ifaceNil))&&!($interfaceIsEqual((h=a.sessionParams[$String.keyFor("identity_auth")],h!==undefined?h.v:$ifaceNil),$ifaceNil));};AW.prototype.canLogin=function(){return this.$val.canLogin();};AW.ptr.prototype.makeCreateSessionAction=function(){var a,aa,ab,ac,ad,ae,af,ag,ah,ai,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z;a=false;b=this;a=$makeMap($String.keyFor,[{k:"action",v:new $String("create_session")}]);d=(c=b.sessionParams[$String.keyFor("user_id")],c!==undefined?c.v:$ifaceNil);if($interfaceIsEqual(d,$ifaceNil)){e=b.sessionParams;f=0;g=$keys(e);while(true){if(!(f<g.length)){break;}h=e[g[f]];if(h===undefined){f++;continue;}i=h.k;j=h.v;k=i;(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(k)]={k:k,v:j};f++;}}else{m=(l=b.sessionParams[$String.keyFor("user_auth")],l!==undefined?l.v:$ifaceNil);if(!($interfaceIsEqual(m,$ifaceNil))){n="user_id";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(n)]={k:n,v:d};o="user_auth";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(o)]={k:o,v:m};}else{q=(p=b.sessionParams[$String.keyFor("master_sign")],p!==undefined?p.v:$ifaceNil);if(!($interfaceIsEqual(q,$ifaceNil))){r="user_id";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(r)]={k:r,v:d};s="master_sign";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(s)]={k:s,v:q};}else{u=(t=b.sessionParams[$String.keyFor("identity_type")],t!==undefined?t.v:$ifaceNil);if(!($interfaceIsEqual(u,$ifaceNil))){v="identity_type";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(v)]={k:v,v:u};w="identity_name";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(w)]={k:w,v:(x=b.sessionParams[$String.keyFor("identity_name")],x!==undefined?x.v:$ifaceNil)};y="identity_auth";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(y)]={k:y,v:(z=b.sessionParams[$String.keyFor("identity_auth")],z!==undefined?z.v:$ifaceNil)};}else{aa="user_id";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(aa)]={k:aa,v:d};}}}ab=b.sessionParams;ac=0;ad=$keys(ab);while(true){if(!(ac<ad.length)){break;}ae=ab[ad[ac]];if(ae===undefined){ac++;continue;}af=ae.k;ag=ae.v;ah=af;if(ah===("user_id")||ah===("user_auth")||ah===("identity_type")||ah===("identity_name")||ah===("identity_auth")||ah===("access_key")||ah===("master_sign")){}else{ai=af;(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(ai)]={k:ai,v:ag};}ac++;}}return a;};AW.prototype.makeCreateSessionAction=function(){return this.$val.makeCreateSessionAction();};AW.ptr.prototype.makeResumeSessionAction=function(a){var a,b,c,d;b=false;c=this;b=$makeMap($String.keyFor,[{k:"action",v:new $String("resume_session")},{k:"event_id",v:c.receivedEventId}]);if(a){d="session_id";(b||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(d)]={k:d,v:c.sessionId};}c.sendEventAck=false;c.ackedEventId=c.receivedEventId;return b;};AW.prototype.makeResumeSessionAction=function(a){return this.$val.makeResumeSessionAction(a);};AW.ptr.prototype.handleSessionEvent=function(a){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=false;c=this;d=new H.ptr(a,BR.nil,false);e=false;if(d.String()==="error"){c.sessionId=$ifaceNil;e=true;f=d.Str("error_type");g=f[0];h=g;if(h===("internal")){}else{c.running=false;}}$r=c.deliverSessionEvent(d);$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(e){$s=-1;return b;}delete c.sessionParams[$String.keyFor("user_attrs")];delete c.sessionParams[$String.keyFor("user_settings")];delete c.sessionParams[$String.keyFor("identity_attrs")];delete c.sessionParams[$String.keyFor("access_key")];delete c.sessionParams[$String.keyFor("master_sign")];i="user_id";(c.sessionParams||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(i)]={k:i,v:(j=d.Params[$String.keyFor("user_id")],j!==undefined?j.v:$ifaceNil)};l=(k=d.Params[$String.keyFor("user_auth")],k!==undefined?k.v:$ifaceNil);if(!($interfaceIsEqual(l,$ifaceNil))){m="user_auth";(c.sessionParams||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(m)]={k:m,v:l};}n=new BO(["identity_type","identity_name","identity_auth"]);o=0;while(true){if(!(o<n.$length)){break;}p=((o<0||o>=n.$length)?($throwRuntimeError("index out of range"),undefined):n.$array[n.$offset+o]);r=(q=c.sessionParams[$String.keyFor(p+"_new")],q!==undefined?q.v:$ifaceNil);if(!($interfaceIsEqual(r,$ifaceNil))){delete c.sessionParams[$String.keyFor(p+"_new")];s=p;(c.sessionParams||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(s)]={k:s,v:r};}o++;}c.sessionId=(t=d.Params[$String.keyFor("session_id")],t!==undefined?t.v:$ifaceNil);if(c.sendBuffer.$length===0){c.lastActionId=new $Int64(0,0);}c.sendEventAck=false;u=d.Int64("event_id");c.receivedEventId=u[0];c.ackedEventId=new $Int64(0,0);$r=c.log(new BP([new $String("session created")]));$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}b=true;$s=-1;return b;}return;}if($f===undefined){$f={$blk:AW.ptr.prototype.handleSessionEvent};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.$s=$s;$f.$r=$r;return $f;};AW.prototype.handleSessionEvent=function(a){return this.$val.handleSessionEvent(a);};AW.ptr.prototype.handleEvent=function(a){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=[b];c=[c];b[0]=new $Int64(0,0);d=false;e=false;f=false;c[0]=this;g=a.Int64("event_id");h=g[0];if((h.$high>0||(h.$high===0&&h.$low>0))){c[0].receivedEventId=h;if(!c[0].sendEventAck){if((i=(j=c[0].receivedEventId,k=c[0].ackedEventId,new $Int64(j.$high-k.$high,j.$low-k.$low)),(i.$high>AV.$high||(i.$high===AV.$high&&i.$low>=AV.$low)))){c[0].sendAck();}else{e=true;}}}l=a.Int64("action_id");b[0]=l[0];if((b[0].$high>0||(b[0].$high===0&&b[0].$low>0))){$s=1;continue;}$s=2;continue;case 1:m=C.Search(c[0].numSent,(function(b,c){return function(m){var m,n,o,p;o=(n=c[0].sendBuffer,((m<0||m>=n.$length)?($throwRuntimeError("index out of range"),undefined):n.$array[n.$offset+m]));return(p=o.id,(p.$high>b[0].$high||(p.$high===b[0].$high&&p.$low>=b[0].$low)));};})(b,c));$s=3;case 3:if($c){$c=false;m=m.$blk();}if(m&&m.$blk!==undefined){break s;}n=m;if(n<c[0].numSent){$s=4;continue;}$s=5;continue;case 4:p=(o=c[0].sendBuffer,((n<0||n>=o.$length)?($throwRuntimeError("index out of range"),undefined):o.$array[o.$offset+n]));if((q=p.id,(q.$high===b[0].$high&&q.$low===b[0].$low))){$s=6;continue;}$s=7;continue;case 6:a.initLastReply(p);if(!(p.OnReply===$throwNilPointerError)){$s=8;continue;}$s=9;continue;case 8:$r=p.OnReply(a);$s=10;case 10:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 9:if(a.LastReply){c[0].sendBuffer=$appendSlice($subslice(c[0].sendBuffer,0,n),$subslice(c[0].sendBuffer,(n+1>>0)));c[0].numSent=c[0].numSent-(1)>>0;}case 7:case 5:case 2:if(a.String()==="user_deleted"){$s=11;continue;}$s=12;continue;case 11:c[0].sessionId=$ifaceNil;c[0].running=false;$r=c[0].deliverSessionEvent(a);$s=13;case 13:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}d=true;$s=-1;return[b[0],d,e,f];case 12:r=a.getError();s=r[0];t=r[1];d=r[2];u=r[3];if(!($interfaceIsEqual(u,$ifaceNil))){$s=14;continue;}$s=15;continue;case 14:$r=c[0].log(new BP([new $String("event:"),u]));$s=16;case 16:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(d){$s=17;continue;}$s=18;continue;case 17:c[0].sessionId=$ifaceNil;if(!c[0].canLogin()){$s=19;continue;}$s=20;continue;case 19:c[0].running=false;$r=c[0].deliverSessionEvent(a);$s=21;case 21:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 20:case 18:$s=-1;return[b[0],d,e,f];case 15:if(s==="deprecated"){$s=22;continue;}$s=23;continue;case 22:$r=c[0].log(new BP([new $String("deprecated:"),new $String(t)]));$s=24;case 24:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 23:$r=c[0].deliverEvent(a);$s=25;case 25:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}f=true;$s=-1;return[b[0],d,e,f];}return;}if($f===undefined){$f={$blk:AW.ptr.prototype.handleEvent};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.$s=$s;$f.$r=$r;return $f;};AW.prototype.handleEvent=function(a){return this.$val.handleEvent(a);};AW.ptr.prototype.deliverSessionEvent=function(a){var a,b,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=this;$r=b.mutex.Unlock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(b.mutex,"Lock"),[]]);$r=b.OnSessionEvent(a);$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AW.ptr.prototype.deliverSessionEvent};}$f.a=a;$f.b=b;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AW.prototype.deliverSessionEvent=function(a){return this.$val.deliverSessionEvent(a);};AW.ptr.prototype.deliverEvent=function(a){var a,b,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=this;$r=b.mutex.Unlock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(b.mutex,"Lock"),[]]);$r=b.OnEvent(a);$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AW.ptr.prototype.deliverEvent};}$f.a=a;$f.b=b;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AW.prototype.deliverEvent=function(a){return this.$val.deliverEvent(a);};AW.ptr.prototype.connState=function(a){var a,b,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=this;if(b.latestConnState===a){$s=-1;return;}b.latestConnState=a;if(b.OnConnState===$throwNilPointerError){$s=-1;return;}$r=b.mutex.Unlock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(b.mutex,"Lock"),[]]);$r=b.OnConnState(a);$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AW.ptr.prototype.connState};}$f.a=a;$f.b=b;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AW.prototype.connState=function(a){return this.$val.connState(a);};AW.ptr.prototype.connActive=function(){var a,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);a=this;if(a.OnConnActive===$throwNilPointerError){$s=-1;return;}$r=a.mutex.Unlock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(a.mutex,"Lock"),[]]);$r=a.OnConnActive();$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AW.ptr.prototype.connActive};}$f.a=a;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AW.prototype.connActive=function(){return this.$val.connActive();};AW.ptr.prototype.log=function(a){var a,b,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=this;if(b.OnLog===$throwNilPointerError){$s=-1;return;}$r=b.mutex.Unlock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(b.mutex,"Lock"),[]]);$r=b.OnLog(a);$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AW.ptr.prototype.log};}$f.a=a;$f.b=b;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AW.prototype.log=function(a){return this.$val.log(a);};BA=function(){var a;return((a=$internalize(new($global.Date)().getTime(),$Int64),new AZ(a.$high,a.$low)));};BB=function(a,b){var a,b,c;return(c=(new AZ(b.$high,b.$low)),new AZ(a.$high+c.$high,a.$low+c.$low));};BC=function(a,b){var a,b,c;return((c=new AZ(a.$high-b.$high,a.$low-b.$low),new AY(c.$high,c.$low)));};BE=function(a){var a,b;b=CE.nil;b=new BD.ptr(new $Chan(CB,0),null);if((a.$high>0||(a.$high===0&&a.$low>=0))){b.Reset(a);}return b;};BD.ptr.prototype.Active=function(){var a;a=this;return!(a.id===null);};BD.prototype.Active=function(){return this.$val.Active();};BD.ptr.prototype.Reset=function(a){var a,b;b=this;b.Stop();b.id=$global.setTimeout($externalize((function(){b.id=null;$go((function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=$send(b.C,$clone(new CB.ptr(),CB));$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;}),[]);}),BY),$externalize(a,AY));};BD.prototype.Reset=function(a){return this.$val.Reset(a);};BD.ptr.prototype.Stop=function(){var a;a=this;if(!(a.id===null)){$global.clearTimeout(a.id);a.id=null;}};BD.prototype.Stop=function(){return this.$val.Stop();};BH=function(){BF=$global.WebSocket;if(BF===undefined){BF=$module.require($externalize("ws",$String));}BG=!(BF===undefined)&&!(BF.CLOSING===undefined);};BJ=function(a,b){var a,b,c,d,e,f,g;c=CF.nil;c=new BI.ptr(new $Chan(CB,1),false,$ifaceNil,new(BF)($externalize(a,$String)),false,CG.nil);c.impl.binaryType=$externalize("arraybuffer",$String);d=false;e=(function(){if(!d){d=true;$go((function(){$close(c.notify);}),[]);}});f=$global.setTimeout($externalize((function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c.err=A.New("timeout");$r=e();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;}),BY),$externalize(b,AY));g=(function(){if(!(f===null)){$global.clearTimeout(f);f=null;}});c.impl.onopen=$externalize((function $b(h){var h,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;h=$f.h;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=g();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!($interfaceIsEqual(c.err,$ifaceNil))){c.impl.close();$s=-1;return;}c.open=true;$go((function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:if(!d){$s=1;continue;}$s=2;continue;case 1:$r=$send(c.notify,$clone(new CB.ptr(),CB));$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 2:$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;}),[]);$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.h=h;$f.$s=$s;$f.$r=$r;return $f;}),CH);c.impl.onmessage=$externalize((function(h){var h;c.buf=$append(c.buf,h.data);$go((function $b(){var i,$r;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;i=$f.i;$r=$f.$r;}if(!d){i=$select([[c.notify,new CB.ptr()],[]]);if(i[0]===0){}else if(i[0]===1){}}if($f===undefined){$f={$blk:$b};}$f.i=i;$f.$r=$r;return $f;}),[]);}),CH);c.impl.onclose=$externalize((function $b(h){var h,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;h=$f.h;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c.goingAway=(($parseInt(h.code)>>0)===1001);c.open=false;$r=e();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.h=h;$f.$s=$s;$f.$r=$r;return $f;}),CH);c.impl.onerror=$externalize((function $b(h){var h,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;h=$f.h;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=g();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if($interfaceIsEqual(c.err,$ifaceNil)){c.err=A.New($internalize(h.message,$String));}$r=e();$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.h=h;$f.$s=$s;$f.$r=$r;return $f;}),CH);return c;};BI.ptr.prototype.send=function(a){var a,b,c,$deferred;var $err=null;try{$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=$ifaceNil;c=this;$deferred.push([(function(){b=T($recover());}),[]]);c.impl.send(a);return b;}catch(err){$err=err;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return b;}}};BI.prototype.send=function(a){return this.$val.send(a);};BI.ptr.prototype.sendJSON=function(a){var a,b,c,d,e;b=$ifaceNil;c=this;d=AK(a);e=d[0];b=d[1];if(!($interfaceIsEqual(b,$ifaceNil))){return b;}b=c.send(e);return b;};BI.prototype.sendJSON=function(a){return this.$val.sendJSON(a);};BI.ptr.prototype.sendPayload=function(a){var a,b,c,d,e,f,g,h,i,j,k,l,m,$deferred;var $err=null;try{$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=$ifaceNil;c=this;$deferred.push([(function(){b=T($recover());}),[]]);d=a.String()==="update_user";e=a.Payload;f=0;while(true){if(!(f<e.$length)){break;}g=((f<0||f>=e.$length)?($throwRuntimeError("index out of range"),undefined):e.$array[e.$offset+f]);h=g;if(d){i=h.split($externalize(",",$String))[1];j=$global.atob(i);k=$parseInt(j.length);h=new($global.ArrayBuffer)(k);l=new($global.Uint8Array)(h);m=0;while(true){if(!(m<k)){break;}l[m]=j.charCodeAt(m);m=m+(1)>>0;}}c.impl.send(h);f++;}return b;}catch(err){$err=err;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return b;}}};BI.prototype.sendPayload=function(a){return this.$val.sendPayload(a);};BI.ptr.prototype.receive=function(){var a,b,c;a=null;b=this;if(b.buf.$length>0){a=(c=b.buf,(0>=c.$length?($throwRuntimeError("index out of range"),undefined):c.$array[c.$offset+0]));b.buf=$subslice(b.buf,1);}return a;};BI.prototype.receive=function(){return this.$val.receive();};BI.ptr.prototype.receiveJSON=function(){var a,b,c,d,e;a=false;b=$ifaceNil;c=this;d=c.receive();if(d===null){return[a,b];}b=AM(Q(d),(e||(e=new BV(function(){return a;},function($v){a=$v;}))));return[a,b];};BI.prototype.receiveJSON=function(){return this.$val.receiveJSON();};BI.ptr.prototype.close=function(){var a,$deferred;var $err=null;try{$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);a=this;$deferred.push([(function(){$recover();}),[]]);a.impl.close();}catch(err){$err=err;}finally{$callDeferred($deferred,$err);}};BI.prototype.close=function(){return this.$val.close();};BK=function(a,b){var a,b,c,d,e,f,g,h,i,j,k,l,m,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);c=[c];d=false;e=false;c[0]=CF.nil;$deferred.push([(function(c){return function(){if(!(c[0]===CF.nil)){c[0].close();}};})(c),[]]);case 1:e=false;f=false;$r=a.log(new BP([new $String("connecting to"),new $String(b)]));$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}c[0]=BJ("wss://"+b+"/v2/socket",AI(new AY(0,9000),0.1));$r=a.mutex.Unlock();$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}h=$select([[c[0].notify],[a.closeNotify]]);$s=5;case 5:if($c){$c=false;h=h.$blk();}if(h&&h.$blk!==undefined){break s;}g=h;if(g[0]===0){$s=6;continue;}if(g[0]===1){$s=7;continue;}$s=8;continue;case 6:i=g[1];j=i[1];$r=a.mutex.Lock();$s=9;case 9:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(j){$s=10;continue;}if(!($interfaceIsEqual(c[0].err,$ifaceNil))){$s=11;continue;}$s=12;continue;case 10:$r=a.connState("connected");$s=14;case 14:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}d=true;l=BL(a,c[0]);$s=15;case 15:if($c){$c=false;l=l.$blk();}if(l&&l.$blk!==undefined){break s;}k=l;e=k[0];f=k[1];$s=13;continue;case 11:$r=a.log(new BP([new $String("connection failed:"),c[0].err]));$s=16;case 16:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=13;continue;case 12:$r=a.log(new BP([new $String("connection failed")]));$s=17;case 17:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 13:$s=8;continue;case 7:$r=a.mutex.Lock();$s=18;case 18:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 8:m=c[0].goingAway;c[0].close();c[0]=CF.nil;if(m){$s=19;continue;}$s=20;continue;case 19:$r=a.log(new BP([new $String("disconnected (server is going away)")]));$s=22;case 22:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=21;continue;case 20:$r=a.log(new BP([new $String("disconnected")]));$s=23;case 23:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 21:if(!e||!f||!a.running||m){$s=-1;return[d,e];}$s=1;continue;case 2:$s=-1;return[d,e];}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return[d,e];}if($curGoroutine.asleep){if($f===undefined){$f={$blk:BK};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};BL=function(a,b){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);a=[a];b=[b];c=[c];d=[d];e=false;f=false;g=false;if($interfaceIsEqual(a[0].sessionId,$ifaceNil)){$s=1;continue;}$s=2;continue;case 1:$r=a[0].log(new BP([new $String("session creation")]));$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}g=a[0].makeCreateSessionAction();$s=3;continue;case 2:$r=a[0].log(new BP([new $String("session resumption")]));$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}g=a[0].makeResumeSessionAction(true);case 3:h=b[0].sendJSON(g);if(!($interfaceIsEqual(h,$ifaceNil))){$s=6;continue;}$s=7;continue;case 6:$r=a[0].log(new BP([new $String("send:"),h]));$s=8;case 8:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 7:if($interfaceIsEqual(a[0].sessionId,$ifaceNil)){$s=9;continue;}$s=10;continue;case 9:i=false;j=true;k=BE(AI(new AY(0,13000),0.2));case 11:l=$ifaceNil;m=b[0].receiveJSON();i=m[0];l=m[1];if(!($interfaceIsEqual(l,$ifaceNil))){$s=13;continue;}$s=14;continue;case 13:$r=a[0].log(new BP([new $String("session creation:"),l]));$s=15;case 15:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[e,f];case 14:if(!(i===false)){k.Stop();$s=12;continue;}if(!j){$s=16;continue;}$s=17;continue;case 16:$r=a[0].log(new BP([new $String("disconnected during session creation:"),b[0].err]));$s=18;case 18:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}k.Stop();$s=-1;return[e,f];case 17:$r=a[0].mutex.Unlock();$s=19;case 19:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}o=$select([[b[0].notify],[k.C]]);$s=20;case 20:if($c){$c=false;o=o.$blk();}if(o&&o.$blk!==undefined){break s;}n=o;if(n[0]===0){$s=21;continue;}if(n[0]===1){$s=22;continue;}$s=23;continue;case 21:p=n[1];j=p[1];$r=a[0].mutex.Lock();$s=24;case 24:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=23;continue;case 22:$r=a[0].mutex.Lock();$s=25;case 25:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=a[0].log(new BP([new $String("session creation timeout")]));$s=26;case 26:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[e,f];case 23:$s=11;continue;case 12:q=a[0].handleSessionEvent(i);$s=29;case 29:if($c){$c=false;q=q.$blk();}if(q&&q.$blk!==undefined){break s;}if(!q){$s=27;continue;}$s=28;continue;case 27:$s=-1;return[e,f];case 28:e=true;f=true;$r=a[0].connActive();$s=30;case 30:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 10:d[0]=new $Chan(CB,2);c[0]=new $Chan(CB,0);$go((function(a,b,c,d){return function $b(){var r,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;r=$f.r;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);$deferred.push([function(r){$close(r);},[c[0]]]);$r=a[0].mutex.Lock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(a[0].mutex,"Unlock"),[]]);$r=BM(a[0],b[0],d[0]);$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:$b};}$f.r=r;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};})(a,b,c,d),[]);s=BN(a[0],b[0],d[0]);$s=31;case 31:if($c){$c=false;s=s.$blk();}if(s&&s.$blk!==undefined){break s;}r=s;t=r[0];f=r[1];if(t){e=true;}$r=a[0].mutex.Unlock();$s=32;case 32:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(a[0].mutex,"Lock"),[]]);u=$recv(c[0]);$s=33;case 33:if($c){$c=false;u=u.$blk();}if(u&&u.$blk!==undefined){break s;}u[0];$s=-1;return[e,f];}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return[e,f];}if($curGoroutine.asleep){if($f===undefined){$f={$blk:BL};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};BM=function(a,b,c){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;v=$f.v;w=$f.w;x=$f.x;y=$f.y;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);d=BE(AI(new AY(0,56000),-0.3));$deferred.push([$methodVal(d,"Stop"),[]]);a.numSent=0;case 1:case 3:if(!(a.numSent<a.sendBuffer.$length)){$s=4;continue;}g=(e=a.sendBuffer,f=a.numSent,((f<0||f>=e.$length)?($throwRuntimeError("index out of range"),undefined):e.$array[e.$offset+f]));if(!(g.Payload===BR.nil)){h="frames";(g.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(h)]={k:h,v:new $Int(g.Payload.$length)};}if(!((i=a.receivedEventId,j=a.ackedEventId,(i.$high===j.$high&&i.$low===j.$low)))){k="event_id";(g.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(k)]={k:k,v:a.receivedEventId};a.sendEventAck=false;a.ackedEventId=a.receivedEventId;}l=b.sendJSON(g.Params);delete g.Params[$String.keyFor("frames")];delete g.Params[$String.keyFor("event_id")];if(!($interfaceIsEqual(l,$ifaceNil))){$s=5;continue;}$s=6;continue;case 5:$r=a.log(new BP([new $String("send:"),l]));$s=7;case 7:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(c,$clone(new CB.ptr(),CB));$s=8;case 8:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 6:if(!(g.Payload===BR.nil)){$s=9;continue;}$s=10;continue;case 9:m=b.sendPayload(g);if(!($interfaceIsEqual(m,$ifaceNil))){$s=11;continue;}$s=12;continue;case 11:$r=a.log(new BP([new $String("send:"),m]));$s=13;case 13:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(c,$clone(new CB.ptr(),CB));$s=14;case 14:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 12:case 10:if((n=g.id,(n.$high===0&&n.$low===0))){a.sendBuffer=$appendSlice($subslice(a.sendBuffer,0,a.numSent),$subslice(a.sendBuffer,(a.numSent+1>>0)));}else{a.numSent=a.numSent+(1)>>0;}d.Reset(AI(new AY(0,56000),-0.3));$s=3;continue;case 4:if(a.sendEventAck&&!((o=a.receivedEventId,p=a.ackedEventId,(o.$high===p.$high&&o.$low===p.$low)))){$s=15;continue;}$s=16;continue;case 15:q=a.makeResumeSessionAction(false);r=b.sendJSON(q);if(!($interfaceIsEqual(r,$ifaceNil))){$s=17;continue;}$s=18;continue;case 17:$r=a.log(new BP([new $String("send:"),r]));$s=19;case 19:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(c,$clone(new CB.ptr(),CB));$s=20;case 20:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 18:case 16:$r=a.mutex.Unlock();$s=21;case 21:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}t=$select([[a.sendNotify],[d.C],[c]]);$s=22;case 22:if($c){$c=false;t=t.$blk();}if(t&&t.$blk!==undefined){break s;}s=t;if(s[0]===0){$s=23;continue;}if(s[0]===1){$s=24;continue;}if(s[0]===2){$s=25;continue;}$s=26;continue;case 23:u=s[1];v=u[1];$r=a.mutex.Lock();$s=27;case 27:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!v){$s=28;continue;}$s=29;continue;case 28:w=$makeMap($String.keyFor,[{k:"action",v:new $String("close_session")}]);x=b.sendJSON(w);if(!($interfaceIsEqual(x,$ifaceNil))){$s=30;continue;}$s=31;continue;case 30:$r=a.log(new BP([new $String("send:"),x]));$s=32;case 32:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 31:$s=-1;return;case 29:$s=26;continue;case 24:$r=a.mutex.Lock();$s=33;case 33:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}y=b.send(O());if(!($interfaceIsEqual(y,$ifaceNil))){$s=34;continue;}$s=35;continue;case 34:$r=a.log(new BP([new $String("send:"),y]));$s=36;case 36:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(c,$clone(new CB.ptr(),CB));$s=37;case 37:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 35:d.Reset(AI(new AY(0,56000),-0.3));$s=26;continue;case 25:$r=a.mutex.Lock();$s=38;case 38:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 26:$s=1;continue;case 2:$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:BM};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.v=v;$f.w=w;$f.x=x;$f.y=y;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};BN=function(a,b,c){var a,aa,ab,ac,ad,ae,af,ag,ah,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;aa=$f.aa;ab=$f.ab;ac=$f.ac;ad=$f.ad;ae=$f.ae;af=$f.af;ag=$f.ag;ah=$f.ah;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;v=$f.v;w=$f.w;x=$f.x;y=$f.y;z=$f.z;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);d=false;e=false;f=b.notify;g=true;h=BS.nil;i=0;j=AI(new AY(0,64000),0.3);k=BB(BA(),j);l=BE(j);$deferred.push([$methodVal(l,"Stop"),[]]);m=BE(new AY(-1,4294967295));$deferred.push([$methodVal(m,"Stop"),[]]);case 1:n=false;case 3:o=[o];if(h===BS.nil){$s=5;continue;}$s=6;continue;case 5:p=b.receive();if(p===null){$s=4;continue;}q=AI(new AY(0,64000),0.7);k=BB(BA(),q);if(!l.Active()){l.Reset(q);}$r=a.connActive();$s=8;case 8:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}r=Q(p);if(P(r)===0){$s=9;continue;}$s=10;continue;case 9:$s=3;continue;case 10:o[0]=false;s=AM(r,(o.$ptr||(o.$ptr=new BV(function(){return this.$target[0];},function($v){this.$target[0]=$v;},o))));if(!($interfaceIsEqual(s,$ifaceNil))){$s=11;continue;}$s=12;continue;case 11:$r=a.log(new BP([new $String("receive:"),s]));$s=13;case 13:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}e=false;$r=$send(c,$clone(new CB.ptr(),CB));$s=14;case 14:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d,e];case 12:h=new H.ptr(o[0],BR.nil,false);t=h.Int("frames");u=t[0];if(u>0){i=u;}$s=7;continue;case 6:v=b.receive();if(v===null){if(!g){h=BS.nil;i=0;}$s=4;continue;}h.Payload=$append(h.Payload,v);i=i-(1)>>0;case 7:if(i===0){$s=15;continue;}$s=16;continue;case 15:x=a.handleEvent(h);$s=17;case 17:if($c){$c=false;x=x.$blk();}if(x&&x.$blk!==undefined){break s;}w=x;y=w[1];z=w[2];aa=w[3];if(!aa){$s=18;continue;}$s=19;continue;case 18:if(y){d=true;}else{e=false;}$r=$send(c,$clone(new CB.ptr(),CB));$s=20;case 20:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d,e];case 19:if(z){n=true;}h=BS.nil;i=0;d=true;e=true;case 16:$r=a.mutex.Unlock();$s=21;case 21:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}ab=$select([[a.closeNotify],[c],[]]);if(ab[0]===0){$s=22;continue;}if(ab[0]===1){$s=23;continue;}if(ab[0]===2){$s=24;continue;}$s=25;continue;case 22:$r=a.mutex.Lock();$s=26;case 26:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d,e];case 23:$r=a.mutex.Lock();$s=27;case 27:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d,e];case 24:$r=a.mutex.Lock();$s=28;case 28:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 25:$s=3;continue;case 4:if(!g&&h===BS.nil){$s=29;continue;}$s=30;continue;case 29:if(!($interfaceIsEqual(b.err,$ifaceNil))){$s=31;continue;}$s=32;continue;case 31:$r=a.log(new BP([new $String("receive:"),b.err]));$s=34;case 34:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=33;continue;case 32:$r=a.log(new BP([new $String("receive disconnect")]));$s=35;case 35:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 33:$r=$send(c,$clone(new CB.ptr(),CB));$s=36;case 36:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d,e];case 30:if(n&&!m.Active()){m.Reset(AI(new AY(0,7000),-0.3));}$r=a.mutex.Unlock();$s=37;case 37:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}ad=$select([[f],[l.C],[m.C],[a.closeNotify],[c]]);$s=38;case 38:if($c){$c=false;ad=ad.$blk();}if(ad&&ad.$blk!==undefined){break s;}ac=ad;if(ac[0]===0){$s=39;continue;}if(ac[0]===1){$s=40;continue;}if(ac[0]===2){$s=41;continue;}if(ac[0]===3){$s=42;continue;}if(ac[0]===4){$s=43;continue;}$s=44;continue;case 39:ae=ac[1];g=ae[1];$r=a.mutex.Lock();$s=45;case 45:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!g){f=$chanNil;}$s=44;continue;case 40:$r=a.mutex.Lock();$s=46;case 46:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}af=BC(k,BA());if((af.$high>0||(af.$high===0&&af.$low>16))){$s=47;continue;}$s=48;continue;case 47:l.Reset(af);$s=49;continue;case 48:$r=a.log(new BP([new $String("receive timeout")]));$s=50;case 50:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(c,$clone(new CB.ptr(),CB));$s=51;case 51:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d,e];case 49:$s=44;continue;case 41:$r=a.mutex.Lock();$s=52;case 52:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!a.sendEventAck&&!((ag=a.ackedEventId,ah=a.receivedEventId,(ag.$high===ah.$high&&ag.$low===ah.$low)))){a.sendAck();}$s=44;continue;case 42:$r=a.mutex.Lock();$s=53;case 53:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d,e];case 43:$r=a.mutex.Lock();$s=54;case 54:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d,e];case 44:$s=1;continue;case 2:$s=-1;return[d,e];}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return[d,e];}if($curGoroutine.asleep){if($f===undefined){$f={$blk:BN};}$f.a=a;$f.aa=aa;$f.ab=ab;$f.ac=ac;$f.ad=ad;$f.ae=ae;$f.af=af;$f.ag=ag;$f.ah=ah;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.v=v;$f.w=w;$f.x=x;$f.y=y;$f.z=z;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};CC.methods=[{prop:"String",name:"String",pkg:"",typ:$funcType([],[$String],false)}];BS.methods=[{prop:"Bool",name:"Bool",pkg:"",typ:$funcType([$String],[$Bool],false)},{prop:"Int",name:"Int",pkg:"",typ:$funcType([$String],[$Int,$Bool],false)},{prop:"Int64",name:"Int64",pkg:"",typ:$funcType([$String],[$Int64,$Bool],false)},{prop:"Float64",name:"Float64",pkg:"",typ:$funcType([$String],[$Float64,$Bool],false)},{prop:"Str",name:"Str",pkg:"",typ:$funcType([$String],[$String,$Bool],false)},{prop:"Array",name:"Array",pkg:"",typ:$funcType([$String],[BP,$Bool],false)},{prop:"Map",name:"Map",pkg:"",typ:$funcType([$String],[BQ,$Bool],false)},{prop:"String",name:"String",pkg:"",typ:$funcType([],[$String],false)},{prop:"initLastReply",name:"initLastReply",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([CC],[],false)},{prop:"getError",name:"getError",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[$String,$String,$Bool,$error],false)}];CJ.methods=[{prop:"success",name:"success",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[],false)},{prop:"failure",name:"failure",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([AY],[AY],false)}];CK.methods=[{prop:"Call",name:"Call",pkg:"",typ:$funcType([CC],[BT,$error],false)}];AA.methods=[{prop:"Set",name:"Set",pkg:"",typ:$funcType([$String,$String],[],false)}];CL.methods=[{prop:"SetParams",name:"SetParams",pkg:"",typ:$funcType([BQ],[],false)},{prop:"Open",name:"Open",pkg:"",typ:$funcType([],[],false)},{prop:"Close",name:"Close",pkg:"",typ:$funcType([],[],false)},{prop:"Send",name:"Send",pkg:"",typ:$funcType([CC],[$error],false)},{prop:"send",name:"send",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([CC],[],false)},{prop:"sendAck",name:"sendAck",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[],false)},{prop:"discover",name:"discover",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[],false)},{prop:"connect",name:"connect",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([AX,BO,CJ],[$Bool],false)},{prop:"backOff",name:"backOff",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([CJ],[$Bool],false)},{prop:"canLogin",name:"canLogin",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[$Bool],false)},{prop:"makeCreateSessionAction",name:"makeCreateSessionAction",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[BQ],false)},{prop:"makeResumeSessionAction",name:"makeResumeSessionAction",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([$Bool],[BQ],false)},{prop:"handleSessionEvent",name:"handleSessionEvent",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BQ],[$Bool],false)},{prop:"handleEvent",name:"handleEvent",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BS],[$Int64,$Bool,$Bool,$Bool],false)},{prop:"deliverSessionEvent",name:"deliverSessionEvent",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BS],[],false)},{prop:"deliverEvent",name:"deliverEvent",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BS],[],false)},{prop:"connState",name:"connState",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([$String],[],false)},{prop:"connActive",name:"connActive",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[],false)},{prop:"log",name:"log",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BP],[],true)}];CE.methods=[{prop:"Active",name:"Active",pkg:"",typ:$funcType([],[$Bool],false)},{prop:"Reset",name:"Reset",pkg:"",typ:$funcType([AY],[],false)},{prop:"Stop",name:"Stop",pkg:"",typ:$funcType([],[],false)}];CF.methods=[{prop:"send",name:"send",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BZ],[$error],false)},{prop:"sendJSON",name:"sendJSON",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BQ],[$error],false)},{prop:"sendPayload",name:"sendPayload",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([CC],[$error],false)},{prop:"receive",name:"receive",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[BZ],false)},{prop:"receiveJSON",name:"receiveJSON",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[BQ,$error],false)},{prop:"close",name:"close",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[],false)}];G.init("github.com/ninchat/ninchat-go",[{prop:"Params",name:"Params",anonymous:false,exported:true,typ:BQ,tag:""},{prop:"Payload",name:"Payload",anonymous:false,exported:true,typ:BR,tag:""},{prop:"OnReply",name:"OnReply",anonymous:false,exported:true,typ:CI,tag:""},{prop:"id",name:"id",anonymous:false,exported:false,typ:$Int64,tag:""}]);H.init("",[{prop:"Params",name:"Params",anonymous:false,exported:true,typ:BQ,tag:""},{prop:"Payload",name:"Payload",anonymous:false,exported:true,typ:BR,tag:""},{prop:"LastReply",name:"LastReply",anonymous:false,exported:true,typ:$Bool,tag:""}]);I.init(B.Object);K.init("github.com/ninchat/ninchat-go",[{prop:"lastSlot",name:"lastSlot",anonymous:false,exported:false,typ:$Int,tag:""}]);N.init("",[{prop:"Address",name:"Address",anonymous:false,exported:true,typ:$String,tag:""}]);AA.init($String,$String);AB.init("github.com/ninchat/ninchat-go",[{prop:"Method",name:"Method",anonymous:false,exported:true,typ:$String,tag:""},{prop:"URL",name:"URL",anonymous:false,exported:true,typ:$String,tag:""},{prop:"Header",name:"Header",anonymous:false,exported:true,typ:AA,tag:""},{prop:"data",name:"data",anonymous:false,exported:false,typ:BZ,tag:""}]);AE.init("github.com/ninchat/ninchat-go",[{prop:"data",name:"data",anonymous:false,exported:false,typ:BZ,tag:""},{prop:"err",name:"err",anonymous:false,exported:false,typ:$error,tag:""}]);AW.init("github.com/ninchat/ninchat-go",[{prop:"OnSessionEvent",name:"OnSessionEvent",anonymous:false,exported:true,typ:CI,tag:""},{prop:"OnEvent",name:"OnEvent",anonymous:false,exported:true,typ:CI,tag:""},{prop:"OnClose",name:"OnClose",anonymous:false,exported:true,typ:BY,tag:""},{prop:"OnConnState",name:"OnConnState",anonymous:false,exported:true,typ:CM,tag:""},{prop:"OnConnActive",name:"OnConnActive",anonymous:false,exported:true,typ:BY,tag:""},{prop:"OnLog",name:"OnLog",anonymous:false,exported:true,typ:CN,tag:""},{prop:"Address",name:"Address",anonymous:false,exported:true,typ:$String,tag:""},{prop:"forceLongPoll",name:"forceLongPoll",anonymous:false,exported:false,typ:$Bool,tag:""},{prop:"mutex",name:"mutex",anonymous:false,exported:false,typ:D.Mutex,tag:""},{prop:"sessionParams",name:"sessionParams",anonymous:false,exported:false,typ:BQ,tag:""},{prop:"sessionId",name:"sessionId",anonymous:false,exported:false,typ:$emptyInterface,tag:""},{prop:"latestConnState",name:"latestConnState",anonymous:false,exported:false,typ:$String,tag:""},{prop:"lastActionId",name:"lastActionId",anonymous:false,exported:false,typ:$Int64,tag:""},{prop:"sendNotify",name:"sendNotify",anonymous:false,exported:false,typ:CO,tag:""},{prop:"sendBuffer",name:"sendBuffer",anonymous:false,exported:false,typ:CD,tag:""},{prop:"numSent",name:"numSent",anonymous:false,exported:false,typ:$Int,tag:""},{prop:"sendEventAck",name:"sendEventAck",anonymous:false,exported:false,typ:$Bool,tag:""},{prop:"receivedEventId",name:"receivedEventId",anonymous:false,exported:false,typ:$Int64,tag:""},{prop:"ackedEventId",name:"ackedEventId",anonymous:false,exported:false,typ:$Int64,tag:""},{prop:"closeNotify",name:"closeNotify",anonymous:false,exported:false,typ:CO,tag:""},{prop:"closed",name:"closed",anonymous:false,exported:false,typ:$Bool,tag:""},{prop:"running",name:"running",anonymous:false,exported:false,typ:$Bool,tag:""}]);AX.init([CL,$String],[$Bool,$Bool],false);BD.init("github.com/ninchat/ninchat-go",[{prop:"C",name:"C",anonymous:false,exported:true,typ:CO,tag:""},{prop:"id",name:"id",anonymous:false,exported:false,typ:BZ,tag:""}]);BI.init("github.com/ninchat/ninchat-go",[{prop:"notify",name:"notify",anonymous:false,exported:false,typ:CO,tag:""},{prop:"goingAway",name:"goingAway",anonymous:false,exported:false,typ:$Bool,tag:""},{prop:"err",name:"err",anonymous:false,exported:false,typ:$error,tag:""},{prop:"impl",name:"impl",anonymous:false,exported:false,typ:BZ,tag:""},{prop:"open",name:"open",anonymous:false,exported:false,typ:$Bool,tag:""},{prop:"buf",name:"buf",anonymous:false,exported:false,typ:CG,tag:""}]);$init=function(){$pkg.$init=function(){};var $f,$c=false,$s=0,$r;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=A.$init();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=B.$init();$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=C.$init();$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=D.$init();$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}X=null;Y=false;BF=null;BG=false;AV=AJ(new $Int64(0,4096),-0.25);Z();BH();}return;}if($f===undefined){$f={$blk:$init};}$f.$s=$s;$f.$r=$r;return $f;};$pkg.$init=$init;return $pkg;})();
