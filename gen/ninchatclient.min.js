...
$packages["github.com/ninchat/ninchat-go"]=(function(){var $pkg={},$init,A,C,B,E,D,F,J,K,L,N,Q,AE,AH,AZ,BA,BB,BC,BD,BH,BN,BT,BU,BV,BW,BX,BY,BZ,CA,CB,CC,CD,CE,CF,CG,CH,CI,CJ,CK,CL,CM,CN,CO,CP,CQ,CR,CS,CT,CU,CV,G,AB,AC,AY,BJ,BK,a,H,I,M,R,S,T,V,W,X,Y,Z,AA,AD,AF,AG,AI,AJ,AK,AL,AM,AN,AO,AP,AQ,AR,AS,AT,AU,AV,AW,AX,BE,BF,BG,BI,BL,BM,BO,BP,BQ,BR,BS;A=$packages["errors"];C=$packages["fmt"];B=$packages["github.com/gopherjs/gopherjs/js"];E=$packages["github.com/ninchat/ninchat-go/vendor/sort"];D=$packages["runtime"];F=$packages["sync"];J=$pkg.Action=$newType(0,$kindStruct,"ninchat.Action",true,"github.com/ninchat/ninchat-go",true,function(Params_,Payload_,OnReply_,id_){this.$val=this;if(arguments.length===0){this.Params=false;this.Payload=BW.nil;this.OnReply=$throwNilPointerError;this.id=new $Int64(0,0);return;}this.Params=Params_;this.Payload=Payload_;this.OnReply=OnReply_;this.id=id_;});K=$pkg.Event=$newType(0,$kindStruct,"ninchat.Event",true,"github.com/ninchat/ninchat-go",true,function(Params_,Payload_,LastReply_){this.$val=this;if(arguments.length===0){this.Params=false;this.Payload=BW.nil;this.LastReply=false;return;}this.Params=Params_;this.Payload=Payload_;this.LastReply=LastReply_;});L=$pkg.Frame=$newType(4,$kindPtr,"ninchat.Frame",true,"github.com/ninchat/ninchat-go",true,null);N=$pkg.backoff=$newType(0,$kindStruct,"ninchat.backoff",true,"github.com/ninchat/ninchat-go",false,function(lastSlot_){this.$val=this;if(arguments.length===0){this.lastSlot=0;return;}this.lastSlot=lastSlot_;});Q=$pkg.Caller=$newType(0,$kindStruct,"ninchat.Caller",true,"github.com/ninchat/ninchat-go",true,function(Header_,Address_){this.$val=this;if(arguments.length===0){this.Header=false;this.Address="";return;}this.Header=Header_;this.Address=Address_;});AE=$pkg.httpRequest=$newType(0,$kindStruct,"ninchat.httpRequest",true,"github.com/ninchat/ninchat-go",false,function(Method_,URL_,Header_,data_){this.$val=this;if(arguments.length===0){this.Method="";this.URL="";this.Header=false;this.data=null;return;}this.Method=Method_;this.URL=URL_;this.Header=Header_;this.data=data_;});AH=$pkg.httpResponse=$newType(0,$kindStruct,"ninchat.httpResponse",true,"github.com/ninchat/ninchat-go",false,function(data_,err_){this.$val=this;if(arguments.length===0){this.data=null;this.err=$ifaceNil;return;}this.data=data_;this.err=err_;});AZ=$pkg.Session=$newType(0,$kindStruct,"ninchat.Session",true,"github.com/ninchat/ninchat-go",true,function(OnSessionEvent_,OnEvent_,OnClose_,OnConnState_,OnConnActive_,OnLog_,Header_,Address_,DisableLongPoll_,forceLongPoll_,mutex_,sessionParams_,sessionId_,latestConnState_,lastActionId_,sendNotify_,sendBuffer_,numSent_,sendEventAck_,receivedEventId_,ackedEventId_,closeNotify_,closed_,running_,test_){this.$val=this;if(arguments.length===0){this.OnSessionEvent=$throwNilPointerError;this.OnEvent=$throwNilPointerError;this.OnClose=$throwNilPointerError;this.OnConnState=$throwNilPointerError;this.OnConnActive=$throwNilPointerError;this.OnLog=$throwNilPointerError;this.Header=false;this.Address="";this.DisableLongPoll=false;this.forceLongPoll=false;this.mutex=new F.Mutex.ptr(0,0);this.sessionParams=false;this.sessionId=$ifaceNil;this.latestConnState="";this.lastActionId=new $Int64(0,0);this.sendNotify=$chanNil;this.sendBuffer=CI.nil;this.numSent=0;this.sendEventAck=false;this.receivedEventId=new $Int64(0,0);this.ackedEventId=new $Int64(0,0);this.closeNotify=$chanNil;this.closed=false;this.running=false;this.test=new BB.ptr();return;}this.OnSessionEvent=OnSessionEvent_;this.OnEvent=OnEvent_;this.OnClose=OnClose_;this.OnConnState=OnConnState_;this.OnConnActive=OnConnActive_;this.OnLog=OnLog_;this.Header=Header_;this.Address=Address_;this.DisableLongPoll=DisableLongPoll_;this.forceLongPoll=forceLongPoll_;this.mutex=mutex_;this.sessionParams=sessionParams_;this.sessionId=sessionId_;this.latestConnState=latestConnState_;this.lastActionId=lastActionId_;this.sendNotify=sendNotify_;this.sendBuffer=sendBuffer_;this.numSent=numSent_;this.sendEventAck=sendEventAck_;this.receivedEventId=receivedEventId_;this.ackedEventId=ackedEventId_;this.closeNotify=closeNotify_;this.closed=closed_;this.running=running_;this.test=test_;});BA=$pkg.transport=$newType(4,$kindFunc,"ninchat.transport",true,"github.com/ninchat/ninchat-go",false,null);BB=$pkg.testSupport=$newType(0,$kindStruct,"ninchat.testSupport",true,"github.com/ninchat/ninchat-go",false,function(){this.$val=this;if(arguments.length===0){return;}});BC=$pkg.duration=$newType(8,$kindInt64,"ninchat.duration",true,"github.com/ninchat/ninchat-go",false,null);BD=$pkg.timeTime=$newType(8,$kindInt64,"ninchat.timeTime",true,"github.com/ninchat/ninchat-go",false,null);BH=$pkg.timer=$newType(0,$kindStruct,"ninchat.timer",true,"github.com/ninchat/ninchat-go",false,function(C_,id_){this.$val=this;if(arguments.length===0){this.C=$chanNil;this.id=null;return;}this.C=C_;this.id=id_;});BN=$pkg.webSocket=$newType(0,$kindStruct,"ninchat.webSocket",true,"github.com/ninchat/ninchat-go",false,function(notify_,goingAway_,err_,impl_,open_,buf_,client_){this.$val=this;if(arguments.length===0){this.notify=$chanNil;this.goingAway=false;this.err=$ifaceNil;this.impl=null;this.open=false;this.buf=CL.nil;this.client="";return;}this.notify=notify_;this.goingAway=goingAway_;this.err=err_;this.impl=impl_;this.open=open_;this.buf=buf_;this.client=client_;});BT=$sliceType($emptyInterface);BU=$sliceType($String);BV=$mapType($String,$emptyInterface);BW=$sliceType(L);BX=$ptrType(K);BY=$sliceType(BX);BZ=$ptrType(BT);CA=$ptrType(BV);CB=$sliceType($Uint8);CC=$ptrType(AE);CD=$funcType([],[],false);CE=$ptrType(B.Object);CF=$ptrType($Bool);CG=$structType("",[]);CH=$ptrType(J);CI=$sliceType(CH);CJ=$ptrType(BH);CK=$ptrType(BN);CL=$sliceType(CE);CM=$funcType([CE],[],false);CN=$funcType([BX],[],false);CO=$ptrType(N);CP=$ptrType(Q);CQ=$mapType($String,BU);CR=$ptrType(AZ);CS=$funcType([$String],[],false);CT=$funcType([BT],[],true);CU=$chanType(CG,false,false);CV=$ptrType(BB);H=function(b){var b;if(b===""){return"api.ninchat.com";}else{return b;}};I=function(b){var b,c,d,e,f,g,h,i,j,k,l,m,n,o;c=BU.nil;d=$ifaceNil;f=(e=b[$String.keyFor("hosts")],e!==undefined?e.v:$ifaceNil);if($interfaceIsEqual(f,$ifaceNil)){d=A.New("invalid endpoint document");return[c,d];}g=$assertType(f,BT,true);h=g[0];i=g[1];if(!i){d=A.New("invalid endpoint hosts type");return[c,d];}if(h.$length===0){d=A.New("no endpoint hosts");return[c,d];}j=h;k=0;while(true){if(!(k<j.$length)){break;}l=((k<0||k>=j.$length)?($throwRuntimeError("index out of range"),undefined):j.$array[j.$offset+k]);m=$assertType(l,$String,true);n=m[0];o=m[1];if(o){c=$append(c,n);}else{d=A.New("invalid endpoint host value type");}k++;}if(c.$length>0){d=$ifaceNil;}return[c,d];};J.ptr.prototype.String=function(){var b,c,d,e,f,g,h;b="";c=this;d=(e=c.Params[$String.keyFor("action")],e!==undefined?[e.v,true]:[$ifaceNil,false]);f=d[0];g=d[1];if(g){h=$assertType(f,$String,true);b=h[0];}return b;};J.prototype.String=function(){return this.$val.String();};J.ptr.prototype.GetID=function(){var b,c,d;b=new $Int64(0,0);c=$ifaceNil;d=this;b=d.id;if((b.$high===0&&b.$low===0)){c=G;}return[b,c];};J.prototype.GetID=function(){return this.$val.GetID();};K.ptr.prototype.Bool=function(b){var b,c,d,e,f,g;c=false;d=this;f=(e=d.Params[$String.keyFor(b)],e!==undefined?e.v:$ifaceNil);if(!($interfaceIsEqual(f,$ifaceNil))){g=$assertType(f,$Bool,true);c=g[0];}return c;};K.prototype.Bool=function(b){return this.$val.Bool(b);};K.ptr.prototype.Int=function(b){var b,c,d,e,f,g,h,i;c=0;d=false;e=this;g=(f=e.Params[$String.keyFor(b)],f!==undefined?f.v:$ifaceNil);if(!($interfaceIsEqual(g,$ifaceNil))){h=0;i=$assertType(g,$Float64,true);h=i[0];d=i[1];if(d){c=((h>>0));}}return[c,d];};K.prototype.Int=function(b){return this.$val.Int(b);};K.ptr.prototype.Int64=function(b){var b,c,d,e,f,g,h,i;c=new $Int64(0,0);d=false;e=this;g=(f=e.Params[$String.keyFor(b)],f!==undefined?f.v:$ifaceNil);if(!($interfaceIsEqual(g,$ifaceNil))){h=0;i=$assertType(g,$Float64,true);h=i[0];d=i[1];if(d){c=(new $Int64(0,h));}}return[c,d];};K.prototype.Int64=function(b){return this.$val.Int64(b);};K.ptr.prototype.Float64=function(b){var b,c,d,e,f,g,h;c=0;d=false;e=this;g=(f=e.Params[$String.keyFor(b)],f!==undefined?f.v:$ifaceNil);if(!($interfaceIsEqual(g,$ifaceNil))){h=$assertType(g,$Float64,true);c=h[0];d=h[1];}return[c,d];};K.prototype.Float64=function(b){return this.$val.Float64(b);};K.ptr.prototype.Str=function(b){var b,c,d,e,f,g,h;c="";d=false;e=this;g=(f=e.Params[$String.keyFor(b)],f!==undefined?f.v:$ifaceNil);if(!($interfaceIsEqual(g,$ifaceNil))){h=$assertType(g,$String,true);c=h[0];d=h[1];}return[c,d];};K.prototype.Str=function(b){return this.$val.Str(b);};K.ptr.prototype.Array=function(b){var b,c,d,e,f,g,h;c=BT.nil;d=false;e=this;g=(f=e.Params[$String.keyFor(b)],f!==undefined?f.v:$ifaceNil);if(!($interfaceIsEqual(g,$ifaceNil))){h=$assertType(g,BT,true);c=h[0];d=h[1];}return[c,d];};K.prototype.Array=function(b){return this.$val.Array(b);};K.ptr.prototype.Map=function(b){var b,c,d,e,f,g,h;c=false;d=false;e=this;g=(f=e.Params[$String.keyFor(b)],f!==undefined?f.v:$ifaceNil);if(!($interfaceIsEqual(g,$ifaceNil))){h=$assertType(g,BV,true);c=h[0];d=h[1];}return[c,d];};K.prototype.Map=function(b){return this.$val.Map(b);};K.ptr.prototype.String=function(){var b,c,d;b="";c=this;d=c.Str("event");b=d[0];return b;};K.prototype.String=function(){return this.$val.String();};K.ptr.prototype.initLastReply=function(b){var b,c,d,e,f,g;c=this;d=c.Int("history_length");e=d[0];if(e>0){return;}if(c.String()==="search_results"){if(!($interfaceIsEqual((f=c.Params[$String.keyFor("users")],f!==undefined?f.v:$ifaceNil),$ifaceNil))||!($interfaceIsEqual((g=c.Params[$String.keyFor("channels")],g!==undefined?g.v:$ifaceNil),$ifaceNil))){return;}}c.LastReply=true;};K.prototype.initLastReply=function(b){return this.$val.initLastReply(b);};K.ptr.prototype.getError=function(){var b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t;b="";c="";d=false;e=false;f=$ifaceNil;g=this;h=(i=g.Params[$String.keyFor("event")],i!==undefined?[i.v,true]:[$ifaceNil,false]);j=h[0];k=h[1];if(!k||!($assertType(j,$String)==="error")){return[b,c,d,e,f];}b=$assertType((l=g.Params[$String.keyFor("error_type")],l!==undefined?l.v:$ifaceNil),$String);n=(m=g.Params[$String.keyFor("error_reason")],m!==undefined?m.v:$ifaceNil);if(!($interfaceIsEqual(n,$ifaceNil))){c=$assertType(n,$String);}if(b==="request_malformed"){o=(p=g.Params[$String.keyFor("action_id")],p!==undefined?[p.v,true]:[$ifaceNil,false]);q=o[1];if(q){return[b,c,d,e,f];}}r=b;if(r===("session_not_found")){e=true;t=(s=g.Params[$String.keyFor("user_auth_deleted")],s!==undefined?s.v:$ifaceNil);if(!($interfaceIsEqual(t,$ifaceNil))){d=$assertType(t,$Bool);}if(!(c==="")){f=A.New("error: "+b+" ("+c+")");}else{f=A.New("error: "+b);}}else if(r===("connection_superseded")||r===("message_has_too_many_parts")||r===("message_part_too_long")||r===("message_too_long")||r===("payload_has_too_many_parts")||r===("payload_part_too_long")||r===("request_malformed")){if(!(c==="")){f=A.New("error: "+b+" ("+c+")");}else{f=A.New("error: "+b);}}return[b,c,d,e,f];};K.prototype.getError=function(){return this.$val.getError();};M=function(b){var b;return new BW([b]);};N.ptr.prototype.success=function(){var b;b=this;b.lastSlot=0;};N.prototype.success=function(){return this.$val.success();};N.ptr.prototype.failure=function(b){var b,c,d;c=new BC(0,0);d=this;if(d.lastSlot>0){c=(new BC(0,AK(($flatten64(b))*(d.lastSlot)/1024,-0.5)));}if(d.lastSlot<1023){d.lastSlot=((((d.lastSlot+1>>0))<<1>>0))-1>>0;}return c;};N.prototype.failure=function(b){return this.$val.failure(b);};Q.ptr.prototype.Call=function(b){var aa,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;aa=$f.aa;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;v=$f.v;w=$f.w;x=$f.x;y=$f.y;z=$f.z;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=[c];d=[d];e=BY.nil;f=$ifaceNil;g=this;h="https://"+H(g.Address)+"/v2/call";j=Y(h,g.Header,b.Params);$s=1;case 1:if($c){$c=false;j=j.$blk();}if(j&&j.$blk!==undefined){break s;}i=j;k=i[0];f=i[1];if(!($interfaceIsEqual(f,$ifaceNil))){$s=-1;return[e,f];}l="Accept";(k.Header||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(l)]={k:l,v:new BU(["application/json"])};m="Content-Type";(k.Header||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(m)]={k:m,v:new BU(["application/json"])};n=AL(new BC(0,11000),0.1);p=AI(k,n);$s=2;case 2:if($c){$c=false;p=p.$blk();}if(p&&p.$blk!==undefined){break s;}o=p;q=o[0];f=o[1];if(!($interfaceIsEqual(f,$ifaceNil))){$s=-1;return[e,f];}c[0]=BT.nil;r=AO(q,(c.$ptr||(c.$ptr=new BZ(function(){return this.$target[0];},function($v){this.$target[0]=$v;},c))));$s=5;case 5:if($c){$c=false;r=r.$blk();}if(r&&r.$blk!==undefined){break s;}if(!($interfaceIsEqual(r,$ifaceNil))){$s=3;continue;}$s=4;continue;case 3:d[0]=false;s=AP(q,(d.$ptr||(d.$ptr=new CA(function(){return this.$target[0];},function($v){this.$target[0]=$v;},d))));$s=6;case 6:if($c){$c=false;s=s.$blk();}if(s&&s.$blk!==undefined){break s;}f=s;if(!($interfaceIsEqual(f,$ifaceNil))){$s=-1;return[e,f];}c[0]=new BT([new BV(d[0])]);case 4:e=$makeSlice(BY,0,c[0].$length);t=c[0];u=0;case 7:if(!(u<t.$length)){$s=8;continue;}v=u;w=((u<0||u>=t.$length)?($throwRuntimeError("index out of range"),undefined):t.$array[t.$offset+u]);x=$assertType(w,BV,true);y=x[0];z=x[1];if(!z){f=A.New("response event header is not an object");$s=-1;return[e,f];}aa=new K.ptr(y,BW.nil,v===(c[0].$length-1>>0));if(!(b.OnReply===$throwNilPointerError)){$s=9;continue;}$s=10;continue;case 9:$r=b.OnReply(aa);$s=11;case 11:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 10:e=$append(e,aa);u++;$s=7;continue;case 8:$s=-1;return[e,f];}return;}if($f===undefined){$f={$blk:Q.ptr.prototype.Call};}$f.aa=aa;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.v=v;$f.w=w;$f.x=x;$f.y=y;$f.z=z;$f.$s=$s;$f.$r=$r;return $f;};Q.prototype.Call=function(b){return this.$val.Call(b);};R=function(){return new($global.ArrayBuffer)();};S=function(b){var b;return $parseInt(b.length);};T=function(b){var b;return V(b);};V=function(b){var b,c,d,e,f,g;c=$assertType($internalize(b,$emptyInterface),$String,true);d=c[1];if(d){return b;}e=new($global.Uint8Array)(b);f=$assertType($internalize(e,$emptyInterface),CB);g=($bytesToString(f));return new($global.String)($externalize(g,$String));};$pkg.StringifyFrame=V;W=function(b,c){var b,c,d,e,f,g,h,i,j,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:d=$ifaceNil;if(!($interfaceIsEqual(c,$ifaceNil))){$s=1;continue;}$s=2;continue;case 1:e=c;if($assertType(e,$error,true)[1]){$s=3;continue;}if($assertType(e,$String,true)[1]){$s=4;continue;}$s=5;continue;case 3:f=e;i=f.Error();$s=7;case 7:if($c){$c=false;i=i.$blk();}if(i&&i.$blk!==undefined){break s;}j=A.New(b+": "+i);$s=8;case 8:if($c){$c=false;j=j.$blk();}if(j&&j.$blk!==undefined){break s;}d=j;$s=6;continue;case 4:g=e.$val;d=A.New(b+": "+g);$s=6;continue;case 5:h=e;d=A.New(b+": ?");case 6:case 2:$s=-1;return d;}return;}if($f===undefined){$f={$blk:W};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.$s=$s;$f.$r=$r;return $f;};X=function(b){var b,c,d,e,f,g,h,i,j,k,l,m,n;c={};d=b;e=0;f=$keys(d);while(true){if(!(e<f.length)){break;}g=d[f[e]];if(g===undefined){e++;continue;}h=g.k;i=g.v;j=h;(c||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(j)]={k:j,v:i};e++;}k=(l=c[$String.keyFor("X-User-Agent")],l!==undefined?[l.v,true]:[BU.nil,false]);m=k[1];if(!m){n="X-User-Agent";(c||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(n)]={k:n,v:new BU([$pkg.DefaultUserAgent])};}return c;};Y=function(b,c,d){var b,c,d,e,f,g,h,i,j,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:e=CC.nil;f=$ifaceNil;h=AN(d);$s=1;case 1:if($c){$c=false;h=h.$blk();}if(h&&h.$blk!==undefined){break s;}g=h;i=g[0];f=g[1];if(!($interfaceIsEqual(f,$ifaceNil))){$s=-1;return[e,f];}j=AG("POST",b,c,i);e=j[0];f=j[1];$s=-1;return[e,f];}return;}if($f===undefined){$f={$blk:Y};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.$s=$s;$f.$r=$r;return $f;};Z=function(b,c,d,e){var b,c,d,e,f,g,h,i,j,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:f=new $Chan(AH,1);h=Y(b,c,d);$s=1;case 1:if($c){$c=false;h=h.$blk();}if(h&&h.$blk!==undefined){break s;}g=h;i=g[0];j=g[1];if($interfaceIsEqual(j,$ifaceNil)){$s=2;continue;}$s=3;continue;case 2:$r=AJ(i,e,f);$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=4;continue;case 3:$r=$send(f,$clone(new AH.ptr(null,j),AH));$s=6;case 6:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 4:$s=-1;return f;}return;}if($f===undefined){$f={$blk:Z};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.$s=$s;$f.$r=$r;return $f;};AA=function(b,c){var b,c,d,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:d=new $Chan(AH,1);$r=AJ(b,c,d);$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return d;}return;}if($f===undefined){$f={$blk:AA};}$f.b=b;$f.c=c;$f.d=d;$f.$s=$s;$f.$r=$r;return $f;};AD=function(){AB=$global.XDomainRequest;if(AB===undefined){AB=$global.XMLHttpRequest;if(AB===undefined){AB=$module.require($externalize("xhr2",$String));}AC=true;}};AF=function(b,c){var b,c,d,e;d=CC.nil;e=$ifaceNil;d=new AE.ptr("GET",b,X(c),null);return[d,e];};AG=function(b,c,d,e){var b,c,d,e,f,g;f=CC.nil;g=$ifaceNil;f=new AE.ptr(b,c,X(d),e);return[f,g];};AI=function(b,c){var b,c,d,e,f,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:d=AA(b,c);$s=1;case 1:if($c){$c=false;d=d.$blk();}if(d&&d.$blk!==undefined){break s;}e=$recv(d);$s=2;case 2:if($c){$c=false;e=e.$blk();}if(e&&e.$blk!==undefined){break s;}f=$clone(e[0],AH);$s=-1;return[f.data,f.err];}return;}if($f===undefined){$f={$blk:AI};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.$s=$s;$f.$r=$r;return $f;};AJ=function(b,c,d){var b,c,d,e,f,g,h,i,j,k,l,m,n,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=[b];d=[d];e=[e];$deferred.push([(function(b,d,e){return function $b(){var f,g,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;f=$f.f;g=$f.g;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:f=W("XHR",$recover());$s=1;case 1:if($c){$c=false;f=f.$blk();}if(f&&f.$blk!==undefined){break s;}g=f;if(!($interfaceIsEqual(g,$ifaceNil))){$s=2;continue;}$s=3;continue;case 2:$r=$send(d[0],$clone(new AH.ptr(null,g),AH));$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 3:$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.f=f;$f.g=g;$f.$s=$s;$f.$r=$r;return $f;};})(b,d,e),[]]);e[0]=new(AB)();e[0].onload=$externalize((function(b,d,e){return function(){var f;f=e[0].responseText;$go((function(b,d,e){return function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=$send(d[0],$clone(new AH.ptr(f,$ifaceNil),AH));$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;};})(b,d,e),[]);};})(b,d,e),CD);e[0].onprogress=$externalize((function(b,d,e){return function(){$global.setTimeout($externalize((function(b,d,e){return function(){};})(b,d,e),CD),0);};})(b,d,e),CD);e[0].ontimeout=$externalize((function(b,d,e){return function(){$go((function(b,d,e){return function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=$send(d[0],$clone(new AH.ptr(null,A.New("timeout")),AH));$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;};})(b,d,e),[]);};})(b,d,e),CD);e[0].onerror=$externalize((function(b,d,e){return function(){$go((function(b,d,e){return function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=$send(d[0],$clone(new AH.ptr(null,A.New("error")),AH));$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;};})(b,d,e),[]);};})(b,d,e),CD);e[0].open($externalize(b[0].Method,$String),$externalize(b[0].URL,$String));e[0].timeout=$externalize(c,BC);if(AC){f=b[0].Header;g=0;h=$keys(f);while(true){if(!(g<h.length)){break;}i=f[h[g]];if(i===undefined){g++;continue;}j=i.k;k=i.v;l=k;m=0;while(true){if(!(m<l.$length)){break;}n=((m<0||m>=l.$length)?($throwRuntimeError("index out of range"),undefined):l.$array[l.$offset+m]);e[0].setRequestHeader($externalize(j,$String),$externalize(n,$String));m++;}g++;}}$global.setTimeout($externalize((function(b,d,e){return function(){e[0].send(b[0].data);};})(b,d,e),CD),0);$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AJ};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AK=function(b,c){var b,c;return b+b*c*AX();};AL=function(b,c){var b,c;return(new BC(0,AK(($flatten64(b)),c)));};AM=function(b,c){var b,c;return(new $Int64(0,AK(($flatten64(b)),c)));};AN=function(b){var b,c,d,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);c=[c];d=null;c[0]=$ifaceNil;$deferred.push([(function(c){return function $b(){var e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:e=W("JSON marshal",$recover());$s=1;case 1:if($c){$c=false;e=e.$blk();}if(e&&e.$blk!==undefined){break s;}c[0]=e;$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};})(c),[]]);d=$global.JSON.stringify($externalize(b,BV));$s=-1;return[d,c[0]];}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return[d,c[0]];}if($curGoroutine.asleep){if($f===undefined){$f={$blk:AN};}$f.b=b;$f.c=c;$f.d=d;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AO=function(b,c){var b,c,d,e,f,g,h,i,j,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:d=$ifaceNil;f=AQ(b);$s=1;case 1:if($c){$c=false;f=f.$blk();}if(f&&f.$blk!==undefined){break s;}e=f;g=e[0];d=e[1];if(!($interfaceIsEqual(d,$ifaceNil))){$s=-1;return d;}h=$assertType(g,BT,true);i=h[0];j=h[1];if(!j){d=A.New("json: cannot unmarshal value into Go value of type *[]interface{}");$s=-1;return d;}c.$set(i);$s=-1;return d;}return;}if($f===undefined){$f={$blk:AO};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.$s=$s;$f.$r=$r;return $f;};AP=function(b,c){var b,c,d,e,f,g,h,i,j,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:d=$ifaceNil;f=AQ(b);$s=1;case 1:if($c){$c=false;f=f.$blk();}if(f&&f.$blk!==undefined){break s;}e=f;g=e[0];d=e[1];if(!($interfaceIsEqual(d,$ifaceNil))){$s=-1;return d;}h=$assertType(g,BV,true);i=h[0];j=h[1];if(!j){d=A.New("json: cannot unmarshal value into Go value of type *map[string]interface{}");$s=-1;return d;}c.$set(i);$s=-1;return d;}return;}if($f===undefined){$f={$blk:AP};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.$s=$s;$f.$r=$r;return $f;};AQ=function(b){var b,c,d,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);c=[c];d=$ifaceNil;c[0]=$ifaceNil;$deferred.push([(function(c){return function $b(){var e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:e=W("JSON parse",$recover());$s=1;case 1:if($c){$c=false;e=e.$blk();}if(e&&e.$blk!==undefined){break s;}c[0]=e;$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};})(c),[]]);d=$internalize($global.JSON.parse(b),$emptyInterface);$s=-1;return[d,c[0]];}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return[d,c[0]];}if($curGoroutine.asleep){if($f===undefined){$f={$blk:AQ};}$f.b=b;$f.c=c;$f.d=d;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AR=function(b){var b,c,d,e,f,g;c=BT.nil;d=b.Payload;e=0;while(true){if(!(e<d.$length)){break;}f=((e<0||e>=d.$length)?($throwRuntimeError("index out of range"),undefined):d.$array[d.$offset+e]);g=($pointerOfStructConversion(f,CE)).split($externalize(",",$String))[1];c=$append(c,new $jsObjectPtr(g));e++;}return c;};AS=function(b,c){var b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:d=[d];e=[e];f=[f];e[0]=false;f[0]=false;g="https://"+c+"/v2/poll";if($interfaceIsEqual(b.sessionId,$ifaceNil)){$s=1;continue;}$s=2;continue;case 1:$r=b.log(new BT([new $String("session creation")]));$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}h=b.makeCreateSessionAction();i=AL(new BC(0,37000),0.2);$r=b.mutex.Unlock();$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}k=Z(g,b.Header,h,i);$s=6;case 6:if($c){$c=false;k=k.$blk();}if(k&&k.$blk!==undefined){break s;}l=$select([[k],[b.closeNotify]]);$s=7;case 7:if($c){$c=false;l=l.$blk();}if(l&&l.$blk!==undefined){break s;}j=l;if(j[0]===0){$s=8;continue;}if(j[0]===1){$s=9;continue;}$s=10;continue;case 8:m=$clone(j[1][0],AH);$r=b.mutex.Lock();$s=11;case 11:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!($interfaceIsEqual(m.err,$ifaceNil))){$s=12;continue;}$s=13;continue;case 12:$r=b.log(new BT([new $String("session creation:"),m.err]));$s=14;case 14:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[e[0],f[0]];case 13:d[0]=BT.nil;n=AO(m.data,(d.$ptr||(d.$ptr=new BZ(function(){return this.$target[0];},function($v){this.$target[0]=$v;},d))));$s=15;case 15:if($c){$c=false;n=n.$blk();}if(n&&n.$blk!==undefined){break s;}o=n;if(!($interfaceIsEqual(o,$ifaceNil))){$s=16;continue;}$s=17;continue;case 16:$r=b.log(new BT([new $String("session creation response:"),o]));$s=18;case 18:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[e[0],f[0]];case 17:if(d[0].$length===0){$s=19;continue;}$s=20;continue;case 19:$r=b.log(new BT([new $String("session creation response JSON array is empty")]));$s=21;case 21:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[e[0],f[0]];case 20:p=$assertType((0>=d[0].$length?($throwRuntimeError("index out of range"),undefined):d[0].$array[d[0].$offset+0]),BV,true);q=p[0];r=p[1];if(!r){$s=22;continue;}$s=23;continue;case 22:$r=b.log(new BT([new $String("session creation response header is not a JSON object")]));$s=24;case 24:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[e[0],f[0]];case 23:s=b.handleSessionEvent(q);$s=27;case 27:if($c){$c=false;s=s.$blk();}if(s&&s.$blk!==undefined){break s;}if(!s){$s=25;continue;}$s=26;continue;case 25:$s=-1;return[e[0],f[0]];case 26:$s=10;continue;case 9:$r=b.mutex.Lock();$s=28;case 28:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=AV(b,g);$s=29;case 29:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[e[0],f[0]];case 10:e[0]=true;f[0]=true;$r=b.connState("connected");$s=30;case 30:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=b.connActive();$s=31;case 31:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=3;continue;case 2:$r=b.log(new BT([new $String("session resumption")]));$s=32;case 32:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=AU(b,g);$s=33;case 33:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 3:$r=AT(b,g,(e.$ptr||(e.$ptr=new CF(function(){return this.$target[0];},function($v){this.$target[0]=$v;},e))),(f.$ptr||(f.$ptr=new CF(function(){return this.$target[0];},function($v){this.$target[0]=$v;},f))));$s=34;case 34:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[e[0],f[0]];}return;}if($f===undefined){$f={$blk:AS};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.$s=$s;$f.$r=$r;return $f;};AT=function(b,c,d,e){var aa,ab,ac,ad,ae,af,ag,ah,ai,aj,ak,al,am,an,ao,ap,aq,ar,as,at,au,av,aw,ax,ay,az,b,ba,bb,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;aa=$f.aa;ab=$f.ab;ac=$f.ac;ad=$f.ad;ae=$f.ae;af=$f.af;ag=$f.ag;ah=$f.ah;ai=$f.ai;aj=$f.aj;ak=$f.ak;al=$f.al;am=$f.am;an=$f.an;ao=$f.ao;ap=$f.ap;aq=$f.aq;ar=$f.ar;as=$f.as;at=$f.at;au=$f.au;av=$f.av;aw=$f.aw;ax=$f.ax;ay=$f.ay;az=$f.az;b=$f.b;ba=$f.ba;bb=$f.bb;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;v=$f.v;w=$f.w;x=$f.x;y=$f.y;z=$f.z;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:f=$chanNil;g=$chanNil;h=new $Int64(0,0);i=0;b.numSent=0;case 1:if(!(i<2)){$s=2;continue;}j=[j];k=[k];if(f===$chanNil){$s=3;continue;}$s=4;continue;case 3:l=b.makeResumeSessionAction(true);m=AL(new BC(0,64000),0.2);n=Z(c,b.Header,l,m);$s=5;case 5:if($c){$c=false;n=n.$blk();}if(n&&n.$blk!==undefined){break s;}f=n;case 4:if(g===$chanNil&&b.numSent<b.sendBuffer.$length){$s=6;continue;}$s=7;continue;case 6:q=(o=b.sendBuffer,p=b.numSent,((p<0||p>=o.$length)?($throwRuntimeError("index out of range"),undefined):o.$array[o.$offset+p]));if(!(q.Payload===BW.nil)){$s=8;continue;}$s=9;continue;case 8:if(q.String()==="update_user"){$s=10;continue;}$s=11;continue;case 10:r="payload";(q.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(r)]={k:r,v:AR(q)};$s=12;continue;case 11:k[0]=false;t=AP((s=q.Payload,(0>=s.$length?($throwRuntimeError("index out of range"),undefined):s.$array[s.$offset+0])),(k.$ptr||(k.$ptr=new CA(function(){return this.$target[0];},function($v){this.$target[0]=$v;},k))));$s=13;case 13:if($c){$c=false;t=t.$blk();}if(t&&t.$blk!==undefined){break s;}u=t;if(!($interfaceIsEqual(u,$ifaceNil))){$s=14;continue;}$s=15;continue;case 14:$r=b.log(new BT([new $String("send:"),u]));$s=16;case 16:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 15:v="payload";(q.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(v)]={k:v,v:new BV(k[0])};case 12:case 9:w="session_id";(q.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(w)]={k:w,v:b.sessionId};x=AL(new BC(0,7000),0.2);y=Z(c,b.Header,q.Params,x);$s=17;case 17:if($c){$c=false;y=y.$blk();}if(y&&y.$blk!==undefined){break s;}z=y;delete q.Params[$String.keyFor("session_id")];delete q.Params[$String.keyFor("payload")];if((aa=q.id,(aa.$high===0&&aa.$low===0))){$go(AW,[b,z,"send error:"]);b.sendBuffer=$appendSlice($subslice(b.sendBuffer,0,b.numSent),$subslice(b.sendBuffer,(b.numSent+1>>0)));}else{g=z;h=q.id;}case 7:ab=new AH.ptr(null,$ifaceNil);$r=b.mutex.Unlock();$s=18;case 18:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}ad=$select([[f],[g],[b.sendNotify],[b.closeNotify]]);$s=19;case 19:if($c){$c=false;ad=ad.$blk();}if(ad&&ad.$blk!==undefined){break s;}ac=ad;if(ac[0]===0){$s=20;continue;}if(ac[0]===1){$s=21;continue;}if(ac[0]===2){$s=22;continue;}if(ac[0]===3){$s=23;continue;}$s=24;continue;case 20:AH.copy(ab,ac[1][0]);$r=b.mutex.Lock();$s=25;case 25:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!($interfaceIsEqual(ab.err,$ifaceNil))){$s=26;continue;}$s=27;continue;case 26:$r=b.log(new BT([new $String("poll error:"),ab.err]));$s=28;case 28:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 27:f=$chanNil;$r=b.connActive();$s=29;case 29:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=24;continue;case 21:AH.copy(ab,ac[1][0]);$r=b.mutex.Lock();$s=30;case 30:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!($interfaceIsEqual(ab.err,$ifaceNil))){$s=31;continue;}if((h.$high>0||(h.$high===0&&h.$low>0))){$s=32;continue;}$s=33;continue;case 31:$r=b.log(new BT([new $String("send error:"),ab.err]));$s=34;case 34:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=33;continue;case 32:b.numSent=b.numSent+(1)>>0;case 33:g=$chanNil;h=new $Int64(0,0);$s=24;continue;case 22:ae=ac[1];af=ae[1];$r=b.mutex.Lock();$s=35;case 35:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!af){$s=36;continue;}$s=37;continue;case 36:$r=AV(b,c);$s=38;case 38:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 37:$s=1;continue;$s=24;continue;case 23:$r=b.mutex.Lock();$s=39;case 39:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=AV(b,c);$s=40;case 40:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 24:j[0]=BT.nil;ag=ab.err;if($interfaceIsEqual(ag,$ifaceNil)){$s=41;continue;}$s=42;continue;case 41:ah=AO(ab.data,(j.$ptr||(j.$ptr=new BZ(function(){return this.$target[0];},function($v){this.$target[0]=$v;},j))));$s=43;case 43:if($c){$c=false;ah=ah.$blk();}if(ah&&ah.$blk!==undefined){break s;}ag=ah;if(!($interfaceIsEqual(ag,$ifaceNil))){$s=44;continue;}$s=45;continue;case 44:$r=b.log(new BT([new $String("response:"),ag]));$s=46;case 46:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 45:case 42:if(!($interfaceIsEqual(ag,$ifaceNil))){$s=47;continue;}$s=48;continue;case 47:i=i+(1)>>0;b.numSent=0;$s=1;continue;case 48:i=0;d.$set(true);ai=j[0];aj=0;case 49:if(!(aj<ai.$length)){$s=50;continue;}ak=((aj<0||aj>=ai.$length)?($throwRuntimeError("index out of range"),undefined):ai.$array[ai.$offset+aj]);al=$assertType(ak,BV,true);am=al[0];an=al[1];if(!an){$s=51;continue;}$s=52;continue;case 51:$r=b.log(new BT([new $String("poll event is not an object")]));$s=53;case 53:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 52:ao=new K.ptr(am,BW.nil,false);aq=(ap=am[$String.keyFor("payload")],ap!==undefined?ap.v:$ifaceNil);if(!($interfaceIsEqual(aq,$ifaceNil))){$s=54;continue;}$s=55;continue;case 54:ar=$assertType(aq,BV,true);as=ar[0];at=ar[1];if(!at){$s=56;continue;}$s=57;continue;case 56:$r=b.log(new BT([new $String("poll payload is not an object")]));$s=58;case 58:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 57:av=AN(as);$s=59;case 59:if($c){$c=false;av=av.$blk();}if(av&&av.$blk!==undefined){break s;}au=av;aw=au[0];ax=au[1];if(!($interfaceIsEqual(ax,$ifaceNil))){$s=60;continue;}$s=61;continue;case 60:$r=b.log(new BT([new $String("poll payload:"),ax]));$s=62;case 62:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 61:ao.Payload=M(aw);case 55:az=b.handleEvent(ao);$s=63;case 63:if($c){$c=false;az=az.$blk();}if(az&&az.$blk!==undefined){break s;}ay=az;ba=ay[0];bb=ay[1];an=ay[3];if((h.$high>0||(h.$high===0&&h.$low>0))&&(h.$high<ba.$high||(h.$high===ba.$high&&h.$low<=ba.$low))){h=new $Int64(0,0);b.numSent=b.numSent+(1)>>0;}if(!an){if(bb){e.$set(true);}$s=-1;return;}if(!e.$get()){$s=64;continue;}$s=65;continue;case 64:e.$set(true);$r=b.connState("connected");$s=66;case 66:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 65:aj++;$s=49;continue;case 50:$s=1;continue;case 2:$s=-1;return;}return;}if($f===undefined){$f={$blk:AT};}$f.aa=aa;$f.ab=ab;$f.ac=ac;$f.ad=ad;$f.ae=ae;$f.af=af;$f.ag=ag;$f.ah=ah;$f.ai=ai;$f.aj=aj;$f.ak=ak;$f.al=al;$f.am=am;$f.an=an;$f.ao=ao;$f.ap=ap;$f.aq=aq;$f.ar=ar;$f.as=as;$f.at=at;$f.au=au;$f.av=av;$f.aw=aw;$f.ax=ax;$f.ay=ay;$f.az=az;$f.b=b;$f.ba=ba;$f.bb=bb;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.v=v;$f.w=w;$f.x=x;$f.y=y;$f.z=z;$f.$s=$s;$f.$r=$r;return $f;};AU=function(b,c){var b,c,d,e,f,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:d=$makeMap($String.keyFor,[{k:"action",v:new $String("ping")},{k:"session_id",v:b.sessionId}]);e=Z(c,b.Header,d,AL(new BC(0,7000),0.9));$s=1;case 1:if($c){$c=false;e=e.$blk();}if(e&&e.$blk!==undefined){break s;}f=e;$go(AW,[b,f,"ping error:"]);$s=-1;return;}return;}if($f===undefined){$f={$blk:AU};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.$s=$s;$f.$r=$r;return $f;};AV=function(b,c){var b,c,d,e,f,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:d=$makeMap($String.keyFor,[{k:"action",v:new $String("close_session")},{k:"session_id",v:b.sessionId}]);e=Z(c,b.Header,d,AL(new BC(0,7000),0.9));$s=1;case 1:if($c){$c=false;e=e.$blk();}if(e&&e.$blk!==undefined){break s;}f=e;$go(AW,[b,f,"send error:"]);$s=-1;return;}return;}if($f===undefined){$f={$blk:AV};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.$s=$s;$f.$r=$r;return $f;};AW=function(b,c,d){var b,c,d,e,f,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:e=$recv(c);$s=1;case 1:if($c){$c=false;e=e.$blk();}if(e&&e.$blk!==undefined){break s;}f=$clone(e[0],AH);if(!($interfaceIsEqual(f.err,$ifaceNil))&&!(b.OnLog===$throwNilPointerError)){$s=2;continue;}$s=3;continue;case 2:$r=b.OnLog(new BT([new $String(d),f.err]));$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 3:$s=-1;return;}return;}if($f===undefined){$f={$blk:AW};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.$s=$s;$f.$r=$r;return $f;};AX=function(){return $parseFloat($global.Math.random());};AZ.ptr.prototype.SetParams=function(b){var b,c,d,e,f,g,h,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);c=this;$r=c.mutex.Lock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(c.mutex,"Unlock"),[]]);if($interfaceIsEqual((d=b[$String.keyFor("message_types")],d!==undefined?d.v:$ifaceNil),$ifaceNil)){$panic(new $String("message_types parameter not defined"));}e=(f=b[$String.keyFor("session_id")],f!==undefined?[f.v,true]:[$ifaceNil,false]);g=e[0];h=e[1];if(!($interfaceIsEqual(g,$ifaceNil))){c.sessionId=g;}else if(h){delete b[$String.keyFor("session_id")];}c.sessionParams=b;if(!(c.sendNotify===$chanNil)&&!c.running){c.running=true;$go($methodVal(c,"discover"),[]);}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AZ.ptr.prototype.SetParams};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AZ.prototype.SetParams=function(b){return this.$val.SetParams(b);};AZ.ptr.prototype.Open=function(){var b,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=this;$r=b.mutex.Lock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(b.mutex,"Unlock"),[]]);if(b.closed){$panic(new $String("session already closed"));}if(!(b.sendNotify===$chanNil)){$panic(new $String("session already initialized"));}if(b.OnSessionEvent===$throwNilPointerError){$panic(new $String("onSessionEvent callback not defined"));}if(b.OnEvent===$throwNilPointerError){$panic(new $String("onEvent callback not defined"));}if(b.sessionParams===false){$panic(new $String("session parameters not defined"));}if(b.DisableLongPoll&&!BK){$panic(new $String("websocket not supported by browser"));}b.sendNotify=new $Chan(CG,1);b.closeNotify=new $Chan(CG,1);b.running=true;$go($methodVal(b,"discover"),[]);$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AZ.ptr.prototype.Open};}$f.b=b;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AZ.prototype.Open=function(){return this.$val.Open();};AZ.ptr.prototype.Close=function(){var b,c,d,e,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=[b];b[0]=this;$r=b[0].mutex.Lock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(b[0].mutex,"Unlock"),[]]);if(b[0].closed){$s=-1;return;}c=b[0].sendBuffer;d=0;case 2:if(!(d<c.$length)){$s=3;continue;}e=((d<0||d>=c.$length)?($throwRuntimeError("index out of range"),undefined):c.$array[c.$offset+d]);if(!(e.OnReply===$throwNilPointerError)){$s=4;continue;}$s=5;continue;case 4:$r=e.OnReply(BX.nil);$s=6;case 6:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 5:d++;$s=2;continue;case 3:b[0].sendBuffer=CI.nil;b[0].numSent=0;b[0].closed=true;b[0].running=false;$go((function(b){return function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=$send(b[0].closeNotify,$clone(new CG.ptr(),CG));$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$close(b[0].sendNotify);$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;};})(b),[]);$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AZ.ptr.prototype.Close};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AZ.prototype.Close=function(){return this.$val.Close();};AZ.ptr.prototype.Send=function(b){var b,c,d,e,f,g,h,i,j,k,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);c=$ifaceNil;d=this;$r=d.mutex.Lock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(d.mutex,"Unlock"),[]]);if(d.sendNotify===$chanNil){$panic(new $String("session not initialized"));}if(d.closed){$panic(new $String("session already closed"));}if(b.Payload.$length===0){b.Payload=BW.nil;}e=(f=b.Params[$String.keyFor("action_id")],f!==undefined?[f.v,true]:[$ifaceNil,false]);g=e[0];h=e[1];if(h&&$interfaceIsEqual(g,$ifaceNil)){delete b.Params[$String.keyFor("action_id")];}else{d.lastActionId=(i=d.lastActionId,j=new $Int64(0,1),new $Int64(i.$high+j.$high,i.$low+j.$low));b.id=d.lastActionId;k="action_id";(b.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(k)]={k:k,v:b.id};}d.send(b);$s=-1;return c;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return c;}if($curGoroutine.asleep){if($f===undefined){$f={$blk:AZ.ptr.prototype.Send};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AZ.prototype.Send=function(b){return this.$val.Send(b);};AZ.ptr.prototype.send=function(b){var b,c;c=this;c.sendBuffer=$append(c.sendBuffer,b);$go((function $b(){var d,$r;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;d=$f.d;$r=$f.$r;}d=$select([[c.sendNotify,new CG.ptr()],[]]);if(d[0]===0){}else if(d[0]===1){}if($f===undefined){$f={$blk:$b};}$f.d=d;$f.$r=$r;return $f;}),[]);return;};AZ.prototype.send=function(b){return this.$val.send(b);};AZ.ptr.prototype.sendAck=function(){var b;b=this;b.sendEventAck=true;$go((function $b(){var c,$r;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;c=$f.c;$r=$f.$r;}c=$select([[b.sendNotify,new CG.ptr()],[]]);if(c[0]===0){}else if(c[0]===1){}if($f===undefined){$f={$blk:$b};}$f.c=c;$f.$r=$r;return $f;}),[]);};AZ.prototype.sendAck=function(){return this.$val.sendAck();};AZ.ptr.prototype.discover=function(){var b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=[b];c=[c];c[0]=this;$r=c[0].mutex.Lock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([(function(b,c){return function $b(){var d,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;d=$f.d;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:d=c[0].closed;$r=c[0].mutex.Unlock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(d&&!(c[0].OnClose===$throwNilPointerError)){$s=2;continue;}$s=3;continue;case 2:$r=c[0].OnClose();$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 3:$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.d=d;$f.$s=$s;$f.$r=$r;return $f;};})(b,c),[]]);$r=c[0].log(new BT([new $String("starting")]));$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(c[0],"log"),[new BT([new $String("stopped")])]]);$deferred.push([$methodVal(c[0],"connState"),["disconnected"]]);b[0]=new N.ptr(0);case 3:if(!(c[0].running)){$s=4;continue;}d=[d];$r=c[0].connState("connecting");$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}e="https://"+H(c[0].Address)+"/v2/endpoint";f=AF(e,c[0].Header);g=f[0];h=f[1];if(!($interfaceIsEqual(h,$ifaceNil))){$panic(h);}$r=c[0].mutex.Unlock();$s=6;case 6:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}j=AA(g,AL(new BC(0,7000),0.1));$s=7;case 7:if($c){$c=false;j=j.$blk();}if(j&&j.$blk!==undefined){break s;}k=$select([[j],[c[0].closeNotify]]);$s=8;case 8:if($c){$c=false;k=k.$blk();}if(k&&k.$blk!==undefined){break s;}i=k;if(i[0]===0){$s=9;continue;}if(i[0]===1){$s=10;continue;}$s=11;continue;case 9:l=$clone(i[1][0],AH);$r=c[0].mutex.Lock();$s=12;case 12:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}m=BU.nil;n=l.err;if($interfaceIsEqual(n,$ifaceNil)){$s=13;continue;}$s=14;continue;case 13:d[0]=false;o=AP(l.data,(d.$ptr||(d.$ptr=new CA(function(){return this.$target[0];},function($v){this.$target[0]=$v;},d))));$s=15;case 15:if($c){$c=false;o=o.$blk();}if(o&&o.$blk!==undefined){break s;}n=o;if($interfaceIsEqual(n,$ifaceNil)){p=I(d[0]);m=p[0];n=p[1];}case 14:if($interfaceIsEqual(n,$ifaceNil)){$s=16;continue;}$s=17;continue;case 16:$r=c[0].log(new BT([new $String("endpoint discovered")]));$s=19;case 19:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(BK&&!c[0].forceLongPoll){$s=20;continue;}$s=21;continue;case 20:q=c[0].connect(BP,m,b[0]);$s=24;case 24:if($c){$c=false;q=q.$blk();}if(q&&q.$blk!==undefined){break s;}if(q){$s=22;continue;}$s=23;continue;case 22:$s=3;continue;case 23:case 21:if(!c[0].DisableLongPoll){$s=25;continue;}$s=26;continue;case 25:r=c[0].connect(AS,m,b[0]);$s=27;case 27:if($c){$c=false;r=r.$blk();}if(r&&r.$blk!==undefined){break s;}r;case 26:$s=18;continue;case 17:$r=c[0].log(new BT([new $String("endpoint discovery:"),n]));$s=28;case 28:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 18:$s=11;continue;case 10:$r=c[0].mutex.Lock();$s=29;case 29:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 11:s=c[0].backOff(b[0]);$s=32;case 32:if($c){$c=false;s=s.$blk();}if(s&&s.$blk!==undefined){break s;}if(!s){$s=30;continue;}$s=31;continue;case 30:$s=-1;return;case 31:$s=3;continue;case 4:$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AZ.ptr.prototype.discover};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AZ.prototype.discover=function(){return this.$val.discover();};AZ.ptr.prototype.connect=function(b,c,d){var b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:e=false;f=this;g=0;case 1:if(!(g<2)){$s=2;continue;}h=c;i=0;case 3:if(!(i<h.$length)){$s=4;continue;}j=((i<0||i>=h.$length)?($throwRuntimeError("index out of range"),undefined):h.$array[h.$offset+i]);$r=f.connState("connecting");$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}k=f.Address;l=0;while(true){if(!(l<k.length)){break;}m=$decodeRune(k,l);n=l;o=m[0];if(o===47){j=j+($substring(f.Address,n));break;}l+=m[1];}q=b(f,j);$s=6;case 6:if($c){$c=false;q=q.$blk();}if(q&&q.$blk!==undefined){break s;}p=q;r=p[0];s=p[1];if(r){e=true;}if(s){d.success();$s=-1;return e;}if(!f.running){$s=-1;return e;}t=f.backOff(d);$s=9;case 9:if($c){$c=false;t=t.$blk();}if(t&&t.$blk!==undefined){break s;}if(!t){$s=7;continue;}$s=8;continue;case 7:$s=-1;return e;case 8:i++;$s=3;continue;case 4:g=g+(1)>>0;$s=1;continue;case 2:$s=-1;return e;}return;}if($f===undefined){$f={$blk:AZ.ptr.prototype.connect};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.$s=$s;$f.$r=$r;return $f;};AZ.prototype.connect=function(b,c,d){return this.$val.connect(b,c,d);};AZ.ptr.prototype.backOff=function(b){var b,c,d,e,f,g,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);c=false;d=this;e=b.failure(new BC(0,60000));if((e.$high===0&&e.$low===0)){c=true;$s=-1;return c;}$r=d.connState("disconnected");$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=d.log(new BT([new $String("sleeping")]));$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=d.mutex.Unlock();$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(d.mutex,"Lock"),[]]);g=$select([[BI(e).C],[d.closeNotify]]);$s=4;case 4:if($c){$c=false;g=g.$blk();}if(g&&g.$blk!==undefined){break s;}f=g;if(f[0]===0){c=true;}else if(f[0]===1){}$s=-1;return c;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return c;}if($curGoroutine.asleep){if($f===undefined){$f={$blk:AZ.ptr.prototype.backOff};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AZ.prototype.backOff=function(b){return this.$val.backOff(b);};AZ.ptr.prototype.canLogin=function(){var b,c,d,e,f,g,h,i;b=this;if(!($interfaceIsEqual((c=b.sessionParams[$String.keyFor("access_key")],c!==undefined?c.v:$ifaceNil),$ifaceNil))){return true;}if(!($interfaceIsEqual((d=b.sessionParams[$String.keyFor("user_id")],d!==undefined?d.v:$ifaceNil),$ifaceNil))){return!($interfaceIsEqual((e=b.sessionParams[$String.keyFor("user_auth")],e!==undefined?e.v:$ifaceNil),$ifaceNil))||!($interfaceIsEqual((f=b.sessionParams[$String.keyFor("master_sign")],f!==undefined?f.v:$ifaceNil),$ifaceNil));}return!($interfaceIsEqual((g=b.sessionParams[$String.keyFor("identity_type")],g!==undefined?g.v:$ifaceNil),$ifaceNil))&&!($interfaceIsEqual((h=b.sessionParams[$String.keyFor("identity_name")],h!==undefined?h.v:$ifaceNil),$ifaceNil))&&!($interfaceIsEqual((i=b.sessionParams[$String.keyFor("identity_auth")],i!==undefined?i.v:$ifaceNil),$ifaceNil));};AZ.prototype.canLogin=function(){return this.$val.canLogin();};AZ.ptr.prototype.makeCreateSessionAction=function(){var aa,ab,ac,ad,ae,af,ag,ah,ai,aj,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z;b=false;c=this;b=$makeMap($String.keyFor,[{k:"action",v:new $String("create_session")}]);e=(d=c.sessionParams[$String.keyFor("user_id")],d!==undefined?d.v:$ifaceNil);if($interfaceIsEqual(e,$ifaceNil)){f=c.sessionParams;g=0;h=$keys(f);while(true){if(!(g<h.length)){break;}i=f[h[g]];if(i===undefined){g++;continue;}j=i.k;k=i.v;l=j;(b||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(l)]={k:l,v:k};g++;}}else{n=(m=c.sessionParams[$String.keyFor("user_auth")],m!==undefined?m.v:$ifaceNil);if(!($interfaceIsEqual(n,$ifaceNil))){o="user_id";(b||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(o)]={k:o,v:e};p="user_auth";(b||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(p)]={k:p,v:n};}else{r=(q=c.sessionParams[$String.keyFor("master_sign")],q!==undefined?q.v:$ifaceNil);if(!($interfaceIsEqual(r,$ifaceNil))){s="user_id";(b||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(s)]={k:s,v:e};t="master_sign";(b||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(t)]={k:t,v:r};}else{v=(u=c.sessionParams[$String.keyFor("identity_type")],u!==undefined?u.v:$ifaceNil);if(!($interfaceIsEqual(v,$ifaceNil))){w="identity_type";(b||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(w)]={k:w,v:v};x="identity_name";(b||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(x)]={k:x,v:(y=c.sessionParams[$String.keyFor("identity_name")],y!==undefined?y.v:$ifaceNil)};z="identity_auth";(b||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(z)]={k:z,v:(aa=c.sessionParams[$String.keyFor("identity_auth")],aa!==undefined?aa.v:$ifaceNil)};}else{ab="user_id";(b||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(ab)]={k:ab,v:e};}}}ac=c.sessionParams;ad=0;ae=$keys(ac);while(true){if(!(ad<ae.length)){break;}af=ac[ae[ad]];if(af===undefined){ad++;continue;}ag=af.k;ah=af.v;ai=ag;if(ai===("user_id")||ai===("user_auth")||ai===("identity_type")||ai===("identity_name")||ai===("identity_auth")||ai===("access_key")||ai===("master_sign")){}else{aj=ag;(b||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(aj)]={k:aj,v:ah};}ad++;}}return b;};AZ.prototype.makeCreateSessionAction=function(){return this.$val.makeCreateSessionAction();};AZ.ptr.prototype.makeResumeSessionAction=function(b){var b,c,d,e;c=false;d=this;c=$makeMap($String.keyFor,[{k:"action",v:new $String("resume_session")},{k:"event_id",v:d.receivedEventId}]);if(b){e="session_id";(c||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(e)]={k:e,v:d.sessionId};}d.sendEventAck=false;d.ackedEventId=d.receivedEventId;return c;};AZ.prototype.makeResumeSessionAction=function(b){return this.$val.makeResumeSessionAction(b);};AZ.ptr.prototype.handleSessionEvent=function(b){var b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;v=$f.v;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=false;d=this;e=new K.ptr(b,BW.nil,false);f=false;if(e.String()==="error"){d.sessionId=$ifaceNil;f=true;g=e.Str("error_type");h=g[0];i=h;if(i===("internal")){}else{d.running=false;}}$r=d.deliverSessionEvent(e);$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(f){$s=-1;return c;}delete d.sessionParams[$String.keyFor("user_attrs")];delete d.sessionParams[$String.keyFor("user_settings")];delete d.sessionParams[$String.keyFor("identity_attrs")];delete d.sessionParams[$String.keyFor("access_key")];delete d.sessionParams[$String.keyFor("master_sign")];j="user_id";(d.sessionParams||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(j)]={k:j,v:(k=e.Params[$String.keyFor("user_id")],k!==undefined?k.v:$ifaceNil)};m=(l=e.Params[$String.keyFor("user_auth")],l!==undefined?l.v:$ifaceNil);if(!($interfaceIsEqual(m,$ifaceNil))){n="user_auth";(d.sessionParams||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(n)]={k:n,v:m};}o=new BU(["identity_type","identity_name","identity_auth"]);p=0;while(true){if(!(p<o.$length)){break;}q=((p<0||p>=o.$length)?($throwRuntimeError("index out of range"),undefined):o.$array[o.$offset+p]);s=(r=d.sessionParams[$String.keyFor(q+"_new")],r!==undefined?r.v:$ifaceNil);if(!($interfaceIsEqual(s,$ifaceNil))){delete d.sessionParams[$String.keyFor(q+"_new")];t=q;(d.sessionParams||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(t)]={k:t,v:s};}p++;}d.sessionId=(u=e.Params[$String.keyFor("session_id")],u!==undefined?u.v:$ifaceNil);if(d.sendBuffer.$length===0){d.lastActionId=new $Int64(0,0);}d.sendEventAck=false;v=e.Int64("event_id");d.receivedEventId=v[0];d.ackedEventId=new $Int64(0,0);$r=d.log(new BT([new $String("session created")]));$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}c=true;$s=-1;return c;}return;}if($f===undefined){$f={$blk:AZ.ptr.prototype.handleSessionEvent};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.v=v;$f.$s=$s;$f.$r=$r;return $f;};AZ.prototype.handleSessionEvent=function(b){return this.$val.handleSessionEvent(b);};AZ.ptr.prototype.handleEvent=function(b){var b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;v=$f.v;w=$f.w;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=[c];d=[d];c[0]=new $Int64(0,0);e=false;f=false;g=false;d[0]=this;h=b.Int64("event_id");i=h[0];if((i.$high>0||(i.$high===0&&i.$low>0))){d[0].receivedEventId=i;if(!d[0].sendEventAck){if((j=(k=d[0].receivedEventId,l=d[0].ackedEventId,new $Int64(k.$high-l.$high,k.$low-l.$low)),(j.$high>AY.$high||(j.$high===AY.$high&&j.$low>=AY.$low)))){d[0].sendAck();}else{f=true;}}}m=b.Int64("action_id");c[0]=m[0];if((c[0].$high>0||(c[0].$high===0&&c[0].$low>0))){$s=1;continue;}$s=2;continue;case 1:n=E.Search(d[0].numSent,(function(c,d){return function(n){var n,o,p,q;p=(o=d[0].sendBuffer,((n<0||n>=o.$length)?($throwRuntimeError("index out of range"),undefined):o.$array[o.$offset+n]));return(q=p.id,(q.$high>c[0].$high||(q.$high===c[0].$high&&q.$low>=c[0].$low)));};})(c,d));$s=3;case 3:if($c){$c=false;n=n.$blk();}if(n&&n.$blk!==undefined){break s;}o=n;if(o<d[0].numSent){$s=4;continue;}$s=5;continue;case 4:q=(p=d[0].sendBuffer,((o<0||o>=p.$length)?($throwRuntimeError("index out of range"),undefined):p.$array[p.$offset+o]));if((r=q.id,(r.$high===c[0].$high&&r.$low===c[0].$low))){$s=6;continue;}$s=7;continue;case 6:b.initLastReply(q);if(!(q.OnReply===$throwNilPointerError)){$s=8;continue;}$s=9;continue;case 8:$r=d[0].deliverReply(q,b);$s=10;case 10:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 9:if(b.LastReply){d[0].sendBuffer=$appendSlice($subslice(d[0].sendBuffer,0,o),$subslice(d[0].sendBuffer,(o+1>>0)));d[0].numSent=d[0].numSent-(1)>>0;}case 7:case 5:case 2:if(b.String()==="user_deleted"){$s=11;continue;}$s=12;continue;case 11:d[0].sessionId=$ifaceNil;d[0].running=false;$r=d[0].deliverSessionEvent(b);$s=13;case 13:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}e=true;$s=-1;return[c[0],e,f,g];case 12:s=b.getError();t=s[0];u=s[1];v=s[2];e=s[3];w=s[4];if(!($interfaceIsEqual(w,$ifaceNil))){$s=14;continue;}$s=15;continue;case 14:$r=d[0].log(new BT([new $String("event:"),w]));$s=16;case 16:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(v){delete d[0].sessionParams[$String.keyFor("user_auth")];}if(e){$s=17;continue;}$s=18;continue;case 17:d[0].sessionId=$ifaceNil;if(!d[0].canLogin()){$s=19;continue;}$s=20;continue;case 19:d[0].running=false;$r=d[0].deliverSessionEvent(b);$s=21;case 21:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 20:case 18:$s=-1;return[c[0],e,f,g];case 15:if(t==="deprecated"){$s=22;continue;}$s=23;continue;case 22:$r=d[0].log(new BT([new $String("deprecated:"),new $String(u)]));$s=24;case 24:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 23:$r=d[0].deliverEvent(b);$s=25;case 25:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}g=true;$s=-1;return[c[0],e,f,g];}return;}if($f===undefined){$f={$blk:AZ.ptr.prototype.handleEvent};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.v=v;$f.w=w;$f.$s=$s;$f.$r=$r;return $f;};AZ.prototype.handleEvent=function(b){return this.$val.handleEvent(b);};AZ.ptr.prototype.deliverSessionEvent=function(b){var b,c,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);c=this;$r=c.mutex.Unlock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(c.mutex,"Lock"),[]]);$r=c.OnSessionEvent(b);$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AZ.ptr.prototype.deliverSessionEvent};}$f.b=b;$f.c=c;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AZ.prototype.deliverSessionEvent=function(b){return this.$val.deliverSessionEvent(b);};AZ.ptr.prototype.deliverEvent=function(b){var b,c,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);c=this;$r=c.mutex.Unlock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(c.mutex,"Lock"),[]]);$r=c.OnEvent(b);$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AZ.ptr.prototype.deliverEvent};}$f.b=b;$f.c=c;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AZ.prototype.deliverEvent=function(b){return this.$val.deliverEvent(b);};AZ.ptr.prototype.deliverReply=function(b,c){var b,c,d,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);d=this;$r=d.mutex.Unlock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(d.mutex,"Lock"),[]]);$r=b.OnReply(c);$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AZ.ptr.prototype.deliverReply};}$f.b=b;$f.c=c;$f.d=d;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AZ.prototype.deliverReply=function(b,c){return this.$val.deliverReply(b,c);};AZ.ptr.prototype.connState=function(b){var b,c,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);c=this;if(c.latestConnState===b){$s=-1;return;}c.latestConnState=b;if(c.OnConnState===$throwNilPointerError){$s=-1;return;}$r=c.mutex.Unlock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(c.mutex,"Lock"),[]]);$r=c.OnConnState(b);$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AZ.ptr.prototype.connState};}$f.b=b;$f.c=c;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AZ.prototype.connState=function(b){return this.$val.connState(b);};AZ.ptr.prototype.connActive=function(){var b,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=this;if(b.OnConnActive===$throwNilPointerError){$s=-1;return;}$r=b.mutex.Unlock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(b.mutex,"Lock"),[]]);$r=b.OnConnActive();$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AZ.ptr.prototype.connActive};}$f.b=b;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AZ.prototype.connActive=function(){return this.$val.connActive();};AZ.ptr.prototype.log=function(b){var b,c,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);c=this;if(c.OnLog===$throwNilPointerError){$s=-1;return;}$r=c.mutex.Unlock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(c.mutex,"Lock"),[]]);$r=c.OnLog(b);$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AZ.ptr.prototype.log};}$f.b=b;$f.c=c;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AZ.prototype.log=function(b){return this.$val.log(b);};BB.ptr.prototype.setWebSocket=function(b){var b;};BB.prototype.setWebSocket=function(b){return this.$val.setWebSocket(b);};BB.ptr.prototype.webSocketDisconnected=function(){};BB.prototype.webSocketDisconnected=function(){return this.$val.webSocketDisconnected();};BB.ptr.prototype.shouldAbortConn=function(){return false;};BB.prototype.shouldAbortConn=function(){return this.$val.shouldAbortConn();};AZ.ptr.prototype.closeWebSocket=function(b){var b;b.close();};AZ.prototype.closeWebSocket=function(b){return this.$val.closeWebSocket(b);};BE=function(){var b;return((b=$internalize(new($global.Date)().getTime(),$Int64),new BD(b.$high,b.$low)));};BF=function(b,c){var b,c,d;return(d=(new BD(c.$high,c.$low)),new BD(b.$high+d.$high,b.$low+d.$low));};BG=function(b,c){var b,c,d;return((d=new BD(b.$high-c.$high,b.$low-c.$low),new BC(d.$high,d.$low)));};BI=function(b){var b,c;c=CJ.nil;c=new BH.ptr(new $Chan(CG,0),null);if((b.$high>0||(b.$high===0&&b.$low>=0))){c.Reset(b);}return c;};BH.ptr.prototype.Active=function(){var b;b=this;return!(b.id===null);};BH.prototype.Active=function(){return this.$val.Active();};BH.ptr.prototype.Reset=function(b){var b,c;c=this;c.Stop();c.id=$global.setTimeout($externalize((function(){c.id=null;$go((function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=$send(c.C,$clone(new CG.ptr(),CG));$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;}),[]);}),CD),$externalize(b,BC));};BH.prototype.Reset=function(b){return this.$val.Reset(b);};BH.ptr.prototype.Stop=function(){var b;b=this;if(!(b.id===null)){$global.clearTimeout(b.id);b.id=null;}};BH.prototype.Stop=function(){return this.$val.Stop();};BL=function(){BJ=$global.WebSocket;if(BJ===undefined){BJ=$module.require($externalize("ws",$String));}BK=!(BJ===undefined)&&!(BJ.CLOSING===undefined);};BM=function(b){var b,c,d,e,f;c=(d=b[$String.keyFor("X-User-Agent")],d!==undefined?[d.v,true]:[BU.nil,false]);e=c[0];f=c[1];if(f&&e.$length>0){return(0>=e.$length?($throwRuntimeError("index out of range"),undefined):e.$array[e.$offset+0]);}return $pkg.DefaultUserAgent;};BO=function(b,c,d){var b,c,d,e,f,g,h,i;e=CK.nil;e=new BN.ptr(new $Chan(CG,1),false,$ifaceNil,new(BJ)($externalize(b,$String)),false,CL.nil,BM(c));e.impl.binaryType=$externalize("arraybuffer",$String);f=false;g=(function(){if(!f){f=true;$go((function(){$close(e.notify);}),[]);}});h=$global.setTimeout($externalize((function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:e.err=A.New("timeout");$r=g();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;}),CD),$externalize(d,BC));i=(function(){if(!(h===null)){$global.clearTimeout(h);h=null;}});e.impl.onopen=$externalize((function $b(j){var j,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;j=$f.j;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=i();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!($interfaceIsEqual(e.err,$ifaceNil))){e.impl.close();$s=-1;return;}e.open=true;$go((function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:if(!f){$s=1;continue;}$s=2;continue;case 1:$r=$send(e.notify,$clone(new CG.ptr(),CG));$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 2:$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;}),[]);$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.j=j;$f.$s=$s;$f.$r=$r;return $f;}),CM);e.impl.onmessage=$externalize((function(j){var j;e.buf=$append(e.buf,j.data);$go((function $b(){var k,$r;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;k=$f.k;$r=$f.$r;}if(!f){k=$select([[e.notify,new CG.ptr()],[]]);if(k[0]===0){}else if(k[0]===1){}}if($f===undefined){$f={$blk:$b};}$f.k=k;$f.$r=$r;return $f;}),[]);}),CM);e.impl.onclose=$externalize((function $b(j){var j,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;j=$f.j;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:e.goingAway=(($parseInt(j.code)>>0)===1001);e.open=false;$r=g();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.j=j;$f.$s=$s;$f.$r=$r;return $f;}),CM);e.impl.onerror=$externalize((function $b(j){var j,k,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;j=$f.j;k=$f.k;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=i();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if($interfaceIsEqual(e.err,$ifaceNil)){k=j.message;if(!(k===undefined)){e.err=A.New("websocket onerror: message: "+$internalize(k,$String));}else{e.err=A.New("websocket onerror: "+$internalize(j,$String));}}$r=g();$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.j=j;$f.k=k;$f.$s=$s;$f.$r=$r;return $f;}),CM);return e;};BN.ptr.prototype.sendInitialJSON=function(b){var b,c,d,e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=this;if(!(c.client==="")){d="client";(b||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(d)]={k:d,v:new $String(c.client)};}e=c.sendJSON(b);$s=1;case 1:if($c){$c=false;e=e.$blk();}if(e&&e.$blk!==undefined){break s;}$s=-1;return e;}return;}if($f===undefined){$f={$blk:BN.ptr.prototype.sendInitialJSON};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};BN.prototype.sendInitialJSON=function(b){return this.$val.sendInitialJSON(b);};BN.ptr.prototype.send=function(b){var b,c,d,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);c=[c];c[0]=$ifaceNil;d=this;$deferred.push([(function(c){return function $b(){var e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:e=W("websocket send",$recover());$s=1;case 1:if($c){$c=false;e=e.$blk();}if(e&&e.$blk!==undefined){break s;}c[0]=e;$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};})(c),[]]);d.impl.send(b);$s=-1;return c[0];}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return c[0];}if($curGoroutine.asleep){if($f===undefined){$f={$blk:BN.ptr.prototype.send};}$f.b=b;$f.c=c;$f.d=d;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};BN.prototype.send=function(b){return this.$val.send(b);};BN.ptr.prototype.sendJSON=function(b){var b,c,d,e,f,g,h,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=$ifaceNil;d=this;f=AN(b);$s=1;case 1:if($c){$c=false;f=f.$blk();}if(f&&f.$blk!==undefined){break s;}e=f;g=e[0];c=e[1];if(!($interfaceIsEqual(c,$ifaceNil))){$s=-1;return c;}h=d.send(g);$s=2;case 2:if($c){$c=false;h=h.$blk();}if(h&&h.$blk!==undefined){break s;}c=h;$s=-1;return c;}return;}if($f===undefined){$f={$blk:BN.ptr.prototype.sendJSON};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.$s=$s;$f.$r=$r;return $f;};BN.prototype.sendJSON=function(b){return this.$val.sendJSON(b);};BN.ptr.prototype.sendPayload=function(b){var b,c,d,e,f,g,h,i,j,k,l,m,n,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);c=[c];c[0]=$ifaceNil;d=this;$deferred.push([(function(c){return function $b(){var e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:e=W("websocket send payload",$recover());$s=1;case 1:if($c){$c=false;e=e.$blk();}if(e&&e.$blk!==undefined){break s;}c[0]=e;$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};})(c),[]]);e=b.String()==="update_user";f=b.Payload;g=0;while(true){if(!(g<f.$length)){break;}h=((g<0||g>=f.$length)?($throwRuntimeError("index out of range"),undefined):f.$array[f.$offset+g]);i=h;if(e){j=i.split($externalize(",",$String))[1];k=$global.atob(j);l=$parseInt(k.length);i=new($global.ArrayBuffer)(l);m=new($global.Uint8Array)(i);n=0;while(true){if(!(n<l)){break;}m[n]=k.charCodeAt(n);n=n+(1)>>0;}}d.impl.send(i);g++;}$s=-1;return c[0];}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return c[0];}if($curGoroutine.asleep){if($f===undefined){$f={$blk:BN.ptr.prototype.sendPayload};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};BN.prototype.sendPayload=function(b){return this.$val.sendPayload(b);};BN.ptr.prototype.receive=function(){var b,c,d;b=null;c=this;if(c.buf.$length>0){b=(d=c.buf,(0>=d.$length?($throwRuntimeError("index out of range"),undefined):d.$array[d.$offset+0]));c.buf=$subslice(c.buf,1);}return b;};BN.prototype.receive=function(){return this.$val.receive();};BN.ptr.prototype.receiveJSON=function(){var b,c,d,e,f,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=[b];b[0]=false;c=$ifaceNil;d=this;e=d.receive();if(e===null){$s=-1;return[b[0],c];}f=AP(T(e),(b.$ptr||(b.$ptr=new CA(function(){return this.$target[0];},function($v){this.$target[0]=$v;},b))));$s=1;case 1:if($c){$c=false;f=f.$blk();}if(f&&f.$blk!==undefined){break s;}c=f;$s=-1;return[b[0],c];}return;}if($f===undefined){$f={$blk:BN.ptr.prototype.receiveJSON};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.$s=$s;$f.$r=$r;return $f;};BN.prototype.receiveJSON=function(){return this.$val.receiveJSON();};BN.ptr.prototype.close=function(){var b,$deferred;var $err=null;try{$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=this;$deferred.push([(function(){$recover();}),[]]);b.impl.close();}catch(err){$err=err;}finally{$callDeferred($deferred,$err);}};BN.prototype.close=function(){return this.$val.close();};BP=function(b,c){var b,c,d,e,f,g,h,i,j,k,l,m,n,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);d=[d];e=false;f=false;d[0]=CK.nil;$deferred.push([(function(d){return function(){if(!(d[0]===CK.nil)){d[0].close();}};})(d),[]]);case 1:f=false;g=false;$r=b.log(new BT([new $String("connecting to"),new $String(c)]));$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}d[0]=BO("wss://"+c+"/v2/socket",b.Header,AL(new BC(0,9000),0.1));b.test.setWebSocket(d[0]);$r=b.mutex.Unlock();$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}i=$select([[d[0].notify],[b.closeNotify]]);$s=5;case 5:if($c){$c=false;i=i.$blk();}if(i&&i.$blk!==undefined){break s;}h=i;if(h[0]===0){$s=6;continue;}if(h[0]===1){$s=7;continue;}$s=8;continue;case 6:j=h[1];k=j[1];$r=b.mutex.Lock();$s=9;case 9:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(k){$s=10;continue;}if(!($interfaceIsEqual(d[0].err,$ifaceNil))){$s=11;continue;}$s=12;continue;case 10:$r=b.connState("connected");$s=14;case 14:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}e=true;m=BQ(b,d[0]);$s=15;case 15:if($c){$c=false;m=m.$blk();}if(m&&m.$blk!==undefined){break s;}l=m;f=l[0];g=l[1];$s=13;continue;case 11:$r=b.log(new BT([new $String("connection failed:"),d[0].err]));$s=16;case 16:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=13;continue;case 12:$r=b.log(new BT([new $String("connection failed")]));$s=17;case 17:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 13:$s=8;continue;case 7:$r=b.mutex.Lock();$s=18;case 18:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 8:n=d[0].goingAway;b.closeWebSocket(d[0]);d[0]=CK.nil;if(n){$s=19;continue;}$s=20;continue;case 19:$r=b.log(new BT([new $String("disconnected (server is going away)")]));$s=22;case 22:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=21;continue;case 20:$r=b.log(new BT([new $String("disconnected")]));$s=23;case 23:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 21:b.test.webSocketDisconnected();if(!f||!g||!b.running||n){$s=-1;return[e,f];}$s=1;continue;case 2:$s=-1;return[e,f];}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return[e,f];}if($curGoroutine.asleep){if($f===undefined){$f={$blk:BP};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};BQ=function(b,c){var b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;v=$f.v;w=$f.w;x=$f.x;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=[b];c=[c];d=[d];e=[e];f=false;g=false;h=false;if($interfaceIsEqual(b[0].sessionId,$ifaceNil)){$s=1;continue;}$s=2;continue;case 1:$r=b[0].log(new BT([new $String("session creation")]));$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}h=b[0].makeCreateSessionAction();$s=3;continue;case 2:$r=b[0].log(new BT([new $String("session resumption")]));$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}h=b[0].makeResumeSessionAction(true);case 3:i=c[0].sendInitialJSON(h);$s=6;case 6:if($c){$c=false;i=i.$blk();}if(i&&i.$blk!==undefined){break s;}j=i;if(!($interfaceIsEqual(j,$ifaceNil))){$s=7;continue;}$s=8;continue;case 7:$r=b[0].log(new BT([new $String("send:"),j]));$s=9;case 9:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 8:if($interfaceIsEqual(b[0].sessionId,$ifaceNil)){$s=10;continue;}$s=11;continue;case 10:k=false;l=true;m=BI(AL(new BC(0,37000),0.2));case 12:n=$ifaceNil;p=c[0].receiveJSON();$s=14;case 14:if($c){$c=false;p=p.$blk();}if(p&&p.$blk!==undefined){break s;}o=p;k=o[0];n=o[1];if(!($interfaceIsEqual(n,$ifaceNil))){$s=15;continue;}$s=16;continue;case 15:$r=b[0].log(new BT([new $String("session creation:"),n]));$s=17;case 17:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[f,g];case 16:if(!(k===false)){m.Stop();$s=13;continue;}if(!l){$s=18;continue;}$s=19;continue;case 18:$r=b[0].log(new BT([new $String("disconnected during session creation:"),c[0].err]));$s=20;case 20:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}m.Stop();$s=-1;return[f,g];case 19:$r=b[0].mutex.Unlock();$s=21;case 21:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}r=$select([[c[0].notify],[m.C]]);$s=22;case 22:if($c){$c=false;r=r.$blk();}if(r&&r.$blk!==undefined){break s;}q=r;if(q[0]===0){$s=23;continue;}if(q[0]===1){$s=24;continue;}$s=25;continue;case 23:s=q[1];l=s[1];$r=b[0].mutex.Lock();$s=26;case 26:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=25;continue;case 24:$r=b[0].mutex.Lock();$s=27;case 27:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=b[0].log(new BT([new $String("session creation timeout")]));$s=28;case 28:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[f,g];case 25:$s=12;continue;case 13:t=b[0].handleSessionEvent(k);$s=31;case 31:if($c){$c=false;t=t.$blk();}if(t&&t.$blk!==undefined){break s;}if(!t){$s=29;continue;}$s=30;continue;case 29:$s=-1;return[f,g];case 30:f=true;g=true;$r=b[0].connActive();$s=32;case 32:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 11:e[0]=new $Chan(CG,2);d[0]=new $Chan(CG,0);$go((function(b,c,d,e){return function $b(){var u,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;u=$f.u;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);$deferred.push([function(u){$close(u);},[d[0]]]);$r=b[0].mutex.Lock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(b[0].mutex,"Unlock"),[]]);$r=BR(b[0],c[0],e[0]);$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:$b};}$f.u=u;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};})(b,c,d,e),[]);v=BS(b[0],c[0],e[0]);$s=33;case 33:if($c){$c=false;v=v.$blk();}if(v&&v.$blk!==undefined){break s;}u=v;w=u[0];g=u[1];if(w){f=true;}$r=b[0].mutex.Unlock();$s=34;case 34:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(b[0].mutex,"Lock"),[]]);x=$recv(d[0]);$s=35;case 35:if($c){$c=false;x=x.$blk();}if(x&&x.$blk!==undefined){break s;}x[0];$s=-1;return[f,g];}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return[f,g];}if($curGoroutine.asleep){if($f===undefined){$f={$blk:BQ};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.v=v;$f.w=w;$f.x=x;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};BR=function(b,c,d){var aa,ab,ac,ad,ae,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;aa=$f.aa;ab=$f.ab;ac=$f.ac;ad=$f.ad;ae=$f.ae;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;v=$f.v;w=$f.w;x=$f.x;y=$f.y;z=$f.z;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);e=BI(AL(new BC(0,56000),-0.3));$deferred.push([$methodVal(e,"Stop"),[]]);b.numSent=0;case 1:if(b.test.shouldAbortConn()){$s=3;continue;}$s=4;continue;case 3:$r=b.log(new BT([new $String("abort send")]));$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(d,$clone(new CG.ptr(),CG));$s=6;case 6:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 4:case 7:if(!(b.numSent<b.sendBuffer.$length)){$s=8;continue;}h=(f=b.sendBuffer,g=b.numSent,((g<0||g>=f.$length)?($throwRuntimeError("index out of range"),undefined):f.$array[f.$offset+g]));if(!(h.Payload===BW.nil)){i="frames";(h.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(i)]={k:i,v:new $Int(h.Payload.$length)};}if(!((j=b.receivedEventId,k=b.ackedEventId,(j.$high===k.$high&&j.$low===k.$low)))){l="event_id";(h.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(l)]={k:l,v:b.receivedEventId};b.sendEventAck=false;b.ackedEventId=b.receivedEventId;}m=c.sendJSON(h.Params);$s=9;case 9:if($c){$c=false;m=m.$blk();}if(m&&m.$blk!==undefined){break s;}n=m;delete h.Params[$String.keyFor("frames")];delete h.Params[$String.keyFor("event_id")];if(!($interfaceIsEqual(n,$ifaceNil))){$s=10;continue;}$s=11;continue;case 10:$r=b.log(new BT([new $String("send:"),n]));$s=12;case 12:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(d,$clone(new CG.ptr(),CG));$s=13;case 13:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 11:if(!(h.Payload===BW.nil)){$s=14;continue;}$s=15;continue;case 14:o=c.sendPayload(h);$s=16;case 16:if($c){$c=false;o=o.$blk();}if(o&&o.$blk!==undefined){break s;}p=o;if(!($interfaceIsEqual(p,$ifaceNil))){$s=17;continue;}$s=18;continue;case 17:$r=b.log(new BT([new $String("send:"),p]));$s=19;case 19:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(d,$clone(new CG.ptr(),CG));$s=20;case 20:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 18:case 15:if((q=h.id,(q.$high===0&&q.$low===0))){b.sendBuffer=$appendSlice($subslice(b.sendBuffer,0,b.numSent),$subslice(b.sendBuffer,(b.numSent+1>>0)));}else{b.numSent=b.numSent+(1)>>0;}e.Reset(AL(new BC(0,56000),-0.3));$s=7;continue;case 8:if(b.sendEventAck&&!((r=b.receivedEventId,s=b.ackedEventId,(r.$high===s.$high&&r.$low===s.$low)))){$s=21;continue;}$s=22;continue;case 21:t=b.makeResumeSessionAction(false);u=c.sendJSON(t);$s=23;case 23:if($c){$c=false;u=u.$blk();}if(u&&u.$blk!==undefined){break s;}v=u;if(!($interfaceIsEqual(v,$ifaceNil))){$s=24;continue;}$s=25;continue;case 24:$r=b.log(new BT([new $String("send:"),v]));$s=26;case 26:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(d,$clone(new CG.ptr(),CG));$s=27;case 27:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 25:case 22:$r=b.mutex.Unlock();$s=28;case 28:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}x=$select([[b.sendNotify],[e.C],[d]]);$s=29;case 29:if($c){$c=false;x=x.$blk();}if(x&&x.$blk!==undefined){break s;}w=x;if(w[0]===0){$s=30;continue;}if(w[0]===1){$s=31;continue;}if(w[0]===2){$s=32;continue;}$s=33;continue;case 30:y=w[1];z=y[1];$r=b.mutex.Lock();$s=34;case 34:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!z){$s=35;continue;}$s=36;continue;case 35:aa=$makeMap($String.keyFor,[{k:"action",v:new $String("close_session")}]);ab=c.sendJSON(aa);$s=37;case 37:if($c){$c=false;ab=ab.$blk();}if(ab&&ab.$blk!==undefined){break s;}ac=ab;if(!($interfaceIsEqual(ac,$ifaceNil))){$s=38;continue;}$s=39;continue;case 38:$r=b.log(new BT([new $String("send:"),ac]));$s=40;case 40:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 39:$s=-1;return;case 36:$s=33;continue;case 31:$r=b.mutex.Lock();$s=41;case 41:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}ad=c.send(R());$s=42;case 42:if($c){$c=false;ad=ad.$blk();}if(ad&&ad.$blk!==undefined){break s;}ae=ad;if(!($interfaceIsEqual(ae,$ifaceNil))){$s=43;continue;}$s=44;continue;case 43:$r=b.log(new BT([new $String("send:"),ae]));$s=45;case 45:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(d,$clone(new CG.ptr(),CG));$s=46;case 46:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 44:e.Reset(AL(new BC(0,56000),-0.3));$s=33;continue;case 32:$r=b.mutex.Lock();$s=47;case 47:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 33:$s=1;continue;case 2:$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:BR};}$f.aa=aa;$f.ab=ab;$f.ac=ac;$f.ad=ad;$f.ae=ae;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.v=v;$f.w=w;$f.x=x;$f.y=y;$f.z=z;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};BS=function(b,c,d){var aa,ab,ac,ad,ae,af,ag,ah,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;aa=$f.aa;ab=$f.ab;ac=$f.ac;ad=$f.ad;ae=$f.ae;af=$f.af;ag=$f.ag;ah=$f.ah;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;v=$f.v;w=$f.w;x=$f.x;y=$f.y;z=$f.z;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);e=false;f=false;g=c.notify;h=true;i=BX.nil;j=0;k=BF(BE(),AL(new BC(0,64000),0.3));l=BI(AL(new BC(0,3000),0.4321));$deferred.push([$methodVal(l,"Stop"),[]]);m=BI(new BC(-1,4294967295));$deferred.push([$methodVal(m,"Stop"),[]]);case 1:n=false;case 3:o=[o];if(b.test.shouldAbortConn()){$s=5;continue;}$s=6;continue;case 5:$r=b.log(new BT([new $String("abort receive")]));$s=7;case 7:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(d,$clone(new CG.ptr(),CG));$s=8;case 8:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[e,f];case 6:if(i===BX.nil){$s=9;continue;}$s=10;continue;case 9:p=c.receive();if(p===null){$s=4;continue;}k=BF(BE(),AL(new BC(0,64000),0.7));if(!l.Active()){l.Reset(AL(new BC(0,3000),0.4321));}$r=b.connActive();$s=12;case 12:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}q=T(p);if(S(q)===0){$s=13;continue;}$s=14;continue;case 13:$s=3;continue;case 14:o[0]=false;r=AP(q,(o.$ptr||(o.$ptr=new CA(function(){return this.$target[0];},function($v){this.$target[0]=$v;},o))));$s=15;case 15:if($c){$c=false;r=r.$blk();}if(r&&r.$blk!==undefined){break s;}s=r;if(!($interfaceIsEqual(s,$ifaceNil))){$s=16;continue;}$s=17;continue;case 16:$r=b.log(new BT([new $String("receive:"),s]));$s=18;case 18:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}f=false;$r=$send(d,$clone(new CG.ptr(),CG));$s=19;case 19:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[e,f];case 17:i=new K.ptr(o[0],BW.nil,false);t=i.Int("frames");u=t[0];if(u>0){j=u;}$s=11;continue;case 10:v=c.receive();if(v===null){if(!h){i=BX.nil;j=0;}$s=4;continue;}i.Payload=$append(i.Payload,v);j=j-(1)>>0;case 11:if(j===0){$s=20;continue;}$s=21;continue;case 20:x=b.handleEvent(i);$s=22;case 22:if($c){$c=false;x=x.$blk();}if(x&&x.$blk!==undefined){break s;}w=x;y=w[1];z=w[2];aa=w[3];if(!aa){$s=23;continue;}$s=24;continue;case 23:if(y){e=true;}else{f=false;}$r=$send(d,$clone(new CG.ptr(),CG));$s=25;case 25:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[e,f];case 24:if(z){n=true;}i=BX.nil;j=0;e=true;f=true;case 21:$r=b.mutex.Unlock();$s=26;case 26:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}ab=$select([[b.closeNotify],[d],[]]);if(ab[0]===0){$s=27;continue;}if(ab[0]===1){$s=28;continue;}if(ab[0]===2){$s=29;continue;}$s=30;continue;case 27:$r=b.mutex.Lock();$s=31;case 31:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[e,f];case 28:$r=b.mutex.Lock();$s=32;case 32:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[e,f];case 29:$r=b.mutex.Lock();$s=33;case 33:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 30:$s=3;continue;case 4:if(!h&&i===BX.nil){$s=34;continue;}$s=35;continue;case 34:if(!($interfaceIsEqual(c.err,$ifaceNil))){$s=36;continue;}$s=37;continue;case 36:$r=b.log(new BT([new $String("receive:"),c.err]));$s=39;case 39:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=38;continue;case 37:$r=b.log(new BT([new $String("receive disconnect")]));$s=40;case 40:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 38:$r=$send(d,$clone(new CG.ptr(),CG));$s=41;case 41:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[e,f];case 35:if(n&&!m.Active()){m.Reset(AL(new BC(0,7000),-0.3));}$r=b.mutex.Unlock();$s=42;case 42:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}ad=$select([[g],[l.C],[m.C],[b.closeNotify],[d]]);$s=43;case 43:if($c){$c=false;ad=ad.$blk();}if(ad&&ad.$blk!==undefined){break s;}ac=ad;if(ac[0]===0){$s=44;continue;}if(ac[0]===1){$s=45;continue;}if(ac[0]===2){$s=46;continue;}if(ac[0]===3){$s=47;continue;}if(ac[0]===4){$s=48;continue;}$s=49;continue;case 44:ae=ac[1];h=ae[1];$r=b.mutex.Lock();$s=50;case 50:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!h){g=$chanNil;}$s=49;continue;case 45:$r=b.mutex.Lock();$s=51;case 51:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}af=BG(k,BE());if((af.$high>0||(af.$high===0&&af.$low>16))){$s=52;continue;}$s=53;continue;case 52:l.Reset(af);$s=54;continue;case 53:$r=b.log(new BT([new $String("receive timeout")]));$s=55;case 55:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(d,$clone(new CG.ptr(),CG));$s=56;case 56:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[e,f];case 54:$s=49;continue;case 46:$r=b.mutex.Lock();$s=57;case 57:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!b.sendEventAck&&!((ag=b.ackedEventId,ah=b.receivedEventId,(ag.$high===ah.$high&&ag.$low===ah.$low)))){b.sendAck();}$s=49;continue;case 47:$r=b.mutex.Lock();$s=58;case 58:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[e,f];case 48:$r=b.mutex.Lock();$s=59;case 59:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[e,f];case 49:$s=1;continue;case 2:$s=-1;return[e,f];}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return[e,f];}if($curGoroutine.asleep){if($f===undefined){$f={$blk:BS};}$f.aa=aa;$f.ab=ab;$f.ac=ac;$f.ad=ad;$f.ae=ae;$f.af=af;$f.ag=ag;$f.ah=ah;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.v=v;$f.w=w;$f.x=x;$f.y=y;$f.z=z;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};CH.methods=[{prop:"String",name:"String",pkg:"",typ:$funcType([],[$String],false)},{prop:"GetID",name:"GetID",pkg:"",typ:$funcType([],[$Int64,$error],false)}];BX.methods=[{prop:"Bool",name:"Bool",pkg:"",typ:$funcType([$String],[$Bool],false)},{prop:"Int",name:"Int",pkg:"",typ:$funcType([$String],[$Int,$Bool],false)},{prop:"Int64",name:"Int64",pkg:"",typ:$funcType([$String],[$Int64,$Bool],false)},{prop:"Float64",name:"Float64",pkg:"",typ:$funcType([$String],[$Float64,$Bool],false)},{prop:"Str",name:"Str",pkg:"",typ:$funcType([$String],[$String,$Bool],false)},{prop:"Array",name:"Array",pkg:"",typ:$funcType([$String],[BT,$Bool],false)},{prop:"Map",name:"Map",pkg:"",typ:$funcType([$String],[BV,$Bool],false)},{prop:"String",name:"String",pkg:"",typ:$funcType([],[$String],false)},{prop:"initLastReply",name:"initLastReply",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([CH],[],false)},{prop:"getError",name:"getError",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[$String,$String,$Bool,$Bool,$error],false)}];CO.methods=[{prop:"success",name:"success",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[],false)},{prop:"failure",name:"failure",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BC],[BC],false)}];CP.methods=[{prop:"Call",name:"Call",pkg:"",typ:$funcType([CH],[BY,$error],false)}];CR.methods=[{prop:"SetParams",name:"SetParams",pkg:"",typ:$funcType([BV],[],false)},{prop:"Open",name:"Open",pkg:"",typ:$funcType([],[],false)},{prop:"Close",name:"Close",pkg:"",typ:$funcType([],[],false)},{prop:"Send",name:"Send",pkg:"",typ:$funcType([CH],[$error],false)},{prop:"send",name:"send",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([CH],[],false)},{prop:"sendAck",name:"sendAck",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[],false)},{prop:"discover",name:"discover",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[],false)},{prop:"connect",name:"connect",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BA,BU,CO],[$Bool],false)},{prop:"backOff",name:"backOff",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([CO],[$Bool],false)},{prop:"canLogin",name:"canLogin",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[$Bool],false)},{prop:"makeCreateSessionAction",name:"makeCreateSessionAction",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[BV],false)},{prop:"makeResumeSessionAction",name:"makeResumeSessionAction",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([$Bool],[BV],false)},{prop:"handleSessionEvent",name:"handleSessionEvent",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BV],[$Bool],false)},{prop:"handleEvent",name:"handleEvent",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BX],[$Int64,$Bool,$Bool,$Bool],false)},{prop:"deliverSessionEvent",name:"deliverSessionEvent",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BX],[],false)},{prop:"deliverEvent",name:"deliverEvent",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BX],[],false)},{prop:"deliverReply",name:"deliverReply",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([CH,BX],[],false)},{prop:"connState",name:"connState",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([$String],[],false)},{prop:"connActive",name:"connActive",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[],false)},{prop:"log",name:"log",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BT],[],true)},{prop:"closeWebSocket",name:"closeWebSocket",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([CK],[],false)}];CV.methods=[{prop:"setWebSocket",name:"setWebSocket",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([CK],[],false)},{prop:"webSocketDisconnected",name:"webSocketDisconnected",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[],false)},{prop:"shouldAbortConn",name:"shouldAbortConn",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[$Bool],false)}];CJ.methods=[{prop:"Active",name:"Active",pkg:"",typ:$funcType([],[$Bool],false)},{prop:"Reset",name:"Reset",pkg:"",typ:$funcType([BC],[],false)},{prop:"Stop",name:"Stop",pkg:"",typ:$funcType([],[],false)}];CK.methods=[{prop:"sendInitialJSON",name:"sendInitialJSON",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BV],[$error],false)},{prop:"send",name:"send",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([CE],[$error],false)},{prop:"sendJSON",name:"sendJSON",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BV],[$error],false)},{prop:"sendPayload",name:"sendPayload",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([CH],[$error],false)},{prop:"receive",name:"receive",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[CE],false)},{prop:"receiveJSON",name:"receiveJSON",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[BV,$error],false)},{prop:"close",name:"close",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[],false)}];J.init("github.com/ninchat/ninchat-go",[{prop:"Params",name:"Params",embedded:false,exported:true,typ:BV,tag:""},{prop:"Payload",name:"Payload",embedded:false,exported:true,typ:BW,tag:""},{prop:"OnReply",name:"OnReply",embedded:false,exported:true,typ:CN,tag:""},{prop:"id",name:"id",embedded:false,exported:false,typ:$Int64,tag:""}]);K.init("",[{prop:"Params",name:"Params",embedded:false,exported:true,typ:BV,tag:""},{prop:"Payload",name:"Payload",embedded:false,exported:true,typ:BW,tag:""},{prop:"LastReply",name:"LastReply",embedded:false,exported:true,typ:$Bool,tag:""}]);L.init(B.Object);N.init("github.com/ninchat/ninchat-go",[{prop:"lastSlot",name:"lastSlot",embedded:false,exported:false,typ:$Int,tag:""}]);Q.init("",[{prop:"Header",name:"Header",embedded:false,exported:true,typ:CQ,tag:""},{prop:"Address",name:"Address",embedded:false,exported:true,typ:$String,tag:""}]);AE.init("github.com/ninchat/ninchat-go",[{prop:"Method",name:"Method",embedded:false,exported:true,typ:$String,tag:""},{prop:"URL",name:"URL",embedded:false,exported:true,typ:$String,tag:""},{prop:"Header",name:"Header",embedded:false,exported:true,typ:CQ,tag:""},{prop:"data",name:"data",embedded:false,exported:false,typ:CE,tag:""}]);AH.init("github.com/ninchat/ninchat-go",[{prop:"data",name:"data",embedded:false,exported:false,typ:CE,tag:""},{prop:"err",name:"err",embedded:false,exported:false,typ:$error,tag:""}]);AZ.init("github.com/ninchat/ninchat-go",[{prop:"OnSessionEvent",name:"OnSessionEvent",embedded:false,exported:true,typ:CN,tag:""},{prop:"OnEvent",name:"OnEvent",embedded:false,exported:true,typ:CN,tag:""},{prop:"OnClose",name:"OnClose",embedded:false,exported:true,typ:CD,tag:""},{prop:"OnConnState",name:"OnConnState",embedded:false,exported:true,typ:CS,tag:""},{prop:"OnConnActive",name:"OnConnActive",embedded:false,exported:true,typ:CD,tag:""},{prop:"OnLog",name:"OnLog",embedded:false,exported:true,typ:CT,tag:""},{prop:"Header",name:"Header",embedded:false,exported:true,typ:CQ,tag:""},{prop:"Address",name:"Address",embedded:false,exported:true,typ:$String,tag:""},{prop:"DisableLongPoll",name:"DisableLongPoll",embedded:false,exported:true,typ:$Bool,tag:""},{prop:"forceLongPoll",name:"forceLongPoll",embedded:false,exported:false,typ:$Bool,tag:""},{prop:"mutex",name:"mutex",embedded:false,exported:false,typ:F.Mutex,tag:""},{prop:"sessionParams",name:"sessionParams",embedded:false,exported:false,typ:BV,tag:""},{prop:"sessionId",name:"sessionId",embedded:false,exported:false,typ:$emptyInterface,tag:""},{prop:"latestConnState",name:"latestConnState",embedded:false,exported:false,typ:$String,tag:""},{prop:"lastActionId",name:"lastActionId",embedded:false,exported:false,typ:$Int64,tag:""},{prop:"sendNotify",name:"sendNotify",embedded:false,exported:false,typ:CU,tag:""},{prop:"sendBuffer",name:"sendBuffer",embedded:false,exported:false,typ:CI,tag:""},{prop:"numSent",name:"numSent",embedded:false,exported:false,typ:$Int,tag:""},{prop:"sendEventAck",name:"sendEventAck",embedded:false,exported:false,typ:$Bool,tag:""},{prop:"receivedEventId",name:"receivedEventId",embedded:false,exported:false,typ:$Int64,tag:""},{prop:"ackedEventId",name:"ackedEventId",embedded:false,exported:false,typ:$Int64,tag:""},{prop:"closeNotify",name:"closeNotify",embedded:false,exported:false,typ:CU,tag:""},{prop:"closed",name:"closed",embedded:false,exported:false,typ:$Bool,tag:""},{prop:"running",name:"running",embedded:false,exported:false,typ:$Bool,tag:""},{prop:"test",name:"test",embedded:false,exported:false,typ:BB,tag:""}]);BA.init([CR,$String],[$Bool,$Bool],false);BB.init("",[]);BH.init("github.com/ninchat/ninchat-go",[{prop:"C",name:"C",embedded:false,exported:true,typ:CU,tag:""},{prop:"id",name:"id",embedded:false,exported:false,typ:CE,tag:""}]);BN.init("github.com/ninchat/ninchat-go",[{prop:"notify",name:"notify",embedded:false,exported:false,typ:CU,tag:""},{prop:"goingAway",name:"goingAway",embedded:false,exported:false,typ:$Bool,tag:""},{prop:"err",name:"err",embedded:false,exported:false,typ:$error,tag:""},{prop:"impl",name:"impl",embedded:false,exported:false,typ:CE,tag:""},{prop:"open",name:"open",embedded:false,exported:false,typ:$Bool,tag:""},{prop:"buf",name:"buf",embedded:false,exported:false,typ:CL,tag:""},{prop:"client",name:"client",embedded:false,exported:false,typ:$String,tag:""}]);$init=function(){$pkg.$init=function(){};var $f,$c=false,$s=0,$r;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=A.$init();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=C.$init();$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=B.$init();$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=E.$init();$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=D.$init();$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=F.$init();$s=6;case 6:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}AB=null;AC=false;BJ=null;BK=false;G=A.New("no action_id");a=C.Sprintf("ninchat-go/1 (%s; %s)",new BT([new $String("linux"),new $String("js")]));$s=7;case 7:if($c){$c=false;a=a.$blk();}if(a&&a.$blk!==undefined){break s;}$pkg.DefaultUserAgent=a;AY=AM(new $Int64(0,4096),-0.25);AD();BL();}return;}if($f===undefined){$f={$blk:$init};}$f.$s=$s;$f.$r=$r;return $f;};$pkg.$init=$init;return $pkg;})();
$packages["ninchatclient/lib"]=(function(){var $pkg={},$init,A,B,K,L,P,Q,R,S,T,U,V,W,X,Y,Z,AA,AB,AC,AD,AE,AF,AG,AH,AI,AJ,AK,AL,AM,AN,AO,AP,C,D,E,F,G,H,I,J,M,N,O;A=$packages["github.com/gopherjs/gopherjs/js"];B=$packages["github.com/ninchat/ninchat-go"];K=$pkg.Promise=$newType(0,$kindStruct,"clientlib.Promise",true,"ninchatclient/lib",true,function(OnPanic_,fulfillers_,rejecters_,notifiers_,actionID_){this.$val=this;if(arguments.length===0){this.OnPanic=$throwNilPointerError;this.fulfillers=W.nil;this.rejecters=W.nil;this.notifiers=W.nil;this.actionID=X.nil;return;}this.OnPanic=OnPanic_;this.fulfillers=fulfillers_;this.rejecters=rejecters_;this.notifiers=notifiers_;this.actionID=actionID_;});L=$pkg.SessionAdapter=$newType(0,$kindStruct,"clientlib.SessionAdapter",true,"ninchatclient/lib",true,function(Session_,OnPanic_){this.$val=this;if(arguments.length===0){this.Session=AG.nil;this.OnPanic=$throwNilPointerError;return;}this.Session=Session_;this.OnPanic=OnPanic_;});P=$ptrType(A.Object);Q=$funcType([P],[],false);R=$funcType([$String,$String],[],false);S=$sliceType($String);T=$funcType([$String],[],false);U=$mapType($String,$emptyInterface);V=$funcType([U],[P],false);W=$sliceType(P);X=$ptrType($Int64);Y=$sliceType(B.Frame);Z=$sliceType(U);AA=$sliceType($emptyInterface);AB=$funcType([U,P,P],[P],false);AC=$funcType([],[U],false);AD=$funcType([P],[P],false);AE=$funcType([P,P,P],[P],false);AF=$ptrType(B.Event);AG=$ptrType(B.Session);AH=$ptrType(B.Action);AI=$sliceType(AH);AJ=$funcType([U],[],false);AK=$funcType([$Bool],[],false);AL=$funcType([],[],false);AM=$funcType([U,P],[P],false);AN=$ptrType(K);AO=$funcType([$String,$emptyInterface],[],false);AP=$ptrType(L);C=function(){var a,b;a=undefined;b=new B.Caller.ptr(F(),"");return $makeMap($String.keyFor,[{k:"onLog",v:new Q((function(c){var c;a=c;}))},{k:"setHeader",v:new R((function(c,d){var c,d,e;if(b.Header===false){b.Header={};}e=c;(b.Header||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(e)]={k:e,v:new S([d])};}))},{k:"setAddress",v:new T((function(c){var c;b.Address=c;}))},{k:"call",v:new V((function(c){var c;return E(c,a,$clone(b,B.Caller));}))}]);};D=function(a,b,c){var a,b,c,d;d=new B.Caller.ptr(false,"");if(!(c===undefined)){d.Address=$internalize(c,$String);}return E(a,b,$clone(d,B.Caller));};E=function(a,b,c){var a,b,c,d;d=new K.ptr(H((function(){return(function(d){var d;if(!(b===undefined)){b($externalize(d,$String));}});})),W.nil,W.nil,W.nil,X.nil);$go((function $b(){var e,f,g,h,i,j,k,l,m,n,o,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:e=new B.Action.ptr(a,Y.nil,$throwNilPointerError,new $Int64(0,0));g=c.Call(e);$s=1;case 1:if($c){$c=false;g=g.$blk();}if(g&&g.$blk!==undefined){break s;}f=g;h=f[0];i=f[1];if(!($interfaceIsEqual(i,$ifaceNil))){$s=2;continue;}$s=3;continue;case 2:j=i.Error();$s=4;case 4:if($c){$c=false;j=j.$blk();}if(j&&j.$blk!==undefined){break s;}k=j;if(!(b===undefined)){b($externalize(k,$String));}$r=d.OnReply(new B.Event.ptr($makeMap($String.keyFor,[{k:"event",v:new $String("error")},{k:"error_type",v:new $String("internal")},{k:"error_reason",v:new $String(k)}]),Y.nil,false));$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 3:l=Z.nil;m=h;n=0;while(true){if(!(n<m.$length)){break;}o=((n<0||n>=m.$length)?($throwRuntimeError("index out of range"),undefined):m.$array[m.$offset+n]);l=$append(l,o.Params);n++;}$r=d.Resolve(new AA([l]));$s=6;case 6:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.$s=$s;$f.$r=$r;return $f;}),[]);return d.Object();};F=function(){return $makeMap($String.keyFor,[{k:"X-User-Agent",v:new S(["ninchat-js/1"])}]);};G=function(a){var a;a.defaultXUserAgent=$externalize("ninchat-js/1",$String);a.call=$externalize(D,AB);a.newCaller=$externalize(C,AC);a.newSession=$externalize(N,AC);a.stringifyFrame=$externalize(B.StringifyFrame,AD);};$pkg.Init=G;H=function(a){var a;return(function $b(b,c){var b,c,d,e,f,g,h,i,j,k,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:if(!($interfaceIsEqual(c,$ifaceNil))){$s=1;continue;}$s=2;continue;case 1:d=a();$s=3;case 3:if($c){$c=false;d=d.$blk();}if(d&&d.$blk!==undefined){break s;}e=d;if(!(e===$throwNilPointerError)){$s=4;continue;}$s=5;continue;case 4:f="";g=c;if($assertType(g,$String,true)[1]){$s=6;continue;}if($assertType(g,$error,true)[1]){$s=7;continue;}$s=8;continue;case 6:h=g.$val;f=h;$s=9;continue;case 7:i=g;k=i.Error();$s=10;case 10:if($c){$c=false;k=k.$blk();}if(k&&k.$blk!==undefined){break s;}f=k;$s=9;continue;case 8:j=g;f=$internalize($global.JSON.stringify($externalize(j,$emptyInterface)),$String);case 9:$r=e(b+" "+f);$s=11;case 11:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 5:case 2:$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.$s=$s;$f.$r=$r;return $f;});};$pkg.Panicer=H;I=function(a){var a,b,c;b=Y.nil;if(!(a===null)&&!(a===undefined)){c=0;while(true){if(!(c<$parseInt(a.length))){break;}b=$append(b,a[c]);c=c+(1)>>0;}}return b;};$pkg.WrapPayload=I;J=function(a){var a,b,c,d,e;b=W.nil;c=a;d=0;while(true){if(!(d<c.$length)){break;}e=((d<0||d>=c.$length)?($throwRuntimeError("index out of range"),undefined):c.$array[c.$offset+d]);b=$append(b,e);d++;}return b;};$pkg.UnwrapPayload=J;K.ptr.prototype.Object=function(){var a,b;a=null;b=this;a=new($global.Object)();a.then=$externalize((function(c,d,e){var c,d,e;if(!(c===null)&&!(c===undefined)){b.fulfillers=$append(b.fulfillers,c);}if(!(d===null)&&!(d===undefined)){b.rejecters=$append(b.rejecters,d);}if(!(e===null)&&!(e===undefined)){b.notifiers=$append(b.notifiers,e);}return a;}),AE);if(!(b.actionID===X.nil)){a.actionId=$externalize(b.actionID.$get(),$Int64);}return a;};K.prototype.Object=function(){return this.$val.Object();};K.ptr.prototype.OnReply=function(a){var a,b,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=this;if(!(a===AF.nil)){$s=1;continue;}$s=2;continue;case 1:if(a.String()==="error"){$s=3;continue;}if(a.LastReply){$s=4;continue;}$s=5;continue;case 3:$r=b.Reject(new AA([new U(a.Params)]));$s=7;case 7:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=6;continue;case 4:$r=b.Resolve(new AA([new U(a.Params),J(a.Payload)]));$s=8;case 8:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=6;continue;case 5:$r=b.Notify(new AA([new U(a.Params),J(a.Payload)]));$s=9;case 9:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 6:case 2:$s=-1;return;}return;}if($f===undefined){$f={$blk:K.ptr.prototype.OnReply};}$f.a=a;$f.b=b;$f.$s=$s;$f.$r=$r;return $f;};K.prototype.OnReply=function(a){return this.$val.OnReply(a);};K.ptr.prototype.Resolve=function(a){var a,b,c,d,e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=this;c=b.fulfillers;d=0;case 1:if(!(d<c.$length)){$s=2;continue;}e=((d<0||d>=c.$length)?($throwRuntimeError("index out of range"),undefined):c.$array[c.$offset+d]);$r=b.invoke("Promise onFulfilled callback:",e,a);$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}d++;$s=1;continue;case 2:$s=-1;return;}return;}if($f===undefined){$f={$blk:K.ptr.prototype.Resolve};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};K.prototype.Resolve=function(a){return this.$val.Resolve(a);};K.ptr.prototype.Reject=function(a){var a,b,c,d,e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=this;c=b.rejecters;d=0;case 1:if(!(d<c.$length)){$s=2;continue;}e=((d<0||d>=c.$length)?($throwRuntimeError("index out of range"),undefined):c.$array[c.$offset+d]);$r=b.invoke("Promise onRejected callback:",e,a);$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}d++;$s=1;continue;case 2:$s=-1;return;}return;}if($f===undefined){$f={$blk:K.ptr.prototype.Reject};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};K.prototype.Reject=function(a){return this.$val.Reject(a);};K.ptr.prototype.Notify=function(a){var a,b,c,d,e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=this;c=b.notifiers;d=0;case 1:if(!(d<c.$length)){$s=2;continue;}e=((d<0||d>=c.$length)?($throwRuntimeError("index out of range"),undefined):c.$array[c.$offset+d]);$r=b.invoke("Promise onNotified callback:",e,a);$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}d++;$s=1;continue;case 2:$s=-1;return;}return;}if($f===undefined){$f={$blk:K.ptr.prototype.Notify};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};K.prototype.Notify=function(a){return this.$val.Notify(a);};K.ptr.prototype.invoke=function(a,b,c){var a,b,c,d,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);a=[a];d=[d];d[0]=this;$deferred.push([(function(a,d){return function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=d[0].OnPanic(a[0],$recover());$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;};})(a,d),[]]);b.apply(undefined,$externalize(c,AA));$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:K.ptr.prototype.invoke};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};K.prototype.invoke=function(a,b,c){return this.$val.invoke(a,b,c);};M=function(a){var a;return new L.ptr(a,H((function(){return(function $b(b){var b,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:if(!(a.OnLog===$throwNilPointerError)){$s=1;continue;}$s=2;continue;case 1:$r=a.OnLog(new AA([new $String(b)]));$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 2:$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.b=b;$f.$s=$s;$f.$r=$r;return $f;});})));};$pkg.NewSessionAdapter=M;L.ptr.prototype.InvokeOnSessionEvent=function(a,b,c){var a,b,c,d,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);a=[a];d=[d];d[0]=this;$deferred.push([(function(a,d){return function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=d[0].OnPanic(a[0],$recover());$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;};})(a,d),[]]);b($externalize(c.Params,U));$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:L.ptr.prototype.InvokeOnSessionEvent};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};L.prototype.InvokeOnSessionEvent=function(a,b,c){return this.$val.InvokeOnSessionEvent(a,b,c);};L.ptr.prototype.OnSessionEvent=function(a){var a,b;b=this;b.Session.OnSessionEvent=(function $b(c){var c,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;c=$f.c;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=b.InvokeOnSessionEvent("Session.onSessionEvent callback:",a,c);$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.c=c;$f.$s=$s;$f.$r=$r;return $f;});};L.prototype.OnSessionEvent=function(a){return this.$val.OnSessionEvent(a);};L.ptr.prototype.InvokeOnEvent=function(a,b,c){var a,b,c,d,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);a=[a];d=[d];d[0]=this;$deferred.push([(function(a,d){return function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=d[0].OnPanic(a[0],$recover());$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;};})(a,d),[]]);b($externalize(c.Params,U),$externalize(J(c.Payload),W));$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:L.ptr.prototype.InvokeOnEvent};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};L.prototype.InvokeOnEvent=function(a,b,c){return this.$val.InvokeOnEvent(a,b,c);};L.ptr.prototype.OnEvent=function(a){var a,b;b=this;b.Session.OnEvent=(function $b(c){var c,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;c=$f.c;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=b.InvokeOnEvent("Session.onEvent callback:",a,c);$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.c=c;$f.$s=$s;$f.$r=$r;return $f;});};L.prototype.OnEvent=function(a){return this.$val.OnEvent(a);};L.ptr.prototype.OnClose=function(a){var a,b;b=this;b.Session.OnClose=(function $b(){var $s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);$deferred.push([(function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=b.OnPanic("Session.onClose callback:",$recover());$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;}),[]]);a();$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}});};L.prototype.OnClose=function(a){return this.$val.OnClose(a);};L.ptr.prototype.OnConnState=function(a){var a,b;b=this;if(a===null){b.Session.OnConnState=$throwNilPointerError;return;}b.Session.OnConnState=(function $b(c){var c,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;c=$f.c;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);$deferred.push([(function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=b.OnPanic("Session.onConnState callback:",$recover());$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;}),[]]);a($externalize(c,$String));$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:$b};}$f.c=c;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}});};L.prototype.OnConnState=function(a){return this.$val.OnConnState(a);};L.ptr.prototype.OnConnActive=function(a){var a,b;b=this;if(a===null){b.Session.OnConnActive=$throwNilPointerError;return;}b.Session.OnConnActive=(function $b(){var $s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);$deferred.push([(function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=b.OnPanic("Session.onConnActive callback:",$recover());$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;}),[]]);a(new($global.Date)().getTime());$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}});};L.prototype.OnConnActive=function(a){return this.$val.OnConnActive(a);};L.ptr.prototype.OnLog=function(a){var a,b;b=this;if(a===null){b.Session.OnLog=$throwNilPointerError;return;}b.Session.OnLog=(function $b(c){var c,d,e,f,g,h,i,j,k,l,m,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);$deferred.push([(function(){$recover();}),[]]);d="";e=c;f=0;case 1:if(!(f<e.$length)){$s=2;continue;}g=((f<0||f>=e.$length)?($throwRuntimeError("index out of range"),undefined):e.$array[e.$offset+f]);h="";i=g;if($assertType(i,$String,true)[1]){$s=3;continue;}if($assertType(i,$error,true)[1]){$s=4;continue;}$s=5;continue;case 3:j=i.$val;h=j;$s=6;continue;case 4:k=i;m=k.Error();$s=7;case 7:if($c){$c=false;m=m.$blk();}if(m&&m.$blk!==undefined){break s;}h=m;$s=6;continue;case 5:l=i;h=$internalize($global.JSON.stringify($externalize(l,$emptyInterface)),$String);case 6:if(d.length>0){d=d+(" ");}d=d+(h);f++;$s=1;continue;case 2:while(true){if(!(d.length>0&&(d.charCodeAt((d.length-1>>0))===32))){break;}d=$substring(d,0,(d.length-1>>0));}a($externalize(d,$String));$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:$b};}$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}});};L.prototype.OnLog=function(a){return this.$val.OnLog(a);};L.ptr.prototype.SetHeader=function(a,b){var a,b,c,d;c=this;if(c.Session.Header===false){c.Session.Header={};}d=a;(c.Session.Header||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(d)]={k:d,v:new S([b])};};L.prototype.SetHeader=function(a,b){return this.$val.SetHeader(a,b);};L.ptr.prototype.SetAddress=function(a){var a,b;b=this;b.Session.Address=a;};L.prototype.SetAddress=function(a){return this.$val.SetAddress(a);};L.ptr.prototype.SetDisableLongPoll=function(a){var a,b;b=this;b.Session.DisableLongPoll=a;};L.prototype.SetDisableLongPoll=function(a){return this.$val.SetDisableLongPoll(a);};L.ptr.prototype.Send=function(a,b){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=[c];d=null;e=this;f=new B.Action.ptr(a,I(b),$throwNilPointerError,new $Int64(0,0));g=(h=a[$String.keyFor("action_id")],h!==undefined?[h.v,true]:[$ifaceNil,false]);i=g[0];j=g[1];if(j){$s=1;continue;}$s=2;continue;case 1:if(!($interfaceIsEqual(i,$ifaceNil))){console.log("NinchatClient.Session.send called incorrectly with an action_id value");}k=e.Session.Send(f);$s=4;case 4:if($c){$c=false;k=k.$blk();}if(k&&k.$blk!==undefined){break s;}k;$s=3;continue;case 2:l=new K.ptr(e.OnPanic,W.nil,W.nil,W.nil,X.nil);f.OnReply=$methodVal(l,"OnReply");m=e.Session.Send(f);$s=5;case 5:if($c){$c=false;m=m.$blk();}if(m&&m.$blk!==undefined){break s;}m;c[0]=$assertType((n=a[$String.keyFor("action_id")],n!==undefined?n.v:$ifaceNil),$Int64);l.actionID=(c.$ptr||(c.$ptr=new X(function(){return this.$target[0];},function($v){this.$target[0]=$v;},c)));d=l.Object();case 3:$s=-1;return d;}return;}if($f===undefined){$f={$blk:L.ptr.prototype.Send};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.$s=$s;$f.$r=$r;return $f;};L.prototype.Send=function(a,b){return this.$val.Send(a,b);};N=function(){var a,b;a=new B.Session.ptr($throwNilPointerError,$throwNilPointerError,$throwNilPointerError,$throwNilPointerError,$throwNilPointerError,$throwNilPointerError,F(),"",false,false,new $packages["sync"].Mutex.ptr(0,0),false,$ifaceNil,"",new $Int64(0,0),$chanNil,AI.nil,0,false,new $Int64(0,0),new $Int64(0,0),$chanNil,false,false,new B.testSupport.ptr());b=M(a);return $makeMap($String.keyFor,[{k:"onSessionEvent",v:new Q($methodVal(b,"OnSessionEvent"))},{k:"onEvent",v:new Q($methodVal(b,"OnEvent"))},{k:"onClose",v:new Q($methodVal(b,"OnClose"))},{k:"onConnState",v:new Q($methodVal(b,"OnConnState"))},{k:"onConnActive",v:new Q($methodVal(b,"OnConnActive"))},{k:"onLog",v:new Q($methodVal(b,"OnLog"))},{k:"setParams",v:new AJ($methodVal(a,"SetParams"))},{k:"setTransport",v:new T(O)},{k:"setHeader",v:new R($methodVal(b,"SetHeader"))},{k:"setAddress",v:new T($methodVal(b,"SetAddress"))},{k:"setDisableLongPoll",v:new AK($methodVal(b,"SetDisableLongPoll"))},{k:"open",v:new AL($methodVal(a,"Open"))},{k:"close",v:new AL($methodVal(a,"Close"))},{k:"send",v:new AM($methodVal(b,"Send"))}]);};O=function(a){var a;console.log("NinchatClient.Session.setTransport doesn't do anything anymore");};AN.methods=[{prop:"Object",name:"Object",pkg:"",typ:$funcType([],[P],false)},{prop:"OnReply",name:"OnReply",pkg:"",typ:$funcType([AF],[],false)},{prop:"Resolve",name:"Resolve",pkg:"",typ:$funcType([AA],[],true)},{prop:"Reject",name:"Reject",pkg:"",typ:$funcType([AA],[],true)},{prop:"Notify",name:"Notify",pkg:"",typ:$funcType([AA],[],true)},{prop:"invoke",name:"invoke",pkg:"ninchatclient/lib",typ:$funcType([$String,P,AA],[],true)}];AP.methods=[{prop:"InvokeOnSessionEvent",name:"InvokeOnSessionEvent",pkg:"",typ:$funcType([$String,P,AF],[],false)},{prop:"OnSessionEvent",name:"OnSessionEvent",pkg:"",typ:$funcType([P],[],false)},{prop:"InvokeOnEvent",name:"InvokeOnEvent",pkg:"",typ:$funcType([$String,P,AF],[],false)},{prop:"OnEvent",name:"OnEvent",pkg:"",typ:$funcType([P],[],false)},{prop:"OnClose",name:"OnClose",pkg:"",typ:$funcType([P],[],false)},{prop:"OnConnState",name:"OnConnState",pkg:"",typ:$funcType([P],[],false)},{prop:"OnConnActive",name:"OnConnActive",pkg:"",typ:$funcType([P],[],false)},{prop:"OnLog",name:"OnLog",pkg:"",typ:$funcType([P],[],false)},{prop:"SetHeader",name:"SetHeader",pkg:"",typ:$funcType([$String,$String],[],false)},{prop:"SetAddress",name:"SetAddress",pkg:"",typ:$funcType([$String],[],false)},{prop:"SetDisableLongPoll",name:"SetDisableLongPoll",pkg:"",typ:$funcType([$Bool],[],false)},{prop:"Send",name:"Send",pkg:"",typ:$funcType([U,P],[P],false)}];K.init("ninchatclient/lib",[{prop:"OnPanic",name:"OnPanic",embedded:false,exported:true,typ:AO,tag:""},{prop:"fulfillers",name:"fulfillers",embedded:false,exported:false,typ:W,tag:""},{prop:"rejecters",name:"rejecters",embedded:false,exported:false,typ:W,tag:""},{prop:"notifiers",name:"notifiers",embedded:false,exported:false,typ:W,tag:""},{prop:"actionID",name:"actionID",embedded:false,exported:false,typ:X,tag:""}]);L.init("",[{prop:"Session",name:"Session",embedded:false,exported:true,typ:AG,tag:""},{prop:"OnPanic",name:"OnPanic",embedded:false,exported:true,typ:AO,tag:""}]);$init=function(){$pkg.$init=function(){};var $f,$c=false,$s=0,$r;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=A.$init();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=B.$init();$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}}return;}if($f===undefined){$f={$blk:$init};}$f.$s=$s;$f.$r=$r;return $f;};$pkg.$init=$init;return $pkg;})();
