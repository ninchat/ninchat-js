...
$packages["internal/race"]=(function(){var $pkg={},$init,A,B;A=function(a){var a;};$pkg.Acquire=A;B=function(a){var a;};$pkg.Release=B;$init=function(){$pkg.$init=function(){};var $f,$c=false,$s=0,$r;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:}return;}if($f===undefined){$f={$blk:$init};}$f.$s=$s;$f.$r=$r;return $f;};$pkg.$init=$init;return $pkg;})();
$packages["sync/atomic"]=(function(){var $pkg={},$init,A,H,N;A=$packages["github.com/gopherjs/gopherjs/js"];H=function(ad,ae,af){var ad,ae,af;if(ad.$get()===ae){ad.$set(af);return true;}return false;};$pkg.CompareAndSwapInt32=H;N=function(ad,ae){var ad,ae,af;af=ad.$get()+ae>>0;ad.$set(af);return af;};$pkg.AddInt32=N;$init=function(){$pkg.$init=function(){};var $f,$c=false,$s=0,$r;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=A.$init();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}}return;}if($f===undefined){$f={$blk:$init};}$f.$s=$s;$f.$r=$r;return $f;};$pkg.$init=$init;return $pkg;})();
$packages["sync"]=(function(){var $pkg={},$init,A,C,D,B,F,Z,AC,AD,AO,AY,AZ,BA,BB,BC,BI,BL,BM,BR,CA,CD,H,I,W,AJ,G,K,L,M,N,O,P,AH,AK,AL,AT,AU;A=$packages["github.com/gopherjs/gopherjs/js"];C=$packages["internal/race"];D=$packages["runtime"];B=$packages["sync/atomic"];F=$pkg.Pool=$newType(0,$kindStruct,"sync.Pool",true,"sync",true,function(local_,localSize_,store_,New_){this.$val=this;if(arguments.length===0){this.local=0;this.localSize=0;this.store=BM.nil;this.New=$throwNilPointerError;return;}this.local=local_;this.localSize=localSize_;this.store=store_;this.New=New_;});Z=$pkg.Mutex=$newType(0,$kindStruct,"sync.Mutex",true,"sync",true,function(state_,sema_){this.$val=this;if(arguments.length===0){this.state=0;this.sema=0;return;}this.state=state_;this.sema=sema_;});AC=$pkg.poolLocalInternal=$newType(0,$kindStruct,"sync.poolLocalInternal",true,"sync",false,function(private$0_,shared_,Mutex_){this.$val=this;if(arguments.length===0){this.private$0=$ifaceNil;this.shared=BM.nil;this.Mutex=new Z.ptr(0,0);return;}this.private$0=private$0_;this.shared=shared_;this.Mutex=Mutex_;});AD=$pkg.poolLocal=$newType(0,$kindStruct,"sync.poolLocal",true,"sync",false,function(poolLocalInternal_,pad_){this.$val=this;if(arguments.length===0){this.poolLocalInternal=new AC.ptr($ifaceNil,BM.nil,new Z.ptr(0,0));this.pad=CD.zero();return;}this.poolLocalInternal=poolLocalInternal_;this.pad=pad_;});AO=$pkg.notifyList=$newType(0,$kindStruct,"sync.notifyList",true,"sync",false,function(wait_,notify_,lock_,head_,tail_){this.$val=this;if(arguments.length===0){this.wait=0;this.notify=0;this.lock=0;this.head=0;this.tail=0;return;}this.wait=wait_;this.notify=notify_;this.lock=lock_;this.head=head_;this.tail=tail_;});AY=$ptrType(F);AZ=$sliceType(AY);BA=$ptrType($Uint32);BB=$chanType($Bool,false,false);BC=$sliceType(BB);BI=$ptrType($Int32);BL=$ptrType(AD);BM=$sliceType($emptyInterface);BR=$funcType([],[$emptyInterface],false);CA=$ptrType(Z);CD=$arrayType($Uint8,100);F.ptr.prototype.Get=function(){var l,m,n,o,p,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:l=this;if(l.store.$length===0){$s=1;continue;}$s=2;continue;case 1:if(!(l.New===$throwNilPointerError)){$s=3;continue;}$s=4;continue;case 3:m=l.New();$s=5;case 5:if($c){$c=false;m=m.$blk();}if(m&&m.$blk!==undefined){break s;}$s=-1;return m;case 4:$s=-1;return $ifaceNil;case 2:p=(n=l.store,o=l.store.$length-1>>0,((o<0||o>=n.$length)?($throwRuntimeError("index out of range"),undefined):n.$array[n.$offset+o]));l.store=$subslice(l.store,0,(l.store.$length-1>>0));$s=-1;return p;}return;}if($f===undefined){$f={$blk:F.ptr.prototype.Get};}$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.$s=$s;$f.$r=$r;return $f;};F.prototype.Get=function(){return this.$val.Get();};F.ptr.prototype.Put=function(l){var l,m;m=this;if($interfaceIsEqual(l,$ifaceNil)){return;}m.store=$append(m.store,l);};F.prototype.Put=function(l){return this.$val.Put(l);};G=function(l){var l;};K=function(l,m){var l,m,n,o,p,q,r,s,t,u,v,w,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;v=$f.v;w=$f.w;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:if(((l.$get()-(n=I[BA.keyFor(l)],n!==undefined?n.v:0)>>>0))===0){$s=1;continue;}$s=2;continue;case 1:o=new $Chan($Bool,0);if(m){p=l;(H||$throwRuntimeError("assignment to entry in nil map"))[BA.keyFor(p)]={k:p,v:$appendSlice(new BC([o]),(q=H[BA.keyFor(l)],q!==undefined?q.v:BC.nil))};}else{r=l;(H||$throwRuntimeError("assignment to entry in nil map"))[BA.keyFor(r)]={k:r,v:$append((s=H[BA.keyFor(l)],s!==undefined?s.v:BC.nil),o)};}t=$recv(o);$s=3;case 3:if($c){$c=false;t=t.$blk();}if(t&&t.$blk!==undefined){break s;}t[0];u=l;(I||$throwRuntimeError("assignment to entry in nil map"))[BA.keyFor(u)]={k:u,v:(v=I[BA.keyFor(l)],v!==undefined?v.v:0)-(1)>>>0};if((w=I[BA.keyFor(l)],w!==undefined?w.v:0)===0){delete I[BA.keyFor(l)];}case 2:l.$set(l.$get()-(1)>>>0);$s=-1;return;}return;}if($f===undefined){$f={$blk:K};}$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.v=v;$f.w=w;$f.$s=$s;$f.$r=$r;return $f;};L=function(l,m){var l,m,n,o,p,q,r,s,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:l.$set(l.$get()+(1)>>>0);o=(n=H[BA.keyFor(l)],n!==undefined?n.v:BC.nil);if(o.$length===0){$s=-1;return;}p=(0>=o.$length?($throwRuntimeError("index out of range"),undefined):o.$array[o.$offset+0]);o=$subslice(o,1);q=l;(H||$throwRuntimeError("assignment to entry in nil map"))[BA.keyFor(q)]={k:q,v:o};if(o.$length===0){delete H[BA.keyFor(l)];}r=l;(I||$throwRuntimeError("assignment to entry in nil map"))[BA.keyFor(r)]={k:r,v:(s=I[BA.keyFor(l)],s!==undefined?s.v:0)+(1)>>>0};$r=$send(p,true);$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:L};}$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.$s=$s;$f.$r=$r;return $f;};M=function(l){var l;};N=function(l){var l;return false;};O=function(){return $mul64($internalize(new($global.Date)().getTime(),$Int64),new $Int64(0,1000000));};P=function(l){var l;$throwRuntimeError($externalize(l,$String));};Z.ptr.prototype.Lock=function(){var l,m,n,o,p,q,r,s,t,u,v,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;v=$f.v;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:l=this;if(B.CompareAndSwapInt32((l.$ptr_state||(l.$ptr_state=new BI(function(){return this.$target.state;},function($v){this.$target.state=$v;},l))),0,1)){if(false){C.Acquire((l));}$s=-1;return;}m=new $Int64(0,0);n=false;o=false;p=0;q=l.state;case 1:if(((q&5)===1)&&N(p)){$s=3;continue;}$s=4;continue;case 3:if(!o&&((q&2)===0)&&!(((q>>3>>0)===0))&&B.CompareAndSwapInt32((l.$ptr_state||(l.$ptr_state=new BI(function(){return this.$target.state;},function($v){this.$target.state=$v;},l))),q,q|2)){o=true;}AU();p=p+(1)>>0;q=l.state;$s=1;continue;case 4:r=q;if((q&4)===0){r=r|(1);}if(!(((q&5)===0))){r=r+(8)>>0;}if(n&&!(((q&1)===0))){r=r|(4);}if(o){if((r&2)===0){P("sync: inconsistent mutex state");}r=(r&~(2))>>0;}if(B.CompareAndSwapInt32((l.$ptr_state||(l.$ptr_state=new BI(function(){return this.$target.state;},function($v){this.$target.state=$v;},l))),q,r)){$s=5;continue;}$s=6;continue;case 5:if((q&5)===0){$s=2;continue;}s=!((m.$high===0&&m.$low===0));if((m.$high===0&&m.$low===0)){m=O();}$r=K((l.$ptr_sema||(l.$ptr_sema=new BA(function(){return this.$target.sema;},function($v){this.$target.sema=$v;},l))),s);$s=8;case 8:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}n=n||(t=(u=O(),new $Int64(u.$high-m.$high,u.$low-m.$low)),(t.$high>0||(t.$high===0&&t.$low>1000000)));q=l.state;if(!(((q&4)===0))){if(!(((q&3)===0))||((q>>3>>0)===0)){P("sync: inconsistent mutex state");}v=-7;if(!n||((q>>3>>0)===1)){v=v-(4)>>0;}B.AddInt32((l.$ptr_state||(l.$ptr_state=new BI(function(){return this.$target.state;},function($v){this.$target.state=$v;},l))),v);$s=2;continue;}o=true;p=0;$s=7;continue;case 6:q=l.state;case 7:$s=1;continue;case 2:if(false){C.Acquire((l));}$s=-1;return;}return;}if($f===undefined){$f={$blk:Z.ptr.prototype.Lock};}$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.v=v;$f.$s=$s;$f.$r=$r;return $f;};Z.prototype.Lock=function(){return this.$val.Lock();};Z.ptr.prototype.Unlock=function(){var l,m,n,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;l=$f.l;m=$f.m;n=$f.n;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:l=this;if(false){$unused(l.state);C.Release((l));}m=B.AddInt32((l.$ptr_state||(l.$ptr_state=new BI(function(){return this.$target.state;},function($v){this.$target.state=$v;},l))),-1);if((((m+1>>0))&1)===0){P("sync: unlock of unlocked mutex");}if((m&4)===0){$s=1;continue;}$s=2;continue;case 1:n=m;case 4:if(((n>>3>>0)===0)||!(((n&7)===0))){$s=-1;return;}m=((n-8>>0))|2;if(B.CompareAndSwapInt32((l.$ptr_state||(l.$ptr_state=new BI(function(){return this.$target.state;},function($v){this.$target.state=$v;},l))),n,m)){$s=6;continue;}$s=7;continue;case 6:$r=L((l.$ptr_sema||(l.$ptr_sema=new BA(function(){return this.$target.sema;},function($v){this.$target.sema=$v;},l))),false);$s=8;case 8:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 7:n=l.state;$s=4;continue;case 5:$s=3;continue;case 2:$r=L((l.$ptr_sema||(l.$ptr_sema=new BA(function(){return this.$target.sema;},function($v){this.$target.sema=$v;},l))),true);$s=9;case 9:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 3:$s=-1;return;}return;}if($f===undefined){$f={$blk:Z.ptr.prototype.Unlock};}$f.l=l;$f.m=m;$f.n=n;$f.$s=$s;$f.$r=$r;return $f;};Z.prototype.Unlock=function(){return this.$val.Unlock();};AH=function(){var l,m,n,o,p,q,r,s,t,u;l=AJ;m=0;while(true){if(!(m<l.$length)){break;}n=m;o=((m<0||m>=l.$length)?($throwRuntimeError("index out of range"),undefined):l.$array[l.$offset+m]);((n<0||n>=AJ.$length)?($throwRuntimeError("index out of range"),undefined):AJ.$array[AJ.$offset+n]=AY.nil);p=0;while(true){if(!(p<((o.localSize>>0)))){break;}q=AL(o.local,p);q.poolLocalInternal.private$0=$ifaceNil;r=q.poolLocalInternal.shared;s=0;while(true){if(!(s<r.$length)){break;}t=s;(u=q.poolLocalInternal.shared,((t<0||t>=u.$length)?($throwRuntimeError("index out of range"),undefined):u.$array[u.$offset+t]=$ifaceNil));s++;}q.poolLocalInternal.shared=BM.nil;p=p+(1)>>0;}o.local=0;o.localSize=0;m++;}AJ=new AZ([]);};AK=function(){G(AH);};AL=function(l,m){var l,m,n;n=(((l)+($imul(((m>>>0)),128)>>>0)>>>0));return($pointerOfStructConversion(n,BL));};AT=function(){var l;l=new AO.ptr(0,0,0,0,0);M(20);};AU=function(){$throwRuntimeError("native function not implemented: sync.runtime_doSpin");};AY.methods=[{prop:"Get",name:"Get",pkg:"",typ:$funcType([],[$emptyInterface],false)},{prop:"Put",name:"Put",pkg:"",typ:$funcType([$emptyInterface],[],false)},{prop:"getSlow",name:"getSlow",pkg:"sync",typ:$funcType([],[$emptyInterface],false)},{prop:"pin",name:"pin",pkg:"sync",typ:$funcType([],[BL],false)},{prop:"pinSlow",name:"pinSlow",pkg:"sync",typ:$funcType([],[BL],false)}];CA.methods=[{prop:"Lock",name:"Lock",pkg:"",typ:$funcType([],[],false)},{prop:"Unlock",name:"Unlock",pkg:"",typ:$funcType([],[],false)}];F.init("sync",[{prop:"local",name:"local",embedded:false,exported:false,typ:$UnsafePointer,tag:""},{prop:"localSize",name:"localSize",embedded:false,exported:false,typ:$Uintptr,tag:""},{prop:"store",name:"store",embedded:false,exported:false,typ:BM,tag:""},{prop:"New",name:"New",embedded:false,exported:true,typ:BR,tag:""}]);Z.init("sync",[{prop:"state",name:"state",embedded:false,exported:false,typ:$Int32,tag:""},{prop:"sema",name:"sema",embedded:false,exported:false,typ:$Uint32,tag:""}]);AC.init("sync",[{prop:"private$0",name:"private",embedded:false,exported:false,typ:$emptyInterface,tag:""},{prop:"shared",name:"shared",embedded:false,exported:false,typ:BM,tag:""},{prop:"Mutex",name:"Mutex",embedded:true,exported:true,typ:Z,tag:""}]);AD.init("sync",[{prop:"poolLocalInternal",name:"poolLocalInternal",embedded:true,exported:false,typ:AC,tag:""},{prop:"pad",name:"pad",embedded:false,exported:false,typ:CD,tag:""}]);AO.init("sync",[{prop:"wait",name:"wait",embedded:false,exported:false,typ:$Uint32,tag:""},{prop:"notify",name:"notify",embedded:false,exported:false,typ:$Uint32,tag:""},{prop:"lock",name:"lock",embedded:false,exported:false,typ:$Uintptr,tag:""},{prop:"head",name:"head",embedded:false,exported:false,typ:$UnsafePointer,tag:""},{prop:"tail",name:"tail",embedded:false,exported:false,typ:$UnsafePointer,tag:""}]);$init=function(){$pkg.$init=function(){};var $f,$c=false,$s=0,$r;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=A.$init();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=C.$init();$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=D.$init();$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=B.$init();$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}AJ=AZ.nil;H={};I={};W=(new Uint8Array(8));AK();AT();}return;}if($f===undefined){$f={$blk:$init};}$f.$s=$s;$f.$r=$r;return $f;};$pkg.$init=$init;return $pkg;})();
$packages["github.com/ninchat/ninchat-go"]=(function(){var $pkg={},$init,A,B,C,D,H,I,J,L,O,AB,AC,AF,AX,AY,AZ,BA,BB,BF,BK,BQ,BR,BS,BT,BU,BV,BW,BX,BY,BZ,CA,CB,CC,CD,CE,CF,CG,CH,CI,CJ,CK,CL,CM,CN,CO,CP,CQ,CR,E,Y,Z,AW,BH,BI,F,G,K,P,Q,R,T,U,V,W,X,AA,AD,AE,AG,AH,AI,AJ,AK,AL,AM,AN,AO,AP,AQ,AR,AS,AT,AU,AV,BC,BD,BE,BG,BJ,BL,BM,BN,BO,BP;A=$packages["errors"];B=$packages["github.com/gopherjs/gopherjs/js"];C=$packages["github.com/ninchat/ninchat-go/vendor/sort"];D=$packages["sync"];H=$pkg.Action=$newType(0,$kindStruct,"ninchat.Action",true,"github.com/ninchat/ninchat-go",true,function(Params_,Payload_,OnReply_,id_){this.$val=this;if(arguments.length===0){this.Params=false;this.Payload=BT.nil;this.OnReply=$throwNilPointerError;this.id=new $Int64(0,0);return;}this.Params=Params_;this.Payload=Payload_;this.OnReply=OnReply_;this.id=id_;});I=$pkg.Event=$newType(0,$kindStruct,"ninchat.Event",true,"github.com/ninchat/ninchat-go",true,function(Params_,Payload_,LastReply_){this.$val=this;if(arguments.length===0){this.Params=false;this.Payload=BT.nil;this.LastReply=false;return;}this.Params=Params_;this.Payload=Payload_;this.LastReply=LastReply_;});J=$pkg.Frame=$newType(4,$kindPtr,"ninchat.Frame",true,"github.com/ninchat/ninchat-go",true,null);L=$pkg.backoff=$newType(0,$kindStruct,"ninchat.backoff",true,"github.com/ninchat/ninchat-go",false,function(lastSlot_){this.$val=this;if(arguments.length===0){this.lastSlot=0;return;}this.lastSlot=lastSlot_;});O=$pkg.Caller=$newType(0,$kindStruct,"ninchat.Caller",true,"github.com/ninchat/ninchat-go",true,function(Address_){this.$val=this;if(arguments.length===0){this.Address="";return;}this.Address=Address_;});AB=$pkg.httpHeader=$newType(4,$kindMap,"ninchat.httpHeader",true,"github.com/ninchat/ninchat-go",false,null);AC=$pkg.httpRequest=$newType(0,$kindStruct,"ninchat.httpRequest",true,"github.com/ninchat/ninchat-go",false,function(Method_,URL_,Header_,data_){this.$val=this;if(arguments.length===0){this.Method="";this.URL="";this.Header=false;this.data=null;return;}this.Method=Method_;this.URL=URL_;this.Header=Header_;this.data=data_;});AF=$pkg.httpResponse=$newType(0,$kindStruct,"ninchat.httpResponse",true,"github.com/ninchat/ninchat-go",false,function(data_,err_){this.$val=this;if(arguments.length===0){this.data=null;this.err=$ifaceNil;return;}this.data=data_;this.err=err_;});AX=$pkg.Session=$newType(0,$kindStruct,"ninchat.Session",true,"github.com/ninchat/ninchat-go",true,function(OnSessionEvent_,OnEvent_,OnClose_,OnConnState_,OnConnActive_,OnLog_,Address_,forceLongPoll_,mutex_,sessionParams_,sessionId_,latestConnState_,lastActionId_,sendNotify_,sendBuffer_,numSent_,sendEventAck_,receivedEventId_,ackedEventId_,closeNotify_,closed_,running_,test_){this.$val=this;if(arguments.length===0){this.OnSessionEvent=$throwNilPointerError;this.OnEvent=$throwNilPointerError;this.OnClose=$throwNilPointerError;this.OnConnState=$throwNilPointerError;this.OnConnActive=$throwNilPointerError;this.OnLog=$throwNilPointerError;this.Address="";this.forceLongPoll=false;this.mutex=new D.Mutex.ptr(0,0);this.sessionParams=false;this.sessionId=$ifaceNil;this.latestConnState="";this.lastActionId=new $Int64(0,0);this.sendNotify=$chanNil;this.sendBuffer=CF.nil;this.numSent=0;this.sendEventAck=false;this.receivedEventId=new $Int64(0,0);this.ackedEventId=new $Int64(0,0);this.closeNotify=$chanNil;this.closed=false;this.running=false;this.test=new AZ.ptr();return;}this.OnSessionEvent=OnSessionEvent_;this.OnEvent=OnEvent_;this.OnClose=OnClose_;this.OnConnState=OnConnState_;this.OnConnActive=OnConnActive_;this.OnLog=OnLog_;this.Address=Address_;this.forceLongPoll=forceLongPoll_;this.mutex=mutex_;this.sessionParams=sessionParams_;this.sessionId=sessionId_;this.latestConnState=latestConnState_;this.lastActionId=lastActionId_;this.sendNotify=sendNotify_;this.sendBuffer=sendBuffer_;this.numSent=numSent_;this.sendEventAck=sendEventAck_;this.receivedEventId=receivedEventId_;this.ackedEventId=ackedEventId_;this.closeNotify=closeNotify_;this.closed=closed_;this.running=running_;this.test=test_;});AY=$pkg.transport=$newType(4,$kindFunc,"ninchat.transport",true,"github.com/ninchat/ninchat-go",false,null);AZ=$pkg.testSupport=$newType(0,$kindStruct,"ninchat.testSupport",true,"github.com/ninchat/ninchat-go",false,function(){this.$val=this;if(arguments.length===0){return;}});BA=$pkg.duration=$newType(8,$kindInt64,"ninchat.duration",true,"github.com/ninchat/ninchat-go",false,null);BB=$pkg.timeTime=$newType(8,$kindInt64,"ninchat.timeTime",true,"github.com/ninchat/ninchat-go",false,null);BF=$pkg.timer=$newType(0,$kindStruct,"ninchat.timer",true,"github.com/ninchat/ninchat-go",false,function(C_,id_){this.$val=this;if(arguments.length===0){this.C=$chanNil;this.id=null;return;}this.C=C_;this.id=id_;});BK=$pkg.webSocket=$newType(0,$kindStruct,"ninchat.webSocket",true,"github.com/ninchat/ninchat-go",false,function(notify_,goingAway_,err_,impl_,open_,buf_){this.$val=this;if(arguments.length===0){this.notify=$chanNil;this.goingAway=false;this.err=$ifaceNil;this.impl=null;this.open=false;this.buf=CI.nil;return;}this.notify=notify_;this.goingAway=goingAway_;this.err=err_;this.impl=impl_;this.open=open_;this.buf=buf_;});BQ=$sliceType($String);BR=$sliceType($emptyInterface);BS=$mapType($String,$emptyInterface);BT=$sliceType(J);BU=$ptrType(I);BV=$sliceType(BU);BW=$ptrType(BR);BX=$ptrType(BS);BY=$sliceType($Uint8);BZ=$ptrType(AC);CA=$funcType([],[],false);CB=$ptrType(B.Object);CC=$ptrType($Bool);CD=$structType("",[]);CE=$ptrType(H);CF=$sliceType(CE);CG=$ptrType(BF);CH=$ptrType(BK);CI=$sliceType(CB);CJ=$funcType([CB],[],false);CK=$funcType([BU],[],false);CL=$ptrType(L);CM=$ptrType(O);CN=$ptrType(AX);CO=$funcType([$String],[],false);CP=$funcType([BR],[],true);CQ=$chanType(CD,false,false);CR=$ptrType(AZ);F=function(a){var a;if(a===""){return"api.ninchat.com";}else{return a;}};G=function(a){var a,b,c,d,e,f,g,h,i,j,k,l,m,n;b=BQ.nil;c=$ifaceNil;e=(d=a[$String.keyFor("hosts")],d!==undefined?d.v:$ifaceNil);if($interfaceIsEqual(e,$ifaceNil)){c=A.New("invalid endpoint document");return[b,c];}f=$assertType(e,BR,true);g=f[0];h=f[1];if(!h){c=A.New("invalid endpoint hosts type");return[b,c];}if(g.$length===0){c=A.New("no endpoint hosts");return[b,c];}i=g;j=0;while(true){if(!(j<i.$length)){break;}k=((j<0||j>=i.$length)?($throwRuntimeError("index out of range"),undefined):i.$array[i.$offset+j]);l=$assertType(k,$String,true);m=l[0];n=l[1];if(n){b=$append(b,m);}else{c=A.New("invalid endpoint host value type");}j++;}if(b.$length>0){c=$ifaceNil;}return[b,c];};H.ptr.prototype.String=function(){var a,b,c,d,e,f,g;a="";b=this;c=(d=b.Params[$String.keyFor("action")],d!==undefined?[d.v,true]:[$ifaceNil,false]);e=c[0];f=c[1];if(f){g=$assertType(e,$String,true);a=g[0];}return a;};H.prototype.String=function(){return this.$val.String();};H.ptr.prototype.GetID=function(){var a,b,c;a=new $Int64(0,0);b=$ifaceNil;c=this;a=c.id;if((a.$high===0&&a.$low===0)){b=E;}return[a,b];};H.prototype.GetID=function(){return this.$val.GetID();};I.ptr.prototype.Bool=function(a){var a,b,c,d,e,f;b=false;c=this;e=(d=c.Params[$String.keyFor(a)],d!==undefined?d.v:$ifaceNil);if(!($interfaceIsEqual(e,$ifaceNil))){f=$assertType(e,$Bool,true);b=f[0];}return b;};I.prototype.Bool=function(a){return this.$val.Bool(a);};I.ptr.prototype.Int=function(a){var a,b,c,d,e,f,g,h;b=0;c=false;d=this;f=(e=d.Params[$String.keyFor(a)],e!==undefined?e.v:$ifaceNil);if(!($interfaceIsEqual(f,$ifaceNil))){g=0;h=$assertType(f,$Float64,true);g=h[0];c=h[1];if(c){b=((g>>0));}}return[b,c];};I.prototype.Int=function(a){return this.$val.Int(a);};I.ptr.prototype.Int64=function(a){var a,b,c,d,e,f,g,h;b=new $Int64(0,0);c=false;d=this;f=(e=d.Params[$String.keyFor(a)],e!==undefined?e.v:$ifaceNil);if(!($interfaceIsEqual(f,$ifaceNil))){g=0;h=$assertType(f,$Float64,true);g=h[0];c=h[1];if(c){b=(new $Int64(0,g));}}return[b,c];};I.prototype.Int64=function(a){return this.$val.Int64(a);};I.ptr.prototype.Float64=function(a){var a,b,c,d,e,f,g;b=0;c=false;d=this;f=(e=d.Params[$String.keyFor(a)],e!==undefined?e.v:$ifaceNil);if(!($interfaceIsEqual(f,$ifaceNil))){g=$assertType(f,$Float64,true);b=g[0];c=g[1];}return[b,c];};I.prototype.Float64=function(a){return this.$val.Float64(a);};I.ptr.prototype.Str=function(a){var a,b,c,d,e,f,g;b="";c=false;d=this;f=(e=d.Params[$String.keyFor(a)],e!==undefined?e.v:$ifaceNil);if(!($interfaceIsEqual(f,$ifaceNil))){g=$assertType(f,$String,true);b=g[0];c=g[1];}return[b,c];};I.prototype.Str=function(a){return this.$val.Str(a);};I.ptr.prototype.Array=function(a){var a,b,c,d,e,f,g;b=BR.nil;c=false;d=this;f=(e=d.Params[$String.keyFor(a)],e!==undefined?e.v:$ifaceNil);if(!($interfaceIsEqual(f,$ifaceNil))){g=$assertType(f,BR,true);b=g[0];c=g[1];}return[b,c];};I.prototype.Array=function(a){return this.$val.Array(a);};I.ptr.prototype.Map=function(a){var a,b,c,d,e,f,g;b=false;c=false;d=this;f=(e=d.Params[$String.keyFor(a)],e!==undefined?e.v:$ifaceNil);if(!($interfaceIsEqual(f,$ifaceNil))){g=$assertType(f,BS,true);b=g[0];c=g[1];}return[b,c];};I.prototype.Map=function(a){return this.$val.Map(a);};I.ptr.prototype.String=function(){var a,b,c;a="";b=this;c=b.Str("event");a=c[0];return a;};I.prototype.String=function(){return this.$val.String();};I.ptr.prototype.initLastReply=function(a){var a,b,c,d,e,f;b=this;c=b.Int("history_length");d=c[0];if(d>0){return;}if(b.String()==="search_results"){if(!($interfaceIsEqual((e=b.Params[$String.keyFor("users")],e!==undefined?e.v:$ifaceNil),$ifaceNil))||!($interfaceIsEqual((f=b.Params[$String.keyFor("channels")],f!==undefined?f.v:$ifaceNil),$ifaceNil))){return;}}b.LastReply=true;};I.prototype.initLastReply=function(a){return this.$val.initLastReply(a);};I.ptr.prototype.getError=function(){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p;a="";b="";c=false;d=$ifaceNil;e=this;f=(g=e.Params[$String.keyFor("event")],g!==undefined?[g.v,true]:[$ifaceNil,false]);h=f[0];i=f[1];if(!i||!($assertType(h,$String)==="error")){return[a,b,c,d];}a=$assertType((j=e.Params[$String.keyFor("error_type")],j!==undefined?j.v:$ifaceNil),$String);l=(k=e.Params[$String.keyFor("error_reason")],k!==undefined?k.v:$ifaceNil);if(!($interfaceIsEqual(l,$ifaceNil))){b=$assertType(l,$String);}if(a==="request_malformed"){m=(n=e.Params[$String.keyFor("action_id")],n!==undefined?[n.v,true]:[$ifaceNil,false]);o=m[1];if(o){return[a,b,c,d];}}p=a;if(p===("session_not_found")){c=true;if(!(b==="")){d=A.New("error: "+a+" ("+b+")");}else{d=A.New("error: "+a);}}else if(p===("connection_superseded")||p===("message_has_too_many_parts")||p===("message_part_too_long")||p===("message_too_long")||p===("payload_has_too_many_parts")||p===("payload_part_too_long")||p===("request_malformed")){if(!(b==="")){d=A.New("error: "+a+" ("+b+")");}else{d=A.New("error: "+a);}}return[a,b,c,d];};I.prototype.getError=function(){return this.$val.getError();};K=function(a){var a;return new BT([a]);};L.ptr.prototype.success=function(){var a;a=this;a.lastSlot=0;};L.prototype.success=function(){return this.$val.success();};L.ptr.prototype.failure=function(a){var a,b,c;b=new BA(0,0);c=this;if(c.lastSlot>0){b=(new BA(0,AI(($flatten64(a))*(c.lastSlot)/1024,-0.5)));}if(c.lastSlot<1023){c.lastSlot=((((c.lastSlot+1>>0))<<1>>0))-1>>0;}return b;};L.prototype.failure=function(a){return this.$val.failure(a);};O.ptr.prototype.Call=function(a){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=[b];c=[c];d=BV.nil;e=$ifaceNil;f=this;g="https://"+F(f.Address)+"/v2/call";h=V(g,a.Params);i=h[0];e=h[1];if(!($interfaceIsEqual(e,$ifaceNil))){$s=-1;return[d,e];}new AB(i.Header).Set("Accept","application/json");new AB(i.Header).Set("Content-Type","application/json");j=AJ(new BA(0,11000),0.1);l=AG(i,j);$s=1;case 1:if($c){$c=false;l=l.$blk();}if(l&&l.$blk!==undefined){break s;}k=l;m=k[0];e=k[1];if(!($interfaceIsEqual(e,$ifaceNil))){$s=-1;return[d,e];}b[0]=BR.nil;if(!($interfaceIsEqual(AM(m,(b.$ptr||(b.$ptr=new BW(function(){return this.$target[0];},function($v){this.$target[0]=$v;},b)))),$ifaceNil))){c[0]=false;e=AN(m,(c.$ptr||(c.$ptr=new BX(function(){return this.$target[0];},function($v){this.$target[0]=$v;},c))));if(!($interfaceIsEqual(e,$ifaceNil))){$s=-1;return[d,e];}b[0]=new BR([new BS(c[0])]);}d=$makeSlice(BV,0,b[0].$length);n=b[0];o=0;case 2:if(!(o<n.$length)){$s=3;continue;}p=o;q=((o<0||o>=n.$length)?($throwRuntimeError("index out of range"),undefined):n.$array[n.$offset+o]);r=$assertType(q,BS,true);s=r[0];t=r[1];if(!t){e=A.New("response event header is not an object");$s=-1;return[d,e];}u=new I.ptr(s,BT.nil,p===(b[0].$length-1>>0));if(!(a.OnReply===$throwNilPointerError)){$s=4;continue;}$s=5;continue;case 4:$r=a.OnReply(u);$s=6;case 6:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 5:d=$append(d,u);o++;$s=2;continue;case 3:$s=-1;return[d,e];}return;}if($f===undefined){$f={$blk:O.ptr.prototype.Call};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.$s=$s;$f.$r=$r;return $f;};O.prototype.Call=function(a){return this.$val.Call(a);};P=function(){return new($global.ArrayBuffer)();};Q=function(a){var a;return $parseInt(a.length);};R=function(a){var a;return T(a);};T=function(a){var a,b,c,d,e,f;b=$assertType($internalize(a,$emptyInterface),$String,true);c=b[1];if(c){return a;}d=new($global.Uint8Array)(a);e=$assertType($internalize(d,$emptyInterface),BY);f=($bytesToString(e));return new($global.String)($externalize(f,$String));};$pkg.StringifyFrame=T;U=function(a){var a,b,c,d,e,f;b=$ifaceNil;if(!($interfaceIsEqual(a,$ifaceNil))){c=a;if($assertType(c,$error,true)[1]){d=c;b=d;}else if($assertType(c,$String,true)[1]){e=c.$val;b=A.New(e);}else{f=c;b=A.New("?");}}return b;};V=function(a,b){var a,b,c,d,e,f,g;c=BZ.nil;d=$ifaceNil;e=AL(b);f=e[0];d=e[1];if(!($interfaceIsEqual(d,$ifaceNil))){return[c,d];}g=AE("POST",a,f);c=g[0];d=g[1];return[c,d];};W=function(a,b,c){var a,b,c,d,e,f,g,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:d=new $Chan(AF,1);e=V(a,b);f=e[0];g=e[1];if($interfaceIsEqual(g,$ifaceNil)){$s=1;continue;}$s=2;continue;case 1:$r=AH(f,c,d);$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=3;continue;case 2:$r=$send(d,$clone(new AF.ptr(null,g),AF));$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 3:$s=-1;return d;}return;}if($f===undefined){$f={$blk:W};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.$s=$s;$f.$r=$r;return $f;};X=function(a,b){var a,b,c,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=new $Chan(AF,1);$r=AH(a,b,c);$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return c;}return;}if($f===undefined){$f={$blk:X};}$f.a=a;$f.b=b;$f.c=c;$f.$s=$s;$f.$r=$r;return $f;};AA=function(){Y=$global.XDomainRequest;if(Y===undefined){Y=$global.XMLHttpRequest;if(Y===undefined){Y=$module.require($externalize("xhr2",$String));}Z=true;}};AB.prototype.Set=function(a,b){var a,b,c,d;c=this.$val;d=a;(c||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(d)]={k:d,v:b};};$ptrType(AB).prototype.Set=function(a,b){return new AB(this.$get()).Set(a,b);};AD=function(a){var a,b,c;b=BZ.nil;c=$ifaceNil;b=new AC.ptr("GET",a,{},null);return[b,c];};AE=function(a,b,c){var a,b,c,d,e;d=BZ.nil;e=$ifaceNil;d=new AC.ptr(a,b,{},c);return[d,e];};AG=function(a,b){var a,b,c,d,e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=X(a,b);$s=1;case 1:if($c){$c=false;c=c.$blk();}if(c&&c.$blk!==undefined){break s;}d=$recv(c);$s=2;case 2:if($c){$c=false;d=d.$blk();}if(d&&d.$blk!==undefined){break s;}e=$clone(d[0],AF);$s=-1;return[e.data,e.err];}return;}if($f===undefined){$f={$blk:AG};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};AH=function(a,b,c){var a,b,c,d,e,f,g,h,i,j,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);a=[a];c=[c];d=[d];$deferred.push([(function(a,c,d){return function $b(){var e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:e=U($recover());if(!($interfaceIsEqual(e,$ifaceNil))){$s=1;continue;}$s=2;continue;case 1:$r=$send(c[0],$clone(new AF.ptr(null,e),AF));$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 2:$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};})(a,c,d),[]]);d[0]=new(Y)();d[0].onload=$externalize((function(a,c,d){return function(){var e;e=d[0].responseText;$go((function(a,c,d){return function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=$send(c[0],$clone(new AF.ptr(e,$ifaceNil),AF));$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;};})(a,c,d),[]);};})(a,c,d),CA);d[0].onprogress=$externalize((function(a,c,d){return function(){$global.setTimeout($externalize((function(a,c,d){return function(){};})(a,c,d),CA),0);};})(a,c,d),CA);d[0].ontimeout=$externalize((function(a,c,d){return function(){$go((function(a,c,d){return function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=$send(c[0],$clone(new AF.ptr(null,A.New("timeout")),AF));$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;};})(a,c,d),[]);};})(a,c,d),CA);d[0].onerror=$externalize((function(a,c,d){return function(){$go((function(a,c,d){return function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=$send(c[0],$clone(new AF.ptr(null,A.New("error")),AF));$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;};})(a,c,d),[]);};})(a,c,d),CA);d[0].open($externalize(a[0].Method,$String),$externalize(a[0].URL,$String));d[0].timeout=$externalize(b,BA);if(Z){e=a[0].Header;f=0;g=$keys(e);while(true){if(!(f<g.length)){break;}h=e[g[f]];if(h===undefined){f++;continue;}i=h.k;j=h.v;d[0].setRequestHeader($externalize(i,$String),$externalize(j,$String));f++;}}$global.setTimeout($externalize((function(a,c,d){return function(){d[0].send(a[0].data);};})(a,c,d),CA),0);$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AH};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AI=function(a,b){var a,b;return a+a*b*AV();};AJ=function(a,b){var a,b;return(new BA(0,AI(($flatten64(a)),b)));};AK=function(a,b){var a,b;return(new $Int64(0,AI(($flatten64(a)),b)));};AL=function(a){var a,b,c,$deferred;var $err=null;try{$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=null;c=$ifaceNil;$deferred.push([(function(){c=U($recover());}),[]]);b=$global.JSON.stringify($externalize(a,BS));return[b,c];}catch(err){$err=err;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return[b,c];}}};AM=function(a,b){var a,b,c,d,e,f,g,h;c=$ifaceNil;d=AO(a);e=d[0];c=d[1];if(!($interfaceIsEqual(c,$ifaceNil))){return c;}f=$assertType(e,BR,true);g=f[0];h=f[1];if(!h){c=A.New("json: cannot unmarshal value into Go value of type *[]interface{}");return c;}b.$set(g);return c;};AN=function(a,b){var a,b,c,d,e,f,g,h;c=$ifaceNil;d=AO(a);e=d[0];c=d[1];if(!($interfaceIsEqual(c,$ifaceNil))){return c;}f=$assertType(e,BS,true);g=f[0];h=f[1];if(!h){c=A.New("json: cannot unmarshal value into Go value of type *map[string]interface{}");return c;}b.$set(g);return c;};AO=function(a){var a,b,c,$deferred;var $err=null;try{$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=$ifaceNil;c=$ifaceNil;$deferred.push([(function(){c=U($recover());}),[]]);b=$internalize($global.JSON.parse(a),$emptyInterface);return[b,c];}catch(err){$err=err;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return[b,c];}}};AP=function(a){var a,b,c,d,e,f;b=BR.nil;c=a.Payload;d=0;while(true){if(!(d<c.$length)){break;}e=((d<0||d>=c.$length)?($throwRuntimeError("index out of range"),undefined):c.$array[c.$offset+d]);f=($pointerOfStructConversion(e,CB)).split($externalize(",",$String))[1];b=$append(b,new $jsObjectPtr(f));d++;}return b;};AQ=function(a,b){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=[c];d=[d];e=[e];d[0]=false;e[0]=false;f="https://"+b+"/v2/poll";if($interfaceIsEqual(a.sessionId,$ifaceNil)){$s=1;continue;}$s=2;continue;case 1:$r=a.log(new BR([new $String("session creation")]));$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}g=a.makeCreateSessionAction();h=AJ(new BA(0,37000),0.2);$r=a.mutex.Unlock();$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}j=W(f,g,h);$s=6;case 6:if($c){$c=false;j=j.$blk();}if(j&&j.$blk!==undefined){break s;}k=$select([[j],[a.closeNotify]]);$s=7;case 7:if($c){$c=false;k=k.$blk();}if(k&&k.$blk!==undefined){break s;}i=k;if(i[0]===0){$s=8;continue;}if(i[0]===1){$s=9;continue;}$s=10;continue;case 8:l=$clone(i[1][0],AF);$r=a.mutex.Lock();$s=11;case 11:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!($interfaceIsEqual(l.err,$ifaceNil))){$s=12;continue;}$s=13;continue;case 12:$r=a.log(new BR([new $String("session creation:"),l.err]));$s=14;case 14:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d[0],e[0]];case 13:c[0]=BR.nil;m=AM(l.data,(c.$ptr||(c.$ptr=new BW(function(){return this.$target[0];},function($v){this.$target[0]=$v;},c))));if(!($interfaceIsEqual(m,$ifaceNil))){$s=15;continue;}$s=16;continue;case 15:$r=a.log(new BR([new $String("session creation response:"),m]));$s=17;case 17:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d[0],e[0]];case 16:if(c[0].$length===0){$s=18;continue;}$s=19;continue;case 18:$r=a.log(new BR([new $String("session creation response JSON array is empty")]));$s=20;case 20:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d[0],e[0]];case 19:n=$assertType((0>=c[0].$length?($throwRuntimeError("index out of range"),undefined):c[0].$array[c[0].$offset+0]),BS,true);o=n[0];p=n[1];if(!p){$s=21;continue;}$s=22;continue;case 21:$r=a.log(new BR([new $String("session creation response header is not a JSON object")]));$s=23;case 23:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d[0],e[0]];case 22:q=a.handleSessionEvent(o);$s=26;case 26:if($c){$c=false;q=q.$blk();}if(q&&q.$blk!==undefined){break s;}if(!q){$s=24;continue;}$s=25;continue;case 24:$s=-1;return[d[0],e[0]];case 25:$s=10;continue;case 9:$r=a.mutex.Lock();$s=27;case 27:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=AT(a,f);$s=28;case 28:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d[0],e[0]];case 10:d[0]=true;e[0]=true;$r=a.connState("connected");$s=29;case 29:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=a.connActive();$s=30;case 30:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=3;continue;case 2:$r=a.log(new BR([new $String("session resumption")]));$s=31;case 31:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=AS(a,f);$s=32;case 32:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 3:$r=AR(a,f,(d.$ptr||(d.$ptr=new CC(function(){return this.$target[0];},function($v){this.$target[0]=$v;},d))),(e.$ptr||(e.$ptr=new CC(function(){return this.$target[0];},function($v){this.$target[0]=$v;},e))));$s=33;case 33:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d[0],e[0]];}return;}if($f===undefined){$f={$blk:AQ};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.$s=$s;$f.$r=$r;return $f;};AR=function(a,b,c,d){var a,aa,ab,ac,ad,ae,af,ag,ah,ai,aj,ak,al,am,an,ao,ap,aq,ar,as,at,au,av,aw,ax,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;aa=$f.aa;ab=$f.ab;ac=$f.ac;ad=$f.ad;ae=$f.ae;af=$f.af;ag=$f.ag;ah=$f.ah;ai=$f.ai;aj=$f.aj;ak=$f.ak;al=$f.al;am=$f.am;an=$f.an;ao=$f.ao;ap=$f.ap;aq=$f.aq;ar=$f.ar;as=$f.as;at=$f.at;au=$f.au;av=$f.av;aw=$f.aw;ax=$f.ax;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;v=$f.v;w=$f.w;x=$f.x;y=$f.y;z=$f.z;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:e=$chanNil;f=$chanNil;g=new $Int64(0,0);h=0;a.numSent=0;case 1:if(!(h<2)){$s=2;continue;}i=[i];j=[j];if(e===$chanNil){$s=3;continue;}$s=4;continue;case 3:k=a.makeResumeSessionAction(true);l=AJ(new BA(0,64000),0.2);m=W(b,k,l);$s=5;case 5:if($c){$c=false;m=m.$blk();}if(m&&m.$blk!==undefined){break s;}e=m;case 4:if(f===$chanNil&&a.numSent<a.sendBuffer.$length){$s=6;continue;}$s=7;continue;case 6:p=(n=a.sendBuffer,o=a.numSent,((o<0||o>=n.$length)?($throwRuntimeError("index out of range"),undefined):n.$array[n.$offset+o]));if(!(p.Payload===BT.nil)){$s=8;continue;}$s=9;continue;case 8:if(p.String()==="update_user"){$s=10;continue;}$s=11;continue;case 10:q="payload";(p.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(q)]={k:q,v:AP(p)};$s=12;continue;case 11:j[0]=false;s=AN((r=p.Payload,(0>=r.$length?($throwRuntimeError("index out of range"),undefined):r.$array[r.$offset+0])),(j.$ptr||(j.$ptr=new BX(function(){return this.$target[0];},function($v){this.$target[0]=$v;},j))));if(!($interfaceIsEqual(s,$ifaceNil))){$s=13;continue;}$s=14;continue;case 13:$r=a.log(new BR([new $String("send:"),s]));$s=15;case 15:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 14:t="payload";(p.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(t)]={k:t,v:new BS(j[0])};case 12:case 9:u="session_id";(p.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(u)]={k:u,v:a.sessionId};v=AJ(new BA(0,7000),0.2);w=W(b,p.Params,v);$s=16;case 16:if($c){$c=false;w=w.$blk();}if(w&&w.$blk!==undefined){break s;}x=w;delete p.Params[$String.keyFor("session_id")];delete p.Params[$String.keyFor("payload")];if((y=p.id,(y.$high===0&&y.$low===0))){$go(AU,[a,x,"send error:"]);a.sendBuffer=$appendSlice($subslice(a.sendBuffer,0,a.numSent),$subslice(a.sendBuffer,(a.numSent+1>>0)));}else{f=x;g=p.id;}case 7:z=new AF.ptr(null,$ifaceNil);$r=a.mutex.Unlock();$s=17;case 17:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}ab=$select([[e],[f],[a.sendNotify],[a.closeNotify]]);$s=18;case 18:if($c){$c=false;ab=ab.$blk();}if(ab&&ab.$blk!==undefined){break s;}aa=ab;if(aa[0]===0){$s=19;continue;}if(aa[0]===1){$s=20;continue;}if(aa[0]===2){$s=21;continue;}if(aa[0]===3){$s=22;continue;}$s=23;continue;case 19:AF.copy(z,aa[1][0]);$r=a.mutex.Lock();$s=24;case 24:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!($interfaceIsEqual(z.err,$ifaceNil))){$s=25;continue;}$s=26;continue;case 25:$r=a.log(new BR([new $String("poll error:"),z.err]));$s=27;case 27:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 26:e=$chanNil;$r=a.connActive();$s=28;case 28:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=23;continue;case 20:AF.copy(z,aa[1][0]);$r=a.mutex.Lock();$s=29;case 29:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!($interfaceIsEqual(z.err,$ifaceNil))){$s=30;continue;}if((g.$high>0||(g.$high===0&&g.$low>0))){$s=31;continue;}$s=32;continue;case 30:$r=a.log(new BR([new $String("send error:"),z.err]));$s=33;case 33:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=32;continue;case 31:a.numSent=a.numSent+(1)>>0;case 32:f=$chanNil;g=new $Int64(0,0);$s=23;continue;case 21:ac=aa[1];ad=ac[1];$r=a.mutex.Lock();$s=34;case 34:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!ad){$s=35;continue;}$s=36;continue;case 35:$r=AT(a,b);$s=37;case 37:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 36:$s=1;continue;$s=23;continue;case 22:$r=a.mutex.Lock();$s=38;case 38:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=AT(a,b);$s=39;case 39:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 23:i[0]=BR.nil;ae=z.err;if($interfaceIsEqual(ae,$ifaceNil)){$s=40;continue;}$s=41;continue;case 40:ae=AM(z.data,(i.$ptr||(i.$ptr=new BW(function(){return this.$target[0];},function($v){this.$target[0]=$v;},i))));if(!($interfaceIsEqual(ae,$ifaceNil))){$s=42;continue;}$s=43;continue;case 42:$r=a.log(new BR([new $String("response:"),ae]));$s=44;case 44:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 43:case 41:if(!($interfaceIsEqual(ae,$ifaceNil))){$s=45;continue;}$s=46;continue;case 45:h=h+(1)>>0;a.numSent=0;$s=1;continue;case 46:h=0;c.$set(true);af=i[0];ag=0;case 47:if(!(ag<af.$length)){$s=48;continue;}ah=((ag<0||ag>=af.$length)?($throwRuntimeError("index out of range"),undefined):af.$array[af.$offset+ag]);ai=$assertType(ah,BS,true);aj=ai[0];ak=ai[1];if(!ak){$s=49;continue;}$s=50;continue;case 49:$r=a.log(new BR([new $String("poll event is not an object")]));$s=51;case 51:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 50:al=new I.ptr(aj,BT.nil,false);an=(am=aj[$String.keyFor("payload")],am!==undefined?am.v:$ifaceNil);if(!($interfaceIsEqual(an,$ifaceNil))){$s=52;continue;}$s=53;continue;case 52:ao=$assertType(an,BS,true);ap=ao[0];aq=ao[1];if(!aq){$s=54;continue;}$s=55;continue;case 54:$r=a.log(new BR([new $String("poll payload is not an object")]));$s=56;case 56:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 55:ar=AL(ap);as=ar[0];at=ar[1];if(!($interfaceIsEqual(at,$ifaceNil))){$s=57;continue;}$s=58;continue;case 57:$r=a.log(new BR([new $String("poll payload:"),at]));$s=59;case 59:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 58:al.Payload=K(as);case 53:av=a.handleEvent(al);$s=60;case 60:if($c){$c=false;av=av.$blk();}if(av&&av.$blk!==undefined){break s;}au=av;aw=au[0];ax=au[1];ak=au[3];if((g.$high>0||(g.$high===0&&g.$low>0))&&(g.$high<aw.$high||(g.$high===aw.$high&&g.$low<=aw.$low))){g=new $Int64(0,0);a.numSent=a.numSent+(1)>>0;}if(!ak){if(ax){d.$set(true);}$s=-1;return;}if(!d.$get()){$s=61;continue;}$s=62;continue;case 61:d.$set(true);$r=a.connState("connected");$s=63;case 63:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 62:ag++;$s=47;continue;case 48:$s=1;continue;case 2:$s=-1;return;}return;}if($f===undefined){$f={$blk:AR};}$f.a=a;$f.aa=aa;$f.ab=ab;$f.ac=ac;$f.ad=ad;$f.ae=ae;$f.af=af;$f.ag=ag;$f.ah=ah;$f.ai=ai;$f.aj=aj;$f.ak=ak;$f.al=al;$f.am=am;$f.an=an;$f.ao=ao;$f.ap=ap;$f.aq=aq;$f.ar=ar;$f.as=as;$f.at=at;$f.au=au;$f.av=av;$f.aw=aw;$f.ax=ax;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.v=v;$f.w=w;$f.x=x;$f.y=y;$f.z=z;$f.$s=$s;$f.$r=$r;return $f;};AS=function(a,b){var a,b,c,d,e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=$makeMap($String.keyFor,[{k:"action",v:new $String("ping")},{k:"session_id",v:a.sessionId}]);d=W(b,c,AJ(new BA(0,7000),0.9));$s=1;case 1:if($c){$c=false;d=d.$blk();}if(d&&d.$blk!==undefined){break s;}e=d;$go(AU,[a,e,"ping error:"]);$s=-1;return;}return;}if($f===undefined){$f={$blk:AS};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};AT=function(a,b){var a,b,c,d,e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=$makeMap($String.keyFor,[{k:"action",v:new $String("close_session")},{k:"session_id",v:a.sessionId}]);d=W(b,c,AJ(new BA(0,7000),0.9));$s=1;case 1:if($c){$c=false;d=d.$blk();}if(d&&d.$blk!==undefined){break s;}e=d;$go(AU,[a,e,"send error:"]);$s=-1;return;}return;}if($f===undefined){$f={$blk:AT};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};AU=function(a,b,c){var a,b,c,d,e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:d=$recv(b);$s=1;case 1:if($c){$c=false;d=d.$blk();}if(d&&d.$blk!==undefined){break s;}e=$clone(d[0],AF);if(!($interfaceIsEqual(e.err,$ifaceNil))&&!(a.OnLog===$throwNilPointerError)){$s=2;continue;}$s=3;continue;case 2:$r=a.OnLog(new BR([new $String(c),e.err]));$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 3:$s=-1;return;}return;}if($f===undefined){$f={$blk:AU};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};AV=function(){return $parseFloat($global.Math.random());};AX.ptr.prototype.SetParams=function(a){var a,b,c,d,e,f,g,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=this;$r=b.mutex.Lock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(b.mutex,"Unlock"),[]]);if($interfaceIsEqual((c=a[$String.keyFor("message_types")],c!==undefined?c.v:$ifaceNil),$ifaceNil)){$panic(new $String("message_types parameter not defined"));}d=(e=a[$String.keyFor("session_id")],e!==undefined?[e.v,true]:[$ifaceNil,false]);f=d[0];g=d[1];if(!($interfaceIsEqual(f,$ifaceNil))){b.sessionId=f;}else if(g){delete a[$String.keyFor("session_id")];}b.sessionParams=a;if(!(b.sendNotify===$chanNil)&&!b.running){b.running=true;$go($methodVal(b,"discover"),[]);}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AX.ptr.prototype.SetParams};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AX.prototype.SetParams=function(a){return this.$val.SetParams(a);};AX.ptr.prototype.Open=function(){var a,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);a=this;$r=a.mutex.Lock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(a.mutex,"Unlock"),[]]);if(a.closed){$panic(new $String("session already closed"));}if(!(a.sendNotify===$chanNil)){$panic(new $String("session already initialized"));}if(a.OnSessionEvent===$throwNilPointerError){$panic(new $String("onSessionEvent callback not defined"));}if(a.OnEvent===$throwNilPointerError){$panic(new $String("onEvent callback not defined"));}if(a.sessionParams===false){$panic(new $String("session parameters not defined"));}a.sendNotify=new $Chan(CD,1);a.closeNotify=new $Chan(CD,1);a.running=true;$go($methodVal(a,"discover"),[]);$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AX.ptr.prototype.Open};}$f.a=a;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AX.prototype.Open=function(){return this.$val.Open();};AX.ptr.prototype.Close=function(){var a,b,c,d,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);a=[a];a[0]=this;$r=a[0].mutex.Lock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(a[0].mutex,"Unlock"),[]]);if(a[0].closed){$s=-1;return;}b=a[0].sendBuffer;c=0;case 2:if(!(c<b.$length)){$s=3;continue;}d=((c<0||c>=b.$length)?($throwRuntimeError("index out of range"),undefined):b.$array[b.$offset+c]);if(!(d.OnReply===$throwNilPointerError)){$s=4;continue;}$s=5;continue;case 4:$r=d.OnReply(BU.nil);$s=6;case 6:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 5:c++;$s=2;continue;case 3:a[0].sendBuffer=CF.nil;a[0].numSent=0;a[0].closed=true;a[0].running=false;$go((function(a){return function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=$send(a[0].closeNotify,$clone(new CD.ptr(),CD));$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$close(a[0].sendNotify);$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;};})(a),[]);$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AX.ptr.prototype.Close};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AX.prototype.Close=function(){return this.$val.Close();};AX.ptr.prototype.Send=function(a){var a,b,c,d,e,f,g,h,i,j,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=$ifaceNil;c=this;$r=c.mutex.Lock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(c.mutex,"Unlock"),[]]);if(c.sendNotify===$chanNil){$panic(new $String("session not initialized"));}if(c.closed){$panic(new $String("session already closed"));}if(a.Payload.$length===0){a.Payload=BT.nil;}d=(e=a.Params[$String.keyFor("action_id")],e!==undefined?[e.v,true]:[$ifaceNil,false]);f=d[0];g=d[1];if(g&&$interfaceIsEqual(f,$ifaceNil)){delete a.Params[$String.keyFor("action_id")];}else{c.lastActionId=(h=c.lastActionId,i=new $Int64(0,1),new $Int64(h.$high+i.$high,h.$low+i.$low));a.id=c.lastActionId;j="action_id";(a.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(j)]={k:j,v:a.id};}c.send(a);$s=-1;return b;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return b;}if($curGoroutine.asleep){if($f===undefined){$f={$blk:AX.ptr.prototype.Send};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AX.prototype.Send=function(a){return this.$val.Send(a);};AX.ptr.prototype.send=function(a){var a,b;b=this;b.sendBuffer=$append(b.sendBuffer,a);$go((function $b(){var c,$r;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;c=$f.c;$r=$f.$r;}c=$select([[b.sendNotify,new CD.ptr()],[]]);if(c[0]===0){}else if(c[0]===1){}if($f===undefined){$f={$blk:$b};}$f.c=c;$f.$r=$r;return $f;}),[]);return;};AX.prototype.send=function(a){return this.$val.send(a);};AX.ptr.prototype.sendAck=function(){var a;a=this;a.sendEventAck=true;$go((function $b(){var b,$r;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;$r=$f.$r;}b=$select([[a.sendNotify,new CD.ptr()],[]]);if(b[0]===0){}else if(b[0]===1){}if($f===undefined){$f={$blk:$b};}$f.b=b;$f.$r=$r;return $f;}),[]);};AX.prototype.sendAck=function(){return this.$val.sendAck();};AX.ptr.prototype.discover=function(){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);a=[a];b=[b];b[0]=this;$r=b[0].mutex.Lock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([(function(a,b){return function $b(){var c,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;c=$f.c;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=b[0].closed;$r=b[0].mutex.Unlock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(c&&!(b[0].OnClose===$throwNilPointerError)){$s=2;continue;}$s=3;continue;case 2:$r=b[0].OnClose();$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 3:$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.c=c;$f.$s=$s;$f.$r=$r;return $f;};})(a,b),[]]);$r=b[0].log(new BR([new $String("starting")]));$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(b[0],"log"),[new BR([new $String("stopped")])]]);$deferred.push([$methodVal(b[0],"connState"),["disconnected"]]);a[0]=new L.ptr(0);case 3:if(!(b[0].running)){$s=4;continue;}c=[c];$r=b[0].connState("connecting");$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}d="https://"+F(b[0].Address)+"/v2/endpoint";e=AD(d);f=e[0];g=e[1];if(!($interfaceIsEqual(g,$ifaceNil))){$panic(g);}$r=b[0].mutex.Unlock();$s=6;case 6:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}i=X(f,AJ(new BA(0,7000),0.1));$s=7;case 7:if($c){$c=false;i=i.$blk();}if(i&&i.$blk!==undefined){break s;}j=$select([[i],[b[0].closeNotify]]);$s=8;case 8:if($c){$c=false;j=j.$blk();}if(j&&j.$blk!==undefined){break s;}h=j;if(h[0]===0){$s=9;continue;}if(h[0]===1){$s=10;continue;}$s=11;continue;case 9:k=$clone(h[1][0],AF);$r=b[0].mutex.Lock();$s=12;case 12:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}l=BQ.nil;m=k.err;if($interfaceIsEqual(m,$ifaceNil)){c[0]=false;m=AN(k.data,(c.$ptr||(c.$ptr=new BX(function(){return this.$target[0];},function($v){this.$target[0]=$v;},c))));if($interfaceIsEqual(m,$ifaceNil)){n=G(c[0]);l=n[0];m=n[1];}}if($interfaceIsEqual(m,$ifaceNil)){$s=13;continue;}$s=14;continue;case 13:$r=b[0].log(new BR([new $String("endpoint discovered")]));$s=16;case 16:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(BI&&!b[0].forceLongPoll){$s=17;continue;}$s=18;continue;case 17:o=b[0].connect(BM,l,a[0]);$s=21;case 21:if($c){$c=false;o=o.$blk();}if(o&&o.$blk!==undefined){break s;}if(o){$s=19;continue;}$s=20;continue;case 19:$s=3;continue;case 20:case 18:p=b[0].connect(AQ,l,a[0]);$s=22;case 22:if($c){$c=false;p=p.$blk();}if(p&&p.$blk!==undefined){break s;}p;$s=15;continue;case 14:$r=b[0].log(new BR([new $String("endpoint discovery:"),m]));$s=23;case 23:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 15:$s=11;continue;case 10:$r=b[0].mutex.Lock();$s=24;case 24:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 11:q=b[0].backOff(a[0]);$s=27;case 27:if($c){$c=false;q=q.$blk();}if(q&&q.$blk!==undefined){break s;}if(!q){$s=25;continue;}$s=26;continue;case 25:$s=-1;return;case 26:$s=3;continue;case 4:$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AX.ptr.prototype.discover};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AX.prototype.discover=function(){return this.$val.discover();};AX.ptr.prototype.connect=function(a,b,c){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:d=false;e=this;f=0;case 1:if(!(f<2)){$s=2;continue;}g=b;h=0;case 3:if(!(h<g.$length)){$s=4;continue;}i=((h<0||h>=g.$length)?($throwRuntimeError("index out of range"),undefined):g.$array[g.$offset+h]);$r=e.connState("connecting");$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}j=e.Address;k=0;while(true){if(!(k<j.length)){break;}l=$decodeRune(j,k);m=k;n=l[0];if(n===47){i=i+($substring(e.Address,m));break;}k+=l[1];}p=a(e,i);$s=6;case 6:if($c){$c=false;p=p.$blk();}if(p&&p.$blk!==undefined){break s;}o=p;q=o[0];r=o[1];if(q){d=true;}if(r){c.success();$s=-1;return d;}if(!e.running){$s=-1;return d;}s=e.backOff(c);$s=9;case 9:if($c){$c=false;s=s.$blk();}if(s&&s.$blk!==undefined){break s;}if(!s){$s=7;continue;}$s=8;continue;case 7:$s=-1;return d;case 8:h++;$s=3;continue;case 4:f=f+(1)>>0;$s=1;continue;case 2:$s=-1;return d;}return;}if($f===undefined){$f={$blk:AX.ptr.prototype.connect};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.$s=$s;$f.$r=$r;return $f;};AX.prototype.connect=function(a,b,c){return this.$val.connect(a,b,c);};AX.ptr.prototype.backOff=function(a){var a,b,c,d,e,f,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=false;c=this;d=a.failure(new BA(0,60000));if((d.$high===0&&d.$low===0)){b=true;$s=-1;return b;}$r=c.connState("disconnected");$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=c.log(new BR([new $String("sleeping")]));$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=c.mutex.Unlock();$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(c.mutex,"Lock"),[]]);f=$select([[BG(d).C],[c.closeNotify]]);$s=4;case 4:if($c){$c=false;f=f.$blk();}if(f&&f.$blk!==undefined){break s;}e=f;if(e[0]===0){b=true;}else if(e[0]===1){}$s=-1;return b;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return b;}if($curGoroutine.asleep){if($f===undefined){$f={$blk:AX.ptr.prototype.backOff};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AX.prototype.backOff=function(a){return this.$val.backOff(a);};AX.ptr.prototype.canLogin=function(){var a,b,c,d,e,f,g,h;a=this;if(!($interfaceIsEqual((b=a.sessionParams[$String.keyFor("access_key")],b!==undefined?b.v:$ifaceNil),$ifaceNil))){return true;}if(!($interfaceIsEqual((c=a.sessionParams[$String.keyFor("user_id")],c!==undefined?c.v:$ifaceNil),$ifaceNil))){return!($interfaceIsEqual((d=a.sessionParams[$String.keyFor("user_auth")],d!==undefined?d.v:$ifaceNil),$ifaceNil))||!($interfaceIsEqual((e=a.sessionParams[$String.keyFor("master_sign")],e!==undefined?e.v:$ifaceNil),$ifaceNil));}return!($interfaceIsEqual((f=a.sessionParams[$String.keyFor("identity_type")],f!==undefined?f.v:$ifaceNil),$ifaceNil))&&!($interfaceIsEqual((g=a.sessionParams[$String.keyFor("identity_name")],g!==undefined?g.v:$ifaceNil),$ifaceNil))&&!($interfaceIsEqual((h=a.sessionParams[$String.keyFor("identity_auth")],h!==undefined?h.v:$ifaceNil),$ifaceNil));};AX.prototype.canLogin=function(){return this.$val.canLogin();};AX.ptr.prototype.makeCreateSessionAction=function(){var a,aa,ab,ac,ad,ae,af,ag,ah,ai,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z;a=false;b=this;a=$makeMap($String.keyFor,[{k:"action",v:new $String("create_session")}]);d=(c=b.sessionParams[$String.keyFor("user_id")],c!==undefined?c.v:$ifaceNil);if($interfaceIsEqual(d,$ifaceNil)){e=b.sessionParams;f=0;g=$keys(e);while(true){if(!(f<g.length)){break;}h=e[g[f]];if(h===undefined){f++;continue;}i=h.k;j=h.v;k=i;(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(k)]={k:k,v:j};f++;}}else{m=(l=b.sessionParams[$String.keyFor("user_auth")],l!==undefined?l.v:$ifaceNil);if(!($interfaceIsEqual(m,$ifaceNil))){n="user_id";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(n)]={k:n,v:d};o="user_auth";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(o)]={k:o,v:m};}else{q=(p=b.sessionParams[$String.keyFor("master_sign")],p!==undefined?p.v:$ifaceNil);if(!($interfaceIsEqual(q,$ifaceNil))){r="user_id";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(r)]={k:r,v:d};s="master_sign";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(s)]={k:s,v:q};}else{u=(t=b.sessionParams[$String.keyFor("identity_type")],t!==undefined?t.v:$ifaceNil);if(!($interfaceIsEqual(u,$ifaceNil))){v="identity_type";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(v)]={k:v,v:u};w="identity_name";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(w)]={k:w,v:(x=b.sessionParams[$String.keyFor("identity_name")],x!==undefined?x.v:$ifaceNil)};y="identity_auth";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(y)]={k:y,v:(z=b.sessionParams[$String.keyFor("identity_auth")],z!==undefined?z.v:$ifaceNil)};}else{aa="user_id";(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(aa)]={k:aa,v:d};}}}ab=b.sessionParams;ac=0;ad=$keys(ab);while(true){if(!(ac<ad.length)){break;}ae=ab[ad[ac]];if(ae===undefined){ac++;continue;}af=ae.k;ag=ae.v;ah=af;if(ah===("user_id")||ah===("user_auth")||ah===("identity_type")||ah===("identity_name")||ah===("identity_auth")||ah===("access_key")||ah===("master_sign")){}else{ai=af;(a||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(ai)]={k:ai,v:ag};}ac++;}}return a;};AX.prototype.makeCreateSessionAction=function(){return this.$val.makeCreateSessionAction();};AX.ptr.prototype.makeResumeSessionAction=function(a){var a,b,c,d;b=false;c=this;b=$makeMap($String.keyFor,[{k:"action",v:new $String("resume_session")},{k:"event_id",v:c.receivedEventId}]);if(a){d="session_id";(b||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(d)]={k:d,v:c.sessionId};}c.sendEventAck=false;c.ackedEventId=c.receivedEventId;return b;};AX.prototype.makeResumeSessionAction=function(a){return this.$val.makeResumeSessionAction(a);};AX.ptr.prototype.handleSessionEvent=function(a){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=false;c=this;d=new I.ptr(a,BT.nil,false);e=false;if(d.String()==="error"){c.sessionId=$ifaceNil;e=true;f=d.Str("error_type");g=f[0];h=g;if(h===("internal")){}else{c.running=false;}}$r=c.deliverSessionEvent(d);$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(e){$s=-1;return b;}delete c.sessionParams[$String.keyFor("user_attrs")];delete c.sessionParams[$String.keyFor("user_settings")];delete c.sessionParams[$String.keyFor("identity_attrs")];delete c.sessionParams[$String.keyFor("access_key")];delete c.sessionParams[$String.keyFor("master_sign")];i="user_id";(c.sessionParams||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(i)]={k:i,v:(j=d.Params[$String.keyFor("user_id")],j!==undefined?j.v:$ifaceNil)};l=(k=d.Params[$String.keyFor("user_auth")],k!==undefined?k.v:$ifaceNil);if(!($interfaceIsEqual(l,$ifaceNil))){m="user_auth";(c.sessionParams||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(m)]={k:m,v:l};}n=new BQ(["identity_type","identity_name","identity_auth"]);o=0;while(true){if(!(o<n.$length)){break;}p=((o<0||o>=n.$length)?($throwRuntimeError("index out of range"),undefined):n.$array[n.$offset+o]);r=(q=c.sessionParams[$String.keyFor(p+"_new")],q!==undefined?q.v:$ifaceNil);if(!($interfaceIsEqual(r,$ifaceNil))){delete c.sessionParams[$String.keyFor(p+"_new")];s=p;(c.sessionParams||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(s)]={k:s,v:r};}o++;}c.sessionId=(t=d.Params[$String.keyFor("session_id")],t!==undefined?t.v:$ifaceNil);if(c.sendBuffer.$length===0){c.lastActionId=new $Int64(0,0);}c.sendEventAck=false;u=d.Int64("event_id");c.receivedEventId=u[0];c.ackedEventId=new $Int64(0,0);$r=c.log(new BR([new $String("session created")]));$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}b=true;$s=-1;return b;}return;}if($f===undefined){$f={$blk:AX.ptr.prototype.handleSessionEvent};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.$s=$s;$f.$r=$r;return $f;};AX.prototype.handleSessionEvent=function(a){return this.$val.handleSessionEvent(a);};AX.ptr.prototype.handleEvent=function(a){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=[b];c=[c];b[0]=new $Int64(0,0);d=false;e=false;f=false;c[0]=this;g=a.Int64("event_id");h=g[0];if((h.$high>0||(h.$high===0&&h.$low>0))){c[0].receivedEventId=h;if(!c[0].sendEventAck){if((i=(j=c[0].receivedEventId,k=c[0].ackedEventId,new $Int64(j.$high-k.$high,j.$low-k.$low)),(i.$high>AW.$high||(i.$high===AW.$high&&i.$low>=AW.$low)))){c[0].sendAck();}else{e=true;}}}l=a.Int64("action_id");b[0]=l[0];if((b[0].$high>0||(b[0].$high===0&&b[0].$low>0))){$s=1;continue;}$s=2;continue;case 1:m=C.Search(c[0].numSent,(function(b,c){return function(m){var m,n,o,p;o=(n=c[0].sendBuffer,((m<0||m>=n.$length)?($throwRuntimeError("index out of range"),undefined):n.$array[n.$offset+m]));return(p=o.id,(p.$high>b[0].$high||(p.$high===b[0].$high&&p.$low>=b[0].$low)));};})(b,c));$s=3;case 3:if($c){$c=false;m=m.$blk();}if(m&&m.$blk!==undefined){break s;}n=m;if(n<c[0].numSent){$s=4;continue;}$s=5;continue;case 4:p=(o=c[0].sendBuffer,((n<0||n>=o.$length)?($throwRuntimeError("index out of range"),undefined):o.$array[o.$offset+n]));if((q=p.id,(q.$high===b[0].$high&&q.$low===b[0].$low))){$s=6;continue;}$s=7;continue;case 6:a.initLastReply(p);if(!(p.OnReply===$throwNilPointerError)){$s=8;continue;}$s=9;continue;case 8:$r=c[0].deliverReply(p,a);$s=10;case 10:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 9:if(a.LastReply){c[0].sendBuffer=$appendSlice($subslice(c[0].sendBuffer,0,n),$subslice(c[0].sendBuffer,(n+1>>0)));c[0].numSent=c[0].numSent-(1)>>0;}case 7:case 5:case 2:if(a.String()==="user_deleted"){$s=11;continue;}$s=12;continue;case 11:c[0].sessionId=$ifaceNil;c[0].running=false;$r=c[0].deliverSessionEvent(a);$s=13;case 13:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}d=true;$s=-1;return[b[0],d,e,f];case 12:r=a.getError();s=r[0];t=r[1];d=r[2];u=r[3];if(!($interfaceIsEqual(u,$ifaceNil))){$s=14;continue;}$s=15;continue;case 14:$r=c[0].log(new BR([new $String("event:"),u]));$s=16;case 16:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(d){$s=17;continue;}$s=18;continue;case 17:c[0].sessionId=$ifaceNil;if(!c[0].canLogin()){$s=19;continue;}$s=20;continue;case 19:c[0].running=false;$r=c[0].deliverSessionEvent(a);$s=21;case 21:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 20:case 18:$s=-1;return[b[0],d,e,f];case 15:if(s==="deprecated"){$s=22;continue;}$s=23;continue;case 22:$r=c[0].log(new BR([new $String("deprecated:"),new $String(t)]));$s=24;case 24:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 23:$r=c[0].deliverEvent(a);$s=25;case 25:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}f=true;$s=-1;return[b[0],d,e,f];}return;}if($f===undefined){$f={$blk:AX.ptr.prototype.handleEvent};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.$s=$s;$f.$r=$r;return $f;};AX.prototype.handleEvent=function(a){return this.$val.handleEvent(a);};AX.ptr.prototype.deliverSessionEvent=function(a){var a,b,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=this;$r=b.mutex.Unlock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(b.mutex,"Lock"),[]]);$r=b.OnSessionEvent(a);$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AX.ptr.prototype.deliverSessionEvent};}$f.a=a;$f.b=b;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AX.prototype.deliverSessionEvent=function(a){return this.$val.deliverSessionEvent(a);};AX.ptr.prototype.deliverEvent=function(a){var a,b,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=this;$r=b.mutex.Unlock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(b.mutex,"Lock"),[]]);$r=b.OnEvent(a);$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AX.ptr.prototype.deliverEvent};}$f.a=a;$f.b=b;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AX.prototype.deliverEvent=function(a){return this.$val.deliverEvent(a);};AX.ptr.prototype.deliverReply=function(a,b){var a,b,c,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);c=this;$r=c.mutex.Unlock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(c.mutex,"Lock"),[]]);$r=a.OnReply(b);$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AX.ptr.prototype.deliverReply};}$f.a=a;$f.b=b;$f.c=c;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AX.prototype.deliverReply=function(a,b){return this.$val.deliverReply(a,b);};AX.ptr.prototype.connState=function(a){var a,b,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=this;if(b.latestConnState===a){$s=-1;return;}b.latestConnState=a;if(b.OnConnState===$throwNilPointerError){$s=-1;return;}$r=b.mutex.Unlock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(b.mutex,"Lock"),[]]);$r=b.OnConnState(a);$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AX.ptr.prototype.connState};}$f.a=a;$f.b=b;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AX.prototype.connState=function(a){return this.$val.connState(a);};AX.ptr.prototype.connActive=function(){var a,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);a=this;if(a.OnConnActive===$throwNilPointerError){$s=-1;return;}$r=a.mutex.Unlock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(a.mutex,"Lock"),[]]);$r=a.OnConnActive();$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AX.ptr.prototype.connActive};}$f.a=a;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AX.prototype.connActive=function(){return this.$val.connActive();};AX.ptr.prototype.log=function(a){var a,b,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=this;if(b.OnLog===$throwNilPointerError){$s=-1;return;}$r=b.mutex.Unlock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(b.mutex,"Lock"),[]]);$r=b.OnLog(a);$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:AX.ptr.prototype.log};}$f.a=a;$f.b=b;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};AX.prototype.log=function(a){return this.$val.log(a);};AZ.ptr.prototype.setWebSocket=function(a){var a;};AZ.prototype.setWebSocket=function(a){return this.$val.setWebSocket(a);};AZ.ptr.prototype.webSocketDisconnected=function(){};AZ.prototype.webSocketDisconnected=function(){return this.$val.webSocketDisconnected();};AZ.ptr.prototype.shouldAbortConn=function(){return false;};AZ.prototype.shouldAbortConn=function(){return this.$val.shouldAbortConn();};AX.ptr.prototype.closeWebSocket=function(a){var a;a.close();};AX.prototype.closeWebSocket=function(a){return this.$val.closeWebSocket(a);};BC=function(){var a;return((a=$internalize(new($global.Date)().getTime(),$Int64),new BB(a.$high,a.$low)));};BD=function(a,b){var a,b,c;return(c=(new BB(b.$high,b.$low)),new BB(a.$high+c.$high,a.$low+c.$low));};BE=function(a,b){var a,b,c;return((c=new BB(a.$high-b.$high,a.$low-b.$low),new BA(c.$high,c.$low)));};BG=function(a){var a,b;b=CG.nil;b=new BF.ptr(new $Chan(CD,0),null);if((a.$high>0||(a.$high===0&&a.$low>=0))){b.Reset(a);}return b;};BF.ptr.prototype.Active=function(){var a;a=this;return!(a.id===null);};BF.prototype.Active=function(){return this.$val.Active();};BF.ptr.prototype.Reset=function(a){var a,b;b=this;b.Stop();b.id=$global.setTimeout($externalize((function(){b.id=null;$go((function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=$send(b.C,$clone(new CD.ptr(),CD));$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;}),[]);}),CA),$externalize(a,BA));};BF.prototype.Reset=function(a){return this.$val.Reset(a);};BF.ptr.prototype.Stop=function(){var a;a=this;if(!(a.id===null)){$global.clearTimeout(a.id);a.id=null;}};BF.prototype.Stop=function(){return this.$val.Stop();};BJ=function(){BH=$global.WebSocket;if(BH===undefined){BH=$module.require($externalize("ws",$String));}BI=!(BH===undefined)&&!(BH.CLOSING===undefined);};BL=function(a,b){var a,b,c,d,e,f,g;c=CH.nil;c=new BK.ptr(new $Chan(CD,1),false,$ifaceNil,new(BH)($externalize(a,$String)),false,CI.nil);c.impl.binaryType=$externalize("arraybuffer",$String);d=false;e=(function(){if(!d){d=true;$go((function(){$close(c.notify);}),[]);}});f=$global.setTimeout($externalize((function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c.err=A.New("timeout");$r=e();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;}),CA),$externalize(b,BA));g=(function(){if(!(f===null)){$global.clearTimeout(f);f=null;}});c.impl.onopen=$externalize((function $b(h){var h,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;h=$f.h;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=g();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!($interfaceIsEqual(c.err,$ifaceNil))){c.impl.close();$s=-1;return;}c.open=true;$go((function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:if(!d){$s=1;continue;}$s=2;continue;case 1:$r=$send(c.notify,$clone(new CD.ptr(),CD));$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 2:$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;}),[]);$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.h=h;$f.$s=$s;$f.$r=$r;return $f;}),CJ);c.impl.onmessage=$externalize((function(h){var h;c.buf=$append(c.buf,h.data);$go((function $b(){var i,$r;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;i=$f.i;$r=$f.$r;}if(!d){i=$select([[c.notify,new CD.ptr()],[]]);if(i[0]===0){}else if(i[0]===1){}}if($f===undefined){$f={$blk:$b};}$f.i=i;$f.$r=$r;return $f;}),[]);}),CJ);c.impl.onclose=$externalize((function $b(h){var h,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;h=$f.h;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c.goingAway=(($parseInt(h.code)>>0)===1001);c.open=false;$r=e();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.h=h;$f.$s=$s;$f.$r=$r;return $f;}),CJ);c.impl.onerror=$externalize((function $b(h){var h,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;h=$f.h;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=g();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if($interfaceIsEqual(c.err,$ifaceNil)){c.err=A.New($internalize(h.message,$String));}$r=e();$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.h=h;$f.$s=$s;$f.$r=$r;return $f;}),CJ);return c;};BK.ptr.prototype.send=function(a){var a,b,c,$deferred;var $err=null;try{$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=$ifaceNil;c=this;$deferred.push([(function(){b=U($recover());}),[]]);c.impl.send(a);return b;}catch(err){$err=err;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return b;}}};BK.prototype.send=function(a){return this.$val.send(a);};BK.ptr.prototype.sendJSON=function(a){var a,b,c,d,e;b=$ifaceNil;c=this;d=AL(a);e=d[0];b=d[1];if(!($interfaceIsEqual(b,$ifaceNil))){return b;}b=c.send(e);return b;};BK.prototype.sendJSON=function(a){return this.$val.sendJSON(a);};BK.ptr.prototype.sendPayload=function(a){var a,b,c,d,e,f,g,h,i,j,k,l,m,$deferred;var $err=null;try{$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);b=$ifaceNil;c=this;$deferred.push([(function(){b=U($recover());}),[]]);d=a.String()==="update_user";e=a.Payload;f=0;while(true){if(!(f<e.$length)){break;}g=((f<0||f>=e.$length)?($throwRuntimeError("index out of range"),undefined):e.$array[e.$offset+f]);h=g;if(d){i=h.split($externalize(",",$String))[1];j=$global.atob(i);k=$parseInt(j.length);h=new($global.ArrayBuffer)(k);l=new($global.Uint8Array)(h);m=0;while(true){if(!(m<k)){break;}l[m]=j.charCodeAt(m);m=m+(1)>>0;}}c.impl.send(h);f++;}return b;}catch(err){$err=err;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return b;}}};BK.prototype.sendPayload=function(a){return this.$val.sendPayload(a);};BK.ptr.prototype.receive=function(){var a,b,c;a=null;b=this;if(b.buf.$length>0){a=(c=b.buf,(0>=c.$length?($throwRuntimeError("index out of range"),undefined):c.$array[c.$offset+0]));b.buf=$subslice(b.buf,1);}return a;};BK.prototype.receive=function(){return this.$val.receive();};BK.ptr.prototype.receiveJSON=function(){var a,b,c,d,e;a=false;b=$ifaceNil;c=this;d=c.receive();if(d===null){return[a,b];}b=AN(R(d),(e||(e=new BX(function(){return a;},function($v){a=$v;}))));return[a,b];};BK.prototype.receiveJSON=function(){return this.$val.receiveJSON();};BK.ptr.prototype.close=function(){var a,$deferred;var $err=null;try{$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);a=this;$deferred.push([(function(){$recover();}),[]]);a.impl.close();}catch(err){$err=err;}finally{$callDeferred($deferred,$err);}};BK.prototype.close=function(){return this.$val.close();};BM=function(a,b){var a,b,c,d,e,f,g,h,i,j,k,l,m,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);c=[c];d=false;e=false;c[0]=CH.nil;$deferred.push([(function(c){return function(){if(!(c[0]===CH.nil)){c[0].close();}};})(c),[]]);case 1:e=false;f=false;$r=a.log(new BR([new $String("connecting to"),new $String(b)]));$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}c[0]=BL("wss://"+b+"/v2/socket",AJ(new BA(0,9000),0.1));a.test.setWebSocket(c[0]);$r=a.mutex.Unlock();$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}h=$select([[c[0].notify],[a.closeNotify]]);$s=5;case 5:if($c){$c=false;h=h.$blk();}if(h&&h.$blk!==undefined){break s;}g=h;if(g[0]===0){$s=6;continue;}if(g[0]===1){$s=7;continue;}$s=8;continue;case 6:i=g[1];j=i[1];$r=a.mutex.Lock();$s=9;case 9:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(j){$s=10;continue;}if(!($interfaceIsEqual(c[0].err,$ifaceNil))){$s=11;continue;}$s=12;continue;case 10:$r=a.connState("connected");$s=14;case 14:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}d=true;l=BN(a,c[0]);$s=15;case 15:if($c){$c=false;l=l.$blk();}if(l&&l.$blk!==undefined){break s;}k=l;e=k[0];f=k[1];$s=13;continue;case 11:$r=a.log(new BR([new $String("connection failed:"),c[0].err]));$s=16;case 16:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=13;continue;case 12:$r=a.log(new BR([new $String("connection failed")]));$s=17;case 17:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 13:$s=8;continue;case 7:$r=a.mutex.Lock();$s=18;case 18:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 8:m=c[0].goingAway;a.closeWebSocket(c[0]);c[0]=CH.nil;if(m){$s=19;continue;}$s=20;continue;case 19:$r=a.log(new BR([new $String("disconnected (server is going away)")]));$s=22;case 22:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=21;continue;case 20:$r=a.log(new BR([new $String("disconnected")]));$s=23;case 23:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 21:a.test.webSocketDisconnected();if(!e||!f||!a.running||m){$s=-1;return[d,e];}$s=1;continue;case 2:$s=-1;return[d,e];}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return[d,e];}if($curGoroutine.asleep){if($f===undefined){$f={$blk:BM};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};BN=function(a,b){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);a=[a];b=[b];c=[c];d=[d];e=false;f=false;g=false;if($interfaceIsEqual(a[0].sessionId,$ifaceNil)){$s=1;continue;}$s=2;continue;case 1:$r=a[0].log(new BR([new $String("session creation")]));$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}g=a[0].makeCreateSessionAction();$s=3;continue;case 2:$r=a[0].log(new BR([new $String("session resumption")]));$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}g=a[0].makeResumeSessionAction(true);case 3:h=b[0].sendJSON(g);if(!($interfaceIsEqual(h,$ifaceNil))){$s=6;continue;}$s=7;continue;case 6:$r=a[0].log(new BR([new $String("send:"),h]));$s=8;case 8:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 7:if($interfaceIsEqual(a[0].sessionId,$ifaceNil)){$s=9;continue;}$s=10;continue;case 9:i=false;j=true;k=BG(AJ(new BA(0,37000),0.2));case 11:l=$ifaceNil;m=b[0].receiveJSON();i=m[0];l=m[1];if(!($interfaceIsEqual(l,$ifaceNil))){$s=13;continue;}$s=14;continue;case 13:$r=a[0].log(new BR([new $String("session creation:"),l]));$s=15;case 15:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[e,f];case 14:if(!(i===false)){k.Stop();$s=12;continue;}if(!j){$s=16;continue;}$s=17;continue;case 16:$r=a[0].log(new BR([new $String("disconnected during session creation:"),b[0].err]));$s=18;case 18:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}k.Stop();$s=-1;return[e,f];case 17:$r=a[0].mutex.Unlock();$s=19;case 19:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}o=$select([[b[0].notify],[k.C]]);$s=20;case 20:if($c){$c=false;o=o.$blk();}if(o&&o.$blk!==undefined){break s;}n=o;if(n[0]===0){$s=21;continue;}if(n[0]===1){$s=22;continue;}$s=23;continue;case 21:p=n[1];j=p[1];$r=a[0].mutex.Lock();$s=24;case 24:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=23;continue;case 22:$r=a[0].mutex.Lock();$s=25;case 25:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=a[0].log(new BR([new $String("session creation timeout")]));$s=26;case 26:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[e,f];case 23:$s=11;continue;case 12:q=a[0].handleSessionEvent(i);$s=29;case 29:if($c){$c=false;q=q.$blk();}if(q&&q.$blk!==undefined){break s;}if(!q){$s=27;continue;}$s=28;continue;case 27:$s=-1;return[e,f];case 28:e=true;f=true;$r=a[0].connActive();$s=30;case 30:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 10:d[0]=new $Chan(CD,2);c[0]=new $Chan(CD,0);$go((function(a,b,c,d){return function $b(){var r,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;r=$f.r;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);$deferred.push([function(r){$close(r);},[c[0]]]);$r=a[0].mutex.Lock();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(a[0].mutex,"Unlock"),[]]);$r=BO(a[0],b[0],d[0]);$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:$b};}$f.r=r;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};})(a,b,c,d),[]);s=BP(a[0],b[0],d[0]);$s=31;case 31:if($c){$c=false;s=s.$blk();}if(s&&s.$blk!==undefined){break s;}r=s;t=r[0];f=r[1];if(t){e=true;}$r=a[0].mutex.Unlock();$s=32;case 32:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$deferred.push([$methodVal(a[0].mutex,"Lock"),[]]);u=$recv(c[0]);$s=33;case 33:if($c){$c=false;u=u.$blk();}if(u&&u.$blk!==undefined){break s;}u[0];$s=-1;return[e,f];}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return[e,f];}if($curGoroutine.asleep){if($f===undefined){$f={$blk:BN};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};BO=function(a,b,c){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;v=$f.v;w=$f.w;x=$f.x;y=$f.y;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);d=BG(AJ(new BA(0,56000),-0.3));$deferred.push([$methodVal(d,"Stop"),[]]);a.numSent=0;case 1:if(a.test.shouldAbortConn()){$s=3;continue;}$s=4;continue;case 3:$r=a.log(new BR([new $String("abort send")]));$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(c,$clone(new CD.ptr(),CD));$s=6;case 6:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 4:case 7:if(!(a.numSent<a.sendBuffer.$length)){$s=8;continue;}g=(e=a.sendBuffer,f=a.numSent,((f<0||f>=e.$length)?($throwRuntimeError("index out of range"),undefined):e.$array[e.$offset+f]));if(!(g.Payload===BT.nil)){h="frames";(g.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(h)]={k:h,v:new $Int(g.Payload.$length)};}if(!((i=a.receivedEventId,j=a.ackedEventId,(i.$high===j.$high&&i.$low===j.$low)))){k="event_id";(g.Params||$throwRuntimeError("assignment to entry in nil map"))[$String.keyFor(k)]={k:k,v:a.receivedEventId};a.sendEventAck=false;a.ackedEventId=a.receivedEventId;}l=b.sendJSON(g.Params);delete g.Params[$String.keyFor("frames")];delete g.Params[$String.keyFor("event_id")];if(!($interfaceIsEqual(l,$ifaceNil))){$s=9;continue;}$s=10;continue;case 9:$r=a.log(new BR([new $String("send:"),l]));$s=11;case 11:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(c,$clone(new CD.ptr(),CD));$s=12;case 12:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 10:if(!(g.Payload===BT.nil)){$s=13;continue;}$s=14;continue;case 13:m=b.sendPayload(g);if(!($interfaceIsEqual(m,$ifaceNil))){$s=15;continue;}$s=16;continue;case 15:$r=a.log(new BR([new $String("send:"),m]));$s=17;case 17:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(c,$clone(new CD.ptr(),CD));$s=18;case 18:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 16:case 14:if((n=g.id,(n.$high===0&&n.$low===0))){a.sendBuffer=$appendSlice($subslice(a.sendBuffer,0,a.numSent),$subslice(a.sendBuffer,(a.numSent+1>>0)));}else{a.numSent=a.numSent+(1)>>0;}d.Reset(AJ(new BA(0,56000),-0.3));$s=7;continue;case 8:if(a.sendEventAck&&!((o=a.receivedEventId,p=a.ackedEventId,(o.$high===p.$high&&o.$low===p.$low)))){$s=19;continue;}$s=20;continue;case 19:q=a.makeResumeSessionAction(false);r=b.sendJSON(q);if(!($interfaceIsEqual(r,$ifaceNil))){$s=21;continue;}$s=22;continue;case 21:$r=a.log(new BR([new $String("send:"),r]));$s=23;case 23:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(c,$clone(new CD.ptr(),CD));$s=24;case 24:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 22:case 20:$r=a.mutex.Unlock();$s=25;case 25:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}t=$select([[a.sendNotify],[d.C],[c]]);$s=26;case 26:if($c){$c=false;t=t.$blk();}if(t&&t.$blk!==undefined){break s;}s=t;if(s[0]===0){$s=27;continue;}if(s[0]===1){$s=28;continue;}if(s[0]===2){$s=29;continue;}$s=30;continue;case 27:u=s[1];v=u[1];$r=a.mutex.Lock();$s=31;case 31:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!v){$s=32;continue;}$s=33;continue;case 32:w=$makeMap($String.keyFor,[{k:"action",v:new $String("close_session")}]);x=b.sendJSON(w);if(!($interfaceIsEqual(x,$ifaceNil))){$s=34;continue;}$s=35;continue;case 34:$r=a.log(new BR([new $String("send:"),x]));$s=36;case 36:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 35:$s=-1;return;case 33:$s=30;continue;case 28:$r=a.mutex.Lock();$s=37;case 37:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}y=b.send(P());if(!($interfaceIsEqual(y,$ifaceNil))){$s=38;continue;}$s=39;continue;case 38:$r=a.log(new BR([new $String("send:"),y]));$s=40;case 40:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(c,$clone(new CD.ptr(),CD));$s=41;case 41:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 39:d.Reset(AJ(new BA(0,56000),-0.3));$s=30;continue;case 29:$r=a.mutex.Lock();$s=42;case 42:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 30:$s=1;continue;case 2:$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:BO};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.v=v;$f.w=w;$f.x=x;$f.y=y;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};BP=function(a,b,c){var a,aa,ab,ac,ad,ae,af,ag,ah,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;aa=$f.aa;ab=$f.ab;ac=$f.ac;ad=$f.ad;ae=$f.ae;af=$f.af;ag=$f.ag;ah=$f.ah;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;r=$f.r;s=$f.s;t=$f.t;u=$f.u;v=$f.v;w=$f.w;x=$f.x;y=$f.y;z=$f.z;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);d=false;e=false;f=b.notify;g=true;h=BU.nil;i=0;j=AJ(new BA(0,64000),0.3);k=BD(BC(),j);l=BG(j);$deferred.push([$methodVal(l,"Stop"),[]]);m=BG(new BA(-1,4294967295));$deferred.push([$methodVal(m,"Stop"),[]]);case 1:n=false;case 3:o=[o];if(a.test.shouldAbortConn()){$s=5;continue;}$s=6;continue;case 5:$r=a.log(new BR([new $String("abort receive")]));$s=7;case 7:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(c,$clone(new CD.ptr(),CD));$s=8;case 8:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d,e];case 6:if(h===BU.nil){$s=9;continue;}$s=10;continue;case 9:p=b.receive();if(p===null){$s=4;continue;}q=AJ(new BA(0,64000),0.7);k=BD(BC(),q);if(!l.Active()){l.Reset(q);}$r=a.connActive();$s=12;case 12:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}r=R(p);if(Q(r)===0){$s=13;continue;}$s=14;continue;case 13:$s=3;continue;case 14:o[0]=false;s=AN(r,(o.$ptr||(o.$ptr=new BX(function(){return this.$target[0];},function($v){this.$target[0]=$v;},o))));if(!($interfaceIsEqual(s,$ifaceNil))){$s=15;continue;}$s=16;continue;case 15:$r=a.log(new BR([new $String("receive:"),s]));$s=17;case 17:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}e=false;$r=$send(c,$clone(new CD.ptr(),CD));$s=18;case 18:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d,e];case 16:h=new I.ptr(o[0],BT.nil,false);t=h.Int("frames");u=t[0];if(u>0){i=u;}$s=11;continue;case 10:v=b.receive();if(v===null){if(!g){h=BU.nil;i=0;}$s=4;continue;}h.Payload=$append(h.Payload,v);i=i-(1)>>0;case 11:if(i===0){$s=19;continue;}$s=20;continue;case 19:x=a.handleEvent(h);$s=21;case 21:if($c){$c=false;x=x.$blk();}if(x&&x.$blk!==undefined){break s;}w=x;y=w[1];z=w[2];aa=w[3];if(!aa){$s=22;continue;}$s=23;continue;case 22:if(y){d=true;}else{e=false;}$r=$send(c,$clone(new CD.ptr(),CD));$s=24;case 24:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d,e];case 23:if(z){n=true;}h=BU.nil;i=0;d=true;e=true;case 20:$r=a.mutex.Unlock();$s=25;case 25:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}ab=$select([[a.closeNotify],[c],[]]);if(ab[0]===0){$s=26;continue;}if(ab[0]===1){$s=27;continue;}if(ab[0]===2){$s=28;continue;}$s=29;continue;case 26:$r=a.mutex.Lock();$s=30;case 30:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d,e];case 27:$r=a.mutex.Lock();$s=31;case 31:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d,e];case 28:$r=a.mutex.Lock();$s=32;case 32:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 29:$s=3;continue;case 4:if(!g&&h===BU.nil){$s=33;continue;}$s=34;continue;case 33:if(!($interfaceIsEqual(b.err,$ifaceNil))){$s=35;continue;}$s=36;continue;case 35:$r=a.log(new BR([new $String("receive:"),b.err]));$s=38;case 38:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=37;continue;case 36:$r=a.log(new BR([new $String("receive disconnect")]));$s=39;case 39:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 37:$r=$send(c,$clone(new CD.ptr(),CD));$s=40;case 40:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d,e];case 34:if(n&&!m.Active()){m.Reset(AJ(new BA(0,7000),-0.3));}$r=a.mutex.Unlock();$s=41;case 41:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}ad=$select([[f],[l.C],[m.C],[a.closeNotify],[c]]);$s=42;case 42:if($c){$c=false;ad=ad.$blk();}if(ad&&ad.$blk!==undefined){break s;}ac=ad;if(ac[0]===0){$s=43;continue;}if(ac[0]===1){$s=44;continue;}if(ac[0]===2){$s=45;continue;}if(ac[0]===3){$s=46;continue;}if(ac[0]===4){$s=47;continue;}$s=48;continue;case 43:ae=ac[1];g=ae[1];$r=a.mutex.Lock();$s=49;case 49:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!g){f=$chanNil;}$s=48;continue;case 44:$r=a.mutex.Lock();$s=50;case 50:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}af=BE(k,BC());if((af.$high>0||(af.$high===0&&af.$low>16))){$s=51;continue;}$s=52;continue;case 51:l.Reset(af);$s=53;continue;case 52:$r=a.log(new BR([new $String("receive timeout")]));$s=54;case 54:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=$send(c,$clone(new CD.ptr(),CD));$s=55;case 55:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d,e];case 53:$s=48;continue;case 45:$r=a.mutex.Lock();$s=56;case 56:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}if(!a.sendEventAck&&!((ag=a.ackedEventId,ah=a.receivedEventId,(ag.$high===ah.$high&&ag.$low===ah.$low)))){a.sendAck();}$s=48;continue;case 46:$r=a.mutex.Lock();$s=57;case 57:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d,e];case 47:$r=a.mutex.Lock();$s=58;case 58:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return[d,e];case 48:$s=1;continue;case 2:$s=-1;return[d,e];}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if(!$curGoroutine.asleep){return[d,e];}if($curGoroutine.asleep){if($f===undefined){$f={$blk:BP};}$f.a=a;$f.aa=aa;$f.ab=ab;$f.ac=ac;$f.ad=ad;$f.ae=ae;$f.af=af;$f.ag=ag;$f.ah=ah;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.r=r;$f.s=s;$f.t=t;$f.u=u;$f.v=v;$f.w=w;$f.x=x;$f.y=y;$f.z=z;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};CE.methods=[{prop:"String",name:"String",pkg:"",typ:$funcType([],[$String],false)},{prop:"GetID",name:"GetID",pkg:"",typ:$funcType([],[$Int64,$error],false)}];BU.methods=[{prop:"Bool",name:"Bool",pkg:"",typ:$funcType([$String],[$Bool],false)},{prop:"Int",name:"Int",pkg:"",typ:$funcType([$String],[$Int,$Bool],false)},{prop:"Int64",name:"Int64",pkg:"",typ:$funcType([$String],[$Int64,$Bool],false)},{prop:"Float64",name:"Float64",pkg:"",typ:$funcType([$String],[$Float64,$Bool],false)},{prop:"Str",name:"Str",pkg:"",typ:$funcType([$String],[$String,$Bool],false)},{prop:"Array",name:"Array",pkg:"",typ:$funcType([$String],[BR,$Bool],false)},{prop:"Map",name:"Map",pkg:"",typ:$funcType([$String],[BS,$Bool],false)},{prop:"String",name:"String",pkg:"",typ:$funcType([],[$String],false)},{prop:"initLastReply",name:"initLastReply",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([CE],[],false)},{prop:"getError",name:"getError",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[$String,$String,$Bool,$error],false)}];CL.methods=[{prop:"success",name:"success",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[],false)},{prop:"failure",name:"failure",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BA],[BA],false)}];CM.methods=[{prop:"Call",name:"Call",pkg:"",typ:$funcType([CE],[BV,$error],false)}];AB.methods=[{prop:"Set",name:"Set",pkg:"",typ:$funcType([$String,$String],[],false)}];CN.methods=[{prop:"SetParams",name:"SetParams",pkg:"",typ:$funcType([BS],[],false)},{prop:"Open",name:"Open",pkg:"",typ:$funcType([],[],false)},{prop:"Close",name:"Close",pkg:"",typ:$funcType([],[],false)},{prop:"Send",name:"Send",pkg:"",typ:$funcType([CE],[$error],false)},{prop:"send",name:"send",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([CE],[],false)},{prop:"sendAck",name:"sendAck",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[],false)},{prop:"discover",name:"discover",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[],false)},{prop:"connect",name:"connect",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([AY,BQ,CL],[$Bool],false)},{prop:"backOff",name:"backOff",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([CL],[$Bool],false)},{prop:"canLogin",name:"canLogin",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[$Bool],false)},{prop:"makeCreateSessionAction",name:"makeCreateSessionAction",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[BS],false)},{prop:"makeResumeSessionAction",name:"makeResumeSessionAction",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([$Bool],[BS],false)},{prop:"handleSessionEvent",name:"handleSessionEvent",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BS],[$Bool],false)},{prop:"handleEvent",name:"handleEvent",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BU],[$Int64,$Bool,$Bool,$Bool],false)},{prop:"deliverSessionEvent",name:"deliverSessionEvent",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BU],[],false)},{prop:"deliverEvent",name:"deliverEvent",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BU],[],false)},{prop:"deliverReply",name:"deliverReply",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([CE,BU],[],false)},{prop:"connState",name:"connState",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([$String],[],false)},{prop:"connActive",name:"connActive",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[],false)},{prop:"log",name:"log",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BR],[],true)},{prop:"closeWebSocket",name:"closeWebSocket",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([CH],[],false)}];CR.methods=[{prop:"setWebSocket",name:"setWebSocket",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([CH],[],false)},{prop:"webSocketDisconnected",name:"webSocketDisconnected",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[],false)},{prop:"shouldAbortConn",name:"shouldAbortConn",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[$Bool],false)}];CG.methods=[{prop:"Active",name:"Active",pkg:"",typ:$funcType([],[$Bool],false)},{prop:"Reset",name:"Reset",pkg:"",typ:$funcType([BA],[],false)},{prop:"Stop",name:"Stop",pkg:"",typ:$funcType([],[],false)}];CH.methods=[{prop:"send",name:"send",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([CB],[$error],false)},{prop:"sendJSON",name:"sendJSON",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([BS],[$error],false)},{prop:"sendPayload",name:"sendPayload",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([CE],[$error],false)},{prop:"receive",name:"receive",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[CB],false)},{prop:"receiveJSON",name:"receiveJSON",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[BS,$error],false)},{prop:"close",name:"close",pkg:"github.com/ninchat/ninchat-go",typ:$funcType([],[],false)}];H.init("github.com/ninchat/ninchat-go",[{prop:"Params",name:"Params",embedded:false,exported:true,typ:BS,tag:""},{prop:"Payload",name:"Payload",embedded:false,exported:true,typ:BT,tag:""},{prop:"OnReply",name:"OnReply",embedded:false,exported:true,typ:CK,tag:""},{prop:"id",name:"id",embedded:false,exported:false,typ:$Int64,tag:""}]);I.init("",[{prop:"Params",name:"Params",embedded:false,exported:true,typ:BS,tag:""},{prop:"Payload",name:"Payload",embedded:false,exported:true,typ:BT,tag:""},{prop:"LastReply",name:"LastReply",embedded:false,exported:true,typ:$Bool,tag:""}]);J.init(B.Object);L.init("github.com/ninchat/ninchat-go",[{prop:"lastSlot",name:"lastSlot",embedded:false,exported:false,typ:$Int,tag:""}]);O.init("",[{prop:"Address",name:"Address",embedded:false,exported:true,typ:$String,tag:""}]);AB.init($String,$String);AC.init("github.com/ninchat/ninchat-go",[{prop:"Method",name:"Method",embedded:false,exported:true,typ:$String,tag:""},{prop:"URL",name:"URL",embedded:false,exported:true,typ:$String,tag:""},{prop:"Header",name:"Header",embedded:false,exported:true,typ:AB,tag:""},{prop:"data",name:"data",embedded:false,exported:false,typ:CB,tag:""}]);AF.init("github.com/ninchat/ninchat-go",[{prop:"data",name:"data",embedded:false,exported:false,typ:CB,tag:""},{prop:"err",name:"err",embedded:false,exported:false,typ:$error,tag:""}]);AX.init("github.com/ninchat/ninchat-go",[{prop:"OnSessionEvent",name:"OnSessionEvent",embedded:false,exported:true,typ:CK,tag:""},{prop:"OnEvent",name:"OnEvent",embedded:false,exported:true,typ:CK,tag:""},{prop:"OnClose",name:"OnClose",embedded:false,exported:true,typ:CA,tag:""},{prop:"OnConnState",name:"OnConnState",embedded:false,exported:true,typ:CO,tag:""},{prop:"OnConnActive",name:"OnConnActive",embedded:false,exported:true,typ:CA,tag:""},{prop:"OnLog",name:"OnLog",embedded:false,exported:true,typ:CP,tag:""},{prop:"Address",name:"Address",embedded:false,exported:true,typ:$String,tag:""},{prop:"forceLongPoll",name:"forceLongPoll",embedded:false,exported:false,typ:$Bool,tag:""},{prop:"mutex",name:"mutex",embedded:false,exported:false,typ:D.Mutex,tag:""},{prop:"sessionParams",name:"sessionParams",embedded:false,exported:false,typ:BS,tag:""},{prop:"sessionId",name:"sessionId",embedded:false,exported:false,typ:$emptyInterface,tag:""},{prop:"latestConnState",name:"latestConnState",embedded:false,exported:false,typ:$String,tag:""},{prop:"lastActionId",name:"lastActionId",embedded:false,exported:false,typ:$Int64,tag:""},{prop:"sendNotify",name:"sendNotify",embedded:false,exported:false,typ:CQ,tag:""},{prop:"sendBuffer",name:"sendBuffer",embedded:false,exported:false,typ:CF,tag:""},{prop:"numSent",name:"numSent",embedded:false,exported:false,typ:$Int,tag:""},{prop:"sendEventAck",name:"sendEventAck",embedded:false,exported:false,typ:$Bool,tag:""},{prop:"receivedEventId",name:"receivedEventId",embedded:false,exported:false,typ:$Int64,tag:""},{prop:"ackedEventId",name:"ackedEventId",embedded:false,exported:false,typ:$Int64,tag:""},{prop:"closeNotify",name:"closeNotify",embedded:false,exported:false,typ:CQ,tag:""},{prop:"closed",name:"closed",embedded:false,exported:false,typ:$Bool,tag:""},{prop:"running",name:"running",embedded:false,exported:false,typ:$Bool,tag:""},{prop:"test",name:"test",embedded:false,exported:false,typ:AZ,tag:""}]);AY.init([CN,$String],[$Bool,$Bool],false);AZ.init("",[]);BF.init("github.com/ninchat/ninchat-go",[{prop:"C",name:"C",embedded:false,exported:true,typ:CQ,tag:""},{prop:"id",name:"id",embedded:false,exported:false,typ:CB,tag:""}]);BK.init("github.com/ninchat/ninchat-go",[{prop:"notify",name:"notify",embedded:false,exported:false,typ:CQ,tag:""},{prop:"goingAway",name:"goingAway",embedded:false,exported:false,typ:$Bool,tag:""},{prop:"err",name:"err",embedded:false,exported:false,typ:$error,tag:""},{prop:"impl",name:"impl",embedded:false,exported:false,typ:CB,tag:""},{prop:"open",name:"open",embedded:false,exported:false,typ:$Bool,tag:""},{prop:"buf",name:"buf",embedded:false,exported:false,typ:CI,tag:""}]);$init=function(){$pkg.$init=function(){};var $f,$c=false,$s=0,$r;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=A.$init();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=B.$init();$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=C.$init();$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=D.$init();$s=4;case 4:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}Y=null;Z=false;BH=null;BI=false;E=A.New("no action_id");AW=AK(new $Int64(0,4096),-0.25);AA();BJ();}return;}if($f===undefined){$f={$blk:$init};}$f.$s=$s;$f.$r=$r;return $f;};$pkg.$init=$init;return $pkg;})();
$packages["ninchatclient/lib"]=(function(){var $pkg={},$init,A,B,H,I,M,N,O,P,Q,R,S,T,U,V,W,X,Y,Z,AA,AB,AC,AD,AE,AF,AG,AH,AI,C,D,E,F,G,J,K,L;A=$packages["github.com/gopherjs/gopherjs/js"];B=$packages["github.com/ninchat/ninchat-go"];H=$pkg.Promise=$newType(0,$kindStruct,"clientlib.Promise",true,"ninchatclient/lib",true,function(OnPanic_,fulfillers_,rejecters_,notifiers_,actionID_){this.$val=this;if(arguments.length===0){this.OnPanic=$throwNilPointerError;this.fulfillers=N.nil;this.rejecters=N.nil;this.notifiers=N.nil;this.actionID=O.nil;return;}this.OnPanic=OnPanic_;this.fulfillers=fulfillers_;this.rejecters=rejecters_;this.notifiers=notifiers_;this.actionID=actionID_;});I=$pkg.SessionAdapter=$newType(0,$kindStruct,"clientlib.SessionAdapter",true,"ninchatclient/lib",true,function(Session_,OnPanic_){this.$val=this;if(arguments.length===0){this.Session=Y.nil;this.OnPanic=$throwNilPointerError;return;}this.Session=Session_;this.OnPanic=OnPanic_;});M=$ptrType(A.Object);N=$sliceType(M);O=$ptrType($Int64);P=$sliceType(B.Frame);Q=$mapType($String,$emptyInterface);R=$sliceType(Q);S=$sliceType($emptyInterface);T=$funcType([Q,M,M],[M],false);U=$funcType([],[Q],false);V=$funcType([M],[M],false);W=$funcType([M,M,M],[M],false);X=$ptrType(B.Event);Y=$ptrType(B.Session);Z=$ptrType(B.Action);AA=$sliceType(Z);AB=$funcType([M],[],false);AC=$funcType([Q],[],false);AD=$funcType([$String],[],false);AE=$funcType([],[],false);AF=$funcType([Q,M],[M],false);AG=$ptrType(H);AH=$funcType([$String,$emptyInterface],[],false);AI=$ptrType(I);C=function(a,b,c){var a,b,c,d,e;d="";if(!(c===undefined)){d=$internalize(c,$String);}e=new H.ptr(E((function(){return(function(e){var e;if(!(b===undefined)){b($externalize(e,$String));}});})),N.nil,N.nil,N.nil,O.nil);$go((function $b(){var f,g,h,i,j,k,l,m,n,o,p,q,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;o=$f.o;p=$f.p;q=$f.q;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:f=new B.Caller.ptr(d);g=new B.Action.ptr(a,P.nil,$throwNilPointerError,new $Int64(0,0));i=f.Call(g);$s=1;case 1:if($c){$c=false;i=i.$blk();}if(i&&i.$blk!==undefined){break s;}h=i;j=h[0];k=h[1];if(!($interfaceIsEqual(k,$ifaceNil))){$s=2;continue;}$s=3;continue;case 2:l=k.Error();$s=4;case 4:if($c){$c=false;l=l.$blk();}if(l&&l.$blk!==undefined){break s;}m=l;if(!(b===undefined)){b($externalize(m,$String));}$r=e.OnReply(new B.Event.ptr($makeMap($String.keyFor,[{k:"event",v:new $String("error")},{k:"error_type",v:new $String("internal")},{k:"error_reason",v:new $String(m)}]),P.nil,false));$s=5;case 5:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;case 3:n=R.nil;o=j;p=0;while(true){if(!(p<o.$length)){break;}q=((p<0||p>=o.$length)?($throwRuntimeError("index out of range"),undefined):o.$array[o.$offset+p]);n=$append(n,q.Params);p++;}$r=e.Resolve(new S([n]));$s=6;case 6:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.o=o;$f.p=p;$f.q=q;$f.$s=$s;$f.$r=$r;return $f;}),[]);return e.Object();};D=function(a){var a;a.call=$externalize(C,T);a.newSession=$externalize(K,U);a.stringifyFrame=$externalize(B.StringifyFrame,V);};$pkg.Init=D;E=function(a){var a;return(function $b(b,c){var b,c,d,e,f,g,h,i,j,k,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:if(!($interfaceIsEqual(c,$ifaceNil))){$s=1;continue;}$s=2;continue;case 1:d=a();$s=3;case 3:if($c){$c=false;d=d.$blk();}if(d&&d.$blk!==undefined){break s;}e=d;if(!(e===$throwNilPointerError)){$s=4;continue;}$s=5;continue;case 4:f="";g=c;if($assertType(g,$String,true)[1]){$s=6;continue;}if($assertType(g,$error,true)[1]){$s=7;continue;}$s=8;continue;case 6:h=g.$val;f=h;$s=9;continue;case 7:i=g;k=i.Error();$s=10;case 10:if($c){$c=false;k=k.$blk();}if(k&&k.$blk!==undefined){break s;}f=k;$s=9;continue;case 8:j=g;f=$internalize($global.JSON.stringify($externalize(j,$emptyInterface)),$String);case 9:$r=e(b+" "+f);$s=11;case 11:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 5:case 2:$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.$s=$s;$f.$r=$r;return $f;});};$pkg.Panicer=E;F=function(a){var a,b,c;b=P.nil;if(!(a===null)&&!(a===undefined)){c=0;while(true){if(!(c<$parseInt(a.length))){break;}b=$append(b,a[c]);c=c+(1)>>0;}}return b;};$pkg.WrapPayload=F;G=function(a){var a,b,c,d,e;b=N.nil;c=a;d=0;while(true){if(!(d<c.$length)){break;}e=((d<0||d>=c.$length)?($throwRuntimeError("index out of range"),undefined):c.$array[c.$offset+d]);b=$append(b,e);d++;}return b;};$pkg.UnwrapPayload=G;H.ptr.prototype.Object=function(){var a,b;a=null;b=this;a=new($global.Object)();a.then=$externalize((function(c,d,e){var c,d,e;if(!(c===null)&&!(c===undefined)){b.fulfillers=$append(b.fulfillers,c);}if(!(d===null)&&!(d===undefined)){b.rejecters=$append(b.rejecters,d);}if(!(e===null)&&!(e===undefined)){b.notifiers=$append(b.notifiers,e);}return a;}),W);if(!(b.actionID===O.nil)){a.actionId=$externalize(b.actionID.$get(),$Int64);}return a;};H.prototype.Object=function(){return this.$val.Object();};H.ptr.prototype.OnReply=function(a){var a,b,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=this;if(!(a===X.nil)){$s=1;continue;}$s=2;continue;case 1:if(a.String()==="error"){$s=3;continue;}if(a.LastReply){$s=4;continue;}$s=5;continue;case 3:$r=b.Reject(new S([new Q(a.Params)]));$s=7;case 7:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=6;continue;case 4:$r=b.Resolve(new S([new Q(a.Params),G(a.Payload)]));$s=8;case 8:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=6;continue;case 5:$r=b.Notify(new S([new Q(a.Params),G(a.Payload)]));$s=9;case 9:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 6:case 2:$s=-1;return;}return;}if($f===undefined){$f={$blk:H.ptr.prototype.OnReply};}$f.a=a;$f.b=b;$f.$s=$s;$f.$r=$r;return $f;};H.prototype.OnReply=function(a){return this.$val.OnReply(a);};H.ptr.prototype.Resolve=function(a){var a,b,c,d,e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=this;c=b.fulfillers;d=0;case 1:if(!(d<c.$length)){$s=2;continue;}e=((d<0||d>=c.$length)?($throwRuntimeError("index out of range"),undefined):c.$array[c.$offset+d]);$r=b.invoke("Promise onFulfilled callback:",e,a);$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}d++;$s=1;continue;case 2:$s=-1;return;}return;}if($f===undefined){$f={$blk:H.ptr.prototype.Resolve};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};H.prototype.Resolve=function(a){return this.$val.Resolve(a);};H.ptr.prototype.Reject=function(a){var a,b,c,d,e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=this;c=b.rejecters;d=0;case 1:if(!(d<c.$length)){$s=2;continue;}e=((d<0||d>=c.$length)?($throwRuntimeError("index out of range"),undefined):c.$array[c.$offset+d]);$r=b.invoke("Promise onRejected callback:",e,a);$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}d++;$s=1;continue;case 2:$s=-1;return;}return;}if($f===undefined){$f={$blk:H.ptr.prototype.Reject};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};H.prototype.Reject=function(a){return this.$val.Reject(a);};H.ptr.prototype.Notify=function(a){var a,b,c,d,e,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:b=this;c=b.notifiers;d=0;case 1:if(!(d<c.$length)){$s=2;continue;}e=((d<0||d>=c.$length)?($throwRuntimeError("index out of range"),undefined):c.$array[c.$offset+d]);$r=b.invoke("Promise onNotified callback:",e,a);$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}d++;$s=1;continue;case 2:$s=-1;return;}return;}if($f===undefined){$f={$blk:H.ptr.prototype.Notify};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.$s=$s;$f.$r=$r;return $f;};H.prototype.Notify=function(a){return this.$val.Notify(a);};H.ptr.prototype.invoke=function(a,b,c){var a,b,c,d,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);a=[a];d=[d];d[0]=this;$deferred.push([(function(a,d){return function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=d[0].OnPanic(a[0],$recover());$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;};})(a,d),[]]);b.apply(undefined,$externalize(c,S));$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:H.ptr.prototype.invoke};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};H.prototype.invoke=function(a,b,c){return this.$val.invoke(a,b,c);};J=function(a){var a;return new I.ptr(a,E((function(){return(function $b(b){var b,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;b=$f.b;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:if(!(a.OnLog===$throwNilPointerError)){$s=1;continue;}$s=2;continue;case 1:$r=a.OnLog(new S([new $String(b)]));$s=3;case 3:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}case 2:$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.b=b;$f.$s=$s;$f.$r=$r;return $f;});})));};$pkg.NewSessionAdapter=J;I.ptr.prototype.InvokeOnSessionEvent=function(a,b,c){var a,b,c,d,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);a=[a];d=[d];d[0]=this;$deferred.push([(function(a,d){return function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=d[0].OnPanic(a[0],$recover());$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;};})(a,d),[]]);b($externalize(c.Params,Q));$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:I.ptr.prototype.InvokeOnSessionEvent};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};I.prototype.InvokeOnSessionEvent=function(a,b,c){return this.$val.InvokeOnSessionEvent(a,b,c);};I.ptr.prototype.OnSessionEvent=function(a){var a,b;b=this;b.Session.OnSessionEvent=(function $b(c){var c,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;c=$f.c;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=b.InvokeOnSessionEvent("Session.onSessionEvent callback:",a,c);$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.c=c;$f.$s=$s;$f.$r=$r;return $f;});};I.prototype.OnSessionEvent=function(a){return this.$val.OnSessionEvent(a);};I.ptr.prototype.InvokeOnEvent=function(a,b,c){var a,b,c,d,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);a=[a];d=[d];d[0]=this;$deferred.push([(function(a,d){return function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=d[0].OnPanic(a[0],$recover());$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;};})(a,d),[]]);b($externalize(c.Params,Q),$externalize(G(c.Payload),N));$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:I.ptr.prototype.InvokeOnEvent};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}};I.prototype.InvokeOnEvent=function(a,b,c){return this.$val.InvokeOnEvent(a,b,c);};I.ptr.prototype.OnEvent=function(a){var a,b;b=this;b.Session.OnEvent=(function $b(c){var c,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;c=$f.c;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=b.InvokeOnEvent("Session.onEvent callback:",a,c);$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.c=c;$f.$s=$s;$f.$r=$r;return $f;});};I.prototype.OnEvent=function(a){return this.$val.OnEvent(a);};I.ptr.prototype.OnClose=function(a){var a,b;b=this;b.Session.OnClose=(function $b(){var $s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);$deferred.push([(function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=b.OnPanic("Session.onClose callback:",$recover());$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;}),[]]);a();$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}});};I.prototype.OnClose=function(a){return this.$val.OnClose(a);};I.ptr.prototype.OnConnState=function(a){var a,b;b=this;if(a===null){b.Session.OnConnState=$throwNilPointerError;return;}b.Session.OnConnState=(function $b(c){var c,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;c=$f.c;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);$deferred.push([(function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=b.OnPanic("Session.onConnState callback:",$recover());$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;}),[]]);a($externalize(c,$String));$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:$b};}$f.c=c;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}});};I.prototype.OnConnState=function(a){return this.$val.OnConnState(a);};I.ptr.prototype.OnConnActive=function(a){var a,b;b=this;if(a===null){b.Session.OnConnActive=$throwNilPointerError;return;}b.Session.OnConnActive=(function $b(){var $s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);$deferred.push([(function $b(){var $s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=b.OnPanic("Session.onConnActive callback:",$recover());$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$s=-1;return;}return;}if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$r=$r;return $f;}),[]]);a(new($global.Date)().getTime());$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:$b};}$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}});};I.prototype.OnConnActive=function(a){return this.$val.OnConnActive(a);};I.ptr.prototype.OnLog=function(a){var a,b;b=this;if(a===null){b.Session.OnLog=$throwNilPointerError;return;}b.Session.OnLog=(function $b(c){var c,d,e,f,g,h,i,j,k,l,m,$s,$deferred,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;$s=$f.$s;$deferred=$f.$deferred;$r=$f.$r;}var $err=null;try{s:while(true){switch($s){case 0:$deferred=[];$deferred.index=$curGoroutine.deferStack.length;$curGoroutine.deferStack.push($deferred);$deferred.push([(function(){$recover();}),[]]);d="";e=c;f=0;case 1:if(!(f<e.$length)){$s=2;continue;}g=((f<0||f>=e.$length)?($throwRuntimeError("index out of range"),undefined):e.$array[e.$offset+f]);h="";i=g;if($assertType(i,$String,true)[1]){$s=3;continue;}if($assertType(i,$error,true)[1]){$s=4;continue;}$s=5;continue;case 3:j=i.$val;h=j;$s=6;continue;case 4:k=i;m=k.Error();$s=7;case 7:if($c){$c=false;m=m.$blk();}if(m&&m.$blk!==undefined){break s;}h=m;$s=6;continue;case 5:l=i;h=$internalize($global.JSON.stringify($externalize(l,$emptyInterface)),$String);case 6:if(d.length>0){d=d+(" ");}d=d+(h);f++;$s=1;continue;case 2:while(true){if(!(d.length>0&&(d.charCodeAt((d.length-1>>0))===32))){break;}d=$substring(d,0,(d.length-1>>0));}a($externalize(d,$String));$s=-1;return;}return;}}catch(err){$err=err;$s=-1;}finally{$callDeferred($deferred,$err);if($curGoroutine.asleep){if($f===undefined){$f={$blk:$b};}$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.$s=$s;$f.$deferred=$deferred;$f.$r=$r;return $f;}}});};I.prototype.OnLog=function(a){return this.$val.OnLog(a);};I.ptr.prototype.SetAddress=function(a){var a,b;b=this;b.Session.Address=a;};I.prototype.SetAddress=function(a){return this.$val.SetAddress(a);};I.ptr.prototype.Send=function(a,b){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,$s,$r;$s=0;var $f,$c=false;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;a=$f.a;b=$f.b;c=$f.c;d=$f.d;e=$f.e;f=$f.f;g=$f.g;h=$f.h;i=$f.i;j=$f.j;k=$f.k;l=$f.l;m=$f.m;n=$f.n;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:c=[c];d=null;e=this;f=new B.Action.ptr(a,F(b),$throwNilPointerError,new $Int64(0,0));g=(h=a[$String.keyFor("action_id")],h!==undefined?[h.v,true]:[$ifaceNil,false]);i=g[0];j=g[1];if(j){$s=1;continue;}$s=2;continue;case 1:if(!($interfaceIsEqual(i,$ifaceNil))){console.log("NinchatClient.Session.send called incorrectly with an action_id value");}k=e.Session.Send(f);$s=4;case 4:if($c){$c=false;k=k.$blk();}if(k&&k.$blk!==undefined){break s;}k;$s=3;continue;case 2:l=new H.ptr(e.OnPanic,N.nil,N.nil,N.nil,O.nil);f.OnReply=$methodVal(l,"OnReply");m=e.Session.Send(f);$s=5;case 5:if($c){$c=false;m=m.$blk();}if(m&&m.$blk!==undefined){break s;}m;c[0]=$assertType((n=a[$String.keyFor("action_id")],n!==undefined?n.v:$ifaceNil),$Int64);l.actionID=(c.$ptr||(c.$ptr=new O(function(){return this.$target[0];},function($v){this.$target[0]=$v;},c)));d=l.Object();case 3:$s=-1;return d;}return;}if($f===undefined){$f={$blk:I.ptr.prototype.Send};}$f.a=a;$f.b=b;$f.c=c;$f.d=d;$f.e=e;$f.f=f;$f.g=g;$f.h=h;$f.i=i;$f.j=j;$f.k=k;$f.l=l;$f.m=m;$f.n=n;$f.$s=$s;$f.$r=$r;return $f;};I.prototype.Send=function(a,b){return this.$val.Send(a,b);};K=function(){var a,b;a=new B.Session.ptr($throwNilPointerError,$throwNilPointerError,$throwNilPointerError,$throwNilPointerError,$throwNilPointerError,$throwNilPointerError,"",false,new $packages["sync"].Mutex.ptr(0,0),false,$ifaceNil,"",new $Int64(0,0),$chanNil,AA.nil,0,false,new $Int64(0,0),new $Int64(0,0),$chanNil,false,false,new B.testSupport.ptr());b=J(a);return $makeMap($String.keyFor,[{k:"onSessionEvent",v:new AB($methodVal(b,"OnSessionEvent"))},{k:"onEvent",v:new AB($methodVal(b,"OnEvent"))},{k:"onClose",v:new AB($methodVal(b,"OnClose"))},{k:"onConnState",v:new AB($methodVal(b,"OnConnState"))},{k:"onConnActive",v:new AB($methodVal(b,"OnConnActive"))},{k:"onLog",v:new AB($methodVal(b,"OnLog"))},{k:"setParams",v:new AC($methodVal(a,"SetParams"))},{k:"setTransport",v:new AD(L)},{k:"setAddress",v:new AD($methodVal(b,"SetAddress"))},{k:"open",v:new AE($methodVal(a,"Open"))},{k:"close",v:new AE($methodVal(a,"Close"))},{k:"send",v:new AF($methodVal(b,"Send"))}]);};L=function(a){var a;console.log("NinchatClient.Session.setTransport doesn't do anything anymore");};AG.methods=[{prop:"Object",name:"Object",pkg:"",typ:$funcType([],[M],false)},{prop:"OnReply",name:"OnReply",pkg:"",typ:$funcType([X],[],false)},{prop:"Resolve",name:"Resolve",pkg:"",typ:$funcType([S],[],true)},{prop:"Reject",name:"Reject",pkg:"",typ:$funcType([S],[],true)},{prop:"Notify",name:"Notify",pkg:"",typ:$funcType([S],[],true)},{prop:"invoke",name:"invoke",pkg:"ninchatclient/lib",typ:$funcType([$String,M,S],[],true)}];AI.methods=[{prop:"InvokeOnSessionEvent",name:"InvokeOnSessionEvent",pkg:"",typ:$funcType([$String,M,X],[],false)},{prop:"OnSessionEvent",name:"OnSessionEvent",pkg:"",typ:$funcType([M],[],false)},{prop:"InvokeOnEvent",name:"InvokeOnEvent",pkg:"",typ:$funcType([$String,M,X],[],false)},{prop:"OnEvent",name:"OnEvent",pkg:"",typ:$funcType([M],[],false)},{prop:"OnClose",name:"OnClose",pkg:"",typ:$funcType([M],[],false)},{prop:"OnConnState",name:"OnConnState",pkg:"",typ:$funcType([M],[],false)},{prop:"OnConnActive",name:"OnConnActive",pkg:"",typ:$funcType([M],[],false)},{prop:"OnLog",name:"OnLog",pkg:"",typ:$funcType([M],[],false)},{prop:"SetAddress",name:"SetAddress",pkg:"",typ:$funcType([$String],[],false)},{prop:"Send",name:"Send",pkg:"",typ:$funcType([Q,M],[M],false)}];H.init("ninchatclient/lib",[{prop:"OnPanic",name:"OnPanic",embedded:false,exported:true,typ:AH,tag:""},{prop:"fulfillers",name:"fulfillers",embedded:false,exported:false,typ:N,tag:""},{prop:"rejecters",name:"rejecters",embedded:false,exported:false,typ:N,tag:""},{prop:"notifiers",name:"notifiers",embedded:false,exported:false,typ:N,tag:""},{prop:"actionID",name:"actionID",embedded:false,exported:false,typ:O,tag:""}]);I.init("",[{prop:"Session",name:"Session",embedded:false,exported:true,typ:Y,tag:""},{prop:"OnPanic",name:"OnPanic",embedded:false,exported:true,typ:AH,tag:""}]);$init=function(){$pkg.$init=function(){};var $f,$c=false,$s=0,$r;if(this!==undefined&&this.$blk!==undefined){$f=this;$c=true;$s=$f.$s;$r=$f.$r;}s:while(true){switch($s){case 0:$r=A.$init();$s=1;case 1:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}$r=B.$init();$s=2;case 2:if($c){$c=false;$r=$r.$blk();}if($r&&$r.$blk!==undefined){break s;}}return;}if($f===undefined){$f={$blk:$init};}$f.$s=$s;$f.$r=$r;return $f;};$pkg.$init=$init;return $pkg;})();
